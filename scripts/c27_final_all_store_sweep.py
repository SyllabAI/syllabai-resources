...
PINS = {
    ...
    GP.legacy_rel("concept_edges"): "f4907752eb73cc9b",  # session-62 post (pre was 43ff4b9610cc0927…; batch-9 authored-to-gate regen — 20 authored semantic + 21 PART_OF mints, zero promotions)
