...
# — the store total moved 216 -> 236; the batch-2 slice stays preserved
# exactly.
check("D6 store total 236 (28 pilot + 28 batch-1 + 23 batch-2 + 39 "
...
check("D10 live store shape 188 nodes / 459 edges (199 PART_OF + 260 "
      "semantic)",
