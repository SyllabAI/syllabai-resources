...
Checks (all fail-closed; every group must pass):
  ...
  D. invariants      — the pilot and batch-1 slices are intact (28+28
                       ...
                       both RR edges REVIEW_REQUIRED); store total 118;
...
# session-52 re-anchor (dated, protective intent unchanged): the batch-3
# §18 application added 39 operator promotions (c11_batch3_verdicts) —
# the store total moved 79 -> 118; the batch-2 slice below is preserved
# exactly inside the grown store.
# session-54 re-anchor (dated, protective intent unchanged): the batch-4
...
# §18 application added 19 operator promotions (c11_batch7_verdicts,
# applied 2026-09-23 via the B7 diff-review bundle) — the store total
# moved 187 -> 206; the batch-2 slice stays preserved exactly.
# session-62 re-anchor (dated, protective intent unchanged): the batch-8
# §18 application added 10 operator promotions (c11_batch8_verdicts,
# applied 2026-09-24 via the B8 diff-review bundle) — the store total
# moved 206 -> 216; the batch-2 slice stays preserved exactly.
check("D6 store total 216 (28 pilot + 28 batch-1 + 23 batch-2 + 39 "
...
check("D8 no PART_OF edge promoted through the §18 record "
