...
check("D3 semantic HV at the operator-promoted count (272; the batch-7 "
      ...
      "edges likewise at session 65, and the 17 batch-11 authored "
      "edges likewise at session 67; PART_OF HV rides the T-C19 "
      "G19 record)",
      hv == 272)
