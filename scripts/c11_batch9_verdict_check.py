...
Checks (all fail-closed; every group must pass):
  ...
  D. invariants      — the pilot + batch-1..8 slices are intact
                       ...
                       REVIEW_REQUIRED); store total 236, all operator;
...
check("D13 store total 236 (28+28+23+39+35+18+16+19+10+20), all operator",
      len(store_map) == 236
...
print(f"c11_batch9_verdict_check: ALL PASS — batch-9 operator verdict "
      ...
      f"slices intact; 236 store entries total; the FIVE boundary targets "
