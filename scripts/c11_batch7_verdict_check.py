...
check("D2 the 3 pilot operator HOLDs stay SUGGESTED (un-promoted) and "
      ...
      "through §18 at session 62; batch-7 verdicts applied at session 60)",
...
check("D11 store total 216 (28+28+23+39+35+18+16+19+10), all operator",
      len(store_map) == 216
...
check("D15 live store shape 180 nodes / 425 edges (184 PART_OF + 241 "
