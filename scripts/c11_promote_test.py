...
def make_sandbox(root: Path) -> Path:
    ...
    # session-49: stage the whole decision-record registry (batch 2)
    shutil.copy2(LIVE_SCRIPTS / "c11_batch2_decisions.yaml",
                 sb / "scripts" / "c11_batch2_decisions.yaml")
    # session-51: stage the whole decision-record registry (batch 3)
    shutil.copy2(LIVE_SCRIPTS / "c11_batch3_decisions.yaml",
                 sb / "scripts" / "c11_batch3_decisions.yaml")
    ...
    # session-57: stage the whole decision-record registry (batch 6)
    shutil.copy2(LIVE_SCRIPTS / "c11_batch6_decisions.yaml",
                 sb / "scripts" / "c11_batch6_decisions.yaml")
    # session-59: stage the whole decision-record registry (batch 7)
    shutil.copy2(LIVE_SCRIPTS / "c11_batch7_decisions.yaml",
                 sb / "scripts" / "c11_batch7_decisions.yaml")
    # session-61: stage the whole decision-record registry (batch 8)
    shutil.copy2(LIVE_SCRIPTS / "c11_batch8_decisions.yaml",
                 sb / "scripts" / "c11_batch8_decisions.yaml")
