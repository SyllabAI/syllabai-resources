...
check("D3 semantic HV at the operator-promoted count (272; the batch-6 "
      ...
      "edges likewise at session 62, the 20 batch-9 authored edges "
      "likewise at session 63, and the 19 batch-10 authored edges "
      "likewise at session 65, and the 17 batch-11 authored edges "
      "likewise at session 67; PART_OF HV rides the T-C19 G19 "
      "record)",
      hv == 272)
