...
check("D3 semantic HV at the operator-promoted count (206; the batch-6 "
      ...
      "operator's §6 verdicts via §18 at session 58, and the 19 batch-7 "
      "authored edges likewise at session 60; PART_OF HV rides the "
      "T-C19 G19 record)",
      hv == 206)
