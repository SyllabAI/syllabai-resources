...
# 216 -> 236; the batch-5 slice stays preserved exactly.
check("D9 store total 272 (28+28+23+39+35+18+16+19+10+20+19+17), all operator",
      len(store_map) == 272
...
check("D13 live store shape 193 nodes / 488 edges (211 PART_OF + 277 "
