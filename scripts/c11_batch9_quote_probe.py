#!/usr/bin/env python3
"""T-C11 session 62 — batch-9 quote probe (fail-closed).

Walks scripts/c11_batch9_decisions.yaml and verifies EVERY evidence quote
...
def main() -> int:
    ...
    if fails:
        ...
        for f in fails:
            print("  -", f)
        return 1
    print("c11_batch9_quote_probe: ALL PASS — every quote verbatim under "
