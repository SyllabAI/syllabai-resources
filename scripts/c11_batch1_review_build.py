...
if (HERE / "c11_batch1_verdicts.yaml").exists():
    ...
    _tpl_doc = yaml.safe_load(
        (HERE / "c11_batch1_verdicts_template.yaml")
    ...
    _require(len(_tpl_doc["edge_verdicts"]) == 28,
             "post-write: written template edge_verdicts count drifted")
    _require(len(_tpl_doc["rr_settlement"]) == 1,
             "post-write: written template rr_settlement count drifted")
    _require(len(_tpl_doc["node_verdicts"]) == 24,
