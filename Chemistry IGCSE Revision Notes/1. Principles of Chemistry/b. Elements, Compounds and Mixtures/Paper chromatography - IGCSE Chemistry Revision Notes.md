---
created: 2026-09-10T16:38:13 (UTC +06:00)
tags: []
...
spec_map:
  ...
  - code: 4CH1-1.13
    provenance:
      ...
      evidence: Investigate how paper chromatography can be used to separate and identify a mixture of
        food colourings
...
# Paper chromatography - IGCSE Chemistry Revision Notes

> ## Excerpt
> Explore paper chromatography for IGCSE Chemistry to separate and identify food colorings, analyse Rf values, and compare known and unknown samples.
...
-   This can lead to smearing and an inaccurate measurement of the _R_<sub>f</sub> value
...
-   Therefore, you cannot calculate the _R_<sub>f</sub> values
...
| **Food colouring** | **Distance moved by spot (mm)** | **Distance Moved by solvent (mm)** | _**R**_**f** **value** |
|----------------|-----------------------------|--------------------------------|----------|
| A |  |  |  |
| B |  |  |  |
| C |  |  |  |
...
-   The _R_<sub>f</sub> values of food colours A, B, C and D should be compared to that for the unknown sample as well as a visual comparison being made
