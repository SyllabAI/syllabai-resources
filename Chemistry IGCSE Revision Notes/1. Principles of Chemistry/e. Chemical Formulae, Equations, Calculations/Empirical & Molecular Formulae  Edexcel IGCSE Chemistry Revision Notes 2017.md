---
created: 2026-09-10T16:46:26 (UTC +06:00)
tags: []
...
> ## Excerpt
> Revision notes on Empirical & Molecular Formulae for the Edexcel IGCSE Chemistry syllabus, written by the Chemistry experts at Save My Exams.
...
_A_<sub>r</sub> (H) = 1   _A_<sub>r</sub> (O) = 16
...
| 4. Moles = massAr | 101 = 10 | 8016 = 5 |
| 5. Ratio (divide by smallest) | 105 = 2 | 55 = 1 |
| 6. Answer | The empirical formula is H2O | The empirical formula is H2O |
...
_A_<sub>r&nbsp;</sub> (H) = 1   _A_<sub>r&nbsp;</sub> (C) = 12   _A_<sub>r&nbsp;</sub> (O) = 16
...
| 4. Moles = massAr | 31.5812 = 2.63 | 5.261 = 5.26 | 63.1616 = 3.95 |
| 5. Ratio (divide by smallest) | 2.632.63 = 1 | 5.262.63 = 2 | 3.952.63 = 1.5 |
| 5. Whole number ratio | 1 x 2 = 2 | 2 x 2 = 4 | 1.5 x 2 = 3 |
| 6. Answer | The empirical formula is C2H4O3 | The empirical formula is C2H4O3 | The empirical formula is C2H4O3 |
...
-   To calculate the molecular formula:
    ...
    2.  Use the following equation:
        ...
        -   $\frac{\mathrm{relative}\text{}\mathrm{formula}\text{}\mathrm{mass}\text{}\mathrm{of}\text{}\mathrm{molecular}\text{}\mathrm{formula}}{\mathrm{relative}\text{}\mathrm{formula}\text{}\mathrm{mass}\text{}\mathrm{of}\text{}\mathrm{empirical}\text{}\mathrm{formula}}$
...
The relative formula mass (_M_<sub><i>r </i></sub> ) of **X** is 180.

Calculate the molecular formula of **X**.

_A_<sub>r</sub> (C) = 12      _A_<sub>r</sub> (H) = 1      _A_<sub>r</sub> (S) = 32

**Answer:**

1.  Calculate the relative formula mass of the empirical formula:
    
    -   _M_<sub><i>r </i></sub> \=  (12 x 4) + (1 x 10) + (32 x 1)   =   90
...
_A_<sub>r</sub> (Cu) = 63.5      _A_<sub>r</sub> (S) = 32      _A_<sub>r</sub> (O) = 16     _A_<sub>r</sub> (H) = 1
...
| 3. _M_r | 63.5 + 32 + (16 x 4)<br>= 159.5 | (1 x 2) + 16<br>= 18 |
| 4. Moles = massMr | 7.19159.5 = 0.045 | 4.0618 = 0.226 |
| 5. Salt : water ratio | 0.0450.045 = 1 | 0.2260.045 = 5 |
| 6. Formula of hydrated salt | The formula is CuSO4•**5**H2O |  |
