---
created: 2026-09-10T16:45:49 (UTC +06:00)
tags: []
...
> ## Excerpt
> Learn how to calculate reacting masses and balance equations for IGCSE Chemistry, using worked examples and examiner tips for accurate calculations.
...
**2Mg (s)** **+** **O**<sub><b>2</b></sub> **(g)  ⟶ 2 MgO (s)** 
...
_A_<sub>r</sub>(O) = 16   _A_<sub>r</sub>(Mg) = 24

**Answer:**

-   **Step 1** - calculate the moles of magnesium 
    
    -   Moles = $(\frac{\mathrm{mass}}{M_{r}})$ = $(\frac{6}{24})$ = 0.25
...
-   **Step 3** - calculate the mass of magnesium oxide
    ...
    -   Mass = moles x _M_<sub>r</sub> = 0.25 moles x (24 + 16) = 10 g
...
-   **Step 1** - calculate the moles of aluminium oxide 
    ...
    -   Moles = $(\frac{\mathrm{mass}}{M_{r}})$ = $(\frac{51000000}{102})$ = 500 000
...
-   **Step 3** - calculate the mass of aluminium 
    ...
    -   Mass = moles x _M_<sub>r</sub> = 1 000 000 moles x 27 = 27 000 000 g
...
-   When you see any of the following phrases in a question, make sure you work methodically through the process of calculating moles, using molar ratios and calculating mass
    ...
    -   _Calculate the mass..._
        
    -   _Calculate the minimum mass..._
        
    -   _Calculate the maximum mass..._
...
-   **Step 1:** Write the unbalanced chemical equation:
    ...
    -   _C +_ ZnO → _CO_<sub><i>2</i></sub> _+_ Zn
