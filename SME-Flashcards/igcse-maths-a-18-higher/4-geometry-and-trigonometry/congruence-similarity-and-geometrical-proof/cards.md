...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/flashcards/4-geometry-and-trigonometry/congruence-similarity-and-geometrical-proof/
...
## Card 12 — keyword_definition (`fl_5nwwkTFSHfC98CYB`)
...
## Card 13 — keyword_definition (`fl_fBjRHfxCyKdBbZJv`)
...
## Card 14 — true_or_false (`fl_tTnbTkWFVHcnBNGT`)
...
## Card 15 — question_and_answer (`fl_3PfPRyTCHG2CbRc7`)
...
## Card 16 — keyword_definition (`fl_WsDxrh7R7MGtGzMd`)
...
## Card 17 — keyword_definition (`fl_rVsqq8GySJwvRvNH`)
...
## Card 18 — true_or_false (`fl_RC9R4S4jJQNWTfBf`)
...
## Card 19 — question_and_answer (`fl_x5h8TYnTQv7Yc4Bz`)
...
## Card 20 — keyword_definition (`fl_NxM4zxn8fDZQKwWq`)
...
## Card 21 — question_and_answer (`fl_9kXw8mXmD2gf8SGb`)
...
## Card 22 — question_and_answer (`fl_V3cqdK8jP8CKnnhX`)
