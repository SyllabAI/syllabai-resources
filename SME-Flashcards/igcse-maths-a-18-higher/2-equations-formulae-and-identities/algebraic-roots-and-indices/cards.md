...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/flashcards/2-equations-formulae-and-identities/algebraic-roots-and-indices/


## Card 1 — keyword_definition (`fl_wt6R2SgXTdm9qBmG`)

**FRONT**

Write down the** index law** for $a^{m}\timesa^{n}$.


**BACK**

The index law is: $a^{m}\timesa^{n}=a^{m+n}$.
...
## Card 2 — keyword_definition (`fl_3MQj8wkbwWH6Qgsj`)
...
## Card 3 — keyword_definition (`fl_ZgSCsy4WRcN8NxNQ`)
...
## Card 4 — keyword_definition (`fl_XvDdNbHd38nVC2zD`)
...
A fractional power of $\frac{1}{m}$ means the $m^{\mathrm{th}}$ root.

E.g. `x to the power of 1 fifth end exponent equals fifth root of x`.



## Card 5 — keyword_definition (`fl_tMxZPdbfD7Z9dmH3`)
...
## Card 6 — keyword_definition (`fl_vD3KF5VYhgHwC4Kn`)
...
## Card 7 — keyword_definition (`fl_x3d4vvp69RhdGC3x`)
...
## Card 8 — keyword_definition (`fl_SMK7pH957Xg8qgc3`)
...
## Card 9 — true_or_false (`fl_b4myTSTwwbpRqXzX`)
...
## Card 10 — true_or_false (`fl_yDQWtwtG8S29NNZ7`)
...
You can swap the order of the $n^{\mathrm{th}}$ root and the power of $m$.
...
## Card 11 — question_and_answer (`fl_jjzZhZpZj6SngcRW`)
...
## Card 12 — question_and_answer (`fl_XsTQdw9NRTwfNT7J`)
...
So the **first step** is to **change the base **of 27 to 3, using the fact 27 = 3<sup>3</sup>.

(Alternatively, you could change the base of 3 to 27, as $3=27^{\frac{1}{3}}$).



## Card 13 — true_or_false (`fl_gsmKktH95rCWnRdF`)
