...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/flashcards/1-numbers-and-the-number-system/compound-interest-and-depreciation/


## Card 1 — true_or_false (`fl_gMZkfVGjsBnnz47p`)
...
## Card 2 — keyword_definition (`fl_BvwvdyhTynVQ4mMw`)
...
## Card 3 — true_or_false (`fl_cC9J4Qkpm23XpCBz`)
...
E.g. For an investment of £400 with an interest of 3% over a period of 5 years, the final amount can be calculated by finding a 3% increase, five times in a row ( 400 x 1.03<sup>5</sup>).



## Card 4 — true_or_false (`fl_zrYPW8QbZbsDKsH8`)
...
## Card 5 — question_and_answer (`fl_Skf7Z9SQxj9Hfst6`)
...
## Card 6 — keyword_definition (`fl_kw7twcgzRbmC2qFK`)
...
## Card 7 — keyword_definition (`fl_MRPFVBDJ3YXmVzC4`)
...
## Card 8 — true_or_false (`fl_8QvpwwmrDdqD6Mwq`)
...
E.g. For an item with an original value of £200 that depreciates in value by 4% each year over a period of 6 years, its value at the end of 6 years can be calculated by finding a 4% decrease, six times in a row ( 200 x 0.96<sup>6</sup>).
