...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/flashcards/1-numbers-and-the-number-system/rounding-estimation-and-bounds/


## Card 1 — question_and_answer (`fl_WgHGs9c8kQKQYHSG`)
...
## Card 2 — question_and_answer (`fl_ntxxCsNXkpD2vRVN`)
...
## Card 3 — true_or_false (`fl_KjsvDhsQpwYNHZ8z`)
...
## Card 4 — question_and_answer (`fl_RY42QgX94fWSYpWb`)
...
## Card 5 — question_and_answer (`fl_56c9wqtK2fkRVBkq`)

**FRONT**

What is the **general rule** for rounding when performing **estimating **a calculation?

E.g. Estimate the calculation $\frac{2.1\times3.7}{0.9}$
...
E.g. For the calculation $\frac{2.1\times3.7}{0.9}$, round to $\frac{2\times4}{1}=8$



## Card 6 — question_and_answer (`fl_bzD6JpCNwmvvtFds`)
...
## Card 7 — question_and_answer (`fl_Y4vgpwRqMCMXmN6f`)
...
## Card 8 — true_or_false (`fl_SfcDMmN6wjjnzXp4`)
...
## Card 9 — true_or_false (`fl_ftz8b7fgbCXbKfw5`)
...
## Card 10 — keyword_definition (`fl_Bx63xsSX4kRwSpJW`)
...
## Card 11 — keyword_definition (`fl_rfHzbhvfpxqFBy58`)
...
## Card 12 — true_or_false (`fl_WvVXXcDk7RJmjT5k`)

**FRONT**

**True or False?**

If $x$ is a **rounded **number, the** error interval** for $x$ can be written as $\mathrm{lower} \mathrm{bound}\leqx\leq\mathrm{upper} \mathrm{bound}$.
...
If $x$ is a **rounded **number, the** error interval** for $x$ can not be written as $\mathrm{lower} \mathrm{bound}\leqx\leq\mathrm{upper} \mathrm{bound}$ because $x$ can not be **equal** to the upper bound.

Instead, $\mathrm{lower} \mathrm{bound}\leqx<\mathrm{upper} \mathrm{bound}$ is the correct statement.



## Card 13 — true_or_false (`fl_RKxkd24SxSNkKy5n`)
...
## Card 14 — question_and_answer (`fl_JyjvgHQYbM3R75YY`)
...
## Card 15 — question_and_answer (`fl_6dq7Px58WhBCvVff`)

**FRONT**

What do you need to do to the **lower **and **upper **bounds of $x$ to find the **lower **and **upper **bounds of $4x$?


**BACK**

To find the **lower **and **upper **bounds of $4x$, you need to:

- **Multiply **the **lower bound **of** **$x$by $4$ to find the **lower bound** of $4x$.
- **Multiply** the **upper bound** of $x$ by $4$ to find the **upper bound **of $4x$.



## Card 16 — question_and_answer (`fl_RD9rFkP22RJxPmDR`)
...
## Card 17 — question_and_answer (`fl_PkvZkpBgGqs9KStc`)
...
## Card 18 — true_or_false (`fl_CqCpTxh8KGT2fmHr`)
...
## Card 19 — true_or_false (`fl_djpMy8pNh4JTyxSV`)

**FRONT**

**True or False?**

To find the **lower bound** of $ab$, you should use the **lower bound** of $a$ and the **lower bound** of $b$.
...
## Card 20 — question_and_answer (`fl_WpXddShQzXhMf9xc`)
