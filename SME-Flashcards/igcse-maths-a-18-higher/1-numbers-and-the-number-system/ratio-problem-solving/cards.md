...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/flashcards/1-numbers-and-the-number-system/ratio-problem-solving/


## Card 1 — true_or_false (`fl_2CFQdNsZ78Xr5dsr`)
...
## Card 2 — true_or_false (`fl_qcBVx3VRTqNXbDhz`)
...
## Card 3 — question_and_answer (`fl_xzymXVYgq59pSXDM`)
...
## Card 4 — question_and_answer (`fl_Q4DSqgrn7vJ6pqN2`)
...
## Card 5 — question_and_answer (`fl_7Ty4ZDMtmSPXXBRh`)
...
## Card 6 — true_or_false (`fl_p3TSV8zkPtwmgBk2`)
...
## Card 7 — question_and_answer (`fl_9gx6MrSc8ShWkZWP`)
...
E.g.
$x:y=1\times2:3\times2=2:6$
$y:z=2\times3:5\times3=6:15$

So, $x:y:z=2:6:15$



## Card 8 — true_or_false (`fl_s4PFmvNfX5HxdCrk`)
