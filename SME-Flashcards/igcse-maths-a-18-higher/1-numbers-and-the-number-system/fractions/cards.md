...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/flashcards/1-numbers-and-the-number-system/fractions/


## Card 1 — true_or_false (`fl_xtcC2mhhRDzmmDSy`)
...
## Card 2 — keyword_definition (`fl_MFQRdSVcSnsRN92X`)

**FRONT**

Define the term **equivalent fractions**.

E.g. Find an equivalent fraction to $\frac{2}{5}$.
...
E.g. $\frac{2}{5}=\frac{2\times3}{5\times3}=\frac{6}{15}$



## Card 3 — question_and_answer (`fl_yfBrwDjFStf4yJXM`)

**FRONT**

How do you **simplify a fraction**?

E.g. Simplify $\frac{18}{24}$.
...
E.g. $\frac{18}{24}=\frac{18\div6}{24\div6}=\frac{3}{4}$



## Card 4 — question_and_answer (`fl_Vwkx48qjmVwkHMNd`)

**FRONT**

How do you find a **fraction of an amount**?

E.g. What is $\frac{2}{5}$ of 35?
...
## Card 5 — keyword_definition (`fl_9hbCqbHRGyxTvQWQ`)
...
E.g. $\frac{4}{3}$ is a top heavy fraction.



## Card 6 — keyword_definition (`fl_gyWHCrHqw5xrMGtg`)
...
E.g. $2\frac{3}{5}$is a mixed number.



## Card 7 — question_and_answer (`fl_zZsQPzhNxjTNSsHq`)
...
E.g. $4\frac{5}{8}=\frac{4\times8+5}{8}=\frac{37}{8}$



## Card 8 — question_and_answer (`fl_3cWkZ8dSJXMqMfdj`)
...
E.g. $\frac{22}{7}=\frac{21}{7}+\frac{1}{7}=3\frac{1}{7}$



## Card 9 — question_and_answer (`fl_45gyPmhQHvw77H9t`)
...
## Card 10 — keyword_definition (`fl_thH692h8bCtVhKWt`)

**FRONT**

What is the **lowest common denominator **of two fractions.

E.g. $\frac{2}{5}$ and $\frac{1}{3}$.
...
E.g. The fractions $\frac{2}{5}$ and $\frac{1}{3}$ have denominators of 3 and 5.

Therefore, the lowest common denominator of these two fractions is 15.



## Card 11 — true_or_false (`fl_tQ9TCM8CzBWxXRdm`)

**FRONT**

**True or False?**

To work out $\frac{1}{4}+\frac{5}{7}$, you add the numerators and add the denominators to get $\frac{6}{11}$.
...
E.g. $\frac{1}{4}+\frac{5}{7}=\frac{7}{28}+\frac{20}{28}=\frac{27}{28}$.



## Card 12 — true_or_false (`fl_9FcsrgJyCXvYZbkJ`)
...
E.g. $\frac{2}{5}+\frac{4}{15}=\frac{6}{15}+\frac{4}{15}$.



## Card 13 — question_and_answer (`fl_hDgKSh6GzPj7bWwf`)

**FRONT**

How do you **add or subtract** two **mixed numbers**?

E.g. $5\frac{2}{3}-4\frac{1}{6}$.
...
## Card 14 — true_or_false (`fl_xXCtQGmRKb7GzdTd`)
...
## Card 15 — question_and_answer (`fl_DqQcTDWcK5MXWJtM`)
...
For example, $9\div\frac{2}{3}=9\times\frac{3}{2}$.



## Card 16 — question_and_answer (`fl_63GfgZrFXPbm36rr`)

**FRONT**

How do you **multiply **two fractions?

E.g. $\frac{5}{8}\times\frac{3}{7}$.
...
E.g. $\frac{5}{8}\times\frac{3}{7}=\frac{5\times3}{8\times7}=\frac{15}{56}$



## Card 17 — question_and_answer (`fl_bQy5RVzDsqgWfB2b`)

**FRONT**

How do you **divide **one fraction by another fraction?

E.g. $\frac{3}{9}\div\frac{4}{5}$.
...
E.g. $\frac{3}{9}\div\frac{4}{5}=\frac{3}{9}\times\frac{5}{4}=\frac{15}{36}=\frac{5}{12}$



## Card 18 — true_or_false (`fl_zBMCNKTcdJMyCPgV`)
...
## Card 19 — true_or_false (`fl_Mdx8m3nYhFNptC85`)
