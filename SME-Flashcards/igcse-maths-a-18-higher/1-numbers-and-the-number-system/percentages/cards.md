...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/flashcards/1-numbers-and-the-number-system/percentages/


## Card 1 — question_and_answer (`fl_9zzgFFHKbJ64zhwv`)

**FRONT**

What **number **is a **percentage **out of?
...
## Card 2 — true_or_false (`fl_PQxpDbhMMRXt4bKk`)
...
For example, 23% of 60 can be found by calculating $\frac{23}{100}\times60$.



## Card 3 — question_and_answer (`fl_PCSxHJ4cXcVJm8Y2`)
...
## Card 4 — question_and_answer (`fl_45wcC2nbJsNNpXgD`)
...
## Card 5 — question_and_answer (`fl_XX9bhNh98RqPHNY3`)
...
## Card 6 — true_or_false (`fl_zQVMD2zVtywtPFsK`)
...
## Card 7 — question_and_answer (`fl_N4rBpbjnZgSH7P5d`)
...
## Card 8 — true_or_false (`fl_JP9NyG9vXqfzM8ZD`)

**FRONT**

**True or False?**

To find the **percentage change** from 20 to 32 you can calculate $\frac{32-20}{32}\times100$.
...
$\frac{32-20}{20}\times100$.



## Card 9 — question_and_answer (`fl_j5cV3sdf8C8JJcX3`)
...
the multiplier is $\frac{60}{80}=0.75$, which means that this is a decrease of 25%.



## Card 10 — keyword_definition (`fl_FnKT6Vsyzkv3MXpW`)
...
$\frac{\mathrm{Selling} \mathrm{price}-\mathrm{Cost} \mathrm{price}}{\mathrm{Cost} \mathrm{price}}\times100$
...
## Card 11 — true_or_false (`fl_wwHBDbGcJ3gJgmRN`)
...
## Card 12 — true_or_false (`fl_Sdv6BjMdtMkY3MJw`)
...
## Card 13 — question_and_answer (`fl_zMBf7gjHKCrGCRqm`)
...
## Card 14 — question_and_answer (`fl_hZv4n9F7JVVhHXGy`)
...
## Card 15 — true_or_false (`fl_4qzBqvYKrBXnCHq6`)
...
## Card 16 — true_or_false (`fl_MrjNqpC4t5zRfBrR`)
