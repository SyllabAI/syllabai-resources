...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-1/flashcards/statistics-and-probability/combined-and-conditional-probability/


## Card 1 — question_and_answer (`fl_fbNfPzPkGWjP6jKx`)
...
## Card 2 — question_and_answer (`fl_zBZJ2Xqdgd8cVkjC`)
...
## Card 3 — true_or_false (`fl_9n58c6mctcVBRS82`)
...
## Card 4 — keyword_definition (`fl_QgdQS2gvBbGgT97Q`)
...
## Card 5 — keyword_definition (`fl_ZMk2W4VkKp2BvfW7`)
...
## Card 6 — question_and_answer (`fl_7kHJQt5DDnRnNk84`)
...
## Card 7 — question_and_answer (`fl_j93nQ5qVj62ZpyQ9`)
...
## Card 8 — question_and_answer (`fl_CchND3zTJ27bmyxG`)
...
## Card 9 — keyword_definition (`fl_32jZV35Nc7QF8GYG`)
...
## Card 10 — true_or_false (`fl_2Bt2rHm3X6dRYtc2`)
...
## Card 11 — question_and_answer (`fl_SqhWQNxgzpwKwBxD`)
...
## Card 12 — true_or_false (`fl_mYXSwxTrBVc5g4Ww`)
...
## Card 13 — true_or_false (`fl_Ydwfkq7SYwZsQbgt`)
...
## Card 14 — true_or_false (`fl_sKBQRGnjSBBk8pHR`)
...
## Card 15 — true_or_false (`fl_frKTqSqrd3ckFMgm`)
...
## Card 16 — question_and_answer (`fl_PjFRKVh9RJmDQBcq`)
