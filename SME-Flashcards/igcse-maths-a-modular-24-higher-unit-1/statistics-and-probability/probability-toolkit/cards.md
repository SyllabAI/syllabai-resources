...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-1/flashcards/statistics-and-probability/probability-toolkit/


## Card 1 — question_and_answer (`fl_zrzrY3qQ8M2dGq4x`)

**FRONT**

What does the notation `straight P open parentheses A close parentheses` mean, in the context of probability?
...
## Card 2 — true_or_false (`fl_YsSZ2ncnfvc38PS8`)
...
## Card 3 — keyword_definition (`fl_ZjSzZMYYhmwKR3kb`)
...
## Card 4 — keyword_definition (`fl_pqYZH3PRDw2yz7Pn`)
...
## Card 5 — keyword_definition (`fl_r2kQT4H4R96DdY5T`)
...
## Card 6 — true_or_false (`fl_XyvQNzd9tjhkpCs7`)
...
Therefore, the probability of winning is $\frac{1}{2}$.
...
The outcomes 'win' and 'lose' are** not equally likely**, so the probability of winning is **not** $\frac{1}{2}$.



## Card 7 — keyword_definition (`fl_VFdWrfMtGHg494NY`)
...
## Card 8 — true_or_false (`fl_qKBpQRJq6PJdbGnc`)
...
## Card 9 — question_and_answer (`fl_XNVYSvsrbmd9DZZ8`)
...
## Card 10 — keyword_definition (`fl_KBdqngVXhtvyGxsB`)
...
## Card 11 — question_and_answer (`fl_Yg7C3FqWj5t3sYz4`)
...
## Card 12 — question_and_answer (`fl_fSwDb2ZkzybMqYvp`)
...
## Card 13 — question_and_answer (`fl_HvcgNR8cWHDBdBdM`)
...
## Card 14 — keyword_definition (`fl_tzh93vXgyW5rJCCY`)
...
$\mathrm{Relative} \mathrm{frequency}=\frac{\mathrm{Number} \mathrm{of} \mathrm{successful} \mathrm{outcomes}}{\mathrm{Total} \mathrm{number} \mathrm{of} \mathrm{trials}}$



## Card 15 — true_or_false (`fl_CHJzYKQpkKB8gGtN`)
...
## Card 16 — true_or_false (`fl_k94DvjHHcj95qkBc`)
...
## Card 17 — keyword_definition (`fl_hx68b8vGtvSX7j9Z`)
...
## Card 18 — keyword_definition (`fl_VSgcZ4QFPtzJZ76p`)
...
$\mathrm{Expected} \mathrm{frequency}=np$.



## Card 19 — true_or_false (`fl_jqmV25b2hrzYn6Cm`)
...
## Card 20 — true_or_false (`fl_xgj4Jtgg2ZXNYZgq`)
...
## Card 21 — true_or_false (`fl_gqXCbCWNqS7YPHGx`)
