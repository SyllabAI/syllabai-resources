...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-1/flashcards/number/exchange-rates-and-best-buys/


## Card 1 — question_and_answer (`fl_Bs2wpBGtc7bZBxbv`)
...
## Card 2 — true_or_false (`fl_ZG3C7bsfhDy4nrwD`)
...
## Card 3 — question_and_answer (`fl_HbPRspVB488jVxkQ`)
...
## Card 4 — true_or_false (`fl_YZdM5gVcXyt7RHnj`)
...
To **convert \$10 into £** you perform the calculation $10\div1.25$.
...
## Card 5 — question_and_answer (`fl_k5crpTs5YPySTQDm`)
...
## Card 6 — true_or_false (`fl_3CCKGZTPrYwVPfmn`)
...
## Card 7 — question_and_answer (`fl_q9Zpr62S8BxYTsV3`)
...
## Card 8 — keyword_definition (`fl_wPNq3yS6dX5PTGp5`)
...
## Card 9 — true_or_false (`fl_fp99hkpR8yTH6Fjf`)
...
## Card 10 — question_and_answer (`fl_M9bPqttSJzSXkb9H`)
