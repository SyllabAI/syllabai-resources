...
Source: https://www.savemyexams.com/igcse/biology/edexcel/19/flashcards/2-structure-and-function-in-living-organisms/movement-of-substances-into-and-out-of-cells/


## Card 1 — keyword_definition (`fl_SfnBPD7Gnc7793Pm`)
...
## Card 2 — question_and_answer (`fl_YV7hr2BDTNSk3kyD`)
...
## Card 3 — question_and_answer (`fl_QR3cNdqjFXYXg8GS`)
...
## Card 4 — keyword_definition (`fl_Vjf3zKJMDJZTJtDM`)
...
## Card 5 — question_and_answer (`fl_p726kBD9VRrXZgq8`)
...
## Card 6 — question_and_answer (`fl_7sZf9MKQShKfkPfn`)
...
## Card 7 — question_and_answer (`fl_nDytTGhsDw8RJJrV`)
...
## Card 8 — true_or_false (`fl_cZHVcMtzCyCd9kwP`)
...
## Card 9 — keyword_definition (`fl_RjwR4RmCcdYnHwDT`)
...
## Card 10 — true_or_false (`fl_Tkf7mDvn8zZht3gK`)
...
## Card 11 — question_and_answer (`fl_3xjzw7K366QdWFhz`)
...
## Card 12 — true_or_false (`fl_HS7CsMmNBzzw73nt`)
...
## Card 13 — keyword_definition (`fl_CKtzRT4KgGQP3GX4`)
...
## Card 14 — question_and_answer (`fl_ybZdhkBd4kxDy8xM`)
...
## Card 15 — true_or_false (`fl_xcP4n3wpZH55r3Z6`)
...
## Card 16 — keyword_definition (`fl_njp6SrP88HvQsZc8`)
...
## Card 17 — question_and_answer (`fl_hMhC46HV6wwYFRYT`)
...
## Card 18 — true_or_false (`fl_JGrH4MfMhnDWmZxz`)
...
## Card 19 — question_and_answer (`fl_rPRyBmrgFSm5YgJ8`)
...
## Card 20 — question_and_answer (`fl_CjtZTZztXpZwP6MB`)
...
## Card 21 — true_or_false (`fl_WgSSrqjMd8FGPd7C`)
...
## Card 22 — question_and_answer (`fl_sc8gD43YXYGT8dzT`)
...
## Card 23 — question_and_answer (`fl_JKz7KNBzxr64DDtR`)
...
## Card 24 — keyword_definition (`fl_j58YYSpWFctZ7ZGM`)
...
## Card 25 — question_and_answer (`fl_Gc7hJ6H4n7x6XfCj`)
...
## Card 26 — question_and_answer (`fl_jKWPTVJSTkCp3KPc`)
...
## Card 27 — true_or_false (`fl_GGYMWmm3XygGy2rv`)
...
## Card 28 — question_and_answer (`fl_Zc6d4B2KY2YkhsFZ`)
...
## Card 29 — true_or_false (`fl_6fcPGjfGwpBvWTc8`)
...
## Card 30 — question_and_answer (`fl_B7yxDMF37xhqjtr8`)
