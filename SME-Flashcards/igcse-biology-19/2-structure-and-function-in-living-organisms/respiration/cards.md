...
Source: https://www.savemyexams.com/igcse/biology/edexcel/19/flashcards/2-structure-and-function-in-living-organisms/respiration/


## Card 1 — keyword_definition (`fl_H698XHFVCtn88YCj`)
...
## Card 2 — true_or_false (`fl_MGqBWXJgT2ZPSbvS`)
...
## Card 3 — question_and_answer (`fl_RQjwK4CN3g27rKj2`)
...
## Card 4 — question_and_answer (`fl_YMNNsFsbYwJkCQmZ`)
...
## Card 5 — question_and_answer (`fl_jNR8nvNkj6JJWjPk`)
...
## Card 6 — question_and_answer (`fl_tqnPxtsY3HfVxpR4`)
...
## Card 7 — true_or_false (`fl_TGTFHvCy5v6HSjXJ`)
...
## Card 8 — question_and_answer (`fl_PQcx9N77ZgTxTd7t`)
...
## Card 9 — question_and_answer (`fl_B8yDcHJsV3G5Pgsv`)
...
## Card 10 — keyword_definition (`fl_NcGqnmw95F2Btfvz`)
...
## Card 11 — question_and_answer (`fl_jJvfnS6jzwJvt8NY`)
...
## Card 12 — true_or_false (`fl_ThdjTRpSbhtgZxXV`)
...
## Card 13 — question_and_answer (`fl_64p3hhYzCKwJ54m2`)
...
## Card 14 — question_and_answer (`fl_cWCqD5tYnsNPqh7X`)
...
## Card 15 — true_or_false (`fl_hp7Cf3WGxMtnVbpy`)
...
## Card 16 — question_and_answer (`fl_N7QsNvRHztpS6Fyh`)
...
## Card 17 — keyword_definition (`fl_HvpcZBzbd3yYrHnX`)
...
## Card 18 — keyword_definition (`fl_5H6QNYK8psryQ8ys`)
...
## Card 19 — question_and_answer (`fl_nggT3wzCFX38w5DB`)
...
## Card 20 — true_or_false (`fl_Wx5GN5YWMjSBJsb3`)
...
## Card 21 — question_and_answer (`fl_br3D6DNphw28vmp3`)
...
## Card 22 — question_and_answer (`fl_WnVT7k6wwfhgfnYf`)
...
## Card 23 — question_and_answer (`fl_FhqXVY96gMJ7KNzJ`)
...
## Card 24 — question_and_answer (`fl_GzxyZPtB8PhQ2Gbm`)
...
________→ 2C<sub>3</sub>H<sub>6</sub>O<sub>3</sub>


**BACK**

Glucose (**C**<sub>**6**</sub>**H**<sub>**12**</sub>**O**<sub>**6**</sub>) should be included in the **chemical equation** for anaerobic respiration in animals:

**C**<sub>**6**</sub>**H**<sub>**12**</sub>**O**<sub>**6**</sub><sub> </sub>→ 2C<sub>3</sub>H<sub>6</sub>O<sub>3</sub>



## Card 25 — question_and_answer (`fl_Jngg8XvGBDwVMMfn`)
...
## Card 26 — keyword_definition (`fl_BTPsScTjntQcKGYj`)
...
## Card 27 — question_and_answer (`fl_VVXYRRXmsQ5TTKJc`)
...
## Card 28 — question_and_answer (`fl_3w7HCWYwFdGFd9cc`)
...
C<sub>6</sub>H<sub>12</sub>O<sub>6</sub> → 2C<sub>2</sub>H<sub>5</sub>OH + _______


**BACK**

Carbon dioxide (**CO**<sub>**2**</sub>) should be included in the equation for anaerobic respiration in plants and yeast:

C<sub>6</sub>H<sub>12</sub>O<sub>6</sub> → 2C<sub>2</sub>H<sub>5</sub>OH + **2CO**<sub>**2**</sub>



## Card 29 — question_and_answer (`fl_njm5grxwztZbFKTt`)
...
## Card 30 — question_and_answer (`fl_DTN4VRgHJ23xWdMS`)
...
## Card 31 — true_or_false (`fl_6CpTxMvXp9zbckQQ`)
...
## Card 32 — keyword_definition (`fl_3m3FD4rGwqD85C7s`)
...
## Card 33 — keyword_definition (`fl_GPKywb6FNwYBxk85`)
...
## Card 34 — question_and_answer (`fl_fqZVYwkxR7PZCcjf`)
...
## Card 35 — true_or_false (`fl_nzbwsfz2hCtDp46F`)
...
## Card 36 — question_and_answer (`fl_C3C8S3NsKCTg5nz7`)
...
## Card 37 — true_or_false (`fl_7YF2cSnPqMwhG6dY`)
...
## Card 38 — question_and_answer (`fl_w8qZX4KrGNKk66Zd`)
...
## Card 39 — keyword_definition (`fl_vG2JPRswzYGyRcCS`)
...
## Card 40 — question_and_answer (`fl_m7kkHr3dvMjDtXWs`)
...
## Card 41 — question_and_answer (`fl_6pQTyphnJPNz8dXW`)
...
This is part of the COR**M**MS criteria for measuring the dependent variable.



## Card 42 — question_and_answer (`fl_ZXs6nB56cbp2MNQB`)
...
## Card 43 — question_and_answer (`fl_wQK8GdhDnvS89j8F`)
...
## Card 44 — question_and_answer (`fl_MhS4HFR2trSQPPkZ`)
...
This is part of the **C**ORMMS criteria for planning a practical.



## Card 45 — question_and_answer (`fl_qXd9KbmyZXRyHQQs`)
...
## Card 46 — question_and_answer (`fl_hySmqDR3sncnC5cM`)
...
## Card 47 — question_and_answer (`fl_wddb7wGMXNFjjBwZ`)
