...
Source: https://www.savemyexams.com/igcse/biology/edexcel/19/flashcards/2-structure-and-function-in-living-organisms/excretion/


## Card 1 — keyword_definition (`fl_mDYVY4TfTNFq7tfx`)
...
## Card 2 — question_and_answer (`fl_xZmvWk6msy7VfD79`)
...
## Card 3 — question_and_answer (`fl_fdd4KRmhwwZQXq9B`)
...
## Card 4 — true_or_false (`fl_qkKdrWtmjz2mQQTw`)
...
## Card 5 — question_and_answer (`fl_7Y35sHpQwvfRrj8Q`)
...
## Card 6 — question_and_answer (`fl_tNpqQX7CzvCfgtz7`)
...
## Card 7 — true_or_false (`fl_Wt8xMSZWyW4CDwSq`)
...
## Card 8 — question_and_answer (`fl_yRnSKCThSk6zPdm8`)
...
## Card 9 — question_and_answer (`fl_4vkM9m4fC9xwtztG`)
...
## Card 10 — true_or_false (`fl_kZhNqFQX8sXGJN9V`)
...
## Card 11 — keyword_definition (`fl_HZv3bQzS4rssZQTj`)
...
## Card 12 — question_and_answer (`fl_QkJkzch4cjW36qr9`)
...
## Card 13 — true_or_false (`fl_TgR5CzZ2ppsBmY37`)
...
## Card 14 — question_and_answer (`fl_CDkPR4yzpg8fTnR4`)
...
## Card 15 — question_and_answer (`fl_6yY5PPvcFRx7Sqxh`)
...
## Card 16 — true_or_false (`fl_z2KTnNTPcP4tGH9T`)
...
## Card 17 — question_and_answer (`fl_2JtfNZ6wSfCPjc5G`)
...
## Card 18 — true_or_false (`fl_thgfccRWTjzThv7Y`)
...
## Card 19 — question_and_answer (`fl_wsQG2FZg8X3dKzJ4`)
...
## Card 20 — keyword_definition (`fl_7vxgwCKhDx4cnPsn`)
...
## Card 21 — question_and_answer (`fl_HWxW32V9qhr4SD92`)
...
## Card 22 — true_or_false (`fl_VxzgNG6KtSPPtYfY`)
...
## Card 23 — question_and_answer (`fl_Y7StYgtNXdXQykSJ`)
...
## Card 24 — question_and_answer (`fl_PzzxXtJzhRYm3RCN`)
...
## Card 25 — question_and_answer (`fl_9jbZNQZmCZWVKxhK`)
...
## Card 26 — true_or_false (`fl_NCb8Qqg5PmbGDXMd`)
...
## Card 27 — question_and_answer (`fl_F9Dsd7zD2Qsvzfpd`)
...
## Card 28 — question_and_answer (`fl_yGJZ3KCmzzZQcwWW`)
...
## Card 29 — question_and_answer (`fl_FnNhGY63gBY8vhtW`)
...
## Card 30 — true_or_false (`fl_hKYCmfpFGjfRb6Gq`)
...
## Card 31 — keyword_definition (`fl_bZQgFNHvNrQfYXh9`)
...
## Card 32 — true_or_false (`fl_rCfGjZgZ7m7BGNrj`)
...
## Card 33 — question_and_answer (`fl_MvD3fDrZ2ktdC8sy`)
...
## Card 34 — question_and_answer (`fl_JZBnH2qZmXzkYRDg`)
...
## Card 35 — true_or_false (`fl_gR5QkZh33JCtcyZ7`)
...
## Card 36 — keyword_definition (`fl_wGfrcg8g9FTcCJ2s`)
...
## Card 37 — question_and_answer (`fl_YwyNDk22vJncDSCc`)
...
## Card 38 — true_or_false (`fl_9VXvwNPY4v7RYCP8`)
...
## Card 39 — question_and_answer (`fl_Tbhs8xPwKwJ6DNBC`)
...
## Card 40 — question_and_answer (`fl_cShfP27jKrwtJhFn`)
...
## Card 41 — question_and_answer (`fl_Zjx9GggGqnJKxk8M`)
...
## Card 42 — true_or_false (`fl_vGhPJvBzBDJ4PsW7`)
...
## Card 43 — keyword_definition (`fl_b2g3YRVn7m5SVG4r`)
...
## Card 44 — true_or_false (`fl_zbCqRFsKdcfJBzB3`)
...
## Card 45 — question_and_answer (`fl_wgPmDWBPKMGpPbdP`)
...
## Card 46 — true_or_false (`fl_mCWyWHmxbM8ty56y`)
...
## Card 47 — question_and_answer (`fl_j5rkCvN9ptTKf6vW`)
...
## Card 48 — true_or_false (`fl_99BSckvRD9Bwf7c5`)
...
## Card 49 — question_and_answer (`fl_4HnmrFgJMFnZT2Gm`)
...
## Card 50 — keyword_definition (`fl_mSKNHWGv9C732Dc8`)
...
## Card 51 — question_and_answer (`fl_K4R7J6xD8k3RkpRs`)
...
## Card 52 — question_and_answer (`fl_rcZmC5GVGmCQKtxK`)
...
## Card 53 — true_or_false (`fl_8Nz86D5FgWk3GYWG`)
...
## Card 54 — true_or_false (`fl_MGJYCVWRbSJwK5TP`)
...
## Card 55 — question_and_answer (`fl_kyWr8pm4xq3vSWwT`)
...
## Card 56 — true_or_false (`fl_szBP9tHBr9Z54KXQ`)
...
## Card 57 — question_and_answer (`fl_RNFmqJdqGPGvZqnv`)
...
## Card 58 — question_and_answer (`fl_n5N3w3rTZf5QjRqQ`)
...
## Card 59 — question_and_answer (`fl_6fbJzvKrm2rvgmt3`)
...
## Card 60 — true_or_false (`fl_Hnv5WqzG5fHMM4ZS`)
...
## Card 61 — question_and_answer (`fl_hgHxm6ngKvPpm2Qk`)
...
## Card 62 — true_or_false (`fl_jpbhSR5DqcnqkfZs`)
...
## Card 63 — true_or_false (`fl_8Qth98RmhP28c6Yz`)
...
## Card 64 — question_and_answer (`fl_Cn9WVkD4Q9SbmmnX`)
...
## Card 65 — keyword_definition (`fl_NVqNhR3GFqWRs4vC`)
...
## Card 66 — question_and_answer (`fl_xSrcjz77TjZbyMFY`)
...
## Card 67 — true_or_false (`fl_fv3YQkdHrDVwvBHc`)
