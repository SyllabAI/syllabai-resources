...
Course: igcse-biology-19 · Section: 2. Structure & Function in Living Organisms

Source: https://www.savemyexams.com/igcse/biology/edexcel/19/flashcards/2-structure-and-function-in-living-organisms/transport-systems/


## Card 1 — question_and_answer (`fl_dv6C6jTQt3927chW`)
...
## Card 2 — question_and_answer (`fl_nvPSHzztvjWQJfq9`)
...
## Card 3 — true_or_false (`fl_KNPt9XBDGZqy83zj`)
...
## Card 4 — question_and_answer (`fl_qB6GcTbCfSQGPVDb`)
...
## Card 5 — question_and_answer (`fl_Ghh598qVFpMwFMYb`)
...
## Card 6 — true_or_false (`fl_gp7BqxCXq5Yn2qXj`)
...
## Card 7 — keyword_definition (`fl_dS5hhspcqg2hSJsG`)
...
## Card 8 — question_and_answer (`fl_zFtkrHc7vkfp9n97`)
...
## Card 9 — true_or_false (`fl_NBpVyfNQBHJk6JYc`)
...
## Card 10 — question_and_answer (`fl_zrPVMJwbbd8kRPh6`)
...
## Card 11 — true_or_false (`fl_9cD5gjrjBxB3SPYN`)
...
## Card 12 — keyword_definition (`fl_7jgWvKKcDyz3D25Q`)
...
## Card 13 — true_or_false (`fl_FKVphnFXxgJz4tGN`)
...
## Card 14 — question_and_answer (`fl_NtTsNZKbmnSfMdjm`)
...
## Card 15 — true_or_false (`fl_rSbmSV9JNFWmpzSC`)
...
## Card 16 — true_or_false (`fl_8sq7vpWHqkDBYKkT`)
...
## Card 17 — keyword_definition (`fl_PjSqv6CzPC5NshrC`)
...
## Card 18 — true_or_false (`fl_jgvBzbKgCzwn9vKf`)
...
## Card 19 — question_and_answer (`fl_RK9X6M237DDjY6yS`)
...
## Card 20 — true_or_false (`fl_KTbKRvGjKVpmrfBS`)
...
## Card 21 — question_and_answer (`fl_KcP9SZGKgCgWxpq6`)
...
## Card 22 — question_and_answer (`fl_zsTGJzm48rNRbRqN`)
...
## Card 23 — true_or_false (`fl_q979bkgZDRMyXTVZ`)
...
## Card 24 — keyword_definition (`fl_Hyq6HZFNdSPxYQs3`)
...
## Card 25 — question_and_answer (`fl_xQqs6DmKVJtNtdTC`)
...
## Card 26 — keyword_definition (`fl_MdCwsnx2bQkmFKYp`)
...
## Card 27 — question_and_answer (`fl_7QGcrkxkDK64P4mP`)
...
## Card 28 — true_or_false (`fl_dKJcjz7GQcMTYpYF`)
...
## Card 29 — true_or_false (`fl_ShDkDkRXYhgQc8dn`)
...
## Card 30 — question_and_answer (`fl_B6MctGwwGZckh2Ky`)
...
## Card 31 — question_and_answer (`fl_RBzfR8WkdQYBdK9n`)
...
## Card 32 — question_and_answer (`fl_V73v42KfCZcJgzqw`)
...
## Card 33 — true_or_false (`fl_mW7RxZwGVyWJ76nm`)
...
## Card 34 — question_and_answer (`fl_fn4VCpVzZh2KkDty`)
...
## Card 35 — true_or_false (`fl_2y9w6JCSC48NY8Fx`)
...
## Card 36 — true_or_false (`fl_RWNg7H6rx6tT5qjg`)
...
## Card 37 — question_and_answer (`fl_8BDTCqDrjhWxZBz5`)
...
## Card 38 — question_and_answer (`fl_Rg5QgV967bxKG8y2`)
...
## Card 39 — true_or_false (`fl_pnNTGQWzgtSP55tQ`)
...
## Card 40 — question_and_answer (`fl_P43gCS2FgNg2zRb8`)
...
## Card 41 — question_and_answer (`fl_9qtwGhq4R6YQ2kYb`)
...
## Card 42 — question_and_answer (`fl_399MhkGPKcbFctrr`)
...
## Card 43 — question_and_answer (`fl_prsTKMrPsY92bJgh`)
...
## Card 44 — keyword_definition (`fl_77hB9gMXNYQS2FdF`)
...
This is part of the **C**ORMMS criteria for planning an investigation.



## Card 45 — question_and_answer (`fl_mRqS3VvbvwyJfjGY`)
...
Altering the position of a lamp in relation to a potometer allows the effect of** light **<u>**intensity**</u> on transpiration rate to be investigated.



## Card 46 — question_and_answer (`fl_qNcHkHr3yRkMV6pV`)
...
## Card 47 — true_or_false (`fl_CkvkbJXRzD9pdzMX`)
...
## Card 48 — question_and_answer (`fl_9kZJDC8bzvjCWR7z`)
...
This is part of the CORMM**S** criteria for planning an investigation.



## Card 49 — question_and_answer (`fl_DMbQkDKs5ct4k8z2`)
...
## Card 50 — question_and_answer (`fl_qDst7X9jjffnKXdH`)
...
This is part of the C**O**RMMS criteria for planning an investigation.



## Card 51 — question_and_answer (`fl_7pxTGXKz5QffsQjV`)
...
## Card 52 — question_and_answer (`fl_Tv2hb6Y64cj4f8BF`)
...
## Card 53 — question_and_answer (`fl_dzNXZQQCjP9hNvDk`)
...
## Card 54 — question_and_answer (`fl_YcKwDjPyGFmq3BQK`)
...
## Card 55 — question_and_answer (`fl_XsKtzkXJqJwMXNmg`)
...
## Card 56 — question_and_answer (`fl_yHTjb5dKmpx47CFr`)
...
## Card 57 — question_and_answer (`fl_q7XHBPthFXBWDdth`)
...
## Card 58 — question_and_answer (`fl_CGHMDrKPBSrWGTtz`)
...
## Card 59 — question_and_answer (`fl_STcWCCGxsdzVDT6Y`)
...
## Card 60 — question_and_answer (`fl_GT8Ct5GrfS8tWnCx`)
...
## Card 61 — question_and_answer (`fl_Wkxy86kxZMhKQwqv`)
...
## Card 62 — question_and_answer (`fl_fHG8sCSH8mb29kYw`)
...
## Card 63 — question_and_answer (`fl_RCJ8qnwykpqKjBCp`)
...
## Card 64 — question_and_answer (`fl_K8sN7vJ4fHC8svCj`)
...
## Card 65 — question_and_answer (`fl_8KSnrzJHDzmWD6tv`)
...
## Card 66 — question_and_answer (`fl_xXYM5yJVzTPFBxHs`)
...
## Card 67 — question_and_answer (`fl_xMdQHhcy9g2VC7Gp`)
...
## Card 68 — question_and_answer (`fl_dB3PBqFGCWMbMrzC`)
...
## Card 69 — question_and_answer (`fl_j7hrm6s7HdbXq2XQ`)
...
## Card 70 — question_and_answer (`fl_6BRF2WXJcvmhrwD4`)
...
## Card 71 — question_and_answer (`fl_432DYn62Dv4J6wvX`)
...
## Card 72 — question_and_answer (`fl_7WDnNXbN9Pqp7dQh`)
...
## Card 73 — question_and_answer (`fl_xvnhGj8DB5J9hcqs`)
...
## Card 74 — question_and_answer (`fl_fkDQCyyMmDgbwRsd`)
...
## Card 75 — true_or_false (`fl_2TjFngH2rG7rP3T4`)
...
## Card 76 — keyword_definition (`fl_tyJQjvhmhsmp2h47`)
...
## Card 77 — question_and_answer (`fl_drKQPNb99PVWJVFP`)
...
## Card 78 — true_or_false (`fl_tRwrsyfD6K5B69HK`)
...
## Card 79 — question_and_answer (`fl_cTyK7BVJ83fszHVj`)
...
## Card 80 — question_and_answer (`fl_YBw3DMN2W9X5PNzP`)
...
## Card 81 — question_and_answer (`fl_nFcRMdGxVcxkN3Xr`)
...
## Card 82 — question_and_answer (`fl_fKdq6cfvKbfWRsmc`)
...
## Card 83 — question_and_answer (`fl_sZpddSvpxHRMHyhR`)
...
## Card 84 — keyword_definition (`fl_3g4Z3qfTw2SPMGPN`)
...
## Card 85 — keyword_definition (`fl_xXXCFR9MHQywjCQb`)
...
## Card 86 — question_and_answer (`fl_rNzjB5fZwhfdzJjX`)
...
## Card 87 — true_or_false (`fl_NXJHy7mpQ3kCxNw5`)
...
## Card 88 — question_and_answer (`fl_J2HFHX7CXBc3kwby`)
...
## Card 89 — question_and_answer (`fl_T7nS6j4csKy8CYDP`)
...
## Card 90 — keyword_definition (`fl_YPKwb4nskkMZHJP8`)
...
## Card 91 — question_and_answer (`fl_WZK56NSTtvkgbfqn`)
...
## Card 92 — question_and_answer (`fl_6cQjdC6wKRFK5J39`)
...
## Card 93 — question_and_answer (`fl_DTVFkQGXQ8QR9SWK`)
...
## Card 94 — question_and_answer (`fl_gTKMDK4WDGB6qW75`)
...
## Card 95 — question_and_answer (`fl_48MgzNmmbHqVPMN9`)
...
## Card 96 — question_and_answer (`fl_KdKh88s3mYr5pFZt`)
...
## Card 97 — question_and_answer (`fl_DvSdfWmmsQhrn5ZC`)
...
## Card 98 — question_and_answer (`fl_phwk6PXyyQc5jZGS`)
...
## Card 99 — true_or_false (`fl_q5RwTYmGH7ZtxYc3`)
...
## Card 100 — true_or_false (`fl_MHnczX3PMF7fBx3Z`)
...
## Card 101 — question_and_answer (`fl_SXkB9jw8vXBkVpQV`)
...
## Card 102 — question_and_answer (`fl_prp7VjJKCKpqZ4XM`)
...
## Card 103 — question_and_answer (`fl_TMf6DRg9yQJvDNTy`)
...
## Card 104 — question_and_answer (`fl_8gQTwbq74FBzYSpF`)
...
## Card 105 — question_and_answer (`fl_6WgWHqzvRrKkCBC2`)
...
## Card 106 — question_and_answer (`fl_w4TgWP6fpNWXxvxb`)
...
## Card 107 — keyword_definition (`fl_b86qSH4yy8txYBR6`)
...
## Card 108 — true_or_false (`fl_R27sSjhbTJTnYHJ7`)
...
## Card 109 — question_and_answer (`fl_tXb5zWPvJ53dJkRZ`)
...
## Card 110 — question_and_answer (`fl_kJ6bdkTW4FFDZrjr`)
...
## Card 111 — question_and_answer (`fl_TBFnmSbFgtmQYdns`)
...
## Card 112 — question_and_answer (`fl_M4Jw5zK5Bp5jvrv2`)
...
## Card 113 — question_and_answer (`fl_87NxjXX5K479jzGC`)
...
## Card 114 — true_or_false (`fl_qmDxYHGF4vzhCfPd`)
...
## Card 115 — question_and_answer (`fl_kbDYCZnBn9Vn56p2`)
...
## Card 116 — keyword_definition (`fl_x52DZqJtn4NjwHj3`)
...
## Card 117 — true_or_false (`fl_xcfnvmy8GkJgRRkf`)
...
## Card 118 — question_and_answer (`fl_pcs4J543fkw2YgHF`)
...
## Card 119 — question_and_answer (`fl_WX7m26D2czQSWcFv`)
...
## Card 120 — question_and_answer (`fl_D7Ny873jPsF8DKG4`)
...
## Card 121 — question_and_answer (`fl_9pJdQRCsqmGDN6RN`)
...
## Card 122 — question_and_answer (`fl_sbYgR67m2bZMSXbG`)
...
## Card 123 — question_and_answer (`fl_MpbZ5zRbpYBgn9Q7`)
...
## Card 124 — question_and_answer (`fl_NhZWgzqBrrWQJMNx`)
...
## Card 125 — question_and_answer (`fl_mNZbtf93SwN5H8P5`)
...
## Card 126 — question_and_answer (`fl_QxpVbtsBvpzRwRDv`)
...
## Card 127 — true_or_false (`fl_psbpWf68kf3RjPqx`)
...
## Card 128 — question_and_answer (`fl_YVjb5z8G9mvdcGgV`)
...
## Card 129 — true_or_false (`fl_2K8m5NnMSzNB3Qxd`)
