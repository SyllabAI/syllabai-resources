...
Course: igcse-biology-19 · Section: 5. Use of Biological Resources

Source: https://www.savemyexams.com/igcse/biology/edexcel/19/flashcards/5-use-of-biological-resources/genetic-modification-genetic-engineering/


## Card 1 — question_and_answer (`fl_6Gc8HXGVFPFF38BG`)
...
## Card 2 — question_and_answer (`fl_cvXRynYNc58fptFH`)
...
## Card 3 — question_and_answer (`fl_SdKJrZGrJXMkzsrn`)
...
## Card 4 — question_and_answer (`fl_9DqjtHjVj9djPgtb`)
...
## Card 5 — question_and_answer (`fl_nPxf5rH24Nwf3pfp`)
...
## Card 6 — question_and_answer (`fl_FcnHr25rPn4p6688`)
...
## Card 7 — keyword_definition (`fl_jxpbhnYrJVXKzKG6`)
...
## Card 8 — question_and_answer (`fl_S7DCvWSxMwwryzBN`)
...
## Card 9 — question_and_answer (`fl_Y8CRk6XGgfsQNBZm`)
...
## Card 10 — question_and_answer (`fl_HFr8DHTWWjmZwp3j`)
...
## Card 11 — question_and_answer (`fl_JTB3TdCYWkH2wgDt`)
...
## Card 12 — true_or_false (`fl_GJTzrDwxVsm4Vpd4`)
...
## Card 13 — question_and_answer (`fl_vKWwfZxdXp2RP4wP`)
...
## Card 14 — true_or_false (`fl_fbK9YptkWqw5fM88`)
...
## Card 15 — question_and_answer (`fl_xJCqNBhRwnfrBG8c`)
...
## Card 16 — question_and_answer (`fl_bmX8NNd8DJhQvh6s`)
...
## Card 17 — question_and_answer (`fl_tpzj2C3g4p2yHbdJ`)
...
## Card 18 — question_and_answer (`fl_8p7kr4gtnymg6GTx`)
...
## Card 19 — true_or_false (`fl_TRNbzb2vJV8RRr76`)
...
## Card 20 — question_and_answer (`fl_sPZX6NzsYrHbnk6s`)
...
## Card 21 — keyword_definition (`fl_k89YjnkNRvXcxczp`)
...
## Card 22 — true_or_false (`fl_xPFDt8gMN7kKdTzS`)
