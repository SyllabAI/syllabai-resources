...
Source: https://www.savemyexams.com/igcse/biology/edexcel/19/flashcards/4-ecology-and-the-environment/cycles-within-ecosystems/


## Card 1 — question_and_answer (`fl_Qrpc46tc22YGZpVg`)
...
## Card 2 — question_and_answer (`fl_CSCbhNSR2sTFt5gv`)
...
## Card 3 — question_and_answer (`fl_X4RQyPY2dGcVSw4h`)
...
## Card 4 — question_and_answer (`fl_5vSW59QJYdTYqJTJ`)
...
## Card 5 — keyword_definition (`fl_Wy5QV5QxmDRzTtqz`)
...
## Card 6 — true_or_false (`fl_xVvPb4NxNT3KdKGK`)
...
## Card 7 — question_and_answer (`fl_DVnmWVkQGqfJVnMY`)
...
## Card 8 — question_and_answer (`fl_x72DvpZv2Jv8NMW8`)
...
## Card 9 — true_or_false (`fl_xChKwgmtqF4bd9BM`)
...
Neither plants nor animals can absorb nitrogen gas (N<sub>2</sub>) from the air. N<sub>2</sub> needs to be **fixed** to produce **nitrates** before nitrogen can be absorbed by plants and passed on to animals.



## Card 10 — question_and_answer (`fl_Q8jDvxYKXyZvkSbQ`)
...
- **Nitrogen-fixing bacteria** convert N<sub>2</sub> gas into ammonium compounds, which can then be converted to usable **nitrates**
...
## Card 11 — question_and_answer (`fl_WXHs6WGC3vQmgKPt`)
...
## Card 12 — question_and_answer (`fl_SSmHSshMH4m7nRks`)
...
## Card 13 — question_and_answer (`fl_69vNFzN9BJdSPsjf`)
...
## Card 14 — question_and_answer (`fl_43v7PG3jRFNSKTYP`)
...
## Card 15 — true_or_false (`fl_kgbYcTB2KFXXHDCc`)
...
## Card 16 — question_and_answer (`fl_BGJh4QjH684Jw6QJ`)
...
## Card 17 — true_or_false (`fl_nhYY5ZWDMrvRPrgt`)
