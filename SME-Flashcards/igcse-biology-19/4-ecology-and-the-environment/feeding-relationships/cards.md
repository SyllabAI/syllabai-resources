...
Course: igcse-biology-19 · Section: 4. Ecology & the Environment

Source: https://www.savemyexams.com/igcse/biology/edexcel/19/flashcards/4-ecology-and-the-environment/feeding-relationships/


## Card 1 — question_and_answer (`fl_NwQ8SZ4wnq5xsCfb`)
...
## Card 2 — keyword_definition (`fl_DZdKJ5sFTVjKsx4Z`)
...
## Card 3 — keyword_definition (`fl_4pZPjRmDTRS8vhGd`)
...
## Card 4 — true_or_false (`fl_v5Nn4n2gtqSchgHt`)
...
## Card 5 — keyword_definition (`fl_QvxMtnhBtB4qQxwd`)
...
## Card 6 — true_or_false (`fl_3J5CgRwxS5NrK9ZD`)
...
## Card 7 — question_and_answer (`fl_gzKctmSSRYtdV3DW`)
...
## Card 8 — keyword_definition (`fl_Bsv7XWcNFZZmsXYm`)
...
## Card 9 — keyword_definition (`fl_PFKZfr23KnDsxmhM`)
...
## Card 10 — true_or_false (`fl_M9Z4jmJfXKMDpHRy`)
...
## Card 11 — question_and_answer (`fl_gMDM2BKmyFCmFssr`)
...
## Card 12 — true_or_false (`fl_yjdDxYsvrTSKjXsd`)
...
## Card 13 — question_and_answer (`fl_ZVh8Zk88jzCsbXPd`)
...
## Card 14 — question_and_answer (`fl_96GMsTjngdWQRHQD`)
...
## Card 15 — question_and_answer (`fl_9Kdz6qd5NMTnJYDk`)
...
## Card 16 — true_or_false (`fl_6xGS9Jjpt2Jd87tF`)
...
## Card 17 — question_and_answer (`fl_4mx89WydS8Frz2qp`)
...
## Card 18 — true_or_false (`fl_H2qWJwgxzkhbRSDk`)
...
## Card 19 — question_and_answer (`fl_MFDSv9kdKSqNRmHS`)
...
## Card 20 — question_and_answer (`fl_Bkt2Pq7bQNDFxnfB`)
...
## Card 21 — question_and_answer (`fl_JkrpGXqPsQrTd4kR`)
...
## Card 22 — question_and_answer (`fl_Qgkbd3PVnSNhZvwQ`)
...
## Card 23 — true_or_false (`fl_CkJxYhSxqP5XtmHv`)
...
## Card 24 — question_and_answer (`fl_HGKNsHC8xHgm73HN`)
...
## Card 25 — question_and_answer (`fl_qCRGVgfwCzKnbTKh`)
...
## Card 26 — question_and_answer (`fl_vpPDfvzYmKvbwk6k`)
...
## Card 27 — true_or_false (`fl_frbWDGXgNrMD9Rrv`)
...
## Card 28 — question_and_answer (`fl_78HRfhMbwDjXVWsz`)
...
## Card 29 — true_or_false (`fl_8qNfnzBTkfjTc5rQ`)
