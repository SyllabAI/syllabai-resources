...
Source: https://www.savemyexams.com/igcse/maths/edexcel/b/16/flashcards/number/fractions-decimals-and-percentages/


## Card 1 — question_and_answer (`fl_ckSvJZfW7GfCmNrm`)
...
## Card 2 — question_and_answer (`fl_nF8bRqdvg2qmpM3K`)
...
## Card 3 — question_and_answer (`fl_6Xyh8HD38McVzXFz`)
...
## Card 4 — question_and_answer (`fl_393ctcnQ6qBqZCcK`)
...
## Card 5 — question_and_answer (`fl_qPtmwH4FFxJySkHt`)
...
## Card 6 — question_and_answer (`fl_vczvRHpfrdJnJcb3`)
...
E.g. `equation`2 ÷ 5 = 0.4,   0.4 × 100 = 40%



## Card 7 — true_or_false (`fl_dnMm2776yvy7h3sr`)
...
`stack attributes charalign center stackalign right end attributes row 100 x equals 32.32 end row row minus x equals none 0.32 end row horizontal line row 99 x equals 32 none none none end row end stack
space space x equals 32 over 99`



## Card 8 — question_and_answer (`fl_XwNVWgNdXBSxyZQV`)
...
## Card 9 — question_and_answer (`fl_hX72bQNTHjKCmwBy`)
...
## Card 10 — question_and_answer (`fl_vCfDcyhw32PSzCx9`)
...
## Card 11 — true_or_false (`fl_6kpw6jMDpRHt787m`)
...
## Card 12 — question_and_answer (`fl_3nbhtHPzTPPnWJxP`)
...
## Card 13 — question_and_answer (`fl_V43wMrvqMdQHyx5Z`)
...
## Card 14 — question_and_answer (`fl_m4kVJjCgRkj34W4K`)
...
## Card 15 — true_or_false (`fl_ztyjW2TGPDvMbbTS`)

**FRONT**

**True or False?**

$\frac{4}{29}$ is **greater **than $\frac{4}{27}$ because the numerators are the same and it has the **greater denominator**.
...
$\frac{4}{29}$ is **not greater **than $\frac{4}{27}$.

In the first fraction, 4 is **divided **by a **greater number** so the **decimal will be smaller**.



## Card 16 — question_and_answer (`fl_34Wznm6Wwpbsf64p`)

**FRONT**

Which fraction is **bigger**, $\frac{17}{40}$ or $\frac{21}{40}$?


**BACK**

$\frac{21}{40}$ is **greater **than $\frac{17}{40}$ because the **denominators **are the **same **and the **numerator **is **greater**.
