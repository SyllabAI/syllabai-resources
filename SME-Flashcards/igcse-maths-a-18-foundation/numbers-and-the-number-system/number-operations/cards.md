...
Course: igcse-maths-a-18-foundation · Section: 1. Numbers & the Number System

Source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/foundation/flashcards/numbers-and-the-number-system/number-operations/


## Card 1 — keyword_definition (`fl_8mWWtf4GQ3zCDcXM`)
...
E.g. In the expression $4^{5}$, the 5 is the exponent.



## Card 2 — question_and_answer (`fl_9ztDp8Rw5Ct3fyKB`)
...
## Card 3 — true_or_false (`fl_Fc2GQBQjbcjd9Hr8`)
...
## Card 4 — keyword_definition (`fl_8WmT6KXqVByy5rXr`)
...
## Card 5 — true_or_false (`fl_ZJjxcShDJGTj9jFw`)
...
## Card 6 — question_and_answer (`fl_369tgNjjQzVQnqVt`)

**FRONT**

What does this symbol $\sqrt{}$ represent?


**BACK**

$\sqrt{}$  is the **positive square root**.

It represents the positive result when you find perform the **opposite (inverse) operation of squaring **a number.

$-\sqrt{}$  is the negative square root.



## Card 7 — keyword_definition (`fl_GmtmjcDwh2QJ9J9C`)
...
## Card 8 — true_or_false (`fl_ZrprkkMf2FxB8X5P`)
...
## Card 9 — true_or_false (`fl_K8QPQsCJRc2jvbnj`)
...
E.g. $3\times8\div2\times9$
$=24\div2\times9\,=12\times9\,=108$



## Card 10 — true_or_false (`fl_6mxBZCcM76ztbCsc`)
...
## Card 11 — question_and_answer (`fl_Htbxvwq5zqxZVGxs`)
...
## Card 12 — true_or_false (`fl_9wCNr2fzTjX4xJZK`)
...
## Card 13 — true_or_false (`fl_3TFxbmwxf3sSb8Vy`)
...
## Card 14 — question_and_answer (`fl_8XfDKMMBCsWSMYpk`)
...
## Card 15 — true_or_false (`fl_q3nnPZJqVYgPtd5v`)
...
For example, the calculation $-3--5=2$ but the calculation $-7--5=-2$.



## Card 16 — true_or_false (`fl_ms8Fgmq4Hh7pDtfq`)
...
## Card 17 — keyword_definition (`fl_rTNRyC9CsS2sXpDN`)
...
## Card 18 — true_or_false (`fl_5BBgW4tBHDPcQt2z`)
...
## Card 19 — true_or_false (`fl_Xc7tsnHY5xV28NS8`)
...
## Card 20 — true_or_false (`fl_vXKkCtj4Qh83TFXM`)
...
## Card 21 — true_or_false (`fl_JTwVJqNCPzWghxNJ`)

**FRONT**

**True or false?**

$a\timesb$ is the same as $b\timesa$.
...
For example, $5\times0.05$ is the same as $0.05\times5$.

It is okay to swap them round.



## Card 22 — true_or_false (`fl_G2ykBKsRpn2239YN`)
...
For example, $10-2$ is not the same as $2-10$.

The first gives $8$ but the second gives $-8$.



## Card 23 — true_or_false (`fl_hq5cGknp5ZnjCSRr`)

**FRONT**

**True or false?**

If $6\times17=102$ then $17=\frac{6}{102}$.
...
The correct answer is: if $6\times17=102$ then $17=\frac{102}{6}$.

That is because $a\timesb=c$ means $b=\frac{c}{a}$ (the $c$ stays on the top of the fraction).



## Card 24 — question_and_answer (`fl_jPCY6bnZJ2TbNjqq`)

**FRONT**

How would you use the fact that $9\times15=135$ to work out $900\times150?$


**BACK**

You could write $900\times150$ as $9\times10\times10\times15\times10$.

Then bring the 9 and 15 together, giving  $9\times15\times10\times10\times10$.

You know that $9\times15=135$ so the number above becomes $135\times10\times10\times10$.

Multiplying by ten each time adds an extra zero, so the answer is $135000$.



## Card 25 — true_or_false (`fl_vKDwtfZtjjwcvBTW`)

**FRONT**

**True or false?**

If $3\times2=6$ then $0.3\times0.2=0.6$.
...
$0.3\times0.2$ is the same as `open parentheses 3 divided by 10 close parentheses cross times open parentheses 2 divided by 10 close parentheses`.
...
Alternatively, you can use fractions to see this: $\frac{3}{10}\times\frac{2}{10}=\frac{6}{100}$.

The correct answer is $0.3\times0.2=0.06$.



## Card 26 — question_and_answer (`fl_4C6Y4Y8dKGwVKDrZ`)

**FRONT**

What is the first line of working when simplifying $\frac{126}{1.4}$?


**BACK**

$\frac{126}{1.4}=\frac{1260}{14}$.
