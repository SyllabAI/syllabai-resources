...
Source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/physics/flashcards/electricity/current-potential-difference-and-resistance/


## Card 1 — keyword_definition (`fl_V3MFYWmnpDKHZQGk`)
...
## Card 2 — question_and_answer (`fl_sbTrJnbxMqm664zY`)
...
## Card 3 — question_and_answer (`fl_4QNRK3nNdgvR98d5`)
...
The equation linking charge, current, and time is: $Q=I\timest$
...
## Card 4 — question_and_answer (`fl_vzYywJ2qsBdWbBdh`)
...
## Card 5 — true_or_false (`fl_h3zqwW9hzwmHzvfQ`)
...
## Card 6 — true_or_false (`fl_qXsJqMJZKHSCVkJ6`)
...
## Card 7 — question_and_answer (`fl_9zNBN2ZD3WrCVyKJ`)
...
## Card 8 — true_or_false (`fl_hbdqYQZtyrNRYnrb`)
...
## Card 9 — keyword_definition (`fl_ZjpNXqGWXfh7C9Th`)
...
## Card 10 — question_and_answer (`fl_9c5McsP8dhfJ3SpX`)
...
## Card 11 — question_and_answer (`fl_ZZVXCgmSkqrdHysp`)
...
The  equation linking energy, charge and voltage is: $E=Q\timesV$
...
## Card 12 — true_or_false (`fl_PTC8D65792NmwNxm`)
...
## Card 13 — question_and_answer (`fl_P79zNx2SqKRzqBTc`)
...
## Card 14 — true_or_false (`fl_6QBpj9ypHNszXCD5`)
...
## Card 15 — question_and_answer (`fl_hsQkt9YGDXy8pzb7`)
...
## Card 16 — true_or_false (`fl_TpYddvkkXSJhCZbk`)
...
## Card 17 — question_and_answer (`fl_5JdjgypDqxNY3T7n`)
...
## Card 18 — question_and_answer (`fl_9MHZdvxxQ9XsRhgS`)
...
## Card 19 — question_and_answer (`fl_MkhNCbrd6vZ4cbrd`)
...
The equation linking voltage, current and resistance is: $V=I\timesR$
...
## Card 20 — true_or_false (`fl_9yrTxXJxRZMMdmMS`)
...
## Card 21 — true_or_false (`fl_QhwbwQZJzvgxsbc2`)
...
## Card 22 — true_or_false (`fl_R4hstby44WdYhTfF`)
...
## Card 23 — true_or_false (`fl_ftFgKFYDYGhHjtc9`)
