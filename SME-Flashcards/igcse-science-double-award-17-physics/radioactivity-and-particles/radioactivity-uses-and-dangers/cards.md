...
Source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/physics/flashcards/radioactivity-and-particles/radioactivity-uses-and-dangers/


## Card 1 — keyword_definition (`fl_c2z6QVmf99wcWKj9`)
...
## Card 2 — question_and_answer (`fl_r5Hcqy9YpsfbNyYg`)
...
## Card 3 — question_and_answer (`fl_mh4PYwhFShVtsthw`)
...
## Card 4 — question_and_answer (`fl_tMwndGH9dTP3qckq`)
...
## Card 5 — question_and_answer (`fl_zrjvjJCyr6bmMtcH`)
...
## Card 6 — keyword_definition (`fl_PSgKMv5SfQQMgTV2`)
...
## Card 7 — true_or_false (`fl_F54MxDXJnzN5C4Kp`)
...
## Card 8 — question_and_answer (`fl_JVsQvVSDdxtrMKVs`)
...
## Card 9 — true_or_false (`fl_Pt8MDB6KpFym7Fm9`)
...
## Card 10 — question_and_answer (`fl_cztjXJ72fGBSnhXh`)
...
## Card 11 — question_and_answer (`fl_7kNWsCsJgGCmh2FC`)
...
## Card 12 — question_and_answer (`fl_Hh6xh5C4fjzCHZqq`)
...
## Card 13 — question_and_answer (`fl_S2nBdpK2swHPxjPv`)
...
## Card 14 — question_and_answer (`fl_WCbhnpMpFSFsH8Cd`)
...
## Card 15 — question_and_answer (`fl_6jg6Wt6QwrT5kxYP`)
...
## Card 16 — question_and_answer (`fl_5FJkkYBJk8tJHbDq`)
...
## Card 17 — question_and_answer (`fl_49fT5FpnGbNP2QQ3`)
...
## Card 18 — question_and_answer (`fl_6T24DdFNbmZ9wW4h`)
...
## Card 19 — question_and_answer (`fl_8GMrtDbTJsyYPbBN`)
...
## Card 20 — question_and_answer (`fl_tsR4pPmYMHpcb8kG`)
...
## Card 21 — question_and_answer (`fl_RRXdTKx6sHsfpwGb`)
...
## Card 22 — keyword_definition (`fl_4xqKFKPst5SddKtB`)
...
## Card 23 — keyword_definition (`fl_gWzwpVYpY2YM8K7Z`)
...
## Card 24 — true_or_false (`fl_VSDY9x2xGh4kxZjk`)
...
## Card 25 — question_and_answer (`fl_QYqCjNvcVd7PVqhw`)
...
## Card 26 — true_or_false (`fl_f4DPyz7R2HkX77B2`)
...
## Card 27 — question_and_answer (`fl_FdSZZZcfGFP8YRJC`)
...
## Card 28 — question_and_answer (`fl_TqtrS4q43gbjQ6WP`)
...
## Card 29 — true_or_false (`fl_FxMtTM46YpSVPrpq`)
...
## Card 30 — question_and_answer (`fl_9B2rxGCSVP2KJ4Q7`)
...
## Card 31 — question_and_answer (`fl_4ZXmkRVrV22M3Nzp`)
...
## Card 32 — question_and_answer (`fl_GBV3Rs3nnztFnBvG`)
...
## Card 33 — question_and_answer (`fl_vFtzXw8bxJYzSq3D`)
...
## Card 34 — question_and_answer (`fl_7W2YTbxW35Sfy2Fj`)
