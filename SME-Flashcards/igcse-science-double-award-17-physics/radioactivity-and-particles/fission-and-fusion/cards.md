...
Source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/physics/flashcards/radioactivity-and-particles/fission-and-fusion/


## Card 1 — question_and_answer (`fl_3WBSVwmgGxncmg6w`)

**FRONT**

Name **three **processes for which nuclear energy is a source.
...
## Card 2 — true_or_false (`fl_9XfRh5kRXSS4QT46`)
...
## Card 3 — true_or_false (`fl_VcGr9g9ZMrp8q4rK`)
...
## Card 4 — keyword_definition (`fl_WKS8TB9VfdDr4kcp`)
...
## Card 5 — true_or_false (`fl_FXrPZTyv6qXM9PK2`)
...
## Card 6 — true_or_false (`fl_5HYMRJ4Rk8phQ6N4`)
...
## Card 7 — keyword_definition (`fl_h5SKZ85Wq5WY9DnT`)
...
## Card 8 — true_or_false (`fl_NjMCzVyrR62WRRWS`)
...
## Card 9 — true_or_false (`fl_CMK59bdh96cCvNF3`)
...
## Card 10 — question_and_answer (`fl_KMymFY9kCv2gJxnS`)
...
## Card 11 — question_and_answer (`fl_HGDVqh3jRFZJMKm9`)
...
## Card 12 — question_and_answer (`fl_P99M6F2HYVVQNTwM`)
...
## Card 13 — keyword_definition (`fl_zYx3VCw3wDK7p3Sx`)
...
## Card 14 — question_and_answer (`fl_ChQmdFhWKWs5Xm7m`)
...
## Card 15 — true_or_false (`fl_4QNZBQtnNKwhqwdk`)
...
## Card 16 — question_and_answer (`fl_PH957vPrbJssWmS6`)
...
## Card 17 — keyword_definition (`fl_Ns8MYNSxvjMZVz4f`)
...
## Card 18 — true_or_false (`fl_8vz9wtNRTBwgkbmp`)
...
## Card 19 — true_or_false (`fl_bc2TgSgnSf9nx46n`)
...
## Card 20 — true_or_false (`fl_8y4JQZy3tvqX6vrV`)
...
## Card 21 — question_and_answer (`fl_gQWj5Y4Hph7Q6Xkv`)
...
## Card 22 — true_or_false (`fl_SCdsMQn9rTcmrd4f`)
...
## Card 23 — question_and_answer (`fl_RJP59p3PqmFN85VG`)
...
## Card 24 — question_and_answer (`fl_V6tsgPMsG86QXQnF`)
...
## Card 25 — true_or_false (`fl_rWpRMkbYnq8VgT59`)
...
## Card 26 — true_or_false (`fl_KHjnRbyhMTyp9kNY`)
...
## Card 27 — question_and_answer (`fl_cqrXm7vn7DzSd96z`)
