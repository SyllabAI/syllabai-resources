...
Course: igcse-science-double-award-17-physics · Section: 4. Energy Resources & Energy Transfers

Source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/physics/flashcards/energy-resources-and-energy-transfers/energy-stores-and-transfers/


## Card 1 — keyword_definition (`fl_Q6VBtWRgbc4BTZgd`)
...
## Card 2 — true_or_false (`fl_ZZyr4D7fWx2fqKfx`)
...
## Card 3 — keyword_definition (`fl_xtBSq9PGKG2c9vVX`)
...
## Card 4 — true_or_false (`fl_H63SttbD8FmGn67F`)
...
## Card 5 — true_or_false (`fl_4j4VxRBgFJ7yGjdS`)
...
## Card 6 — true_or_false (`fl_RtQPdxvsctSwbk2x`)
...
## Card 7 — keyword_definition (`fl_3mGHFmDFMxH4frvw`)
...
## Card 8 — true_or_false (`fl_g3nd8cShpBssdcjX`)
...
## Card 9 — keyword_definition (`fl_Bm7cmD6q9Q75gMP8`)
...
## Card 10 — true_or_false (`fl_V43m7gtvT6JFz2km`)
...
## Card 11 — keyword_definition (`fl_Pg9xWFsk79nKvBVr`)
...
## Card 12 — true_or_false (`fl_5S3ZjbT7NyZcw6Mt`)
...
## Card 13 — true_or_false (`fl_YB8sGxGSxwyq3qYw`)
...
## Card 14 — question_and_answer (`fl_VJ9Ztdnvs9jSZfYq`)
...
## Card 15 — keyword_definition (`fl_n8VkyCjNGzm695Nt`)
...
## Card 16 — question_and_answer (`fl_zPSYWbvzzvvkbb5t`)
...
## Card 17 — question_and_answer (`fl_cPmryW2ttNDqC9ZZ`)
...
## Card 18 — question_and_answer (`fl_J6j37QTWXXVtfcF4`)
...
## Card 19 — question_and_answer (`fl_X5wkddrqj2Dcz7S8`)
...
## Card 20 — keyword_definition (`fl_YXCYR8dsyHVhgKck`)
...
$\mathrm{wasted} \mathrm{energy}=\mathrm{total} \mathrm{energy} \mathrm{in}-\mathrm{useful} \mathrm{energy} \mathrm{out}$



## Card 21 — true_or_false (`fl_J4HWsdh62zK9bHBt`)
...
## Card 22 — question_and_answer (`fl_8tv9Bf57FW9mBC72`)
...
## Card 23 — question_and_answer (`fl_Zb6whMcm9DrYHGsN`)
...
- $\mathrm{wasted} \mathrm{energy}=0.2\times200=40J$



## Card 24 — true_or_false (`fl_CbqtSrVcVj6yGsJH`)
...
## Card 25 — question_and_answer (`fl_B8FPbf8KYvsk9MYs`)
...
## Card 26 — true_or_false (`fl_xZNGkKMhmvBKh84t`)
...
## Card 27 — true_or_false (`fl_vXTNjCF56X8qKVJj`)
...
## Card 28 — question_and_answer (`fl_3KryNZQhMr7vxVJ3`)
...
## Card 29 — true_or_false (`fl_m8MKK6QysSQ4d4jn`)
...
## Card 30 — true_or_false (`fl_xMxZbkRDNnH9RJTZ`)
...
## Card 31 — true_or_false (`fl_VSVytFjGCDDvSbVx`)
...
## Card 32 — question_and_answer (`fl_FWBm44mMqHzFkrVv`)
...
## Card 33 — true_or_false (`fl_c75D24CFHrNcSSt9`)
...
## Card 34 — question_and_answer (`fl_CDmrjNfK6B2gg8FJ`)
...
## Card 35 — question_and_answer (`fl_f6VJmdrWwV6fkyZs`)
...
## Card 36 — question_and_answer (`fl_Z7G2cMpBX5XYKQcz`)
...
## Card 37 — question_and_answer (`fl_bqm4mcwz5YDV2sT6`)
