...
Course: igcse-science-double-award-17-physics · Section: 8. Astrophysics

Source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/physics/flashcards/astrophysics/motion-in-the-universe/


## Card 1 — question_and_answer (`fl_BWBmdnXMSCP6FjqG`)

**FRONT**

List the following objects in order of** increasing size**:
...
## Card 2 — keyword_definition (`fl_57SfvfT4cq4BDPrM`)
...
## Card 3 — keyword_definition (`fl_DMDb2JfrRT6kxyhK`)
...
## Card 4 — question_and_answer (`fl_YPYQCNNbZj6bG8GV`)
...
## Card 5 — question_and_answer (`fl_7Vk96GfZW5m6Mnms`)
...
## Card 6 — keyword_definition (`fl_2XZVPRB559nzyR4F`)
...
## Card 7 — true_or_false (`fl_JSh6TT2GWdkZF3B7`)
...
## Card 8 — keyword_definition (`fl_DCbRYpzwXyc6JzXG`)
...
## Card 9 — question_and_answer (`fl_sMsGYrcq5TWcYR9x`)
...
## Card 10 — keyword_definition (`fl_D9qktsMbHFQWS6GV`)
...
## Card 11 — true_or_false (`fl_mx5VbFDMg9CkkFK3`)
...
## Card 12 — question_and_answer (`fl_XGFzg2Ywj6xwDTtG`)
...
## Card 13 — question_and_answer (`fl_ySqDpvJNPpQn54gB`)
...
## Card 14 — true_or_false (`fl_TXWqfswPTQTCK3bM`)
...
## Card 15 — true_or_false (`fl_28gpXcH5868RdDTz`)
...
## Card 16 — true_or_false (`fl_C5FX8c6nwf3vTtWm`)
...
## Card 17 — question_and_answer (`fl_5v2dcmDgtfSdh5Gw`)
...
## Card 18 — true_or_false (`fl_D7VrRh3SYwDmRrfG`)
...
## Card 19 — question_and_answer (`fl_HQwdcpdpzBhTYZTD`)
...
## Card 20 — question_and_answer (`fl_GzZ9NbpRchQhgvcq`)
...
## Card 21 — question_and_answer (`fl_ckMXjSRhJVKXDtd2`)
...
## Card 22 — question_and_answer (`fl_PCP5cnh6RJx4b9Zq`)
...
## Card 23 — keyword_definition (`fl_G76KyPcqdPXWvStZ`)
...
## Card 24 — question_and_answer (`fl_72g6qw82C9yJGd4D`)
...
The equation for calculating orbital speed is $speed=\frac{distance}{time}$



## Card 25 — keyword_definition (`fl_vnk4YSGtzfKbBpRJ`)
...
## Card 26 — question_and_answer (`fl_Zjszm4CcZvXn2RKD`)
...
## Card 27 — true_or_false (`fl_ZSccRwBSxdDm7T79`)
...
## Card 28 — question_and_answer (`fl_7nWb87WsBnyRfxzQ`)
...
The distance travelled by an object moving in circular motion is equal to the circumference of the orbit = $2πr$, where r is the radius of the orbit.



## Card 29 — true_or_false (`fl_grGsppn7NJpffGdR`)
...
## Card 30 — question_and_answer (`fl_Q48RfS9bz7yByNwZ`)
...
The equation for orbital speed is $v=\frac{2πr}{T}$
...
## Card 31 — true_or_false (`fl_DvxZ569qqGXsnXvn`)
