...
Course: igcse-science-double-award-17-physics · Section: 6. Magnetism & Electromagnetism

Source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/physics/flashcards/magnetism-and-electromagnetism/magnetism-and-electromagnetism/


## Card 1 — keyword_definition (`fl_bpbF98WCGY4768hf`)
...
## Card 2 — keyword_definition (`fl_sHSjzZCwXWYWqP9k`)
...
## Card 3 — true_or_false (`fl_9zxPfV7dXR3Bgd7r`)
...
## Card 4 — keyword_definition (`fl_RBrsFbp6zDFb7Ngm`)
...
## Card 5 — keyword_definition (`fl_BYYQnpm8zfC6PmRv`)
...
## Card 6 — question_and_answer (`fl_BZMjGNRGMs4rTJtC`)
...
## Card 7 — keyword_definition (`fl_Fh4WzWMbPYK78rxQ`)
...
## Card 8 — true_or_false (`fl_gJ2TqNVCC5kK6rmv`)
...
## Card 9 — question_and_answer (`fl_jZQyTHzvbzgzGrg7`)
...
## Card 10 — true_or_false (`fl_vVnNwKTq2cfCh53x`)
...
## Card 11 — keyword_definition (`fl_hV9v3Rs32h7jXrs2`)
...
## Card 12 — keyword_definition (`fl_BcJZSgvZS6Qg3mSV`)
...
## Card 13 — question_and_answer (`fl_vynHYVNKF3TT3Vtg`)
...
## Card 14 — question_and_answer (`fl_7QjX4DZbfHZP7NFd`)
...
## Card 15 — question_and_answer (`fl_SYCBKnqgG2jRZNqC`)
...
## Card 16 — true_or_false (`fl_4S4VBz38zk5wYxH4`)
...
## Card 17 — question_and_answer (`fl_Ct5Q6P62GRBhc4Gj`)
...
## Card 18 — question_and_answer (`fl_FPtYfGxF4DyjhynG`)
...
## Card 19 — question_and_answer (`fl_w9swTVdYmSqrN9F6`)
...
## Card 20 — keyword_definition (`fl_YWPP9XHyKQgZg75h`)
...
## Card 21 — question_and_answer (`fl_qjqKNHy72kf9H5Gf`)
...
## Card 22 — keyword_definition (`fl_6jk7nnpyc9Jwvvqz`)
...
## Card 23 — true_or_false (`fl_YsHWdRdBpSr6ZQmC`)
...
## Card 24 — question_and_answer (`fl_yycqpZvWTbcByy82`)
...
## Card 25 — true_or_false (`fl_NqRJtVctjW53RZXV`)
...
## Card 26 — question_and_answer (`fl_c9HTMfYXT5d7P4dq`)
...
## Card 27 — question_and_answer (`fl_48yjJmbjQv59XNv9`)
...
## Card 28 — question_and_answer (`fl_gpsm34bn2sHSZXW3`)
...
## Card 29 — true_or_false (`fl_5NK7Yz3JJ2Q7DsYc`)
...
## Card 30 — question_and_answer (`fl_n3wPjNKntXSY26jF`)
...
## Card 31 — question_and_answer (`fl_jgTYxgBPskPCdms9`)
...
## Card 32 — question_and_answer (`fl_sW9XKbMcZD5nT3sq`)
...
## Card 33 — true_or_false (`fl_94db8v3m6yktG6hx`)
...
## Card 34 — question_and_answer (`fl_6y5y2z4s2kFSztTR`)
...
## Card 35 — question_and_answer (`fl_7F56znytC7hYGWxv`)
...
## Card 36 — true_or_false (`fl_gwXqWKqnVbSKBYBq`)
...
## Card 37 — true_or_false (`fl_RGn3C77c2kvNWbYN`)
...
## Card 38 — question_and_answer (`fl_nsBKbKv3twDfJ56M`)
...
## Card 39 — true_or_false (`fl_yr2XCH58m8cPXqK5`)
...
## Card 40 — true_or_false (`fl_qCdp3wrTrRfxY3cr`)
...
## Card 41 — question_and_answer (`fl_ymxSYfCPJnQ7ymWf`)
...
## Card 42 — true_or_false (`fl_xWcYcZhbxWbtKPMw`)
...
## Card 43 — question_and_answer (`fl_ZR3SHXfhxD32Cnk3`)
...
## Card 44 — true_or_false (`fl_SjGTYKwRj5Y356y9`)
...
## Card 45 — question_and_answer (`fl_KVzrW7yKPp9Jn7jK`)
...
## Card 46 — keyword_definition (`fl_5ZZGHn5CFYqpnVYm`)
...
## Card 47 — question_and_answer (`fl_VQNVY4KFrfRhQ6hK`)
...
## Card 48 — question_and_answer (`fl_p7WgJqwySPZVQFjm`)
...
## Card 49 — question_and_answer (`fl_2spt7dPSJjvckDXZ`)
...
## Card 50 — question_and_answer (`fl_2z4Tt9ZzvMymHpxD`)
...
## Card 51 — question_and_answer (`fl_cWHGGfZ53DFkk72h`)
...
## Card 52 — question_and_answer (`fl_3ZSgDRfztpP5G5VF`)
...
## Card 53 — question_and_answer (`fl_WtyXBPTj4NZFT4H3`)
...
## Card 54 — true_or_false (`fl_qRgj2y8nNdSsWrH6`)
...
## Card 55 — true_or_false (`fl_2dYhdMKwC5QZfH2C`)
