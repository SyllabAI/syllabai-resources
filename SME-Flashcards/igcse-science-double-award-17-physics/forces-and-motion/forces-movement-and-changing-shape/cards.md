...
Course: igcse-science-double-award-17-physics · Section: 1. Forces & Motion

Source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/physics/flashcards/forces-and-motion/forces-movement-and-changing-shape/


## Card 1 — question_and_answer (`fl_9qYMTMDGPWr3np2S`)

**FRONT**

Define the term **force**. `equation`
...
## Card 2 — question_and_answer (`fl_7kpQ3gM8CxDPtrK4`)
...
## Card 3 — true_or_false (`fl_ydd4CJGTq77BSYX9`)
...
## Card 4 — true_or_false (`fl_FHwW48HPWF2XjFGY`)
...
## Card 5 — true_or_false (`fl_y3XDHRspfBVxNndX`)
...
## Card 6 — question_and_answer (`fl_mSv5fpKP4hfSYCmz`)
...
## Card 7 — true_or_false (`fl_3DswVFQgTwfyVsKX`)
...
## Card 8 — true_or_false (`fl_xRXZkQwF3JX29NN2`)
...
## Card 9 — question_and_answer (`fl_T3xwDVYqV2Y8hKdd`)
...
## Card 10 — true_or_false (`fl_ZtfGsYcncGXKqq7G`)
...
## Card 11 — keyword_definition (`fl_6jFYkKKTvNSjSZBZ`)
...
## Card 12 — question_and_answer (`fl_CGcJ97ZWY4pDycJ9`)
...
## Card 13 — true_or_false (`fl_KffHMsqjCm3fRxZr`)
...
## Card 14 — true_or_false (`fl_kfg5P7bwzZSNNhC4`)
...
## Card 15 — question_and_answer (`fl_ZFnGhTsDqmXwQzm3`)
...
## Card 16 — question_and_answer (`fl_Xwtp9CyydtRDJ3V2`)
...
## Card 17 — true_or_false (`fl_s5hd2YHhWqBWMYzb`)
...
## Card 18 — question_and_answer (`fl_QqPdjdy5324PhqgW`)
...
## Card 19 — true_or_false (`fl_Qqnbm3zVFN4sVg7y`)
...
## Card 20 — question_and_answer (`fl_Y89bwxwfXxJCCyCd`)
...
## Card 21 — question_and_answer (`fl_7d7xT7k2CW6nnchk`)
...
## Card 22 — question_and_answer (`fl_pGcSCqJRjs2rH8yV`)
...
## Card 23 — question_and_answer (`fl_xwgJjY43VW94pMfv`)
...
## Card 24 — question_and_answer (`fl_kpTxm9hSzsxKfzQ8`)
...
## Card 25 — true_or_false (`fl_HpkfgDjC5vP66spW`)
...
## Card 26 — keyword_definition (`fl_jxj8Jyn22Bsj48s3`)
...
The equation for the resultant force is $F=ma$
...
## Card 27 — question_and_answer (`fl_5kpcPKyKN4rnMggM`)
...
## Card 28 — question_and_answer (`fl_nydwzc9QWD5R86VW`)
...
## Card 29 — question_and_answer (`fl_BtcBDcJzYpTpgGJf`)
...
## Card 30 — true_or_false (`fl_DgJSWFdrPF3RwDCH`)
...
## Card 31 — question_and_answer (`fl_22RKjbGPPkY8rx28`)
...
## Card 32 — question_and_answer (`fl_NHx6Yf2bwDBxJkmm`)
...
## Card 33 — keyword_definition (`fl_ThMJqcNNHcchS5np`)
...
## Card 34 — true_or_false (`fl_DKCC8YCMKJz4TqFm`)
...
## Card 35 — true_or_false (`fl_dNy3nJJpQT74df3K`)
...
## Card 36 — question_and_answer (`fl_5Kp7RmTMRwr8gt4g`)
...
## Card 37 — question_and_answer (`fl_mkThjx8mhMs5QkhM`)
...
## Card 38 — keyword_definition (`fl_h7jfRVW99KGxnfrT`)
...
## Card 39 — true_or_false (`fl_ZdWSTwRBWztFzc5k`)
...
## Card 40 — keyword_definition (`fl_m7hQHXggHpZknjwD`)
...
## Card 41 — keyword_definition (`fl_NVsSDtK2Kg8pvdMd`)
...
The equation used to calculate the stopping distance of a car is $\mathrm{stopping} \mathrm{distance}=\mathrm{thinking} \mathrm{distance}+\mathrm{braking} \mathrm{distance}$



## Card 42 — question_and_answer (`fl_VYtfQmJzrKYmxFPM`)
...
## Card 43 — keyword_definition (`fl_VS5bhz3f9b28S8bR`)
...
## Card 44 — question_and_answer (`fl_SRyhykRQfXxR6Ksk`)
...
## Card 45 — keyword_definition (`fl_sF3Z2zsNn7pTRPXH`)
...
## Card 46 — question_and_answer (`fl_CTg3f7SVTxdTZG6X`)
...
## Card 47 — keyword_definition (`fl_jKf5MDnzSYDNXch8`)
...
## Card 48 — question_and_answer (`fl_pHKdSdbFKxv998nx`)
...
## Card 49 — keyword_definition (`fl_hB59B7JwGPDsDgBF`)
...
## Card 50 — true_or_false (`fl_NSB9stXDy6ywPhSJ`)
...
## Card 51 — true_or_false (`fl_gvXhx3wswqct6jnb`)
...
## Card 52 — keyword_definition (`fl_xTWQhN988r656jwP`)
...
## Card 53 — true_or_false (`fl_FWBzDp85dv3bPCRk`)
...
## Card 54 — keyword_definition (`fl_r9zpKFnNzC6xZ4qR`)
...
## Card 55 — question_and_answer (`fl_hXfCt2kCZrJgr298`)
...
## Card 56 — question_and_answer (`fl_8rNFgDHYdDCXBw24`)
...
## Card 57 — question_and_answer (`fl_xrx6CpFM6bYHwWHP`)
...
## Card 58 — true_or_false (`fl_GpZgxyYnQytFwXwt`)
...
## Card 59 — question_and_answer (`fl_qM45cJBstkMQYZpM`)
...
## Card 60 — keyword_definition (`fl_SN5mScv4k9BS9BCp`)
...
## Card 61 — true_or_false (`fl_dQMKMDgCD6GjkRh3`)
...
## Card 62 — question_and_answer (`fl_QQwmzRWwcf7nw5FG`)

**FRONT**

What does the green arrow represent on this force-extension graph?

![A force-extension graph showing a straight line from the origin going up at an angle, then curving and flattening out. A green arrow highlights the linear section of the graph.](assets/01c31b1f4553-56029-force-extension-graph-linear-region.bin)
...
## Card 63 — question_and_answer (`fl_RG6qpXJ5Cm7W4t5y`)

**FRONT**

What does the green arrow represent on this force-extension graph?

![A force extension graph showing a straight line that begins at the origin and slopes upward, then curves and flattens out. A green arrow is positioned next to the non-linear portion of the graph](assets/d15bb94cb2ab-10713-force-extension-graph-non-linear-region.bin)
...
## Card 64 — question_and_answer (`fl_qVYhzWp4kMwX4NBK`)

**FRONT**

What does the red cross represent on this force-extension graph?

![A force extension graph with a straight line that starts at the origin and slopes upward, then curves and flattens out. A red cross is positioned at the end of the linear region.](assets/f93662565697-60849-force-extension-graph-limit-of-proportiona.bin)
...
## Card 65 — question_and_answer (`fl_F9GxD5hy5jwCXcmW`)
...
## Card 66 — true_or_false (`fl_8bMP83k9sZ7SCd5M`)
...
## Card 67 — true_or_false (`fl_zMxHkG8hS4TS8ZNZ`)
