...
Source: https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-1/flashcards/structure-and-functions-in-living-organisms-part-1/gas-exchange/


## Card 1 — true_or_false (`fl_Sc8w6kd3RJqTkWFh`)
...
## Card 2 — keyword_definition (`fl_PjDFBdnpfgPWS8ny`)
...
## Card 3 — true_or_false (`fl_wCqKt4Vxm7PkzTxb`)
...
## Card 4 — keyword_definition (`fl_GDtpJ7D47kZXVqFD`)
...
## Card 5 — true_or_false (`fl_ySGsm35xscJQCVyv`)
...
## Card 6 — question_and_answer (`fl_fyFFKx2vpQTpYRGw`)
...
## Card 7 — question_and_answer (`fl_Sv9WkxzVxJS2SRB8`)
...
## Card 8 — question_and_answer (`fl_sCMDgJxzfXP9XtZJ`)
...
## Card 9 — true_or_false (`fl_QvB3GZ2FHBKdYMDM`)
...
## Card 10 — true_or_false (`fl_vYGhbzfNf6khSwQc`)
...
## Card 11 — question_and_answer (`fl_KBc3Ddh5y3YCbT4j`)
...
## Card 12 — question_and_answer (`fl_VbZxG5JGpvnyknZP`)
...
During photosynthesis** carbon dioxide diffuses in**to photosynthesising tissues, and** oxygen diffuses out**. This is because photosynthesising plant tissues are carrying out photosynthesis at a higher rate than respiration.



## Card 13 — question_and_answer (`fl_jsMNhPXWd3FF3PGH`)
...
## Card 14 — question_and_answer (`fl_yg8Mc4hvhpsgXvKy`)
...
## Card 15 — true_or_false (`fl_3Kzxh6V34k5rKhMT`)
...
## Card 16 — question_and_answer (`fl_SSPhCDSMy63vVthm`)
...
## Card 17 — true_or_false (`fl_MsF6vqj3PcCbbMZM`)
...
## Card 18 — question_and_answer (`fl_JnkQ8DpMsbQTN2Cd`)
...
## Card 19 — keyword_definition (`fl_zzNDCtwZxhbdG7jP`)
...
## Card 20 — true_or_false (`fl_bPFWPbX9Hj5dZkTB`)
...
## Card 21 — question_and_answer (`fl_5tp4PjKWTB7CHv24`)
...
## Card 22 — question_and_answer (`fl_YGSt4nfhT2XrZTzZ`)
...
## Card 23 — true_or_false (`fl_ZSBw6mw9CJVmxRHk`)
...
## Card 24 — true_or_false (`fl_6TxcZgntWNGy3KBr`)
...
## Card 25 — keyword_definition (`fl_vnhmSycqsTcy69V4`)
...
## Card 26 — question_and_answer (`fl_bffvYDPcJFvHvpf2`)
...
## Card 27 — true_or_false (`fl_YNPWjg7hGDymTm9s`)
...
## Card 28 — question_and_answer (`fl_wnNNmkbv3t5K8qgW`)
...
## Card 29 — question_and_answer (`fl_Kkm3M4fpRbVSz92r`)
...
## Card 30 — question_and_answer (`fl_wNbDPrTXwwq43Pcv`)
...
## Card 31 — question_and_answer (`fl_NxYSfbS994p3r54y`)
...
## Card 32 — question_and_answer (`fl_9t2cF8ptdZKXy2Nz`)
...
## Card 33 — true_or_false (`fl_rt6z4sqxFrf7HN57`)
...
## Card 34 — true_or_false (`fl_Yj4NyBcshpZsvJwv`)
...
## Card 35 — true_or_false (`fl_gjs7PDQbm47R5WDD`)
...
## Card 36 — question_and_answer (`fl_c7SjVcgzhMfqQCr7`)
...
## Card 37 — question_and_answer (`fl_fSFrx7Qzvcqw6Sdw`)
...
## Card 38 — question_and_answer (`fl_2NbcrW4bysW2j3m8`)
...
## Card 39 — true_or_false (`fl_q6mkWDWd5mtyZdnb`)
...
## Card 40 — question_and_answer (`fl_ryfXCjNTGpThbvcw`)
...
## Card 41 — question_and_answer (`fl_qvJJbXk4hMTZMj79`)
...
## Card 42 — question_and_answer (`fl_vZ5NYjghxPSyRYM6`)
...
## Card 43 — true_or_false (`fl_gMcRy74VMXwWmHZx`)
...
## Card 44 — question_and_answer (`fl_F42Yp2t3cxrPbgyf`)
...
## Card 45 — question_and_answer (`fl_HYc7xnrbRtSKvrj2`)
...
## Card 46 — true_or_false (`fl_fykz3DzBPPxctRZD`)
...
## Card 47 — question_and_answer (`fl_3SB3dXh6tgTGvKwM`)
...
## Card 48 — question_and_answer (`fl_JnXytGSWmmVFvG7t`)
...
## Card 49 — true_or_false (`fl_WgjgX3MkGbNY52MD`)
...
## Card 50 — question_and_answer (`fl_GzR7zCT2YnXfPfYm`)
...
## Card 51 — question_and_answer (`fl_THZMxqMZp8KbCqYb`)
...
## Card 52 — question_and_answer (`fl_WRSBXgxHJ5Hwb7Ny`)
...
## Card 53 — question_and_answer (`fl_GgfHGGjhZ6jyCcfr`)
...
## Card 54 — true_or_false (`fl_cCFxSx5Qfb7XrVDp`)
...
## Card 55 — true_or_false (`fl_8PMHqkDNVBgZmjCv`)
...
## Card 56 — question_and_answer (`fl_J3QW8fsJtXjZX9hF`)
...
## Card 57 — question_and_answer (`fl_Pc3BkZ5PBRp2CXW7`)
...
## Card 58 — question_and_answer (`fl_CNPd545kPwBkg78B`)
...
## Card 59 — question_and_answer (`fl_v6stS9c7wBfFGmKZ`)
...
## Card 60 — true_or_false (`fl_ZxTr9RxcdbyTxX3c`)
...
## Card 61 — keyword_definition (`fl_42v6GPXwRwjWBjxy`)
...
## Card 62 — true_or_false (`fl_VfK49jy84wQHtdD8`)
...
## Card 63 — true_or_false (`fl_6wHGnnkbP9b4rxCn`)
...
## Card 64 — question_and_answer (`fl_pJsKv5Dv84hhsjM3`)
...
## Card 65 — question_and_answer (`fl_Hn25GFsKqmG4WdTD`)
...
## Card 66 — question_and_answer (`fl_pRCwvq9wbQbKvzGh`)
...
This forms part of the CORMM**S** criteria for planning an investigation.



## Card 67 — question_and_answer (`fl_qSZPz99ZRvcq7xM3`)
...
## Card 68 — question_and_answer (`fl_9BwZmHjqp9DtyfGM`)
