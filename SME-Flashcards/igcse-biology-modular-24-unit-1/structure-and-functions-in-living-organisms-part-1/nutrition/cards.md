...
Course: igcse-biology-modular-24-unit-1 · Section: 2. Structure & Functions in Living Organisms: Part 1

Source: https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-1/flashcards/structure-and-functions-in-living-organisms-part-1/nutrition/


## Card 1 — keyword_definition (`fl_kyK7gSY2wbNxzTFf`)
...
## Card 2 — question_and_answer (`fl_p9vXzsfMYRwRbphs`)
...
## Card 3 — true_or_false (`fl_MmxNWRHk7dQcsQBT`)
...
## Card 4 — question_and_answer (`fl_FkHJHRjcxhd3R5VG`)
...
## Card 5 — question_and_answer (`fl_WWMPmxYqBXtxK5mb`)
...
## Card 6 — true_or_false (`fl_jSz9y6zszYg9MTfz`)
...
## Card 7 — true_or_false (`fl_3vQs8SJMmYPWxm5H`)
...
## Card 8 — question_and_answer (`fl_tQSCJnKQ4CWVrf43`)
...
## Card 9 — question_and_answer (`fl_b42nJqjnY85tbxRN`)
...
## Card 10 — true_or_false (`fl_2Sw9tmQsmYcb9MsH`)
...
## Card 11 — question_and_answer (`fl_HsrgXhFgfxbc7fdK`)
...
## Card 12 — true_or_false (`fl_HDjtCSMPJprvpBX8`)
...
## Card 13 — question_and_answer (`fl_DzQ9mR3HVXsxBD3y`)
...
## Card 14 — question_and_answer (`fl_TFfgsCRdPVt7YmtG`)
...
## Card 15 — true_or_false (`fl_hSt8B7Rx6tXT7h77`)
...
## Card 16 — question_and_answer (`fl_ypKBMvfdvCbNPR6q`)
...
## Card 17 — true_or_false (`fl_6TZYRxxJw4t5mmhf`)
...
## Card 18 — question_and_answer (`fl_5bBk3mdzXhHHTXNq`)
...
## Card 19 — keyword_definition (`fl_4xGgXfdcWNtZB6Td`)
...
## Card 20 — question_and_answer (`fl_Ngc4cYcjh4Sgx37d`)
...
## Card 21 — true_or_false (`fl_RPyYx4vbsfjfbCjk`)
...
## Card 22 — question_and_answer (`fl_Sj6pfcmkP3sr3fPH`)
...
## Card 23 — true_or_false (`fl_QGydkxpdVyBcFFwH`)
...
## Card 24 — question_and_answer (`fl_6sSDy4xB4JMphGJX`)
...
## Card 25 — true_or_false (`fl_7pChvRZhDHHGVz6b`)
...
## Card 26 — question_and_answer (`fl_qpHwPm6jZgyKZDxN`)
...
## Card 27 — question_and_answer (`fl_MJVR2XbCK8KfPDR8`)
...
## Card 28 — true_or_false (`fl_m65dcbHbp9jH3G3V`)
...
## Card 29 — question_and_answer (`fl_xgB5dD8wPrhDpmDw`)
...
## Card 30 — true_or_false (`fl_8xJsbKc68Gkdfk6h`)
...
## Card 31 — question_and_answer (`fl_VDw7wHg2PzpCfGxX`)
...
## Card 32 — true_or_false (`fl_kPbDPm8pp6dCgbm9`)
...
## Card 33 — question_and_answer (`fl_nHZNDQTwsp2ncCR5`)
...
## Card 34 — question_and_answer (`fl_GF3Gr5Z54Y7vdqZP`)
...
## Card 35 — true_or_false (`fl_GtRrFssWQzVVPbqP`)
...
## Card 36 — question_and_answer (`fl_PwDPT4VGhDX7wxK9`)
...
## Card 37 — true_or_false (`fl_dffChG7mHsptrG9f`)
...
## Card 38 — true_or_false (`fl_QNNdKzPr5HCtrcWy`)
...
## Card 39 — true_or_false (`fl_6jpvw44zxGKtGKB4`)
...
## Card 40 — question_and_answer (`fl_ysRs5mDK4ntScrnz`)
...
## Card 41 — keyword_definition (`fl_5mYHPb4rBGpxCKDp`)
...
## Card 42 — true_or_false (`fl_Ms2B5NcC59mxHkD3`)
...
## Card 43 — question_and_answer (`fl_GDxfngZtWSXRcNGp`)
...
## Card 44 — question_and_answer (`fl_7QNRhWgzYw3Ntmn3`)
...
## Card 45 — question_and_answer (`fl_HWKMJF6CtSFmYVr9`)
...
## Card 46 — question_and_answer (`fl_pjJcZDHymYnkYTBY`)
...
## Card 47 — question_and_answer (`fl_8dN8GBqyrtXvMW4f`)
...
## Card 48 — question_and_answer (`fl_BjWSZdThhg7fKxpJ`)
...
## Card 49 — true_or_false (`fl_WdkbCDkSY7sJ9Yz7`)
...
## Card 50 — question_and_answer (`fl_DRm5RPnZrKXMGkP4`)
...
## Card 51 — true_or_false (`fl_J9WC9ZQSZYRn5ZRx`)
...
## Card 52 — question_and_answer (`fl_vhNZVPXxptWP7NVR`)
...
## Card 53 — keyword_definition (`fl_879KmkqgHSJ2hZ6q`)
...
## Card 54 — question_and_answer (`fl_S7ZHKf6ZnxmmFY3j`)
...
## Card 55 — question_and_answer (`fl_ZCW6mYyQ5vRkvV2P`)
...
## Card 56 — question_and_answer (`fl_GdHggMHRgStpDWcT`)
...
## Card 57 — true_or_false (`fl_6XtrDv85Wsm88tKq`)
...
## Card 58 — keyword_definition (`fl_J8SMW9DzT3dY9q3R`)
...
## Card 59 — question_and_answer (`fl_F5QF9gGjwdc6rRXR`)
...
## Card 60 — true_or_false (`fl_kKzsVcqWWnbf6Y7K`)
...
## Card 61 — question_and_answer (`fl_7Mrtmm3pgNwbBW2C`)
...
## Card 62 — true_or_false (`fl_FcMvRmwcps7VSd6W`)
...
## Card 63 — true_or_false (`fl_W9bbVx2wyKYdMM74`)
...
## Card 64 — question_and_answer (`fl_vS2fWvXDDKbswdkf`)
...
## Card 65 — question_and_answer (`fl_rM5zDQ8TPvtqfcws`)
...
## Card 66 — question_and_answer (`fl_3kGMDnCHMmKzS9mk`)
...
## Card 67 — true_or_false (`fl_NzCyxgkCRnyw8Tyc`)
...
## Card 68 — true_or_false (`fl_SBx9gVsPFY6FK65t`)
...
## Card 69 — question_and_answer (`fl_84W6DxvzDHB6SfzM`)
...
## Card 70 — question_and_answer (`fl_SPyPRF7cFtbbkDJZ`)
...
## Card 71 — true_or_false (`fl_sfJxgtvKWrRvWWxp`)
...
## Card 72 — true_or_false (`fl_DtrmjdW6Mfng4NVW`)
...
## Card 73 — question_and_answer (`fl_TVWjS7HxQ7pQ7z8D`)
...
## Card 74 — true_or_false (`fl_3rBf7XJyr2cN82XP`)
...
## Card 75 — question_and_answer (`fl_Fcp57wSVbjRpHrbt`)
...
## Card 76 — true_or_false (`fl_kXYztHMKmPQcmtpT`)
...
## Card 77 — question_and_answer (`fl_6J9FcFD77TJT563y`)
...
## Card 78 — question_and_answer (`fl_zqrhs4WQwpx6kyGS`)
...
## Card 79 — question_and_answer (`fl_x2hJfJ87rVNncNQ9`)
...
## Card 80 — true_or_false (`fl_Djvt52SCB3S3hh2k`)
...
## Card 81 — question_and_answer (`fl_xYmCDXFMY6qcy9vR`)
...
## Card 82 — question_and_answer (`fl_Pgx6fwfwsBDMPd59`)
...
## Card 83 — keyword_definition (`fl_9HD7r7jP4S869jb2`)
...
## Card 84 — true_or_false (`fl_CffHM8GYdbSwrVSc`)
...
## Card 85 — question_and_answer (`fl_vTcJ6zQFbjbrXKmq`)
...
## Card 86 — true_or_false (`fl_gksGGHFYrRF5yB8T`)
...
## Card 87 — question_and_answer (`fl_qqhBcHK2nJk5YccQ`)
...
## Card 88 — question_and_answer (`fl_8v4gcsfBCVPKXngS`)
...
## Card 89 — true_or_false (`fl_yDk7rwCB4BNqs4Yp`)
...
## Card 90 — true_or_false (`fl_qvK4tZ4kD4hH9tBJ`)
...
## Card 91 — question_and_answer (`fl_fQxCRh6SVqqWFcRN`)
...
## Card 92 — question_and_answer (`fl_yMqQQ7Z3SQtRsDsG`)
...
## Card 93 — true_or_false (`fl_PW7wZJP46ZwCPDFF`)
...
## Card 94 — keyword_definition (`fl_StTw3gVhQyXKcvnG`)
...
## Card 95 — true_or_false (`fl_JvRznQtkydqTBmDD`)
...
## Card 96 — question_and_answer (`fl_b6kXtrGRR222C3Cg`)
...
## Card 97 — true_or_false (`fl_rWpgJsd6Kj7t7QyJ`)
...
## Card 98 — question_and_answer (`fl_MHhmdXf7Nm3Yr33c`)
...
## Card 99 — question_and_answer (`fl_HTDRkXdsdYqNbxfT`)
...
## Card 100 — keyword_definition (`fl_jNZPTWkBHQcX6pFH`)
...
## Card 101 — question_and_answer (`fl_ZZ6MCddhx6x7zQFQ`)
...
## Card 102 — question_and_answer (`fl_P76sXZzxXcSMNbT8`)
...
## Card 103 — true_or_false (`fl_7Vj7XcQSzJvghzXx`)
...
## Card 104 — true_or_false (`fl_jK6kP5jk257yxMzF`)
...
## Card 105 — question_and_answer (`fl_GGq3cgkRwQ9tXdNN`)
...
## Card 106 — true_or_false (`fl_zbQ4xGZxYVR73Q4T`)
...
## Card 107 — question_and_answer (`fl_MgtGm9wy8s5TYD7Y`)
...
## Card 108 — question_and_answer (`fl_q2ddMMH8gpFcyQKf`)
...
## Card 109 — question_and_answer (`fl_bqytyphcDDJFKgQT`)
...
## Card 110 — question_and_answer (`fl_tYNSfXkx8nYFfXdH`)
...
## Card 111 — question_and_answer (`fl_2WTrbqhXfhQ2phx6`)
...
## Card 112 — true_or_false (`fl_YMmmg7yvWjCRFKyz`)
...
## Card 113 — question_and_answer (`fl_MbtkxSJmsfyMhbQr`)
...
## Card 114 — keyword_definition (`fl_2VmZr6rMRxkdM7Xs`)
...
## Card 115 — true_or_false (`fl_XvZb4GMMrRyQ7C87`)
...
## Card 116 — question_and_answer (`fl_xZHX84KKgVNkdxdt`)
...
## Card 117 — question_and_answer (`fl_hCGVs9cjqTChMzgd`)
...
## Card 118 — true_or_false (`fl_Dt28Zw84nt4CyfgS`)
...
## Card 119 — true_or_false (`fl_t3bPXbSm7Jy9T9H7`)
...
## Card 120 — question_and_answer (`fl_KtVgDNVg7hvdbRFS`)
...
## Card 121 — keyword_definition (`fl_47FqVwRYVtD2KX7x`)
...
## Card 122 — question_and_answer (`fl_y2YbtVM2Sz8Pj8Pd`)
...
## Card 123 — question_and_answer (`fl_z5MzJxtZyCSHfhNk`)
...
## Card 124 — question_and_answer (`fl_wRrh6gjH9qncRKJM`)
...
## Card 125 — true_or_false (`fl_2KjhV55sC6xmq9f5`)
...
## Card 126 — question_and_answer (`fl_6HHzqs39wzZrxNRg`)
...
## Card 127 — true_or_false (`fl_ZqPxzjyD5NrDnQzM`)
...
## Card 128 — true_or_false (`fl_5Q4wyGnGtTfTY7Cc`)
...
## Card 129 — question_and_answer (`fl_HWRHRYZ9KVWFf9Mq`)
...
## Card 130 — question_and_answer (`fl_7YHfkHfvmhK4mBNJ`)
...
## Card 131 — question_and_answer (`fl_4Rs4mQ38zKVgnCTq`)
...
## Card 132 — question_and_answer (`fl_djmGkBCt2DZRkfxn`)
...
This is part of the COR**MM**S criteria for planning an investigation.
