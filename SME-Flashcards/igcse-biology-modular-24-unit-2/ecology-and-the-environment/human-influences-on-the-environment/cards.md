...
Course: igcse-biology-modular-24-unit-2 · Section: 5. Ecology & the Environment

Source: https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-2/flashcards/ecology-and-the-environment/human-influences-on-the-environment/


## Card 1 — question_and_answer (`fl_ds62cY9Vs4z43Bnj`)
...
## Card 2 — question_and_answer (`fl_Pz8WCnjhQhmY8pxM`)
...
## Card 3 — question_and_answer (`fl_kMvS2NtxnDt43xkC`)
...
## Card 4 — true_or_false (`fl_W5TrjDFX38YxYHBw`)

**FRONT**

**True or False?**

Carbon monoxide is released when impure fossil fuels are burned.
...
## Card 5 — question_and_answer (`fl_q5tGwBCs3drpxjBx`)
...
## Card 6 — keyword_definition (`fl_Cm8bfGTj6fY9QXQt`)
...
## Card 7 — true_or_false (`fl_K8JPpzXWzmG3ZscM`)

**FRONT**

**True or False? **

Increased atmospheric greenhouse gas concentrations lead to an increase in  average atmospheric temperatures.
...
## Card 8 — question_and_answer (`fl_xkWCRZwjrRV5gFn6`)
...
## Card 9 — question_and_answer (`fl_CCj6vVfFQ4Jsp7Fz`)
...
## Card 10 — true_or_false (`fl_JK9RGMhNCF36yFYX`)
...
## Card 11 — question_and_answer (`fl_ST9NZWpScwkp9PXp`)
...
## Card 12 — question_and_answer (`fl_PVXbZpnP7vYW5SYM`)
...
## Card 13 — true_or_false (`fl_4rkv8nMq5PQCQZvk`)

**FRONT**

**True or False? **

The greenhouse effect is caused by **human activities **alone.
...
## Card 14 — question_and_answer (`fl_cmY8sFMMj6y9nCFr`)
...
## Card 15 — keyword_definition (`fl_vSsY2zW6KcqtbxWs`)
...
## Card 16 — question_and_answer (`fl_3k83YGYQDPCwfFw4`)
...
## Card 17 — true_or_false (`fl_SnV3gdSrvTj7CVZh`)
...
## Card 18 — question_and_answer (`fl_k7P6xnRpgSy2V2GR`)
...
## Card 19 — question_and_answer (`fl_2xbRVfpxtY6K53jw`)
...
## Card 20 — question_and_answer (`fl_3hGPN7ryHjYFYK9d`)
...
## Card 21 — question_and_answer (`fl_gbjW2wyCTWHtTCqJ`)
...
## Card 22 — keyword_definition (`fl_9Rmr6SbYCc7SjQZx`)
...
## Card 23 — keyword_definition (`fl_fKRsJktjSvhR3VT6`)
...
## Card 24 — true_or_false (`fl_95b4M4cpG3RVvsvh`)

**FRONT**

**True or False? **

Algal blooms occur due to a lack of nutrients in water bodies.
...
## Card 25 — question_and_answer (`fl_FjPgDvCnrQNvxTvN`)
...
## Card 26 — question_and_answer (`fl_h4X62qYmHMhFyTWz`)
...
## Card 27 — question_and_answer (`fl_2PsjcGzB3WrV88KK`)
...
## Card 28 — keyword_definition (`fl_PPCpmgWJjv9mGFzR`)
...
## Card 29 — question_and_answer (`fl_SNDMMFj347vpBdmn`)
...
## Card 30 — keyword_definition (`fl_B9g2T3q2N2M3Hh9t`)
...
## Card 31 — true_or_false (`fl_mzq5kFvJW36vg7ZR`)
...
## Card 32 — true_or_false (`fl_Sbq9x9ns7hdspMKT`)
