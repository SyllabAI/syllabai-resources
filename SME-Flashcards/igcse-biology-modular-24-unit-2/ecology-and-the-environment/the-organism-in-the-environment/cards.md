...
Source: https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-2/flashcards/ecology-and-the-environment/the-organism-in-the-environment/


## Card 1 — keyword_definition (`fl_7ZR4h2qkycFz6dmn`)
...
## Card 2 — keyword_definition (`fl_m7WQpbyN4cnDDHsz`)
...
## Card 3 — question_and_answer (`fl_vhMt9Fr6szCcG84B`)
...
## Card 4 — true_or_false (`fl_t3XnCVrcpxMJvycX`)
...
## Card 5 — keyword_definition (`fl_gM5YBFKM7sV824GX`)
...
## Card 6 — true_or_false (`fl_QmyRkPWDYJp2wTzw`)
...
## Card 7 — question_and_answer (`fl_CXnrcfTHVWMNK6wR`)
...
## Card 8 — keyword_definition (`fl_mYwXjdYwZhcG3PxS`)
...
## Card 9 — question_and_answer (`fl_pkSFm3MfWX6bKgBj`)
...
## Card 10 — question_and_answer (`fl_NqRBnGfNfPhF4PFs`)
...
## Card 11 — question_and_answer (`fl_9D87YftQtSWysghB`)
...
## Card 12 — question_and_answer (`fl_yDHgBcFwzzDGhG48`)
...
## Card 13 — question_and_answer (`fl_rgfcP9N6cfqBbcjF`)
...
## Card 14 — true_or_false (`fl_43bVMFPPB4zJhXPy`)
...
## Card 15 — keyword_definition (`fl_KwmZy9KdQ69yX2f7`)
...
## Card 16 — question_and_answer (`fl_6gdGnV95SJpNH67w`)
...
## Card 17 — true_or_false (`fl_VJyK2YhQykGScNV6`)
...
## Card 18 — keyword_definition (`fl_TmBsBgQWcW3VbWFg`)
...
## Card 19 — question_and_answer (`fl_dMVYR5TyN27qZTJJ`)
...
## Card 20 — true_or_false (`fl_WhMfwDQSsTgrr2cY`)
...
## Card 21 — keyword_definition (`fl_JFp6XwbcZGBh9VZQ`)
...
## Card 22 — question_and_answer (`fl_Z4PtXktBMwkkgddg`)
...
## Card 23 — question_and_answer (`fl_WMPRJhtDT38QNG9Q`)
...
## Card 24 — true_or_false (`fl_Qr44FFcDwKV83kzy`)
...
## Card 25 — keyword_definition (`fl_D6kyjrXpZtwwmbN5`)
...
## Card 26 — question_and_answer (`fl_3xsPGX2b2pZcrtmX`)
...
## Card 27 — true_or_false (`fl_HskTBRMkTSrRjXJ7`)
...
## Card 28 — keyword_definition (`fl_b8hNTvMZ656XTypv`)
...
## Card 29 — true_or_false (`fl_NZb6pqybXjzx2kdy`)
