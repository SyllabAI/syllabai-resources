...
Course: igcse-biology-modular-24-unit-2 · Section: 6. Use of Biological Resources

Source: https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-2/flashcards/use-of-biological-resources/food-production/


## Card 1 — question_and_answer (`fl_69nyCBJBNCk5CmwV`)
...
Limiting factors are those affecting the rate of photosynthesis, including:
...
## Card 2 — true_or_false (`fl_Jst9McgfkQhJnJMQ`)

**FRONT**

**True or False? **

Growing crops **outside** allows farmers to **control all limiting factors**.
...
Growing crops outside does not allow farmers to control all limiting factors, such as temperature, lighting, and carbon dioxide levels, which can affect the rate of photosynthesis and crop yields.



## Card 3 — question_and_answer (`fl_PkM5ptKTWWpzjzhv`)

**FRONT**

Why are **glasshouses** used in farming?


**BACK**

Glasshouses are used to create an **enclosed environment **where farmers can **control conditions like temperature, lighting, and carbon dioxide levels** to enhance the rate of photosynthesis and** increase crop yields.**



## Card 4 — question_and_answer (`fl_DT5m8W6vHnWDszWs`)
...
Polytunnels, also known as polythene tunnels, are** large plastic tunnels covering crops **that** protect** them from adverse weather conditions, regulate temperature, and prevent the entry of pests and diseases, thereby improving crop growth and yield.



## Card 5 — true_or_false (`fl_tqjsP9hhBG9xG5ZR`)

**FRONT**

**True or False? **

Glasshouses are primarily used in tropical countries.
...
Glasshouses are primarily used in temperate countries like the UK, where **artificial heating is required** to maintain optimal temperatures for photosynthesis, while in tropical countries, they may still be used but require ventilation to prevent overheating.



## Card 6 — question_and_answer (`fl_n8js3fj8CgXJ9mFR`)

**FRONT**

How do **polytunnels** protect crops?


**BACK**

Polytunnels protect crops by **shielding them from adverse weather conditions **such as excessive wind, rain, and **extreme temperatures**, while also regulating temperature and **preventing the entry of pests and diseases**, thereby promoting healthy crop growth.



## Card 7 — question_and_answer (`fl_vZH7jtmwcP5b7mTT`)

**FRONT**

What factors can be manipulated inside a glasshouse to increase the rate of photosynthesis?


**BACK**

Inside a glasshouse, factors like** artificial heating, lighting, and increased carbon dioxide content **can be manipulated to enhance the rate of photosynthesis in crops, thereby improving crop yields.



## Card 8 — true_or_false (`fl_ytYZhPq8KvKBRJv6`)

**FRONT**

**True or False? **

Polytunnels have no effect on the temperature inside them.
...
Polytunnels slightly increase the temperature inside them, providing a more favourable microclimate for crop growth, while also shielding crops from extreme weather conditions and pests.



## Card 9 — question_and_answer (`fl_5jCGJYHXQByCTHSG`)

**FRONT**

What **considerations do farmers **need to balance when using glasshouses?


**BACK**

When using glasshouses, farmers need to** balance the additional costs** of providing heating, lighting, and carbon dioxide **against the potential increase in income** resulting from enhanced crop yields.



## Card 10 — question_and_answer (`fl_KJVz7V77dbZrfHSb`)
...
The rate of photosynthesis is limited by **temperature, light intensity, and carbon dioxide concentration**, with the factor that is lowest at a given time determining the overall rate of photosynthesis, known as the limiting factor.



## Card 11 — true_or_false (`fl_c9vzBsyNcbFtS7Wr`)

**FRONT**

**True or False? **

Increasing temperature** always** increases the rate of photosynthesis.
...
## Card 12 — true_or_false (`fl_KWGbw99QhDRG86p2`)

**FRONT**

**True or False? **

Carbon dioxide concentration in a glasshouse will have **no **effect on the rate of photosynthesis.
...
## Card 13 — keyword_definition (`fl_62RhHMgCcvJ9t8TC`)
...
## Card 14 — question_and_answer (`fl_w9R3DpGrhwfJcfRS`)
...
## Card 15 — true_or_false (`fl_XyqCkzNFgJhBghPW`)

**FRONT**

**True or False? **

The rate of photosynthesis is **solely** determined by light intensity.
...
## Card 16 — question_and_answer (`fl_kqgVfm4PJ6cxhtY9`)
...
## Card 17 — question_and_answer (`fl_XRrmPcQpzmQHHJC3`)

**FRONT**

How can fertilisers be used to increase food supply?
...
## Card 18 — true_or_false (`fl_cM58XwrmMyrCs8ZQ`)

**FRONT**

**True or False? **

Fertilisers are **only available in chemical form.**
...
## Card 19 — keyword_definition (`fl_VKn77ttGx8chrMPH`)

**FRONT**

Define the term** organic fertilisers**.
...
## Card 20 — question_and_answer (`fl_HpJrnhbfvkhwHVdG`)

**FRONT**

What are the **main nutrients** provided by chemical fertilisers?
...
## Card 21 — true_or_false (`fl_95qtX9mcxpWKrHG2`)

**FRONT**

**True or False? **

Lack of nitrates can lead to **poor growth.**
...
## Card 22 — question_and_answer (`fl_H9Pg4TffpNjNRkNz`)

**FRONT**

What is a symptom in a plant of** low nitrate levels**?
...
## Card 23 — question_and_answer (`fl_sdHPq4mYT7nf3BpS`)
...
## Card 24 — true_or_false (`fl_85vg7PjHCpJ3g5gb`)

**FRONT**

**True or False? **

Biological control involves the use of **chemicals** to kill pests.
...
## Card 25 — question_and_answer (`fl_DjJ9NyxX8YXqRw3y`)

**FRONT**

What is the purpose of using **pesticides in pest control**?
...
## Card 26 — keyword_definition (`fl_yk7PFMWzbnHvhYNS`)

**FRONT**

Define** biological control **in the context of pest management.
...
## Card 27 — true_or_false (`fl_3csFhxYcYV6myqs2`)

**FRONT**

**True or False? **

Biological control **eliminates pests entirely.**
...
## Card 28 — question_and_answer (`fl_xJp4s8TPhFjQNbv8`)

**FRONT**

How do **herbicides **contribute to pest control?
...
## Card 29 — question_and_answer (`fl_P5p5vNKsr2tsyzqT`)
...
## Card 30 — question_and_answer (`fl_fVvPNQy85j4r8b4v`)
...
## Card 31 — question_and_answer (`fl_F6ZB4ffYTT5DCPqZ`)

**FRONT**

List three **advantages** of biological control.
...
## Card 32 — question_and_answer (`fl_CXbZ9fHd7S8R5sCh`)

**FRONT**

List three **disadvantages** of biological control.
...
## Card 33 — question_and_answer (`fl_pJSgF3DKcQWsHzYJ`)
...
## Card 34 — true_or_false (`fl_sSPpgZBFswMzzFDG`)
...
## Card 35 — question_and_answer (`fl_bDgxBHV8pBBqxTDP`)
...
## Card 36 — question_and_answer (`fl_8NwDSQNQcR94bpvt`)
...
## Card 37 — true_or_false (`fl_xX62YG5Tvfm36RmM`)
...
Yeast can carry out** anaerobic respiration**, making it suitable for fermentation processes.



## Card 38 — keyword_definition (`fl_7VPQHB9bQqVbzrBn`)
...
## Card 39 — question_and_answer (`fl_BwT9tZQvcXDhxJFz`)
...
## Card 40 — question_and_answer (`fl_vWHdzQFxsmFgZ8gW`)
...
## Card 41 — question_and_answer (`fl_GdyVmSjVp8h7YqXJ`)
...
## Card 42 — true_or_false (`fl_6kYCG42K6ZQFnKkM`)

**FRONT**

**True or False? **

Enzyme activity in yeast fermentation **increases with higher temperatures**.
...
## Card 43 — question_and_answer (`fl_ZhQM82bxws5jHwRW`)
...
## Card 44 — question_and_answer (`fl_xZ98Kgr3498SXth8`)
...
## Card 45 — question_and_answer (`fl_ZfbSX8b3NwQvrvj2`)
...
## Card 46 — question_and_answer (`fl_FyghyVm9PQtbY428`)
...
## Card 47 — true_or_false (`fl_jn92HFTxnbgXhrDg`)

**FRONT**

**True or False? **

Yoghurt production involves the use of** pasteurised milk**.
...
## Card 48 — keyword_definition (`fl_ZkQgYdmFk5pgFfMy`)
...
## Card 49 — question_and_answer (`fl_b674BVxYJvnk3c97`)
...
## Card 50 — question_and_answer (`fl_XdyrHMYq82NmvJ46`)
...
## Card 51 — true_or_false (`fl_BwGKXSBPxqKn7ggh`)

**FRONT**

**True or False? **

*Lactobacillus* bacteria **convert lactose into ethanol** during yoghurt production.
...
## Card 52 — question_and_answer (`fl_Srhzm5dnvcGWGWfV`)
...
## Card 53 — keyword_definition (`fl_sMhxvJv4sJmw5DWG`)
...
## Card 54 — question_and_answer (`fl_dd8fjHhtxgjVkNRF`)

**FRONT**

List** three** uses of an industrial fermenter.
...
## Card 55 — question_and_answer (`fl_MjTx6Zf2zhVbk9Zh`)
...
## Card 56 — question_and_answer (`fl_JWF7FjvcXY7cJ9ND`)
...
## Card 57 — question_and_answer (`fl_wR7rc24Y2HV5qXMy`)
...
## Card 58 — question_and_answer (`fl_ZdST6r5tZx3x44dV`)
...
## Card 59 — question_and_answer (`fl_qk5D7vxqSNxHdcXy`)
...
## Card 60 — keyword_definition (`fl_DGfm5z3qSjyWGx7t`)

**FRONT**

Define the term **fish farming**.
...
## Card 61 — question_and_answer (`fl_hWcZTmjwndz9Db5B`)

**FRONT**

What are some** advantages** of fish farming **compared to wild-caught fish**?
...
## Card 62 — question_and_answer (`fl_hbPq5dVr58XJH2Xy`)

**FRONT**

What are some methods used in fish farms to** ensure high yields**?
...
## Card 63 — question_and_answer (`fl_dPCmjmYyT6jTcpnr`)

**FRONT**

Why is fish farming considered a **sustainable** alternative to wild-caught fish?
...
## Card 64 — true_or_false (`fl_8mVMkm4TxGfrRF4s`)

**FRONT**

**True or False? **

Fish farming allows ** control **over environmental factors.
...
## Card 65 — question_and_answer (`fl_fnGZZHF4MbDzKGPT`)

**FRONT**

How does fish farming help address the issue of **overfishing**?
...
## Card 66 — question_and_answer (`fl_8c6xZcXysvkB5j7P`)

**FRONT**

How does fish farming contribute to **water quality management**?
...
## Card 67 — question_and_answer (`fl_r2DKqDQmSvQ8W59W`)

**FRONT**

What steps are involved in fish farming to **prevent disease outbreaks**?
...
## Card 68 — question_and_answer (`fl_t2vpbBPbYsnHkhh2`)

**FRONT**

How does fish farming aid in **waste management**?
