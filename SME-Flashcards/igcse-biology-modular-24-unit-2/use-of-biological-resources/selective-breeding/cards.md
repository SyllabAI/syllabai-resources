...
Source: https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-2/flashcards/use-of-biological-resources/selective-breeding/


## Card 1 — keyword_definition (`fl_CZS2kCDPH223FxNr`)
...
## Card 2 — question_and_answer (`fl_BwGYhfy7ntSscGxb`)
...
## Card 3 — question_and_answer (`fl_7SwKVdGtmfNdgKYg`)
...
## Card 4 — question_and_answer (`fl_QPRcVMPPqCyB55N6`)
...
## Card 5 — question_and_answer (`fl_VtnX437QDMdjpDH3`)
...
## Card 6 — keyword_definition (`fl_TRtVcrCM2kPCjQSJ`)
...
## Card 7 — question_and_answer (`fl_CfSF9BCKhbSfDKSQ`)
...
## Card 8 — question_and_answer (`fl_hXxTj4XNwhfjNDW4`)
...
## Card 9 — question_and_answer (`fl_pPm5rQQT5SCn7sDX`)
...
## Card 10 — question_and_answer (`fl_Rvwk2k9pBVPK4vJv`)
...
## Card 11 — true_or_false (`fl_dJTV6pPsDrcXSw8r`)
