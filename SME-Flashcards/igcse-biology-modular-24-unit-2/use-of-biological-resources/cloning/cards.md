...
Source: https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-2/flashcards/use-of-biological-resources/cloning/


## Card 1 — keyword_definition (`fl_sgrjMrgBg2QHtpGt`)
...
## Card 2 — true_or_false (`fl_h6fDVYH3DfV8BGmZ`)
...
## Card 3 — question_and_answer (`fl_xT6tBPMppRGswyX2`)
...
## Card 4 — question_and_answer (`fl_Sz4SMW5BCKmqHgNX`)
...
## Card 5 — question_and_answer (`fl_4V3MP7ssNwQKQFnw`)
...
## Card 6 — question_and_answer (`fl_9xBHGjNcjrqCqh5M`)
...
## Card 7 — question_and_answer (`fl_CwBgXtdh32F77Rp2`)
...
## Card 8 — true_or_false (`fl_rC2fGQDQKsVpMjzh`)
...
## Card 9 — keyword_definition (`fl_bZkMGQgCsGCqKKCK`)
...
## Card 10 — keyword_definition (`fl_MBGSQXVhwDKsNprz`)
...
## Card 11 — true_or_false (`fl_BbFyjWvVZwCpD57W`)
...
## Card 12 — question_and_answer (`fl_YzJbXHZmHHh9tFsZ`)
...
## Card 13 — question_and_answer (`fl_NjGxK5ZJpw72GT2B`)
...
## Card 14 — true_or_false (`fl_fcyWpYDf4ZjjYxMj`)
...
## Card 15 — question_and_answer (`fl_2BfRQRc5JnWcshVm`)
...
## Card 16 — question_and_answer (`fl_TZds23MdcyVtrywP`)
...
## Card 17 — true_or_false (`fl_rYgdjBHJCYcthrvJ`)
...
## Card 18 — question_and_answer (`fl_sBHdC222qFTxNvK9`)
...
## Card 19 — keyword_definition (`fl_YwSKK92tQncXSsCd`)
...
## Card 20 — true_or_false (`fl_cmHzyqKffJW8jfMY`)
...
## Card 21 — question_and_answer (`fl_vJ3Ph3sDhGmXTc29`)
...
## Card 22 — question_and_answer (`fl_xMP6dhXtM4fkyKwf`)
...
## Card 23 — question_and_answer (`fl_SR8JbqbFckbPP3xw`)
...
## Card 24 — question_and_answer (`fl_zY6HJJ6CrHt9jddf`)
...
## Card 25 — keyword_definition (`fl_fmx2kx7k3t3znZwv`)
...
## Card 26 — question_and_answer (`fl_rFqMZvZhV9KwNx9f`)
...
## Card 27 — question_and_answer (`fl_zcmVKgf3KPT5wFDc`)
