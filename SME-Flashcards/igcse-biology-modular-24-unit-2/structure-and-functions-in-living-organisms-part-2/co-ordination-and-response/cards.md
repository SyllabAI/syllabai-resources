...
Course: igcse-biology-modular-24-unit-2 · Section: 3. Structure & Functions in Living Organisms: Part 2

Source: https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-2/flashcards/structure-and-functions-in-living-organisms-part-2/co-ordination-and-response/


## Card 1 — question_and_answer (`fl_zPt62pN4yVF7GPSn`)

**FRONT**

What are some **physiological factors** controlled by homeostasis in mammals?
...
## Card 2 — question_and_answer (`fl_3SjsxvYvmh5tWdTt`)
...
## Card 3 — true_or_false (`fl_35xtn7pKPW5wPVJp`)
...
## Card 4 — keyword_definition (`fl_2yJcJnqZwhsTFdQ7`)
...
## Card 5 — question_and_answer (`fl_qkcDW56QSHr45JZj`)
...
## Card 6 — true_or_false (`fl_bXCZK6v3JmypNhft`)
...
## Card 7 — true_or_false (`fl_RyHYPTXMZQBpMtnJ`)
...
## Card 8 — question_and_answer (`fl_KXbqPY6TccBhRHCs`)
...
## Card 9 — question_and_answer (`fl_RnY72QrKz2gkDg5f`)
...
## Card 10 — question_and_answer (`fl_ByhWyQ5SJTgkXTsN`)
...
## Card 11 — true_or_false (`fl_wzNhbyzZXp8Sds7x`)
...
## Card 12 — keyword_definition (`fl_s7yJQHqFCMwdRwv2`)
...
## Card 13 — true_or_false (`fl_7RvJZZthrNK44zzv`)
...
## Card 14 — keyword_definition (`fl_HCYYC2ftZKCGtDbz`)
...
## Card 15 — question_and_answer (`fl_DPVbf3S6m6JkvYzY`)
...
## Card 16 — question_and_answer (`fl_fTn3ykkX3y736zKs`)
...
## Card 17 — keyword_definition (`fl_hTPsV3Qvym6sJkFB`)
...
## Card 18 — question_and_answer (`fl_ZXDzzY8FDgbR2kft`)
...
## Card 19 — question_and_answer (`fl_XkcWBJfWtTJgHSP8`)
...
## Card 20 — true_or_false (`fl_t2wsspywdDjPbc78`)
...
## Card 21 — keyword_definition (`fl_bXBxTRFBvZzNs9zw`)
...
## Card 22 — keyword_definition (`fl_8Pg59KqfHmJJkxgp`)
...
## Card 23 — true_or_false (`fl_JGkvZFQ7FkvrwBZV`)
...
## Card 24 — true_or_false (`fl_x4N9PNrzCV8TNsHv`)
...
## Card 25 — true_or_false (`fl_XXFFCkX9Rmxpx98p`)
...
## Card 26 — question_and_answer (`fl_f6FkqsvMt55QMZZm`)
...
## Card 27 — question_and_answer (`fl_vdD2NvGW2WBXrV6D`)
...
## Card 28 — question_and_answer (`fl_gpFjF4QX6hQ4Hh8g`)
...
## Card 29 — question_and_answer (`fl_SbYpyxkrqd5Vmvvf`)
...
## Card 30 — question_and_answer (`fl_SQHNmSVb33y98G6M`)
...
## Card 31 — question_and_answer (`fl_vQzzWR65Cfq9TxTP`)
...
## Card 32 — question_and_answer (`fl_XRn3c2YSjDv4wGxK`)
...
## Card 33 — true_or_false (`fl_zBgckMkcNSKRrQY7`)
...
## Card 34 — question_and_answer (`fl_JhPQYg9N7f2S9kZk`)
...
## Card 35 — true_or_false (`fl_39Qggr5zmcJ8whN4`)
...
## Card 36 — true_or_false (`fl_RPRRd5JQRXQP5RBS`)
...
## Card 37 — question_and_answer (`fl_PRcGydDMck3GVmjn`)
...
## Card 38 — true_or_false (`fl_zg8N2jZCycRXy3CS`)
...
## Card 39 — question_and_answer (`fl_D3rWCvdQ6JgDX2Hn`)
...
## Card 40 — question_and_answer (`fl_p5xv9zVTCzM3wP5r`)
...
## Card 41 — true_or_false (`fl_gkT5QPw2xfDRn8cB`)
...
## Card 42 — true_or_false (`fl_ZSXMYDc2vPpzmxjy`)
...
## Card 43 — question_and_answer (`fl_2BgrtSv7qr393YDC`)
...
## Card 44 — question_and_answer (`fl_7yVpBWY45NpKxdwS`)
...
## Card 45 — question_and_answer (`fl_fpkFZy3m5kSDc8zy`)
...
## Card 46 — true_or_false (`fl_dZmZrMS2QnJcX2KQ`)
...
## Card 47 — question_and_answer (`fl_KQtMHDty3bCf59wY`)
...
## Card 48 — true_or_false (`fl_x8Jcd9HmQpTRJ5Qt`)
...
## Card 49 — keyword_definition (`fl_q6tT282whJ6x49sJ`)
...
## Card 50 — keyword_definition (`fl_hrxyq9x3m4jBP6Wb`)
...
## Card 51 — true_or_false (`fl_R7hfdRZSF9PtgvDF`)
...
## Card 52 — question_and_answer (`fl_DWcj3Y4HQSHxMbpH`)
...
## Card 53 — true_or_false (`fl_DkSn78z8fxBJppgc`)
...
## Card 54 — question_and_answer (`fl_7RVc5drDVgvRjwHP`)
...
## Card 55 — true_or_false (`fl_ZKf8dm35BPckf9gD`)
...
## Card 56 — keyword_definition (`fl_vfHrbbxFChmjK965`)
...
## Card 57 — question_and_answer (`fl_6TynnsWmgJwWFfrw`)
...
## Card 58 — question_and_answer (`fl_Trm8wJYtDTmvtB2S`)
...
## Card 59 — question_and_answer (`fl_M9Zq2xdqypHYQFnp`)
...
## Card 60 — question_and_answer (`fl_rVttdxBgsJT26GJX`)
...
## Card 61 — question_and_answer (`fl_sRjGf7cq7Ks9K9fh`)
...
## Card 62 — question_and_answer (`fl_v3wqcKxCRdFvNZ7s`)
...
## Card 63 — question_and_answer (`fl_yC8Bh6mzZPppKfy7`)
...
## Card 64 — question_and_answer (`fl_t3gZhqgcgp2rcBbz`)
...
## Card 65 — question_and_answer (`fl_7C6hxXWhHjxtbHxZ`)
...
## Card 66 — true_or_false (`fl_YSWDC4BSZWtN8fDY`)
...
## Card 67 — question_and_answer (`fl_SzDn9XdMrDn4FnqR`)
...
## Card 68 — keyword_definition (`fl_TSBCDh55kGwZC9ts`)
...
## Card 69 — question_and_answer (`fl_YDk8XfTwC8HRtQtd`)
...
## Card 70 — question_and_answer (`fl_Syf2N5skFzYrHr5V`)
...
## Card 71 — question_and_answer (`fl_jGNQSzChJHJr2Kh2`)
...
## Card 72 — question_and_answer (`fl_MckRRPn4GDnDV9h9`)
...
## Card 73 — keyword_definition (`fl_KxQmKskwttZyHmkc`)
...
## Card 74 — keyword_definition (`fl_fWmTdkftqpKByGPD`)
...
## Card 75 — question_and_answer (`fl_mQmKkzkTBPnv2d75`)
...
## Card 76 — question_and_answer (`fl_Qf4scq6mSYfbQrB5`)
...
## Card 77 — question_and_answer (`fl_6yq7B8ZdxtY8QMj3`)
...
## Card 78 — true_or_false (`fl_b3q3XrgtK2sGmJdh`)
...
## Card 79 — question_and_answer (`fl_DpMQkGwyYyWfKpvW`)
...
## Card 80 — question_and_answer (`fl_hrBMWPBfPxXjDcn8`)
...
## Card 81 — true_or_false (`fl_x67yNmpz7wPHvnNr`)
...
## Card 82 — question_and_answer (`fl_ZH2yNxFSGzdvT7wB`)
...
## Card 83 — question_and_answer (`fl_RNgfSHvSGBChSgFg`)
...
## Card 84 — question_and_answer (`fl_9QJNPgHZpmzzwXDY`)
...
## Card 85 — keyword_definition (`fl_Q5RMHsKzJRc8bYV7`)
...
## Card 86 — question_and_answer (`fl_vqPscN3XRrqWvpzB`)
...
## Card 87 — true_or_false (`fl_sKNkSfck2y6nVZnB`)
...
## Card 88 — true_or_false (`fl_JCbCwvxkB6Fgj2XC`)
...
## Card 89 — question_and_answer (`fl_Tncy3ZKRsbdHSkT9`)
...
## Card 90 — true_or_false (`fl_CQXHrGSH4CchwXTq`)
...
## Card 91 — keyword_definition (`fl_3rnfBFqcN6TKHmk7`)
...
## Card 92 — question_and_answer (`fl_SgrYsKrzRp2xTMCH`)
...
## Card 93 — question_and_answer (`fl_8wwGKvjqnWWRZHf2`)
...
## Card 94 — true_or_false (`fl_sQd8Dxj4vVmkcVZ6`)
...
## Card 95 — question_and_answer (`fl_psn3BYt86T6bTG5r`)
...
## Card 96 — true_or_false (`fl_cZGz6kKw5NppB65j`)
...
## Card 97 — question_and_answer (`fl_bhGh8gp3x4Ww4MR9`)
...
## Card 98 — question_and_answer (`fl_bxmJ6DQkmCnzkYh9`)
...
## Card 99 — question_and_answer (`fl_kpwnnRJyCMcvrzGR`)
...
## Card 100 — true_or_false (`fl_JQykgvssWXGzVdJY`)
...
## Card 101 — question_and_answer (`fl_94C8KQJbtcjDXVKd`)
...
## Card 102 — question_and_answer (`fl_kjPrQHKBCd2fH5yP`)
...
## Card 103 — true_or_false (`fl_KCQVXcYs5RPkSTvx`)
