...
Course: igcse-biology-modular-24-unit-2 · Section: 4. Reproduction & Inheritance

Source: https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-2/flashcards/reproduction-and-inheritance/inheritance/


## Card 1 — keyword_definition (`fl_QTphFYXHghZrmk9v`)
...
## Card 2 — keyword_definition (`fl_H3vg5dgBRRbZdhCz`)
...
## Card 3 — true_or_false (`fl_DdY7DvfrX4ZbjxKK`)
...
## Card 4 — true_or_false (`fl_zj5ffppwGZx69GN8`)
...
## Card 5 — keyword_definition (`fl_v8bKk6BYws7wkjrf`)
...
## Card 6 — keyword_definition (`fl_bmYHccftwd6qG3mM`)
...
## Card 7 — true_or_false (`fl_C9fh7KXrVDFTRrtJ`)
...
## Card 8 — question_and_answer (`fl_6BytBtzbTyF6cjpg`)
...
Human body cells contain** 23 pairs** of chromosomes, totalling **46 chromosomes** in diploid cells (often represented as 2*n*).



## Card 9 — question_and_answer (`fl_KMjVthXKQwZDhrgJ`)
...
## Card 10 — question_and_answer (`fl_D47wtX8SGtXwmK4T`)
...
## Card 11 — true_or_false (`fl_nGWQ7xRNCgwvJC92`)
...
## Card 12 — true_or_false (`fl_8DqnSBY7QtsnyBp9`)
...
## Card 13 — question_and_answer (`fl_fQX2yGQWMRK8Z6m8`)
...
## Card 14 — keyword_definition (`fl_hq62Chh9Nm42bTv4`)
...
## Card 15 — true_or_false (`fl_mCfy24pkKXggWrnP`)
...
## Card 16 — question_and_answer (`fl_N5jSzYsqZQHpNYkC`)
...
## Card 17 — question_and_answer (`fl_CRS4jDxV6vFnG9FS`)
...
## Card 18 — question_and_answer (`fl_spskgftZfxbZhYz4`)
...
## Card 19 — keyword_definition (`fl_7TC6XYs3zvd2Jw29`)
...
## Card 20 — question_and_answer (`fl_xKjXSNHrSkBVCycc`)
...
## Card 21 — keyword_definition (`fl_4mP5js9PB9xZk9bT`)
...
## Card 22 — question_and_answer (`fl_YWRCrzYm7B2Dqy2w`)
...
## Card 23 — true_or_false (`fl_TBQGJZbX56hRDXSy`)
...
DNA stands for deoxyribo**nucleic acid** and RNA stands for ribo**nucleic acid.**



## Card 24 — question_and_answer (`fl_fMWVHtytWGJfkwnJ`)
...
## Card 25 — question_and_answer (`fl_hkQMsJXnnx4pqJdD`)
...
## Card 26 — true_or_false (`fl_gHqDYzkw4W2qC4dn`)
...
## Card 27 — question_and_answer (`fl_jdXPXHBNCX2wBx9V`)
...
## Card 28 — question_and_answer (`fl_3GmxpB6vQjb4JHQk`)
...
## Card 29 — question_and_answer (`fl_ZRD4tqpkdRTQWhvx`)
...
## Card 30 — keyword_definition (`fl_4qKXJspVnVPnSkKZ`)
...
## Card 31 — question_and_answer (`fl_tRH7KPRG9ckK44nW`)
...
## Card 32 — question_and_answer (`fl_d77dBzFZ8HQqj2hC`)
...
## Card 33 — question_and_answer (`fl_x72zcXM5jZqMH5Pd`)
...
## Card 34 — question_and_answer (`fl_6nz2w3XCNfBNRTYB`)
...
## Card 35 — question_and_answer (`fl_n5pP889VfgTkCQYw`)
...
## Card 36 — question_and_answer (`fl_G9gdkzcvrCNncy55`)
...
## Card 37 — question_and_answer (`fl_wmQcDWP4MQYXW8nt`)
...
## Card 38 — true_or_false (`fl_JSjcbRxJJNh4rFBg`)
...
## Card 39 — keyword_definition (`fl_PgsPcPVr9nCpxcrm`)
...
## Card 40 — question_and_answer (`fl_gdZpt6D9TdvycN4F`)
...
## Card 41 — question_and_answer (`fl_wN4ztgrFpVDFgRGz`)
...
## Card 42 — question_and_answer (`fl_8hpfdf9SfQkHSgDb`)
...
## Card 43 — keyword_definition (`fl_F4zZQz4c7hgxbfrn`)
...
## Card 44 — keyword_definition (`fl_rmmKSRVJs6zVcNdG`)
...
## Card 45 — true_or_false (`fl_yQ67R2PZygswKtrR`)
...
## Card 46 — true_or_false (`fl_W9c5t2R49WFVdT9w`)
...
## Card 47 — keyword_definition (`fl_rRyPrYCP6r6W6GBn`)
...
## Card 48 — keyword_definition (`fl_TNDj2kK6dcRqDbr5`)
...
## Card 49 — keyword_definition (`fl_yB5YSgMxKs3tW4P4`)
...
## Card 50 — keyword_definition (`fl_pQ369TTGyvs6NCJh`)
...
## Card 51 — question_and_answer (`fl_5dd7tRWscTdqp5NC`)
...
## Card 52 — question_and_answer (`fl_wZFcTjwmTdWBst9y`)
...
## Card 53 — keyword_definition (`fl_R5nw6jX25q8CZjhM`)
...
## Card 54 — true_or_false (`fl_z2vkR7rBcQHfDrxg`)
...
## Card 55 — question_and_answer (`fl_tRZFbmNscrwp2chH`)
...
## Card 56 — keyword_definition (`fl_wy2hmwm5kjYnsVmf`)
...
## Card 57 — true_or_false (`fl_7WyKbPMvkqKdBwvD`)
...
## Card 58 — question_and_answer (`fl_6BhHr77f4WY8QTJZ`)
...
## Card 59 — question_and_answer (`fl_wSFBZKkZfZqcscGY`)
...
## Card 60 — question_and_answer (`fl_6BKNmMbZd6b82tYw`)
...
## Card 61 — question_and_answer (`fl_ktTtFzG598xqmcXj`)
...
## Card 62 — question_and_answer (`fl_QH9mVfKBpDtrdzqq`)
...
## Card 63 — question_and_answer (`fl_M75vFmKZsbWc28bB`)
...
## Card 64 — true_or_false (`fl_4zJ7NNt8Zz8MFSsz`)
...
## Card 65 — true_or_false (`fl_C4Q94SpWq7qqS9FV`)
...
## Card 66 — question_and_answer (`fl_vcsXrXs634THF7HS`)
...
## Card 67 — question_and_answer (`fl_HVZyGY7sFBSpXt7z`)
...
## Card 68 — question_and_answer (`fl_B975ZnWnGfmftqCv`)
...
## Card 69 — question_and_answer (`fl_cRDwD3wwSv3gfMzy`)
...
## Card 70 — question_and_answer (`fl_RmHHytxWNQ3QD7FR`)
...
## Card 71 — question_and_answer (`fl_xSm27wsWR4jm9jMg`)
...
## Card 72 — question_and_answer (`fl_FcrxnnGVDjSbh4Mr`)
...
## Card 73 — question_and_answer (`fl_KqhyDmndZ5yH6Z3M`)
...
## Card 74 — true_or_false (`fl_66k5VmQjKxSMydzK`)
...
## Card 75 — question_and_answer (`fl_hrbGzQCVhh5GWQwp`)
...
## Card 76 — true_or_false (`fl_MrP6vX4C5QNHXK8C`)
...
## Card 77 — question_and_answer (`fl_jYfb9s34rT8NqrgQ`)
...
## Card 78 — keyword_definition (`fl_hY46nqzd78wr4RsX`)
...
## Card 79 — keyword_definition (`fl_WWmm6zVX6pMJT8XC`)
...
## Card 80 — true_or_false (`fl_q5ZWM9zp5Hy7jxJr`)
...
## Card 81 — question_and_answer (`fl_MCHWKp3mYzy7fgkf`)
...
## Card 82 — question_and_answer (`fl_4hYZsfr5rmN3zndM`)
...
## Card 83 — question_and_answer (`fl_Js2GdCm9NYryF9hY`)
...
## Card 84 — question_and_answer (`fl_bNJVtdhBS8WnwB5m`)
...
## Card 85 — question_and_answer (`fl_j3YwWXkWZS4GGR7J`)
...
## Card 86 — keyword_definition (`fl_nR2DPfGWSGkf6rjb`)
...
## Card 87 — question_and_answer (`fl_7kr9jQCf5vkq7Typ`)
...
## Card 88 — true_or_false (`fl_NqVrpSqbtJBZkmKq`)
...
## Card 89 — question_and_answer (`fl_QVqcsKNzsJnNWwGS`)
...
## Card 90 — question_and_answer (`fl_ggDCk9tqQHbnwMvW`)
...
## Card 91 — question_and_answer (`fl_YcN7vQC6dX5Nj7G9`)
...
## Card 92 — question_and_answer (`fl_C3tbFx5sVbXWSrFX`)
...
## Card 93 — question_and_answer (`fl_6sr5nDbXBt59N2Nq`)
...
## Card 94 — keyword_definition (`fl_nrGtKZSHQf925pPq`)
...
## Card 95 — question_and_answer (`fl_QwP4gdpzwYBm3pQz`)
...
## Card 96 — keyword_definition (`fl_sQy5mbVdH768wC7b`)
...
## Card 97 — keyword_definition (`fl_YM73T4dDQsP28Ypb`)
...
## Card 98 — question_and_answer (`fl_V7rm5fHqS8vVYbxR`)
...
## Card 99 — keyword_definition (`fl_qKjfjq5X8t58SqG9`)
...
Spec links: `spcpt_QJfdBxNppVvfqRm3`


## Card 100 — keyword_definition (`fl_662DKfpmSv5cG4CP`)
...
This is **half** the number of chromosomes found in a diploid cell.


Spec links: `spcpt_QJfdBxNppVvfqRm3`


## Card 101 — question_and_answer (`fl_6c7G39vC5SZcRPGW`)
...
## Card 102 — question_and_answer (`fl_JGqgK4qStRhhKMRQ`)
...
## Card 103 — question_and_answer (`fl_7h6b5zFSk6QPvp6y`)
...
The **gametes**, which are involved in sexual reproduction:
...
## Card 104 — true_or_false (`fl_Dxm6tqBt5JHrQhBB`)

**FRONT**

**True or False?**

Nearly all cells in the human body are haploid.
...
Nearly all cells in the human body are **diploid**, containing **46** chromosomes. Only the **gametes** are haploid.


Spec links: `spcpt_QJfdBxNppVvfqRm3`


## Card 105 — keyword_definition (`fl_HYnJvn856GZBQ3GJ`)
...
## Card 106 — question_and_answer (`fl_brdbTFK2Bwyn8hBP`)
...
## Card 107 — true_or_false (`fl_YpmRTj68gvgFGYP9`)
...
## Card 108 — question_and_answer (`fl_Rj9gzc7KwPWRk8ht`)
...
## Card 109 — question_and_answer (`fl_FgQjKbpVmtcrrb5G`)
...
## Card 110 — question_and_answer (`fl_vBc98YM7YFkJBkKs`)
...
## Card 111 — true_or_false (`fl_9yfmY7JWWW6B5G7g`)
...
## Card 112 — keyword_definition (`fl_mXNZVjH8BHNDzMgc`)
...
## Card 113 — true_or_false (`fl_mDqdptgG2hMb7m9v`)
...
## Card 114 — true_or_false (`fl_24sWnpy884NNhyyN`)
...
## Card 115 — question_and_answer (`fl_qzDmjNnbkNwwygkR`)
...
## Card 116 — question_and_answer (`fl_fxKwkc7PZYfx66NZ`)
...
## Card 117 — question_and_answer (`fl_pXzxG2kF4bW47WdV`)
...
## Card 118 — true_or_false (`fl_pkDBpn6r5gKJ3vW8`)
...
## Card 119 — true_or_false (`fl_4nNvr4QZWcXvJTnv`)
...
## Card 120 — true_or_false (`fl_YD2vpTRHKv5Yw6HX`)
...
## Card 121 — keyword_definition (`fl_yBD6cPz6Xtrwkgdf`)
...
## Card 122 — question_and_answer (`fl_z2vPxfrmkGZZpzkv`)
...
## Card 123 — question_and_answer (`fl_dHTxYCGK7DTTX49y`)
...
## Card 124 — question_and_answer (`fl_7fGx6XdtDT43xMXp`)
...
## Card 125 — keyword_definition (`fl_ftfBvk4GSXz487WB`)
...
## Card 126 — question_and_answer (`fl_sCyg8HRWwnbBbz37`)
...
## Card 127 — true_or_false (`fl_62R6Vr8kdZv2Rr2Z`)
...
## Card 128 — true_or_false (`fl_sTRYVPKYRzjwV4mT`)
...
## Card 129 — question_and_answer (`fl_VxF7z6VXxMBrYB4d`)
...
## Card 130 — true_or_false (`fl_jHSqfCw8FWbx5kH8`)
...
## Card 131 — question_and_answer (`fl_sXSP855tzgg9Nnjt`)
...
## Card 132 — question_and_answer (`fl_XPKbRgZ5c84WyR3Q`)
...
## Card 133 — true_or_false (`fl_c7jcRJV9wnWVj6sC`)
...
## Card 134 — question_and_answer (`fl_FSTVR4DXXMk8XGC2`)
