...
Source: https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-2/flashcards/reproduction-and-inheritance/reproduction/


## Card 1 — keyword_definition (`fl_6vy6wfmgRRCKtrkt`)
...
## Card 2 — keyword_definition (`fl_cn6rghSh5KwN6yJP`)
...
## Card 3 — keyword_definition (`fl_NzdJmnN6gpdKkXTM`)
...
## Card 4 — question_and_answer (`fl_tkK6ND26vPWhCGC6`)
...
## Card 5 — keyword_definition (`fl_yySKJRxYNgsxsPF6`)
...
## Card 6 — question_and_answer (`fl_HPYtM74wDGhhW6Cv`)
...
## Card 7 — question_and_answer (`fl_B9ftJ2y8hGqjtxps`)
...
## Card 8 — question_and_answer (`fl_BmQZCBjRmSQhTyns`)
...
## Card 9 — question_and_answer (`fl_rRw5wgw4dXZ5kqTq`)
...
## Card 10 — question_and_answer (`fl_srZkTCwNchFzj52B`)
...
## Card 11 — question_and_answer (`fl_3wRDTQBq73m3CFWw`)
...
## Card 12 — question_and_answer (`fl_4kKrQp9gfzRJZnQM`)
...
## Card 13 — keyword_definition (`fl_NcHkhDzpDKZpj8pd`)
...
## Card 14 — question_and_answer (`fl_gqqPTnvxb2dkzRfD`)
...
Fertilisation in humans involves the **fusion of a sperm cell with an egg cel**l.



## Card 15 — question_and_answer (`fl_hxFRMpghN93tcWbW`)
...
## Card 16 — true_or_false (`fl_9w9HCBHjHrnhyHXq`)
...
## Card 17 — keyword_definition (`fl_C8D4MYnSZrw9YKrb`)
...
## Card 18 — question_and_answer (`fl_JDpsxmXmYfXRN9Mz`)
...
## Card 19 — question_and_answer (`fl_9hNkjCtVBbGznzNs`)
...
## Card 20 — keyword_definition (`fl_yppnDYKSkWhBfnb9`)
...
## Card 21 — true_or_false (`fl_fGYchkQ9jRjFMp7h`)
...
## Card 22 — keyword_definition (`fl_tV29gjJs49f4gwN9`)
...
## Card 23 — keyword_definition (`fl_BPPqSjkvpMK9NDDG`)
...
## Card 24 — question_and_answer (`fl_t6HphyYKPb6BgRS2`)
...
## Card 25 — true_or_false (`fl_sG8CDVT8Bz9NdCHt`)
...
## Card 26 — question_and_answer (`fl_ShvDMPrwxtJBJk5X`)
...
## Card 27 — question_and_answer (`fl_DWNrPPgPzzpqzSTW`)
...
## Card 28 — question_and_answer (`fl_9TDtrdpZ6VrSfnr7`)
...
## Card 29 — question_and_answer (`fl_cVTCBkv8T3hWrVk6`)
...
## Card 30 — keyword_definition (`fl_zSnQnvVzG6Y9Cj78`)
...
## Card 31 — true_or_false (`fl_4j4HTkjJVvr2Z6xX`)
...
## Card 32 — question_and_answer (`fl_GYVhCnqGdzHsjBFP`)
...
## Card 33 — keyword_definition (`fl_BV5WJnV2dcBvnNNb`)
...
## Card 34 — question_and_answer (`fl_8g8Gmq7gyjQRJKmW`)
...
## Card 35 — true_or_false (`fl_7gq5CRBk47g8kbcd`)
...
## Card 36 — question_and_answer (`fl_NFcW78YBVHC9RTZM`)
...
## Card 37 — question_and_answer (`fl_V9FGCQFpsZHWPHb3`)
...
## Card 38 — keyword_definition (`fl_FfZzX3PSz4StDJmV`)
...
## Card 39 — true_or_false (`fl_YGW56z9QRkr8qp6P`)
...
## Card 40 — question_and_answer (`fl_GprkFPYmSx5Md24s`)
...
## Card 41 — keyword_definition (`fl_QfWJc47mXDwb88pv`)
...
## Card 42 — question_and_answer (`fl_D4xPGxDRVbNbyRFv`)
...
## Card 43 — keyword_definition (`fl_R943GkYdgZPTyT7z`)
...
## Card 44 — question_and_answer (`fl_cshgvMztJ8SRvjgV`)
...
## Card 45 — true_or_false (`fl_t2b4tXwMdPtMbFMF`)
...
## Card 46 — question_and_answer (`fl_JN7pHZcD8bbdj9bF`)
...
## Card 47 — question_and_answer (`fl_xHzDxzRcSnpcyYBJ`)
...
## Card 48 — true_or_false (`fl_Q2CN835YgBb2kg9x`)
...
## Card 49 — question_and_answer (`fl_r2BhjJd3sZqHnsWx`)
...
## Card 50 — question_and_answer (`fl_whqgXdhDTvdWRjPB`)
...
## Card 51 — question_and_answer (`fl_H7zYCrdjd5k2J9wF`)
...
This is part of the COR**M**MS criteria for planning an investigation.



## Card 52 — question_and_answer (`fl_yRgdcr6GV2MH6nCk`)
...
## Card 53 — keyword_definition (`fl_mMHs8q62xgnNqzWD`)
...
The organism being investigated in the germination experiment is the <u>**same**</u>** species** of **seeds**.

This is part of the C**O**RMMS criteria for planning an investigation.



## Card 54 — true_or_false (`fl_3ZJp6kn4W3KrrwSg`)
...
## Card 55 — question_and_answer (`fl_nYNF47VKmQvj8RBz`)
...
## Card 56 — question_and_answer (`fl_TmFWV6JXbDBJqSmx`)
...
## Card 57 — question_and_answer (`fl_VXhBhBh53JXkZyDB`)
...
## Card 58 — question_and_answer (`fl_HntQkKddV2bJsb75`)
...
## Card 59 — question_and_answer (`fl_Y4zgqSwfBythSdSB`)
...
## Card 60 — question_and_answer (`fl_fhDy4BWNs2dfbnbp`)
...
## Card 61 — true_or_false (`fl_WhfsCSRgqWV59RXx`)
...
## Card 62 — question_and_answer (`fl_b3RBN9bxp36KCCsj`)
...
## Card 63 — question_and_answer (`fl_cdgCHcXbWV3ZthNy`)
...
## Card 64 — keyword_definition (`fl_c6dfmrMV2HBvGmV3`)
...
## Card 65 — true_or_false (`fl_3GbcMv69nqYgmjfV`)
...
## Card 66 — question_and_answer (`fl_q4s6k6hybw9RTGtq`)
...
## Card 67 — question_and_answer (`fl_yTHzd22YJxGkBwXF`)
...
## Card 68 — question_and_answer (`fl_tZnSYfXwhDH3gzMs`)
...
## Card 69 — true_or_false (`fl_V3cz4vQPMphBbVVV`)
...
## Card 70 — question_and_answer (`fl_6mWygV2G27dGhcYM`)
...
## Card 71 — question_and_answer (`fl_Zy8P3kBVVhWwgwNH`)
...
## Card 72 — question_and_answer (`fl_Gfzkd52fCtPKjYWP`)
...
## Card 73 — question_and_answer (`fl_869VPrqd6Tr4xHFn`)
...
## Card 74 — true_or_false (`fl_mWYj6q66xcBfY4mq`)
...
## Card 75 — question_and_answer (`fl_QjbCsfbRf8RH6VcH`)
...
## Card 76 — true_or_false (`fl_gZx27s2nRFR92wnM`)
...
## Card 77 — question_and_answer (`fl_88Y9vjs5Kg87pD8c`)
...
## Card 78 — keyword_definition (`fl_pvPhZdb6RPQXdTng`)
...
## Card 79 — keyword_definition (`fl_ymvQdHzjJdg7JW26`)
...
## Card 80 — question_and_answer (`fl_zWv5pk5GBGxdkqCc`)
...
## Card 81 — question_and_answer (`fl_B36YH9nSH2PzB5hq`)
...
## Card 82 — keyword_definition (`fl_p56mbs8GCZZqYmD5`)
...
## Card 83 — true_or_false (`fl_nJKSgYvhB8Ym5WvW`)
...
## Card 84 — question_and_answer (`fl_bYBmg2YX3wDPG8cQ`)
...
## Card 85 — question_and_answer (`fl_j6r34htWQzqc6ppM`)
...
## Card 86 — question_and_answer (`fl_zRHjkv8kBnSBHS6B`)
...
## Card 87 — true_or_false (`fl_6x78NVwDkyc5zcJc`)
...
## Card 88 — question_and_answer (`fl_XxzGNVHWNs9jqyMB`)
...
## Card 89 — question_and_answer (`fl_2T9YCDV9xw53c6vh`)
...
## Card 90 — question_and_answer (`fl_Tt4BgmzhVshBDmZM`)
...
## Card 91 — true_or_false (`fl_Dswycydx7RmsWkKg`)
...
## Card 92 — question_and_answer (`fl_h2HsV9y85syVC73r`)
...
## Card 93 — true_or_false (`fl_bkJmnm5vtScmQjmW`)
...
## Card 94 — question_and_answer (`fl_xxp8QwPfdytMs5XD`)
...
## Card 95 — question_and_answer (`fl_gJ5MFDHJpbTVJNCB`)
...
## Card 96 — question_and_answer (`fl_3xcHhNYXV7WVWNWj`)
...
## Card 97 — question_and_answer (`fl_qmtD7KhJzsSzGprD`)
...
## Card 98 — question_and_answer (`fl_MsWJVzgBwKDKKCYZ`)
...
## Card 99 — question_and_answer (`fl_qSN429r3RKH28MxT`)
...
## Card 100 — question_and_answer (`fl_xmJxggKJsShwQM5c`)
...
## Card 101 — question_and_answer (`fl_dMVz5HCMS5Xfz8Qq`)
...
## Card 102 — question_and_answer (`fl_FpjPksyKR2gHkfhh`)
...
## Card 103 — true_or_false (`fl_WsNGS2RVbXJBr4kj`)
