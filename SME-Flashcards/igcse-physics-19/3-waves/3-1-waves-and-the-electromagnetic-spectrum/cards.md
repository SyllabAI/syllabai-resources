...
Course: igcse-physics-19 · Section: 3. Waves

Source: https://www.savemyexams.com/igcse/physics/edexcel/19/flashcards/3-waves/3-1-waves-and-the-electromagnetic-spectrum/


## Card 1 — keyword_definition (`fl_rCypWSVryrXhFWjh`)
...
## Card 2 — question_and_answer (`fl_PRYm3smN7y9w7ZH8`)
...
## Card 3 — keyword_definition (`fl_kXq7S7vKpBHJmSX3`)
...
## Card 4 — question_and_answer (`fl_4N36NDCvSMB862yb`)
...
## Card 5 — true_or_false (`fl_Pn9TpmHYrfsrgWn5`)
...
## Card 6 — question_and_answer (`fl_7bFgfzvh3qrqKtFX`)
...
## Card 7 — question_and_answer (`fl_QdcShpchKSfgNz7y`)
...
## Card 8 — true_or_false (`fl_bZw58HT5xfMxxNty`)
...
## Card 9 — true_or_false (`fl_PKrCBXgwdHDGXzxC`)
...
## Card 10 — question_and_answer (`fl_fp2pxBdqCkHVxQ2p`)
...
## Card 11 — true_or_false (`fl_wnbPnQWZ9Mmcw8HS`)
...
## Card 12 — question_and_answer (`fl_7839TcWdPRFXR5tF`)
...
## Card 13 — question_and_answer (`fl_3vZK42MCnrjZStYr`)

**FRONT**

What type of wave is shown in the diagram?

![A green waveform moves up and down with peaks and troughs at 90 degrees to the wave's motion and energy transfer.](assets/6ba969365a84-38472-transverse-wave-vibration.bin)
...
## Card 14 — question_and_answer (`fl_BYG6HKRJXv5jKCqd`)
...
## Card 16 — keyword_definition (`fl_76QmfsB5XTdmZW4D`)
...
## Card 17 — keyword_definition (`fl_Q9J99R64zRGqDjY5`)
...
## Card 18 — keyword_definition (`fl_7NrkswrGdXGfTrmn`)
...
## Card 19 — question_and_answer (`fl_NChfPnT9r3pDwN4t`)
...
## Card 20 — question_and_answer (`fl_VsG78HPnfWSsswMB`)
...
## Card 21 — question_and_answer (`fl_JnSrFVxKq9hv2qFB`)
...
![An oscillating waveform with peaks and troughs has a horizontal axis through the middle. Amplitude is labelled from the horizontal axis to a peak. Wavelength is labelled from one peak to the next. ](assets/fb4224c1f910-51212-amplitude-and-wavelength-labelled.bin)



## Card 22 — question_and_answer (`fl_NWrPbxsP7Kx98S9G`)

**FRONT**

Identify the wave property indicated by the arrow on the diagram.

![An oscillating wave with peaks and troughs is labelled with a double-headed arrow from the equilibrium point between a peak and a trough to the corresponding equilibrium point between a peak and a trough.](assets/8aaa5946dc02-59175-time-period-graph.bin)
...
## Card 23 — question_and_answer (`fl_XmBJcjtGkRJr22CR`)
...
## Card 24 — question_and_answer (`fl_HBh3cWx83G94zcNK`)
...
## Card 25 — true_or_false (`fl_3zkRctPrBqS5tZhz`)

**FRONT**

**True or False? **

The symbol for frequency is $λ$.
...
## Card 26 — true_or_false (`fl_54PT8D2YrMCbKxCx`)
...
## Card 27 — question_and_answer (`fl_j7G3c7Zp6DSgTr3M`)
...
## Card 28 — question_and_answer (`fl_tCTj7XmVM663hryX`)
...
## Card 29 — keyword_definition (`fl_CP6XsHyhZSz3j27k`)
...
The wave equation in terms of wave speed is $v=f\timesλ$
...
## Card 30 — true_or_false (`fl_7d7QGV2qF5XnBtpJ`)

**FRONT**

**True or False?**

The wave speed equation in terms of wavelength is $λ=\frac{f}{v}$.
...
The wave speed equation in terms of wavelength is $λ=\frac{v}{f}$
...
## Card 31 — true_or_false (`fl_wznw8dXHS6xzPWSp`)

**FRONT**

**True or False?**

The wave speed equation in terms of frequency is $f=\frac{v}{λ}$.
...
## Card 32 — keyword_definition (`fl_mwjHVQFkCp2tCZpZ`)
...
## Card 33 — keyword_definition (`fl_fR79n37pdW55JVXW`)
...
## Card 34 — question_and_answer (`fl_SHDhJYsTkSbygFTX`)
...
## Card 35 — question_and_answer (`fl_rfWgjwmwZnMmbvxZ`)
...
## Card 36 — question_and_answer (`fl_kbvRbpTfxZ8XYf3m`)
...
## Card 37 — true_or_false (`fl_3hNh6nvfWthN2Mhd`)
...
## Card 38 — question_and_answer (`fl_7n4GdsRJZ6cbbdS4`)
...
## Card 39 — question_and_answer (`fl_53hftDQS2mc8q4Wt`)
...
## Card 40 — question_and_answer (`fl_mXxRkmHDhR9qfTHK`)
...
## Card 41 — question_and_answer (`fl_tpWRvwmGVtj7bM2G`)

**FRONT**

State the feature of the diagram that identifies that the car is **stationary** when sound is emitted from the horn.

![A car is in the centre of three equally spaced concentric circles. A double-headed arrow between the second and third circles indicates this is the wavelength. ](assets/808c835d584e-45087-doppler-effect-stationary-source.bin)
...
## Card 42 — question_and_answer (`fl_Y2pBYyhDMf4VVGTp`)

**FRONT**

What **feature** of the diagram shows that the observer hears a **higher pitch** as the source moves towards them?

![A moving source is at the centre of four concentric circles. The circles are not evenly spaced. The circles are closer together on the right side next to the stationary observer.](assets/cec440ab568e-22589-doppler-shift-diagram.bin)
...
## Card 43 — true_or_false (`fl_qF5mK4CY6Bnj8fm5`)
...
## Card 44 — question_and_answer (`fl_zspB4GRSRH8xW7Fc`)
...
## Card 45 — question_and_answer (`fl_ckRvmQRkz3b3smNN`)
...
## Card 46 — keyword_definition (`fl_BWwxFWNFZScZHz7y`)
...
## Card 47 — true_or_false (`fl_ptrNjg6FMHjT4jRF`)
...
## Card 48 — question_and_answer (`fl_PJFWJBQYjnDw4GfT`)
...
## Card 49 — question_and_answer (`fl_rHw6SRrBrVQtfbng`)
...
## Card 50 — question_and_answer (`fl_7FGxQGTgYFHQRjCw`)

**FRONT**

Identify using the diagram the electromagnetic radiation type with the **shortest wavelength**.

![An oscillating wave decreases in wavelength as it moves from left to right. Labels below the waveform also moving from left to right are radio waves, microwaves, infrared, visible light, ultraviolet, x-rays and gamma rays.](assets/4470eabc10cb-33871-em-spectrum-diagram.bin)
...
## Card 51 — question_and_answer (`fl_4S7SwjxssNNcrhhB`)
...
## Card 52 — question_and_answer (`fl_nYY3kQWpf52Pf42W`)
...
## Card 53 — keyword_definition (`fl_wG7GCcd9p7YjR6cG`)
...
## Card 54 — question_and_answer (`fl_cwC4JwGyqqQnWWj2`)
...
## Card 55 — question_and_answer (`fl_RDMTwNPVNhKHGNxS`)
...
## Card 56 — true_or_false (`fl_yFmXMdKPbZ72psKM`)
...
## Card 57 — true_or_false (`fl_Mf862d6683nPSJXX`)
...
## Card 58 — true_or_false (`fl_ZTc8zZnBYQJXtvbJ`)
...
## Card 59 — true_or_false (`fl_TM6KrnczRgVyc7DZ`)
...
## Card 60 — true_or_false (`fl_FMSTjPGNTz3sxK3V`)
...
## Card 61 — question_and_answer (`fl_cgjGsQZG7GVfY7N8`)

**FRONT**

State the type of radiation used in the device in the diagram.

![A potato is sitting on a tray in a machine with a translucent door, an emitter at the top and buttons on the side.](assets/a4178856cfde-63110-microwave-oven.bin)
...
## Card 62 — true_or_false (`fl_3tXmHZg8TGyfyG5v`)
...
## Card 63 — question_and_answer (`fl_ptpGch93q6HqRKqw`)
...
## Card 64 — true_or_false (`fl_Dgf6N6jgBbB4qJsz`)
...
## Card 65 — true_or_false (`fl_9Vqd4dwTMfvSbxTy`)
...
## Card 66 — true_or_false (`fl_gChQhwkp6dsFMWyH`)
...
## Card 67 — true_or_false (`fl_3Bxvwpt3RSkGWPQ5`)
...
## Card 68 — true_or_false (`fl_J79J8jj3h4TWTWWR`)
...
## Card 69 — true_or_false (`fl_x9cF4KNzym47JNRn`)
...
## Card 70 — true_or_false (`fl_X6cYM5TmzBsgtXC6`)
...
## Card 71 — true_or_false (`fl_BJBW4mJqtRc3k2v7`)
...
## Card 72 — question_and_answer (`fl_dd2k3GZd5pPYBFRk`)

**FRONT**

State the purpose of the device in the image.

![A blue sealed badge with a photographic plate inside that can be attached with a safety pin.](assets/f5d5f79e136c-51771-radiation-badge.bin)
