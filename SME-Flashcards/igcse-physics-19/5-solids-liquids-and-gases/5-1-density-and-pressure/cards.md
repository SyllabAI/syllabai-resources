...
Source: https://www.savemyexams.com/igcse/physics/edexcel/19/flashcards/5-solids-liquids-and-gases/5-1-density-and-pressure/


## Card 1 — keyword_definition (`fl_NFgd6s8H82F3Vv9J`)
...
## Card 2 — true_or_false (`fl_BRkWbBnXcxNTwCtf`)
...
## Card 3 — question_and_answer (`fl_HNYJ54QqnxytP4mg`)
...
The equation for density is $ρ=\frac{m}{V}$

Where:

- *ρ*  = density, measured in kg / m<sup>3</sup>
- $m$ = mass, measured in kilograms (kg)
- $V$ = volume, measured in metres cubed (m<sup>3</sup>)



## Card 4 — keyword_definition (`fl_vVQ4fptS3FBfbPSh`)
...
## Card 5 — question_and_answer (`fl_wf4gq85GFmR2PssS`)
...
## Card 6 — true_or_false (`fl_dTkpZgfSdYHJrMHk`)
...
## Card 7 — keyword_definition (`fl_GVDThK4BSN9wyKWZ`)
...
## Card 8 — keyword_definition (`fl_bTbhwZgYvFDbZw24`)
...
The equation used to calculate the volume of an object is $V=l\timesw\timesh$
...
## Card 9 — question_and_answer (`fl_YMqPVjh8wftvTk2C`)

**FRONT**

Identify which object is more dense, the one on the left or the one on the right.

![Two transparent cubes: the left cube has 4 pink spheres inside, and the right cube has 14 tightly packed pink spheres.](assets/b2f958d2ad5b-29880-density-comparison.bin)
...
## Card 10 — question_and_answer (`fl_Gy3hHc8P5CC5mKJH`)
...
## Card 11 — keyword_definition (`fl_9WB2GwnQjGd877bS`)
...
## Card 12 — question_and_answer (`fl_xbDM7RG2vwF2djvP`)
...
## Card 13 — question_and_answer (`fl_QNhNFGMz4pY4pND2`)
...
## Card 14 — true_or_false (`fl_2X9QsmQkJrytsGyP`)
...
## Card 15 — question_and_answer (`fl_jXxMCQjNHGzcQfZN`)
...
## Card 16 — question_and_answer (`fl_bkvt4vjj2tBYdkfh`)
...
## Card 17 — question_and_answer (`fl_5Vrm5WccCWrvfv94`)
...
## Card 18 — question_and_answer (`fl_yhmwjJfChmRWfP4t`)
...
## Card 19 — question_and_answer (`fl_HH48rPgYBfjyxnb3`)
...
## Card 20 — keyword_definition (`fl_pFzczCHyy4xbnydm`)
...
The equation for pressure, force and area is $P=\frac{F}{A}$

Where:

- $P$ = pressure, measured in pascals (Pa)
- $F$ = force, measured in newton's (N)
- $A$ = surface area, measured in metres squared (m<sup>2</sup>)



## Card 21 — true_or_false (`fl_W9r6N7S2hhjKFwrV`)
...
## Card 22 — question_and_answer (`fl_GDwvbpYxWZmGmzXR`)
...
## Card 23 — true_or_false (`fl_DGBGNmvfKdt68M4C`)
...
## Card 24 — question_and_answer (`fl_VBdrYfYh5tbsyjVW`)
...
## Card 25 — question_and_answer (`fl_7vfRb3PVvsTVYhBf`)
...
## Card 26 — true_or_false (`fl_qW9bGwqbyzypkbDZ`)
...
## Card 27 — question_and_answer (`fl_WPg2wnDHdw2rkFB6`)

**FRONT**

A box is placed on a table. Calculate the pressure applied by the grey face of the box onto the table.

![A rectangular prism with dimensions labeled as 4 meters tall, 3 meters wide, and 2 meters deep. It is noted to weigh 24 newtons.](assets/037ff547d8b9-26488-calculating-pressure-block.bin)
...
- $\mathrm{surface} \mathrm{area}=3\times2=6m^{2}$
- $P=\frac{F}{A}=\frac{24}{6}=4\mathrm{Pa}$



## Card 28 — keyword_definition (`fl_tCfrM4drCfX3wmDP`)
...
## Card 29 — question_and_answer (`fl_Vqn49tVbbVk5pWvb`)
...
## Card 30 — question_and_answer (`fl_MHR73js5SKSJv3S2`)
...
## Card 31 — true_or_false (`fl_6JXjJZ2bbVcngSC2`)
...
## Card 32 — question_and_answer (`fl_zjMVrTfBWWKq5634`)
...
The equation for the pressure difference of an object in a fluid is $\Deltap=ρg\Deltah$

Where:

- $\Deltap$ = change in pressure, measured in pascals (Pa)
- $ρ$ = density of the liquid, measured in kilograms per metre cubed (kg/m<sup>3</sup>)
- $g$ = gravitational field strength on Earth, measured in newtons per kilogram (N/kg)
- $\Deltah$ = change in depth of the object in the liquid, measured in metres (m)



## Card 33 — keyword_definition (`fl_J7ByX53p65cVxY7y`)

**FRONT**

State the meaning of $\Deltap$ in equation $\Deltap=ρg\Deltah$.


**BACK**

In the pressure equation for liquids $\Deltap$ represents the change in pressure in pascals (Pa).



## Card 34 — keyword_definition (`fl_ZsdVFqTBr8qwfG5R`)

**FRONT**

State the meaning of$ρ$ in the equation $\Deltap=ρg\Deltah$.


**BACK**

$ρ$ in the pressure equation for liquids stands for the density of the liquid, measured in kilograms per metre cubed (kg/m³).



## Card 35 — question_and_answer (`fl_y7QHYmY9qQMK8bzK`)
...
The depth of water in a swimming pool can be calculated using the pressure equation: $\Deltap=ρg\Deltah$

The quantities needed to calculate depth $\Deltah$ are:

- $\Deltap$ = the pressure of the water at the bottom of the pool
- $ρ$ = the density of the water
- $g$ = the gravitational field strength of Earth



## Card 36 — question_and_answer (`fl_SjwGvmzXfwmhsynk`)

**FRONT**

State the property of pressure in a liquid demonstrated in the diagram.

![Diagram showing three water jets from a pressurized tank, labeled with weakest jet at the top (low pressure) and strongest jet at the bottom (high pressure) with a ruler below.](assets/130abb663e47-47014-liquid-pressure-experiment.bin)
