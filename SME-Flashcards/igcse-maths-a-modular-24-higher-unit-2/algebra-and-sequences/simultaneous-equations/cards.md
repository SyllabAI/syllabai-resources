...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-2/flashcards/algebra-and-sequences/simultaneous-equations/


## Card 1 — keyword_definition (`fl_BdC9WjHZ6qFV3Qqh`)
...
Linear simultaneous equations are equations with two unknowns (say $x$ and $y$) where the terms have variables with no powers higher than 1 (so no $x^{2}$, $y^{2}$, $xy$, etc.).

E.g. $4x-11=y$ and $3x+4y=32$.



## Card 2 — keyword_definition (`fl_vs5zvJhTgD95qCPb`)
...
E.g. For the pair of simultaneous equations $2x+3y=3$ and $6x-5y=23$:

1. Multiply one equation to make the coefficient of one variable the same, Multiply $2x+3y=3$ by $3$ to get $6x+9y=9$.
2. Add or subtract the equations to eliminate a variable, $-14y=14$
3. Solve to find one variable, $y=-1$.
4. Substitute into one of the equations and solve for the other variable, $x=3$.



## Card 3 — keyword_definition (`fl_n3YxnJQcrfD48QqH`)
...
E.g. For the pair of simultaneous equations $3x+y=7$ and $2x+1=5y$:

1. Rearrange the first equation to make $y$ the subject, $y=7-3x$.
2. Then substitute the expression for $y$ into the second equation, `2 x plus 1 equals 5 open parentheses 7 minus 3 x close parentheses`.
3. Solve for $x$, $x=2$.
4. Substitute the value for $x$ into one of the equations and solve for $y$, $y=1$.



## Card 4 — question_and_answer (`fl_jqJ7FxpHnHHdssjd`)
...
## Card 5 — true_or_false (`fl_7ZZBJyQ9pFQccm3p`)
...
## Card 6 — keyword_definition (`fl_MgBdvCKyQ7hp4MYG`)
...
**Quadratic simultaneous equations **are simultaneous equations where at least one equation contains a **squared term** ($x^{2}$ or $y^{2}$ or $xy$).



## Card 7 — question_and_answer (`fl_bzjkfnmfmJwKCFtm`)
...
## Card 8 — true_or_false (`fl_VQgdDFRpYx9pw6N8`)
...
## Card 9 — true_or_false (`fl_9NQZdS2DDZpQtFwC`)
...
## Card 10 — question_and_answer (`fl_Ghpfxrhr5SYpYxbW`)
...
## Card 11 — true_or_false (`fl_kDVBBgdWvxkDYY8G`)
