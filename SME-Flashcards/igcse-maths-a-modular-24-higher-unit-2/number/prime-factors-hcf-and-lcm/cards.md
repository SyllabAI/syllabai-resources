...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-2/flashcards/number/prime-factors-hcf-and-lcm/


## Card 1 — question_and_answer (`fl_F3vDXTvzxZ6N985W`)
...
## Card 2 — question_and_answer (`fl_dDFWg5ysPVyCVqdq`)
...
## Card 3 — keyword_definition (`fl_KW5ZBCR8dfYsjG56`)
...
## Card 4 — true_or_false (`fl_pY7kyghvGCMt6kF2`)
...
## Card 5 — question_and_answer (`fl_jdzntf4J5PfsHzNT`)
...
## Card 6 — true_or_false (`fl_7DXsSRCgCwmKJc5N`)
...
## Card 7 — true_or_false (`fl_TqJDFCfNB3YWwWf2`)
...
## Card 8 — keyword_definition (`fl_KFQ4wkfs6w6szkdp`)
...
## Card 9 — keyword_definition (`fl_gJ2PyRQfGmftwNRy`)
...
## Card 10 — question_and_answer (`fl_Jfv2pdPSyj9HMJDg`)
...
## Card 11 — question_and_answer (`fl_sG8n3KrRgt4Vdq8b`)
...
## Card 12 — question_and_answer (`fl_HHRNPvsfb3wpNM5D`)
...
## Card 13 — keyword_definition (`fl_mDxXJWxYt67CRPRF`)
...
## Card 14 — true_or_false (`fl_wD38Vd9sxqHyd2qm`)
...
## Card 15 — question_and_answer (`fl_jQ6DBPqFfy5kcCft`)
...
## Card 16 — true_or_false (`fl_xkcdPxpQDQKQwdfD`)
...
## Card 17 — true_or_false (`fl_qwskXBWVSBvGK8xJ`)
