...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-2/flashcards/functions-graphs-and-differentiation/functions/


## Card 1 — keyword_definition (`fl_FgvmMrxJy75tRqwn`)
...
## Card 2 — keyword_definition (`fl_GQHQS7tS8DPKNQC4`)
...
The notations  `straight f open parentheses x close parentheses equals...`  or  `straight f colon x rightwards arrow from bar...`  indicate a function $f$, where $x$ is the input and `straight f open parentheses x close parentheses` is the output.

You should be familiar with both notations, as either one can appear on the exam.



## Card 3 — keyword_definition (`fl_bjx5ntNhj75QCj39`)
...
## Card 4 — keyword_definition (`fl_82tfbDfKmW7kV422`)
...
## Card 5 — question_and_answer (`fl_YY27GVpVKgZ8MWVr`)
...
To find the value of `straight f open parentheses 3 close parentheses` for a function `straight f open parentheses x close parentheses`, substitute $x=3$ into the equation of the function.

For example, if $f(x)=2x+1$, then `straight f left parenthesis 3 right parenthesis equals 2 open parentheses 3 close parentheses plus 1 equals 6 plus 1 equals 7`.



## Card 6 — question_and_answer (`fl_5yMgchS3VyVjrM8k`)
...
$2x+1=15\Rightarrow2x=14\Rightarrowx=7$



## Card 7 — keyword_definition (`fl_3Z92vv3Prtgxs7Z9`)
...
## Card 8 — true_or_false (`fl_FSZ9B9K2PdfpW2Vp`)
...
`straight f open parentheses x close parentheses equals 1 over x` is **not defined** when $x=0$.

Therefore zero must be **excluded** from the domain of `straight f open parentheses x close parentheses`.

`straight f open parentheses x close parentheses equals 1 over x`, $x\neq0$.



## Card 9 — keyword_definition (`fl_TbcssMG2vrZGCzb4`)
...
## Card 10 — true_or_false (`fl_bF5GwzXqd6bn5bpp`)
...
## Card 11 — question_and_answer (`fl_Zr8MkC2xRyQw9Gkx`)
...
The **range** is expressed in terms of $y$ or `straight f open parentheses x close parentheses`  (e.g.  $y\geq0$  or  `straight f open parentheses x close parentheses greater or equal than 0` ).



## Card 12 — keyword_definition (`fl_XJXYF8P6HsT52x7C`)
...
## Card 13 — keyword_definition (`fl_GyCy5tCYC5ZqJj23`)
...
`fg open parentheses x close parentheses` is the notation for a composite function made up of functions $f$ and $g$.

It means "$f$ is applied to the output of `straight g open parentheses x close parentheses`".

I.e., **first** put $x$ into the function $g$, and **next** put the output `straight g open parentheses x close parentheses` into the function $f$.

Note that the function on the right ($g$) acts first, and the function on the left ($f$) acts second.



## Card 14 — keyword_definition (`fl_MBx6fnM5W6zryWXH`)
...
`gf open parentheses x close parentheses` is the notation for a composite function made up of functions $g$ and $f$.

It means "$g$ is applied to the output of `straight f open parentheses x close parentheses`".

I.e., **first** put $x$ into the function $f$, and **next** put the output `straight f open parentheses x close parentheses` into the function $g$.

Note that the function on the right ($f$) acts first, and the function on the left ($g$) acts second.



## Card 15 — question_and_answer (`fl_twF4hDs9Kwt995SY`)
...
1. First substitute $x=2$ into the equation for `straight g open parentheses x close parentheses`.
...
## Card 16 — keyword_definition (`fl_nTzwgr6qWrxJTNHv`)
...
## Card 17 — keyword_definition (`fl_MCnW9hddS6DSqf6P`)
...
## Card 18 — question_and_answer (`fl_gPqqm39YvDWS7rmy`)
...
4. Replace $y$ with `straight f to the power of negative 1 end exponent open parentheses x close parentheses`to rewrite as `straight f to the power of negative 1 end exponent open parentheses x close parentheses equals...`.



## Card 19 — question_and_answer (`fl_r92tdny8rG5fPwG4`)
...
## Card 20 — question_and_answer (`fl_mTDWrfv2VsqVsNQY`)
...
`ff to the power of negative 1 end exponent open parentheses x close parentheses` is a **composite function** of $f$ and its **inverse** $f^{-1}$.
...
## Card 21 — question_and_answer (`fl_3BWQQVf8pXSTfmss`)
...
## Card 22 — question_and_answer (`fl_hYnJp2bQ2rVxDJVx`)
...
## Card 23 — true_or_false (`fl_n5wT7qhFbC8jcBfM`)
