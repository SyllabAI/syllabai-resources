...
Source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-2/flashcards/functions-graphs-and-differentiation/differentiation-and-gradients/


## Card 1 — keyword_definition (`fl_TFpXrDvXyJrqPnXV`)
...
## Card 2 — keyword_definition (`fl_Mv6QK63hgFM272Nc`)
...
## Card 3 — true_or_false (`fl_Jsnn766XbHm7MqkV`)
...
## Card 4 — question_and_answer (`fl_GNKv75xTtzMd5XWZ`)
...
## Card 5 — keyword_definition (`fl_F9HSPpgQf2mCkr8b`)
...
## Card 6 — true_or_false (`fl_hzQzx5KDd7Rhtyvx`)
...
## Card 7 — keyword_definition (`fl_KJx5fTrVy7YNTnFP`)
...
## Card 8 — keyword_definition (`fl_wPgxvMhp44sPKHDy`)
...
## Card 9 — question_and_answer (`fl_snmJ3pSfZGD5jhj5`)
...
$\frac{dy}{dx}$ represents the **gradient function** or **derivative**. It is pronounced "dy by dx" or "dy over dx".



## Card 10 — keyword_definition (`fl_7B3YvSXMGtbG83WW`)
...
## Card 11 — question_and_answer (`fl_sThkD9fn5pzVBcB6`)
...
So the derivative of $2x^{3}$ is  `open parentheses 3 cross times 2 close parentheses x to the power of 3 minus 1 end exponent equals 6 x squared`.



## Card 12 — question_and_answer (`fl_fBF72XHP5Rrb3ztF`)
...
When **differentiating** a term like 10*x* (where there is no power written next to the *x*), remember that this means 10x<sup>1</sup>, so will differentiate to 1×10x<sup>0</sup>, which is 10.



## Card 13 — true_or_false (`fl_H2zvffWvGDrZm2wn`)
...
## Card 14 — question_and_answer (`fl_NP2b5H2mkgq5XTpb`)

**FRONT**

What is the **main rule** for differentiating a **number of terms** added or subtracted together?  (For example something like $2x^{3}-3x+4$.)
...
So the derivative of  $2x^{3}-3x+4$  is  `open parentheses 3 cross times 2 close parentheses x to the power of 3 minus 1 end exponent minus 3 plus 0 equals 6 x squared minus 3`.



## Card 15 — question_and_answer (`fl_qkDQfNrn4zQ4cb9W`)
...
## Card 16 — keyword_definition (`fl_9ZWSNvs3b9j6tPzZ`)
...
## Card 17 — keyword_definition (`fl_wXjhNn7jCGZvN3z4`)
...
## Card 18 — question_and_answer (`fl_XmB8RZFsWRHVgN8F`)
...
## Card 19 — question_and_answer (`fl_bZqBCqfn9nGhCKsK`)
...
At a** turning point** the **derivative is equal to zero**, so an equation that can be used to find the *x*-coordinate of a turning point is  $\frac{dy}{dx}=0$.

(To find the *x*-coordinate(s) of the turning point(s), solve that equation for *x*.)



## Card 20 — true_or_false (`fl_fM9dHPkqMM8zB7f4`)
...
## Card 21 — question_and_answer (`fl_v9bxjfKvXx5Z7Bqs`)
...
## Card 22 — true_or_false (`fl_WQyjC8rqPSswPnsG`)
...
## Card 23 — keyword_definition (`fl_SC3SkGyMbGNxKw9G`)
...
## Card 24 — keyword_definition (`fl_CyGZQ3m3NpZTpGKn`)
...
## Card 25 — true_or_false (`fl_WmHQNGTp8Xp3KBJW`)
...
## Card 26 — true_or_false (`fl_3g8fk2YV8SvtSBrz`)
...
## Card 27 — true_or_false (`fl_BpD657nWggk6sQsX`)
...
## Card 28 — true_or_false (`fl_33XCtPDcjF2Wc6qK`)
...
## Card 29 — question_and_answer (`fl_VKfh58w7ZnS8cv5P`)
...
## Card 30 — true_or_false (`fl_z8rZCzmWzYFn9bNF`)
...
## Card 31 — question_and_answer (`fl_2k7mfVkCxHDxSB4M`)

**FRONT**

Without doing any calculations, how do you know that the graph of $y=x^{2}-10x+26$ has a **minimum** point and not a maximum point?


**BACK**

The graph of $y=x^{2}-10x+26$ has a positive $x^{2}$ term so it has the shape of a positive parabola (quadratic curve).

This means it is a U shaped curve, so must have a **minimum **point (not a maximum point).



## Card 32 — question_and_answer (`fl_B2zTPsyVzVHXYrWj`)

**FRONT**

The area of a shape, $A$ m<sup>2</sup>, is given by $A=x^{2}-6x+14$.
...
1. Differentiate $A$ to get $\frac{dA}{dx}$
2. Set $\frac{dA}{dx}=0$ to form and solve an equation in $x$
3. Substitute this value of $x$ back into $A$
4. This must be the minimum value of $A$ as $A=x^{2}-6x+14$ is a positive quadratic curve (U-shaped)



## Card 33 — true_or_false (`fl_VqPxtThsnkmKSKfc`)

**FRONT**

**True or False?**

You can find the maximum or minimum value of $A=x^{2}+2y$ by setting $\frac{dA}{dx}=0$.
...
You cannot find the maximum or minimum value of $A=x^{2}+2y$ by setting $\frac{dA}{dx}=0$ because $A$ needs to be in terms of **one variable only**.

You cannot have both $x$ and $y$ in the equation you want to maximise / minimise.



## Card 34 — question_and_answer (`fl_Mh4BXRDMTSchnptK`)

**FRONT**

A rectangular field measures $x$ m by $y$ m with a perimeter of $100$ m.

Explain how you would find its area, $A$ m<sup>2</sup>, in terms of $x$ only.
...
To find its area, $A$ m<sup>2</sup>, in terms of $x$ only
...
This gives `A equals x open parentheses 50 minus x close parentheses` which expands to give $A=50x-x^{2}$. This is now in **one variable** only.



## Card 35 — true_or_false (`fl_wPWphq6wpdbFhjn8`)

**FRONT**

**True or False?**

The minimum volume of the shape given by $V=x^{3}-12x+20$ is the value of $x$ that satisfies $\frac{dV}{dx}=0$.
...
The minimum volume of the shape given by $V=x^{3}-12x+20$ is not the value of $x$ that satisfies $\frac{dV}{dx}=0$ as the minimum **volume **will be a value of $V$, not $x$.

You need to find the two values of $x$ that satisfies $\frac{dV}{dx}=0$ then substitute them into the equation for $V$ to get a maximum and a minimum value. The smaller value is the minimum value of $V$ required.



## Card 36 — question_and_answer (`fl_SgM7tVCKBy5YhG67`)
...
## Card 37 — keyword_definition (`fl_zbdMyXb9jr78vQPw`)
...
## Card 38 — question_and_answer (`fl_wPxgq7JwFw5bn6P5`)
...
## Card 39 — question_and_answer (`fl_xyKnWk8Zn4Md9FPP`)
...
So the displacement of a particle at time $t$, for example, might be given as  $s=3t^{2}-2t+1$.



## Card 40 — keyword_definition (`fl_mnxxVstS9Zbz372B`)
...
## Card 41 — question_and_answer (`fl_fkQmw5BpCX54BsJc`)
...
## Card 42 — question_and_answer (`fl_djXrGn9v3GhZjD78`)
...
As an equation, that is  $v=\frac{ds}{dt}$.



## Card 43 — question_and_answer (`fl_zwgSSPpVK8Gfj3HV`)
...
## Card 44 — keyword_definition (`fl_K2p34j8gy9BgqnHF`)
...
It can be positive or negative, and is usually measured in metres per second squared (m/s<sup>2</sup>).



## Card 45 — question_and_answer (`fl_mqMfX7tnmkcS56mf`)
...
As an equation, that is  $a=\frac{dv}{dt}$.



## Card 46 — question_and_answer (`fl_zMt6XVPbM6p46fFh`)
...
## Card 47 — question_and_answer (`fl_pY9pFDdHRqgTcs8v`)
