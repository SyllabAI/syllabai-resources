...
> Source: [https://www.savemyexams.com/igcse/chemistry/edexcel/19/topic-questions/4-organic-chemistry/4-8-synthetic-polymers/exam-questions/](https://www.savemyexams.com/igcse/chemistry/edexcel/19/topic-questions/4-organic-chemistry/4-8-synthetic-polymers/exam-questions/) · 15 questions · total 99 marks
...
![4-8-4a-h-polyester-formation-a](assets/001-4-8-4a-h-polyester-formation-a.png)
...
![4-8-4b-h-polyester-repeat-unit-a](assets/003-4-8-4b-h-polyester-repeat-unit-a.png)
...
![4-8-4c-h-polyester-monomers-a](assets/007-4-8-4c-h-polyester-monomers-a.png)
...
The diagram shows a range of organic compounds with the general formula C<sub>4</sub>H<sub>8</sub>.

![4-8-5b-h-c4h8-isomers](assets/014-4-8-5b-h-c4h8-isomers.png)
...
![4-8-5c-h-2-methylpropene-polymerisation-a](assets/015-4-8-5c-h-2-methylpropene-polymerisation-a.png)

### 4 — 2 marks — command: multiple — structured
The diagram shows the repeat unit of the polymer formed by compound **E**.

![4-8-5d-h-polybut-2-ene-repeat-unit-brackets-n](assets/017-4-8-5d-h-polybut-2-ene-repeat-unit-brackets-n.png)
...
### 6 — 1 mark — command: why — structured
This question is about ethene, the structure of which is shown below**. **

![ethene](assets/018-ethene.png)

Why is this molecule described as **unsaturated?**

### 6 — 3 marks — command: complete — structured
Ethene can undergo a polymerisation reaction.

Complete the sentences using the words in the box.

| \| high \| poly(ethene) \| polymers \| poly(ethane) \|<br>\|---\|---\|---\|---\|<br><br>\| ten \| monomers \| a few \| many \|<br>\|---\|---\|---\|---\| |
|---|
...
### 6 — 2 marks — command: complete — structured
Complete the repeat unit of the polymer formed by ethene.

![aqa-gcse-7-3e-tq1c-repeating-unit-of-polyethene](assets/019-aqa-gcse-7-3e-tq1c-repeating-unit-of-polyethene.png)

### 6 — 1 mark — command: tick — structured
...
### 6 — 1 mark — command: give — structured
...
### 7 — 3 marks — command: compare — structured
...
### 7 — 4 marks — command: multiple — structured
...
![SNx2OKA0_3](assets/022-snx2oka0-3.png)
...
![j92YlLlN_1](assets/023-j92yllln-1.png)

What is the correct repeat unit?

![2-1](assets/024-2-1.png)
- **A.** 
- **B.** 
- **C.** 
- **D.** 
...
![NB7rJx~C_6](assets/026-nb7rjx-c-6.png)
- **A.** 
- **B.** 
- **C.** 
- **D.** 
...
![fig-4-q5b-1cho-2h-paper-1-june-2018](assets/027-fig-4-q5b-1cho-2h-paper-1-june-2018.png)
...
![fig-6-q1e-1cho-2h-paper-1-june-2018](assets/028-fig-6-q1e-1cho-2h-paper-1-june-2018.png)
...
Show, by calculation, that the empirical formula of chloroethene is C<sub>2</sub>H<sub>3</sub>Cl

### 5(b) — 5 marks — command: multiple — structured — from paper 2019 · Ju1CR
The molecular formula of chloroethene is also C<sub>2</sub>H<sub>3</sub>Cl
...
ii) Organic compound Q reacts with bromine, without the presence of ultraviolet radiation, to form the compound C<sub>4</sub>H<sub>8</sub>Br<sub>2</sub>.
...
![WB3A4ZSD_1cr-q8b](assets/041-wb3a4zsd-1cr-q8b.png)
...
Ethene (C<sub>2</sub>H<sub>4</sub>) can be represented by different types of formula.
...
![alkene-addition-reaction](assets/043-alkene-addition-reaction.png)
...
![repeat-unit-of-a-polymer](assets/045-repeat-unit-of-a-polymer.png)
...
An addition polymer can be formed from the monomer CH<sub>2</sub>=CHCl
...
![screen-shot-2022-10-12-at-21-27-12](assets/047-screen-shot-2022-10-12-at-21-27-12.png)
...
![screen-shot-2022-10-12-at-21-39-25](assets/049-screen-shot-2022-10-12-at-21-39-25.png)
