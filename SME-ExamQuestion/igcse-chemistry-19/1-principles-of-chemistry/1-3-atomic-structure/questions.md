...
> Source: [https://www.savemyexams.com/igcse/chemistry/edexcel/19/topic-questions/1-principles-of-chemistry/1-3-atomic-structure/exam-questions/](https://www.savemyexams.com/igcse/chemistry/edexcel/19/topic-questions/1-principles-of-chemistry/1-3-atomic-structure/exam-questions/) · 18 questions · total 104 marks
...
The table contains some information about elements, which can be atoms, isotopes, or ions.

|   | V | W | X | Y | Z |
|---|---|---|---|---|---|
| protons | 6 | 15 | 6 | 4 | 9 |
| neutrons | 6 | 16 | 7 | 5 | 10 |
| electrons | 6 | 18 | 6 | 2 | 9 |

Choose letters from the table to answer these questions.

Each letter may be used once, more than once, or not at all.

ii) Which species are isotopes?

[1]

iii) Which species is an element from Group 5 of the Periodic Table?

[1]

iv) Which species are ions?

[1]

v) Which species is an element from Period 3 of the Periodic Table?
...
Table 1 shows some information about subatomic particles, but the headers are missing.

Complete the missing headers in table 1.

|   | _____________ | _____________ | _____________ |
|---|---|---|---|
| _____________ | 1 | 1 | 0.0005 |
| Relative charge | +1 | 0 | -1 |

**Table 1**

### 3 — 5 marks — command: multiple — structured
Table 2 gives the number of protons, neutrons, and electrons in atoms and ions of some elements.
...
i) What is the atomic number of element K in table 2?
...
ii) What is the mass number of element N in table 2?
...
iii) State the element in table 2 that is in Group 2 of the Periodic Table.

[1]

iv) Which element(s) in table 2 are ions?

[2]

### 3 — 3 marks — command: calculate — structured
The relative atomic mass (*A*<sub>*r*</sub>) of elements K and L is 10.8. Calculate the percentage abundance of element K.
...
Using information from the table, calculate the relative atomic mass (*A*<sub>r</sub>) of this sample of element Y.
...
![2020-ja1c-q2a](assets/001-2020-ja1c-q2a.png)
...
Calculate the relative atomic mass (*A*<sub>r</sub>) of this element. Give your answer to one decimal place.
...
![2c-q1](assets/002-2c-q1.png)

The box gives the names of some particles.

![2c-q1-1](assets/003-2c-q1-1.png)
...
### 2(b) — 4 marks — command: give — structured — from paper 2021 · Ju1C
...
A sample of neon contains two isotopes, <sup>20</sup>Ne and <sup>22</sup>Ne

The relative abundances of the two isotopes in the sample are

<sup>20</sup>Ne    91.2%           <sup>22</sup>Ne    8.80%
...
![1-3-q1-image](assets/005-1-3-q1-image.png)
...
![2019-ju2cr-q2a](assets/006-2019-ju2cr-q2a.png)
...
![1-1_q1-edexcel-gcse-mcq](assets/007-1-1-q1-edexcel-gcse-mcq.png)
...
![aqa-gcse-1-1h-sq-q2a-2-8-electron-configuration](assets/008-aqa-gcse-1-1h-sq-q2a-2-8-electron-configuration.png)
...
![be-electronic-structure](assets/009-be-electronic-structure.png)
...
![2021-ja2c-q1a](assets/010-2021-ja2c-q1a.png)
...
![screen-shot-2022-10-10-at-10-27-37](assets/011-screen-shot-2022-10-10-at-10-27-37.png)
...
### 1(c) — 1 mark — command: how — structured — from paper 2017 · Specimen1C
...
There are 6.022 × 10<sup>23</sup> atoms in one mole.
