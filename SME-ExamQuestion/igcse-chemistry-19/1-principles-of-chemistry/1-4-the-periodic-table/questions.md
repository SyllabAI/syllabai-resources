...
> Source: [https://www.savemyexams.com/igcse/chemistry/edexcel/19/topic-questions/1-principles-of-chemistry/1-4-the-periodic-table/exam-questions/](https://www.savemyexams.com/igcse/chemistry/edexcel/19/topic-questions/1-principles-of-chemistry/1-4-the-periodic-table/exam-questions/) · 17 questions · total 89 marks


## Q1 — medium — 4 marks

### 2 — 4 marks — command: complete — structured
The table contains statements about elements in the Periodic Table.
...
| Statement |   |
|---|---|
| The name of the element with atomic number 18. |   |
| The name of the element with relative atomic mass 7. |   |
| The name of the element in Group 3, Period 4. |   |
| The electronic configuration of the element phosphorus. |   |
...
![1-4-q3-edexcel-igcse-chemistry](assets/001-1-4-q3-edexcel-igcse-chemistry.png)
- **A.** element M
- **B.** element Q
- **C.** element T
- **D.** element R
...
### 4 — 2 marks — command: identify — structured
...
i) Draw a dot-and-cross diagram to show the bonding in a molecule of the compound formed with a relative molecular mass (*M*<sub>r</sub>) of 70.

(2)

ii) An alternative product with a relative molecular mass (*M*<sub>r</sub>) of 146 is formed under different conditions. Suggest the molecular formula of this product.
...
### 1(b) — 2 marks — command: multiple — structured — from paper 2020 · Nov1C
...
![1-4-q1-edexcel-igcse-chemistry](assets/003-1-4-q1-edexcel-igcse-chemistry.png)
- **A.** 2,4
- **B.** 2,2,4
- **C.** 2,2,8
- **D.** 2,8,4
...
### 11 — 2 marks — command: state — structured
...
### 11 — 2 marks — command: multiple — structured
One of the elements can form the giant covalent structure shown.

![1-4-4b-h-labelled-silicon-dioxide](assets/004-1-4-4b-h-labelled-silicon-dioxide.png)
...
### 11 — 1 mark — command: give — structured
...
![screen-shot-2022-10-17-at-19-10-35](assets/005-screen-shot-2022-10-17-at-19-10-35.png)
...
### 13 — 2 marks — command: give — structured
...
### 13 — 4 marks — command: how — structured
...
![alphabet-periodic-table](assets/006-alphabet-periodic-table.png)
...
### 15 — 3 marks — command: multiple — structured
...
### 16 — 1 mark — command: what — structured
...
### 16 — 3 marks — command: multiple — structured
...
![6-1-2c-e-3-electron-shells](assets/007-6-1-2c-e-3-electron-shells.png)
...
![hydrogen-airship](assets/009-hydrogen-airship.png)
...
Hydrogen is used to manufacture ammonia, NH<sub>3</sub>
...
![1-2-the-periodic-table-3a](assets/010-1-2-the-periodic-table-3a.png)
