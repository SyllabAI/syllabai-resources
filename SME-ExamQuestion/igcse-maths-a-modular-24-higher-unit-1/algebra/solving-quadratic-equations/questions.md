...
> Source: [https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-1/topic-questions/algebra/solving-quadratic-equations/exam-questions/](https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-1/topic-questions/algebra/solving-quadratic-equations/exam-questions/) · 39 questions · total 141 marks
...
### 9() — 3 marks — command: show — structured — from paper Jan 2021 · 4MA1/2HR
Solve  $x^{2}--21x+20=0$
...
### 27((b)) — 3 marks — command: show — structured — from paper June 2018 · 8300/1H
...
### 6((d)) — 3 marks — command: multiple — structured — from paper 2023 June · 4MA1/1H
...
### 15((a)) — 3 marks — command: describe — structured — from paper Nov 2020 · J560/04
Here are two pieces of work.

For each one, describe the error made and give the complete correct solution.

| Question:<br><br>Solve by factorisation.<br><br>$3x^{2}--2x--5=0$<br><br>Solution:<br><br>$(3x+5)(x--1)=0$<br><br>Therefore $x=-5/3\mathrm{or}x=1$ |
|---|

Error: ........................................................ Correct solution:

### 15((b)) — 3 marks — command: solve — structured — from paper Nov 2020 · J560/04
| Question: Solve, giving your answers correct to 3 significant figures.<br><br>$2x^{2}--8x+3=0$<br><br>Solution:<br><br>`x equals negative open parentheses blank to the power of minus 8 close parentheses plus-or-minus fraction numerator square root of open parentheses blank to the power of minus 8 close parentheses squared minus 4 cross times 2 cross times 3 end root over denominator 2 cross times 2 end fraction`<br><br>Therefore $x=6.42$ or $x=9.58$ |
|---|
...
![q4-hard-2-10-solving-quadratic-equation-edexcel-gcse-maths](assets/001-q4-hard-2-10-solving-quadratic-equation-edexcel-.png)

All the measurements are in centimetres.

The area of the trapezium is $351$ cm<sup>2</sup>.
...
![q5-hard-2-10-solving-quadratic-equation-edexcel-gcse-maths](assets/003-q5-hard-2-10-solving-quadratic-equation-edexcel-.png)

The lengths of the sides are in centimetres.

The area of triangle **T**<sub>**1**</sub> is equal to the area of triangle **T**<sub>**2**</sub>**.**
...
### 18((a)) — 3 marks — command: show — structured — from paper Jan 2019 · 4MA1/2H
The diagram shows a trapezium.

![q15-paper2h-jan2019-edexcel-igcse-maths](assets/002-q15-paper2h-jan2019-edexcel-igcse-maths.png)
...
### 18((b)) — 3 marks — command: show — structured — from paper Jan 2019 · 4MA1/2H
Find the value of $x.$
...
### 17() — 6 marks — command: show — structured — from paper Specimen 2015 · J560/06
