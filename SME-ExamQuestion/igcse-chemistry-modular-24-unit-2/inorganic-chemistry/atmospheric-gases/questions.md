...
> Source: [https://www.savemyexams.com/igcse/chemistry/edexcel/modular/24/unit-2/topic-questions/inorganic-chemistry/atmospheric-gases/exam-questions/](https://www.savemyexams.com/igcse/chemistry/edexcel/modular/24/unit-2/topic-questions/inorganic-chemistry/atmospheric-gases/exam-questions/) · 17 questions · total 108 marks
...
![air-comopsition](assets/010-air-comopsition.png)
...
### 1((a)) — 4 marks — command: multiple — structured — from paper 2019 · Ju2CR
This question is about gases in the atmosphere.

The box gives the names of some gases in the atmosphere.

| argon                     carbon dioxide                helium<br><br>nitrogen                                oxygen |
|---|
...
![Diagram of a setup with two gas syringes connected to a tube containing pieces of copper wire. One gas syringe contains 50 cm³ of air, and the other is empty.](assets/001-diagram-of-a-setup-with-two-gas-syringes-connect.png)
...
The teacher measures the volume of the syringe at the end of the experiment and records the volume as 42 cm<sup>3</sup>.

Give one reason why this was not the expected result.

## Q8 — medium — 8 marks · exam-questions

### 4((a)) — 2 marks — command: show — structured — from paper 2017 · Specimen1C
...
![screen-shot-2022-10-10-at-12-55-10](assets/005-screen-shot-2022-10-10-at-12-55-10.png)
...
![screen-shot-2022-10-10-at-12-55-16](assets/006-screen-shot-2022-10-10-at-12-55-16.png)
...
|---|---|
| syringe reading at end / cm<sup>3</sup> |   |
| volume of oxygen used / cm<sup>3</sup> |   |
...
| volume of air in conical flask / cm<sup>3</sup> | 100 |
|---|---|
| volume of air in connecting tube / cm<sup>3</sup> | 10 |
| original volume of air in syringe / cm<sup>3</sup> | 80 |
| final volume of air in syringe / cm<sup>3</sup> | 43 |
...
![2-3-q2-edexcel-igcse-chemistry](assets/013-2-3-q2-edexcel-igcse-chemistry.png)
...
### 5((a)) — 1 mark — command: state — structured — from paper 2020 · Ja1CR
...
![phosphorus-experiment](assets/014-phosphorus-experiment.png)
...
| **Time in minutes** | **Volume of gas in tube in cm**<sup>**3**</sup> |
|---|---|
| 0 | 48.5 |
| 1 | 41.0 |
| 2 | 38.0 |
...
- **A.** LiCO<sub>3</sub> → LiO + CO<sub>2</sub>
- **B.** Mg<sub>2</sub>CO<sub>3</sub> → Mg<sub>2</sub>O + CO<sub>2</sub>
- **C.** CaCO<sub>3</sub> + CO<sub>2 </sub>→ CaO
- **D.** CuCO<sub>3</sub> → CuO + CO<sub>2</sub>
...
| ☐ | **D** | The balanced symbol equation for the combustion of hydrogen is: H<sub>2</sub> + O<sub>2</sub> → H<sub>2</sub>O<sub>2</sub> |
...
![oxygen-composition-of-air-experiment](assets/003-oxygen-composition-of-air-experiment.png)
...
| **Reading number** | **Reading on syringe A in cm**<sup>**3**</sup>** ** |
|---|---|
| Start | 78 |
| 1 | 70 |
| 2 | 67 |
...
ii) The volume of gas in the glass tube and connecting tubes is 175 cm<sup>3</sup>.
...
![2-3-3a-h-a](assets/007-2-3-3a-h-a.png)
...
In experiment 2, two 100 cm<sup>3</sup> gas syringes are connected to a reaction tube containing copper powder. The sample of air is passed over hot copper oxide. The diagram shows the apparatus that is used.

![2-3-3a-h-b](assets/008-2-3-3a-h-b.png)

ii) Explain why both syringes should not be filled with 100 cm<sup>3</sup> of oxygen.
...
The total volume of the mixture of gases in the syringes at the start is 76 cm<sup>3</sup>.

The total volume of the mixture of gases in the syringes at the end is 64 cm<sup>3</sup>.
...
![2-3-3c-h-per-cent-of-co2-in-air](assets/009-2-3-3c-h-per-cent-of-co2-in-air.png)
...
![2-3-4b-h-products-of-combustion-incorrect-set-up](assets/004-2-3-4b-h-products-of-combustion-incorrect-set-up.png)
...
![2-3-5b-h-per-cent-of-air-using-iron-filings](assets/011-2-3-5b-h-per-cent-of-air-using-iron-filings.png)
...
![2-3-5c-h-syringe-readings](assets/012-2-3-5c-h-syringe-readings.png)

The student completes their results table, as shown, to calculate that the percentage of oxygen in the air is 21.5%.

| syringe reading at start / cm<sup>3</sup> | 84 |
|---|---|
| syringe reading at end / cm<sup>3</sup> | 40 |
| volume of oxygen used / cm<sup>3</sup> | 44 |

Identify the error that the student has made and calculate the correct percentage of oxygen in the air.

### 4() — 6 marks — command: explain — structured
