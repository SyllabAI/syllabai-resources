...
### 3((c)) — 2 marks
Give the hazard caused by the build up of electrostatic charges on an object:

- There is a risk of a spark / shock / fire / damage; **[1 mark]**

State how the risk from the hazard could be reduced:
...
### 7((a)) — 2 marks
The man gains an electric charge because:
...
### 3() — 3 marks
The man receives a shock even though the button is properly earthed because...
...
### 2((a)) — 1 marks
To show that the rod has gained charge:

The rod can be shown to:

Any **one** from:

- Attract scraps of paper; **[1 mark]**
- Deflect a stream of water (towards it); **[1 mark]**
- Attract hair / a balloon; **[1 mark]**
- Deflect a gold leaf electroscope (towards it); **[1 mark]**
- Use a coulomb meter (to obtain a reading for the charge of the rod); **[1 mark]**

**[Total: 1 mark]**

### 2((b)) — 2 marks
The plastic rod gains charge when it is rubbed because:
...
- Which discharges / neutralises the tanker **OR** reduces voltage to zero; **[1 mark]**
...
- Mean charging current = 2.8 × 10<sup>−7</sup> A **[1 mark]**
...
### 1() — 3 marks
Calculate the charge supplied to the sprayer:

List the known quantities and convert to SI units:

- Current, $I$ = 6 mA = 6 × 10<sup>−3</sup> A
...
- Charge = (6 × 10<sup>−3</sup>) × 480 **[1 mark]**
...
### 2((c)) — 3 marks
Describe an experiment to demonstrate there are two types of charge:
...
### 1() — 2 marks
The build-up of static electricity could be dangerous because:
...
### 7((c)) — 3 marks
The cables reduce the dangers because:
...
### 1() — 2 marks
The threads are not vertical because:
...
### 1() — 2 marks
The difference between conductors and insulators in terms of electrons is:
...
![static-charge-investigation-1-sq-igcse-ma](assets/021-static-charge-investigation-1-sq-igcse-ma.png)
...
![static-charge-investigation-2-sq-igcse-ma](assets/023-static-charge-investigation-2-sq-igcse-ma.png)
