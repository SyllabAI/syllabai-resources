...
> Source: [https://www.savemyexams.com/igcse/physics/edexcel/19/topic-questions/3-waves/3-3-sound/exam-questions/](https://www.savemyexams.com/igcse/physics/edexcel/19/topic-questions/3-waves/3-3-sound/exam-questions/) · 16 questions · total 104 marks
...
![foghorn](assets/004-foghorn.png)
...
![3-3-q4b-e-microphone-and-oscilloscope-sound-waves-sq-igcse](assets/027-3-3-q4b-e-microphone-and-oscilloscope-sound-wave.png)
...
![2-graphs](assets/008-2-graphs.png)
...
| **Length of pipe in m** | **Frequency of signal in Hz** |
|---|---|
| 2 | 42 |
| $1\frac{1}{2}$ | 57 |
...
![temp-graph](assets/019-temp-graph.png)
...
| Distance<br><br>in m | Time<br><br>in ms |
|---|---|
| 0.62 | 1.8 |
| 0.80 | 2.4 |
| 1.00 | 3.0 |
...
![Black and white image of a person speaking. The speech bubble says, "It is easier for an aeroplane to make a sonic boom when it travels higher up."](assets/011-black-and-white-image-of-a-person-speaking-the-s.png)
...
![3-3-q4a-h-speed-of-sound-oscilloscope-trace-sq-igcse-png](assets/025-3-3-q4a-h-speed-of-sound-oscilloscope-trace-sq-i.png)
...
The speed of sound is then calculated by dividing the distance travelled by the time taken.
...
![3-3-q5a-h-buzzer-microphone-sound-experiment-sq-igcse](assets/005-3-3-q5a-h-buzzer-microphone-sound-experiment-sq-.png)
...
![3-3-q5b-h-wavelength-of-sound-oscillioscope-trace-sq-igcse](assets/006-3-3-q5b-h-wavelength-of-sound-oscillioscope-trac.png)
...
![Graph displaying a sinusoidal waveform with labelled oscilloscope settings: 2.0 V per square on y-axis, 5.0ms per square on x-axis.](assets/001-graph-displaying-a-sinusoidal-waveform-with-labe.png)
...
![Blank grid, 8 squares tall and 10 squares wide](assets/002-blank-grid-8-squares-tall-and-10-squares-wide.png)
