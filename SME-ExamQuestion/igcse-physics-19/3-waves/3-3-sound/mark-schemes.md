...
### 1() — 1 marks
The relationship between frequency and pitch is:
...
### 3() — 2 marks
Astronauts in space cannot hear sounds from outside their spacesuits because:
...
### 3((b)) — 1 marks
Find the time period of wave P:
...
![file-000-10](assets/023-file-000-10.png)
...
### 3((b)) — 1 marks
Find the frequency of wave Q:

![file-000-11](assets/024-file-000-11.png)
...
### 3() — 2 marks
The technician halves the equation because:
...
![file-000-12](assets/020-file-000-12.png)
...
![file-000-11](assets/021-file-000-11.png)
...
![file-000-47](assets/022-file-000-47.png)
...
![file-000-8](assets/016-file-000-8.png)
...
![distance-time-graph-sound-gradient](assets/017-distance-time-graph-sound-gradient.png)
...
![f33bc9d3-e56d-413c-ae7d-fc36abd6f066](assets/009-f33bc9d3-e56d-413c-ae7d-fc36abd6f066.jpeg)
...
![file-000-39](assets/012-file-000-39.png)
...
### 1() — 5 marks
Calculate the speed of sound from the oscilloscope trace:

List the known quantities:

- Wavelength of the sound wave, *λ* = 1.3 m
- Time-base: 1 square = 1 ms = 1 × 10<sup>−3</sup> s

Determine the period of the sound wave:

![speed-of-sound-oscilloscope-trace-sq-igcse-ma](assets/026-speed-of-sound-oscilloscope-trace-sq-igcse-ma.png)

- Period = time to complete one oscillation or wavelength
- Period = 4 squares
- Period = 4 × 1 ms = 4 ms **[1 mark]**
- Period = 4 ms = 4 × 10<sup>−3</sup> s **[1 mark]**
...
### 2() — 5 marks
A valid evaluation of the student's alternative method is:
...
### 1() — 3 marks
The difference in the average speeds of A and B is:
...
### 2() — 5 marks
Calculate the wavelength of the sound wave from the oscilloscope trace:

List the known quantities:

- Speed of the sound wave, *v *= 340 m/s
- Time-base: 1 square = 2 ms = 2 × 10<sup>−3</sup> s

Determine the period of the sound wave:

![wavelength-of-sound-oscillioscope-trace-sq-igcse-ma](assets/007-wavelength-of-sound-oscillioscope-trace-sq-igcse.png)

- Period = time to complete one oscillation or wavelength
- Period = 4 squares
- Period = 4 × 2 ms = 8 ms **[1 mark]**
- Period = 8 ms = 8 × 10<sup>−3</sup> s **[1 mark]**
...
### 3() — 5 marks
An experimental method for measuring the speed of sound in air:
...
![Graph depicting a sinusoidal wave with a period of 2 squares and an amplitude of 3 squares](assets/003-graph-depicting-a-sinusoidal-wave-with-a-period-.png)
