...
> Source: [https://www.savemyexams.com/igcse/physics/edexcel/19/topic-questions/3-waves/3-1-waves-and-the-electromagnetic-spectrum/exam-questions/](https://www.savemyexams.com/igcse/physics/edexcel/19/topic-questions/3-waves/3-1-waves-and-the-electromagnetic-spectrum/exam-questions/) · 39 questions · total 170 marks
...
![em-spectrum-arrow](assets/044-em-spectrum-arrow.png)
...
![prism-1](assets/027-prism-1.png)
...
![wave-spring](assets/031-wave-spring.png)
...
![wooden-ring](assets/033-wooden-ring.png)
...
![microwaves](assets/038-microwaves.png)
...
[speed of microwave in free space = 3.0 × 10<sup>8</sup> m/s]
...
A bat emits sound waves to locate objects.

Sound waves are longitudinal waves.

(i) Describe what is meant by the term **longitudinal wave**.

[1]

(ii) Describe the relationship between the time period and frequency of a wave.

[1]

### 2() — 5 marks — command: multiple — structured
While stationary, the bat emits a short sound wave towards an object and hears its echo 2.4 s later.

(i) State the formula linking speed, distance and time.
...
### 3() — 9 marks — command: multiple — structured
The sound wave emitted by the bat has a frequency of 25 kHz.

(i) State whether a human would hear this sound. Explain your answer.

[2]

(ii) Calculate the time period of this sound wave.

[3]

(iii) State the formula linking the speed, frequency and wavelength of a wave.

[1]

(iv) Calculate the wavelength of this sound wave.
...
![2-2-q5a](assets/017-2-2-q5a.jpg)
...
![2-2-q5bq2](assets/019-2-2-q5bq2.jpg)

### 5() — 2 marks — command: evaluate — structured — from paper June 2013 · 2P
The student concludes:

![Black and white image of a person with a speech bubble saying, "The minimum voltage depends on the wavelength of the light emitted."](assets/021-black-and-white-image-of-a-person-with-a-speech-.jpg)
...
### 13((d)) — 2 marks — command: state — structured — from paper June 2015 · 1P
