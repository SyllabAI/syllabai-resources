...
![863a05a0-8e16-4aba-a6be-260ffd06163d](assets/024-863a05a0-8e16-4aba-a6be-260ffd06163d.jpeg)
...
![trophic-loss-calc-ma](assets/022-trophic-loss-calc-ma.png)
...
![4bi1br-nov-2020-q4a-food-web---ma](assets/016-4bi1br-nov-2020-q4a-food-web-ma.png)
...
- x 5 **OR** 3 000 (mice per km<sup>2</sup>); **[1 mark]**
- 15 000 **OR** 1.5 × 10<sup>4</sup>;** [1 mark]**

*Award full marks for the correct numerical answer of 15 000 or 1.5 x 10*<sup>*4 *</sup>*without working.*

***Allow**** incorrectly-written standard form if expressed as 15 × 10*<sup>*3*</sup>*.*
...
> *(i) The biggest hazard in the question is converting from standard form to regular number notation; make sure you're aware that 10*<sup>*3*</sup>* is 1 followed by 3 zeros, or (10 × 10 × 10), i.e. 1 000. You can always leave your answer in standard form though (1.5 × 10*<sup>*4*</sup>*), because the question does not specify the number format to use in your answer. *

![4bi1br-nov-2020-q4ci-mice---ma](assets/017-4bi1br-nov-2020-q4ci-mice-ma.png)
...
- 2.5 ÷ 15 000 **OR** 2.5 ÷ (1.5 x 10<sup>4</sup>); **[1 mark]**
- 0.00017; **[1 mark]**
- 1.7 x 10<sup>-4</sup>; **[1 mark]**

*Award full marks for the correct answer of 1.7 x 10*<sup>*-4*</sup>* in the absence of any calculations.*

***Accept ****1.66 recurring x 10*<sup>*-4*</sup>* ****OR**** 1.67 x 10*<sup>*-4*</sup>* ****OR**** 1.7 x 10*<sup>*-4*</sup>

***Accept**** a final answer of 17 x 10*<sup>*-5*</sup>*.*
...
![untitled-18](assets/014-untitled-18.png)

> *The pyramid of biomass for (b)(ii):*

![biomass-pyramid-q6bii](assets/015-biomass-pyramid-q6bii.png)
...
### 6((c)) — 2 marks
Scientists could estimate the energy of the producers in 1 m<sup>2</sup> of crop field in the following way...

Any **two** of the following:

- Sampling (of crop plants) using quadrats;** [1 mark]**
- Burn the plants to release the energy;** [1 mark]**
- Use a calorimeter / heat (a set) volume of water and note the temperature change; **[1 mark]**
...
Microscopic plankton are considered producers because they are able to produce their own organic nutrients through photosynthesis.

**A**,** C **and** D **are incorrect as these organisms are all different types of consumers. This means that they feed on other organisms and are unable to photosynthesise.

(ii)** ****The correct answer is ****C ****because...**

Line 13 of the passage mentions that humans eat fish, which are secondary consumers in this food chain. Since humans are eating secondary consumers, it makes them the tertiary consumers in this food chain.

**A** is incorrect as crustaceans are primary consumers, since they feed on plankton (producers).

**B** is incorrect as fin whales are either primary or secondary consumers, depending on their food source.

**D** is incorrect as whale sharks are primary consumers that feed on plankton (producers).

**[Total: 2 marks]**

### 1((b)) — 5 marks
Blocked tubes leading from the mouth can lead to death in some animals because...

Any **five** of the following:

- Less food is taken in / eaten / reaches the stomach / the animal may starve;** [1 mark]**
- Food cannot be digested / less digestion occurs;** [1 mark]**
- Fewer amino acids / less glucose / fatty acids / glycerol (are available to the cells); **[1 mark]**
- Less gas exchange (occurs in the lungs) / less air taken into the lungs / (the animal) can’t breathe / air cannot flow through the trachea/bronchi (to the lungs) / the animal may suffocate;** [1 mark]**
- There will be less oxygen in the blood / less oxygen to the lungs; **[1 mark]**
- There will be less carbon dioxide removed (from the blood/lungs);** [1 mark]**
- Less (aerobic) respiration will occur **OR** more anaerobic respiration will occur; **[1 mark]**
- Less energy (will be released) / ATP (produced) **OR** more lactic acid will be produced; **[1 mark]**

*Allow the idea of less energy from less food/glucose only once.*

**[Total: 5 marks]**

> *Remember that the tubes leading from the mouth can either be the oesophagus that leads to the stomach or the trachea that leads to the lungs. If these tubes are blocked, then the process of digestion and gas exchange will be greatly affected, potentially leading to the death of the animal.*

### 1((c)) — 2 marks
Bioaccumulation of microplastics is a problem for humans because...

Any **two** of the following:

- The amount of plastic/toxin concentrate (along the food chain) / the amount of plastic/toxin increases in the bodies of organisms (along the food chain) / more plastic/toxin are found in the higher trophic levels / plastic/toxin works along the food chain / the plastic/toxin builds up (along the food chain) **OR **the** **plastic/toxin is not excreted/removed from the bodies / it stays in the bodies (of organisms);** [1 mark]**
- Humans are at the end of the food chain / humans eat plastic when eating fish / humans gain plastic from the fish; **[1 mark]**
- Less fish will be caught / less food for humans (if fish populations decrease);** [1 mark]**

**[Total: 2 marks]**

> *Microplastics can build up to toxic levels in the bodies of organisms occupying the higher trophic levels in a food chain. For humans, it can have a very negative impact on their health when consuming these organisms containing large amounts of plastic. Microplastics are also blamed for killing marine life such as fish and/or negatively affecting their ability to reproduce, leading to a decrease in food supply for other organisms and humans.*

### 1((d)) — 3 marks
The difference between the number of plastic particles ingested in a year by a fin whale and a whale shark can be calculated as follows...

- (2000 - 200) = 1800; **[1 mark]**
- (1800 x 365) = 657 000 / 660 000; **[1 mark]**
- = 6.57 x 10<sup>5</sup> / 6.6 x 10<sup>5</sup>; **[1 mark]**

*Full marks awarded for the correct answer in standard form in the absence of calculations.* *Allow a maximum of* **[2 marks]** *for an answer of 657 000 or 660 000.* *Allow a maximum of ***[2 marks]*** for an answer of 6.57 / 6.6 with the wrong power.*

**[Total: 3 marks]**

![jan2021p2bq1dma](assets/008-jan2021p2bq1dma.png)

### 1((e)) — 2 marks
The effects of reduced reproduction on biodiversity would be...

Any **two** of the following:

- Reduced/decreased biodiversity; **[1 mark]**
- Fewer species / lower populations **OR** some species become extinct / die out;** [1 mark]**
- Fewer food sources (for organisms) / fewer niches (available) **OR** (it will) disrupt interactions within food chains;** [1 mark]**

**[Total: 2 marks]**

> *Reduced reproduction would mean fewer organisms being added to a population in an ecosystem. This could result in the death rate of a population exceeding the birth rate, leading to an overall decrease in population size. If this happens across several different species, it could lead to extinctions in the ecosystem and negatively affect the other organisms that depend on these species either directly or indirectly.*

### 1((f)) — 2 marks
A benefit of using biodegradable plastic bags would be...

Any **two** of the following:

- Less microplastic would be produced; **[1 mark]**
- Fewer animals would be harmed / suffocated / killed / damaged / not eaten by animals **OR** less bioaccumulation would occur / less plastic/toxin would be passed along food chains; **[1 mark]**
- Plastic bags would be broken down / digested / decomposed; **[1 mark]**
- This would be done by microorganisms/bacteria/fungi; **[1 mark]**

*Ignore mention of (bio)degrade at marking point 3 or 4.*

**[Total: 2 marks]**

> *Remember that you cannot gain marks for repeating information that is stated in the question stem in your answer. If you say that the plastic bags can be biodegraded by microorganisms it will be ignored by the marker, since it is stated in the question stem that the plastic bags are biodegradable. You have to rewrite this in your own words to convey the meaning of the word 'biodegradable'.*
...
- Producer to primary consumer: (1.4 x10<sup>4</sup> / 8.7 x10<sup>5</sup>) x 100 = 1.61 %; **[1 mark]**
- Primary consumer to secondary consumer: (1.6 x10<sup>3</sup> / 1.4 x10<sup>4</sup>) x 100 = 11.4 %; **[1 mark]**
...
![ma-for-jan-22-1b-q7b](assets/005-ma-for-jan-22-1b-q7b.png)
...
![4bi1b-nov-2020-q4a-food-chain---ma](assets/002-4bi1b-nov-2020-q4a-food-chain-ma.png)
...
- 1m<sup>2</sup> = 10 000cm<sup>2</sup>
...
> *Because the crux of this question is to realise that 1 square metre needs to be converted to 10 000cm*<sup>*2*</sup>* , it is helpful to visualise a 1 metre square (like a quadrat) divided into 100 ×1cm divisions along all four sides - this means that there are 10 000 small squares in total. Then, imagine the krill clearing 1.6 of these small squares per second. The calculation remains to work out how long the krill would need to clear the whole quadrat-sized area. For this, 10 000cm*<sup>*2*</sup>* has to be divided by 1.6 cm*<sup>*2*</sup>*s*<sup>*-1*</sup>* to get 6 250 seconds. A straightforward division by 60 gives the number of minutes of 104.2 (approx). *

![4bi1b-nov-2020-q4b-ice-clearing---ma](assets/003-4bi1b-nov-2020-q4b-ice-clearing-ma.png)
