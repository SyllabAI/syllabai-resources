...
> *You can tell that the yellow allele is the dominant one because all the plant's offspring (F*<sub>*1*</sub>*) had yellow seeds, meaning that this allele was expressed over the green version, which would be recessive in this case. *
...
- The fetus is female/girl; **[1 mark]**
...
***Allow ****"the fetus does not have Down's syndrome" for marking point 2.*
...
![4bi1br-nov-2020-q5cii-iron---ma](assets/033-4bi1br-nov-2020-q5cii-iron-ma.png)
...
- 0.25 **OR** 25 % **OR** <sup>1</sup>/<sub>4</sub>; **[1 mark]**
- 0.125 **OR** <sup>1</sup>/<sub>8</sub> **OR** 12.5%; **[1 mark]**
...
![gIsiJbeO_4bi1br-nov-2020-q9b-punnett---ma](assets/030-gisijbeo-4bi1br-nov-2020-q9b-punnett-ma.png)
...
- *Probability that child is female = *<sup>*1*</sup>*/*<sub>*2*</sub>* = 0.5*
- *Probability that child will not have a cleft chin = *<sup>*1*</sup>*/*<sub>*4 *</sub>*= 0.25*
- *0.5 x 0.25 = 0.125*
...
![untitled-20](assets/027-untitled-20.png)
...
![untitled1](assets/028-untitled1.png)
...
![untitled2](assets/029-untitled2.png)
...
### 5((a)) — 4 marks
(i) The sex of the person in the karyotype is...

- Male;** [1 mark]**
- (We can tell this because it) has X and Y / different sized length of chromosomes / heterogametic / has a Y chromosome **OR** female would be XX;** [1 mark]**

(ii) The difference between haploid and diploid can be explained as follows...

Any **two** from the following:

- (Diagram 1 is) diploid; **[1 mark]**
- Because diploid has two of each chromosome / has 23 pairs / has 46 chromosomes / has 2 sets of chromosomes;** [1 mark]**
- (Whereas) haploid only has one of each pair / would have 23 chromosomes / has one set of chromosomes / would have half the number of chromosomes ; **[1 mark]**

**[Total: 4 marks]**

> *This karyotype is for a human and so the diploid chromosome number is 46 or 23 pairs. Different organisms have different numbers of chromosomes so it is important to read the thread carefully before referring to any chromosome numbers in your answer.*

### 5((b)) — 7 marks
(i) The differences between diagrams 1 and 2 can be described as follows...

- Diagram 2/Klinefelter has an extra chromosome / has 47 chromosomes;** [1 mark]**
- X chromosome / sex chromosomes are different; **[1 mark]**

***Allow ****converse for karyotype 1*

*Statements which say 'has an extra X chromosome' or 'has three sex chromosomes' can be awarded*** [2 marks]**

(ii) The karyotype in diagram 2 is caused by...

Any **two** from the following:

- A mutation; **[1 mark]**
- (This could have occurred due to) failure of chromosomes to separate; **[1 mark]**
- During meiosis / gamete formation;** [1 mark]**

***Accept ****nondisjunction*

(iii) The total number of males with Klinefelter can be calculated as follows...

- 49 % of 66 million = 32 340 000 men **OR **1/660 x 32 340 000; **[1 mark]**
- = 49 000;** [1 mark]**

*Full marks should be awarded for the correct answer without working*

*Award ***[1 mark] ***for the number 32 340 000*

![kleinfelter-ma](assets/026-kleinfelter-ma.png)

(iv) Females over 35 are more likely to have a baby with Klinefelter because...

Any **one** from the following:

- Mutation more likely (in older women);** [1 mark]**
- This is because, gametes are older; **[1 mark]**
...
This sequence of bases will code for 5 amino acids.

**A** is incorrect because it will not just code for 1 amino acid.

**B** is incorrect as it will not code for 3 amino acids.

**D** is incorrect as the sequence of bases will not code for 15 amino acids.

(ii) The complementary mRNA code for this sequence of bases would be...

- GUA AGU UAA GUA AAG;** [2 marks]**

*Allow* **[1 mark]** *if one error is present.* *Allow* **[1 mark] ***for GTA AGT TAA GTA AAG.*

(iii) The term 'non-overlapping' means...

Any** two** of the following:

- Each triplet/codon codes for one amino acid **OR** one codon/triplet determines each/one amino acid; **[1 mark]**
- Codons are discrete/independent of each other **OR** nucleotides/bases are not shared between codons/amino acids;** [1 mark]**
- An example of triplet reading frames, eg. CAT TCA **OR** triplets read CAT TCA; **[1 mark]**

**[Total: 5 marks]**

> *The answer for (a)(i):*

![jan2021p2bq5a](assets/022-jan2021p2bq5a.png)

> *For (a)(ii):*

![jan2021p2bq5aii](assets/023-jan2021p2bq5aii.png)

### 5((b)) — 4 marks
The following events happens in the translation stage of protein synthesis...

Any **four** of the following:

- (mRNA arrives at the) ribosome;** [1 mark]**
- mRNA has codons / is a template; **[1 mark]**
- The ribosome moves along the mRNA strand / moves along to the next codon;** [1 mark]**
- tRNA brings amino acids (to the ribosome); **[1 mark]**
- The anticodon (on the tRNA) binds with the codon (on mRNA) / tRNA binds with mRNA **OR** the codon (on mRNA) is complementary to the anticodon (on the tRNA); **[1 mark]**
- An amino acid chain is produced / amino acids are joined / a polypeptide is produced;** [1 mark]**

**[Total: 4 marks]**

> *During translation, the DNA code that was transcribed onto mRNA is translated by the ribosomes. This involves joining amino acids together in the correct sequence as determined by the codons on the mRNA molecule. The result is a polypeptide with a specific structure and function to fulfil.*

### 5((c)) — 1 marks
The genome of an organism refers to...

- The genes / DNA / genetic material (of an organism); **[1 mark]**
...
### 1((a)) — 2 marks
Bursting of red blood cells will affect the development of a foetus in the following ways...

Any **two** of the following:

- Less oxygen (would be transported to foetal cells); **[1 mark]**
- (This would result in less / a lower rate of) respiration;** [1 mark]**
- (Less) energy (would be released) / ATP (would be produced); **[1 mark]**

**[Total: 2 marks]**

> *Remember that the function of red blood cells is to transport oxygen around the body which is needed for aerobic respiration. Without a sufficient oxygen supply, the rate of respiration will decrease, resulting in less energy being available for the growth and development of the foetus.*

### 1((b)) — 3 marks
The dominant allele leads to the production of RNA in the following ways...

Any **three** of the following:

- DNA unzips / separates / one strand is copied; **[1 mark]**
- Complementary / base pairing (occurs between DNA strand and growing RNA strand); **[1 mark]**
- (The DNA strand serves as a) template; **[1 mark]**
- mRNA is produced;** [1 mark]**
- (This process is known as) transcription;** [1 mark]**

**[Total: 3 marks]**

> *It is important for the genetic information contained in the DNA molecule to be copied into mRNA during transcription. Since double stranded DNA is too large to fit through the nuclear pores the message is carried by the single stranded mRNA molecule out of the nucleus and into the cytoplasm where the ribosomes can translate it.*

### 1((c)) — 1 marks
Proteins cannot be made by red blood cells because...

- (Red blood cells have) no nucleus / DNA / ribosomes / mitochondria; **[1 mark]**

*Ignore mention of amino acids or genetic material.*

**[Total: 1 mark]**

### 1((d)) — 1 marks
Evidence from the passage that shows that antibodies are smaller than red blood cells is...

- (Antibodies) can cross the placenta; **[1 mark]**

**[Total: 1 mark]**

> *The placenta forms a protective barrier between the maternal and foetal bloodstream so anything that can cross this barrier must be very small. The red blood cells are too large to cross the placenta, thereby preventing the mixing of blood between mother and foetus. Antibodies from the mother can however cross the placenta in order to provide the foetus with protection against pathogens.*

### 1((a)) — 4 marks
(i) The genotypes of the parents, their gametes and offspring would be...

- Parent genotypes: <u>dd</u> (mother) x <u>Dd</u> (father); **[1 mark]**
- Gamete genotypes: d (and d)(mother) **and** D or d (father);** [1 mark]**
- Offspring genotypes: Dd **and** dd; **[1 mark]**

*Allow an answer in the form of a Punnett square.* *A maximum of* **[2 marks]** *for use of any letter other than D/d. *

> *Don't forget to show the genotype of the gametes clearly in your answer as failure to do so will cost you a mark.*

![jan2021p2brq1ei](assets/020-jan2021p2brq1ei.png)

(ii) The probability that the child will be rhesus positive is...

- 50% / 0.5 / half / 50:50;** [1 mark]**

*Do not accept an answer that contradicts (e)(i).*

**[Total: 4 marks]**

![jan2021p2brq1eii](assets/021-jan2021p2brq1eii.png)

### 1((f)) — 3 marks
The concentration of rhesus antibody in the mother's blood will quickly rise to harmful levels with a second Rhesus positive child because...

Any **three** of the following:

- (There will be) memory cells (against the rhesus factor protein); **[1 mark]**
- (That) remain in the mother’s blood (after the birth of her first child);** [1 mark]**
- (The memory cells will) recognise/identify the antigen/rhesus factor (protein) / binds with the antigen/rhesus factor (protein); **[1 mark]**
- (This results in) more antibodies (being) produced **OR **(the antibodies are) produced faster/sooner; **[1 mark]**
- (This is known as the) secondary immune response;** [1 mark]**

**[Total: 3 marks]**

> *This will have devasting consequences for a second foetus, as the antibodies will destroy the foetal red blood cells that contain the rhesus factor protein on their surface. Treatment and careful monitoring of the pregnancy will be necessary to avoid a possible miscarriage from occurring.*

### 1((g)) — 1 marks
The term *in utero* means...

- **in** the uterus / womb; **[1 mark]**

**[Total: 1 mark]**

### 1((h)) — 1 marks
The blood group of the source of the cells used for the blood transfusion would be...

- (Adult) (rhesus) positive;** [1 mark]**

**[Total: 1 mark]**

> *It is vital that the foetus receives the same blood group as their own blood to avoid an immune response against the transfused blood. They will therefore have to receive donor blood from someone that is also rhesus positive.*
...
![ma-for-nov-20-2br-q4b](assets/017-ma-for-nov-20-2br-q4b.png)
...
### 4((e)) — 3 marks
This affects the growth of rats because...

Any **three **of the following:

- (More) mRNA made; **[1 mark]**
- (So there will be more) translation; **[1 mark]**
- (And therefore more) proteins / polypeptides made; **[1 mark]**
- (The proteins become) enzymes / muscle / tissue (which allow for growth)*(ignore references to more cells);* **[1 mark]**

**[Total: 3 marks]**

> *For the last marking point you need to be specific in terms of what the proteins become, saying just "cells" is not sufficient detail and will not get you the mark. Proteins make up lots of different substances within the cells, so "cells" alone is too vague. *
...
### 6((b)) — 5 marks
A change in the DNA of a microorganism can reduce its ability to digest a substance because...

Any **five **of the following:

- (There will be) different (sequence of) <u>bases</u> in DNA;** [1 mark]**
- (Which will lead to) changes in the mRNA / codons;** [1 mark]**
- Transcription (of the bases); **[1 mark]**
- (Leads to changes of the) tRNA / anticodons / (sequence of) amino acids; **[1 mark]**
- Translation (of mRNA);** [1 mark]**
- (Leads to) changes in the <u>structure</u> / <u>shape</u> of protein (translated); **[1 mark]**
- (Which can cause) changes to active site (of enzymes which are proteins);** [1 mark]**
- The enzyme is not functional / (there will be) no binding with substrate / no enzyme-substrate complex formed; **[1 mark]**

**[Total: 5 marks]**

### 6((c)) — 4 marks
A change in DNA may not affect the phenotype of an organism because...

Any **four **of the following:

- Some triplets / codons code for the same amino acid / degenerative;** [1 mark]**
- (Therefore) no change in the protein / polypeptide / enzyme produced;** [1 mark]**
- The active site is not changed / affected; **[1 mark]**
- The mutation / allele may be recessive...; **[1 mark]**
- So it will not be expressed in the phenotype / if heterozygous / dominant allele present; **[1 mark]**
- Mutation may occur in a non-coding sequence of DNA; **[1 mark]**
...
(iii) The genetic diagram showing the possible genotypes and phenotypes of the offspring produced by individuals 6 and 7 should appear as follows...
...
![ma-for-jan-22-1br-q7a-iii](assets/014-ma-for-jan-22-1br-q7a-iii.png)

![sBow0rp-_ma-for-jan-22-1br-q7a-iv](assets/015-sbow0rp-ma-for-jan-22-1br-q7a-iv.png)
...
![ma-for-jan-22-1b-q9b](assets/012-ma-for-jan-22-1b-q9b.png)
...
![DGVQmhrR_q7bma](assets/010-dgvqmhrr-q7bma.png)
...
This is due to complementary base pairing where C pairs with G, G pairs with C, A pairs with U, and T pairs with A.

![untitled101](assets/005-untitled101.png)

Don't forget that mRNA will have uracil instead of thymine, so option A is incorrect.
...
The image shows two molecules of tRNA (recognisable by their clover-like shape), the molecule that transports amino acids during the process of **translation**. The unpaired bases on the end of a tRNA molecule are known as an **anticodon**, and they pair with the mRNA codon on the single-stranded mRNA molecule.

**[Total: 1 mark]**

### 6((c)) — 3 marks
A mutation in a gene can affect the phenotype of an organism as follows...

Any **three** of the following:

- A mutation is a <u>rare</u>/<u>random</u> change to the DNA/genetic material; **[1 mark]**
- The change affects the nucleotides/bases/triplets (of DNA) / codons (of mRNA); **[1 mark]**
- (This leads to a) change in (the sequence of) amino acids (in proteins/polypeptides); **[1 mark]**
- Changing the / producing a different enzyme/protein **OR** changing the shape/active site of a protein; **[1 mark]**

**[Total: 3 marks]**

> *Mutations are random changes to the DNA sequence which alter the amino acid sequence of the proteins for which the DNA codes. These altered proteins can affect the appearance of an organism. e.g. by altering the activity of an enzyme.*

> *Be careful not to mix up DNA sequence (formed by DNA bases) and amino acid sequence (which forms a protein).*

### 6((d)) — 8 marks
(i) The scientists could have sampled the population of butterflies in the area as follows...

Any **three** of the following:

- Use of quadrats / laying out a grid over the area to be sampled; **[1 mark]**
- Random sampling / selection (of areas to lay quadrat/grid); **[1 mark]**
- Count butterflies (within the selected areas); **[1 mark]**
- Repeat / calculate a mean; **[1 mark]**

*Marking points 1 and 4 can be awarded in the same sentence, e.g. the idea of multiple quadrat*<u>*s*</u>* for repeats.*

(ii) Discussion points relating to the conclusion that the increased level of radioactivity has led to an increased rate of mutation of DNA include...

Any **five** of the following:

*Points in support of the conclusion*

- Increase in abnormal (adult/offspring/both adult and offspring) butterflies (over time) / more abnormal (adult/offspring/both adult and offspring) butterflies found after 10 months; **[1 mark]**
- (Due to) longer exposure to radioactivity / longer exposure to radioactivity increases the number of mutations; **[1 mark]**
- Larger increase in the number of / more abnormal/mutated offspring (compared with adults after 10 months) **OR **abnormal adults increase by 15.7 % and abnormal offspring increase by 41.9 %; **[1 mark]**
- Mutations/genes (caused by radioactivity) passed on to offspring; **[1 mark]**
- Recessive mutations (caused by radioactivity) may be carried by adults; **[1 mark]**
- Mating of heterozygotes/carriers may produce abnormal offspring (due to the inheritance of a mutated allele from each parent); **[1 mark]**

*Points that do not support the conclusion*

- Abnormalities may be caused by other factors / may not be due to mutations/genes/DNA **OR** butterflies may have other (unknown) health issue / disease; **[1 mark]**
- There is no control experiment / data from before the accident / data from an area with no radioactivity / data showing normal level of abnormality (in the butterfly population); **[1 mark]**
- Radioactivity levels have not been monitored/measured / may change/decay (over time) **OR **no information on how long the radioactivity will last / remain unchanged; **[1 mark]**
- No information has been provided on the number of butterflies sampled / butterfly sample size **OR** butterfly sample size may be small **OR** the experiment has not been repeated; **[1 mark]**

**[Total: 5 marks]**

> *In questions requiring discussion of investigations, it is important to consider both the resulting **data** and the **design of the experiment**. Here the data itself supports the conclusion in the question, showing an increase in the number of butterfly abnormalities over time, but there are aspects of the design of the investigation that could be improved to increase the validity of this data, such as the inclusion of an experimental control, and carrying out repeat experiments.*
...
![4bi2b-nov-2020-q3bi-punnett---ma](assets/003-4bi2b-nov-2020-q3bi-punnett-ma.png)
...
![4bi2b-nov-2020-q3b-pedigree---ma](assets/004-4bi2b-nov-2020-q3b-pedigree-ma.png)

### 3((c)) — 3 marks
Ways that this drug reduces damage to nerve cells in people with HD are...

Any** three** of the following:

- (The drug) prevents translation / there is no translation; **[1 mark]**
- (The drug) prevents ribosomes attaching (to mRNA); **[1 mark]**
- (The drug) prevents/no codon binding to anticodon / tRNA does not bind to mRNA; **[1 mark]**
- (The drug) prevents amino acids joining / amino acid chain not made; **[1 mark]**
- Huntingtin/protein/polypeptide not made / less huntingtin/protein made; **[1 mark]**
