...
- kg per hectare / kg hectare<sup>-1</sup> / kg/hectare; **[1 mark]**

*Accept Ha for hectare.*

![untitled-31](assets/009-untitled-31.png)
...
![bacteria-division-calculations-ma](assets/006-bacteria-division-calculations-ma.png)
...
### 1() — 4 marks
(i) The new protein produced by the yeast cells in the fermentation tank is...

- The hepatitis B/HB antigen;** [1 mark]**

> *The gene for the hep B antigen is isolated from the virus and inserted into the yeast cells. This results in the yeast cells producing the hep B antigen protein.*

(ii) The hep B antigen is needed in order to produce the vaccine because...

Any **three** of the following:

- It identifies the virus / the body will recognise it as foreign/non-self;** [1 mark]**
- Lymphocytes recognise it/the antigen; **[1 mark]**
- (Lymphocytes) are activated / an immune response is triggered;** [1 mark]**
- Antibodies / memory cells are produced; **[1 mark]**

> *This is a synoptic question that requires knowledge gained in the section of the specification relating to the immune system. Different areas of biology may be linked together in their real-world applications, so it is a good idea to be used to exam questions that require you to draw on knowledge from more than one part of the specification.*

**[Total: 4 marks]**

### 2() — 2 marks
Enzyme 1 is used to cut both the desired gene and the plasmid DNA in the process shown in part (a) because...

Any **two** of the following:

- Enzyme 1 is a restriction enzyme; **[1 mark]**
- The enzyme cuts the DNA at the same base sequence;** [1 mark]**
- The same bases are exposed / the sticky ends match each other (allowing the DNA to join together);** [1 mark]**

**[Total: 2 marks]**

### 3() — 2 marks
Advantages of producing hepatitis B vaccines using yeast-derived protein rather than plasma-derived protein could include...

Any **two** of the following:

- More vaccines can be produced / vaccine production is not limited by the number of previously infected donors **OR** the success of the vaccine will reduce the number of potential donors in the future; **[1 mark]**
- There is no risk of passing on (other) infections (in the blood plasma); **[1 mark]**
- The gene/protein produced can be easily altered/modified if a pathogen mutates / to provide immunity to multiple pathogens; **[1 mark]**

**[Total: 2 marks]**

> *This question requires you to apply reasoning skills, as well as your knowledge of the advantages of producing insulin using bacteria, to this new scenario.*

> *The question stem says that plasma-derived vaccines are made using proteins from the plasma of previously infected individuals; this will limit the number of potential donors to those who have been previously infected, and this number may fall as the vaccine takes effect on human populations.*

> *Blood can contain pathogens, so transferring blood, or any component of blood, from one individual to another can bring a risk of infection.*

> *The ability to genetically alter organisms to produce one hepatitis protein means that in theory it should be easy to alter the organism again to produce a different protein should the virus mutate into a different strain.*

### 4() — 7 marks
(i) The percentage increase in infants with chronic heptatitis B, for infants given the plasma-derived vaccine, between 1 and 9 months is...

- (4.5 ÷ 0.6) x 100; **[1 mark]**
- 750 (%); **[1 mark]**

> *750 % seems like a very big number, but remember that a doubling of the % of infants with chronic hepatitis B would be a 100 % increase, so increasing the % by more than 7 times gives more than a 700 % increase.*

![untitled-28](assets/005-untitled-28.png)

(ii) The effect of the GM yeast-derived vaccine on infants with chronic hepatitis B and that of the plasma-derived vaccine can be compared as follows...

Any **three** of the following:

- <u>Both</u> vaccines keep the level of infection (with chronic hepatitis B) below 6 % **OR** the maximum infection rate for either vaccine is 5.1 %; **[1 mark]**
- Levels of infection increase between 0-9 months for <u>both</u> vaccines; **[1 mark]**
- Up to 4 months of age the plasma-derived vaccine is<u> more</u> effective / keeps the level of infection low<u>er</u> than the GM yeast-derived vaccine; **[1 mark]**
- From 4-5 months <u>both</u> vaccines are equally effective / there is no difference in the effect of the two vaccines; **[1 mark]**
- From 5 months onwards the GM yeast-derived vaccine keeps the level of infection low<u>er</u> than the plasma-derived vaccine; **[1 mark]**

> *The question asks you to describe how the effects of the two vaccines compare to each other, so you should look for similarities and differences in their effects. Remember to use comparative language such as 'both', 'more' and 'lower' when describing how the vaccine effects compare with each other.*

(iii) A reason for the trend in infants with chronic hepatitis B between age 0-18 months could be...

Any **one** of the following:

- Infants catch hepatitis B from their mothers after birth / during breastfeeding; **[1 mark]**
- The hepatitis B virus remains dormant during the first months after birth / becomes increasingly active between 0-9 months; **[1 mark]**
- Infants have immunity/antibodies from their mothers when they are born **BUT** this is lost over time; **[1 mark]**

*Ignore references to the infants catching hepatitis B from anywhere other than from their mother, as this is specified in the question stem in part (c).*

> *This is a **suggest** question, and you are expected to use information provided in part (c) along with your own reasoning. Part (c) tells you that we are studying hepatitis B transmission **from mother to baby**, so your answers must relate to this method of transmission, and should attempt to explain why infections rates increase during the first months of an infant's life. The infant could receive the infection from their mother after birth, e.g. during breastfeeding, or the virus could be dormant at birth and only become active as the infant grows older. Alternatively, the infant could be born with immunity, e.g. antibodies, from the mother which then decreases over time.*

**[Total: 7 marks]**

## Q10 — hard — 19 marks · exam-questions
...
(iii) The piglet in step 5 is able to produce *E. coli* and mouse proteins because...

- DNA/genes code for proteins; **[1 mark]**
- The *E. coli*/mouse DNA /gene is transcribed **AND** translated; **[1 mark]**
