...
![4bi2b-nov-2020-q2aii-graph-paper---ma](assets/008-4bi2b-nov-2020-q2aii-graph-paper-ma.png)
...
![cloning-ma](assets/005-cloning-ma.png)
...
![plant-conservation-percentage-success-ma](assets/004-plant-conservation-percentage-success-ma.png)
...
- S = same temperature / light intensity/wavelength / CO<sub>2 </sub>/ humidity / oxygen / water; **[1 mark]**
...
- Micropropagation can produce more new plants than cuttings
- Micropropagation produces disease-free plants
- All plantlets produced by micropropagation are genetically identical, so will be suited to the environment

Arguments for cuttings

- Cuttings can be taken on the farm / don't require a lab / specialist equipment / a trained lab worker
- Cuttings produce new plants more quickly than micropropagation

Conclusion

- Cuttings would (probably) be most suitable for the farmer
