...
### 1() — 3 marks
(a) A correct sentence using the words from the box to complete the gaps is:
...
### 3() — 3 marks
(c) A diagram with lines drawn correctly should look like this:

![star-temp-colour-match-sq-edexcel-igcse-ma](assets/028-star-temp-colour-match-sq-edexcel-igcse-ma.png)
...
### 2() — 3 marks
(b) A diagram with the correct labels should look like this:

![8-2-2b-e-life-cycle-solar-mass-stars-label-sq-edexcel-igcse-ma](assets/030-8-2-2b-e-life-cycle-solar-mass-stars-label-sq-ed.png)
...
### 2() — 3 marks
(b) A table with ticks (✔) to show the four statements that are correct should look like this:
...
### 3() — 4 marks
(c) The correct stages of the life cycle of the large star after the main sequence are:

![8-2-4c-e-life-cycle-larger-stars-box-fill-sq-edexcel-igcse-ma](assets/023-8-2-4c-e-life-cycle-larger-stars-box-fill-sq-ede.png)
...
### 1() — 2 marks
(a) A HR diagram with the horizontal and vertical axis correctly labelled should look like this:

![2OjO8-nw_hr-fill-in-axis-sq-edexcel-igcse-ma1](assets/025-2ojo8-nw-hr-fill-in-axis-sq-edexcel-igcse-ma1.png)
...
### 2() — 4 marks
(b) A table with each of the areas correctly labelled would look like this:
...
### 3() — 2 marks
(c) Draw lines on the Hertzsprung-Russell diagram to identify the temperature and luminosity of the Sun:

![JITo6P7N_hr-fill-in-axis-sq-edexcel-igcse-ma2](assets/026-jito6p7n-hr-fill-in-axis-sq-edexcel-igcse-ma2.png)

- The temperature of the Sun = 6000 K **[1 mark]**
- The luminosity of the Sun = 1 L<sub>Sun</sub> **[1 mark]**
...
### 1() — 1 marks
(a) The process described in the diagram is:
...
### 1() — 4 marks
(a) The colour classification of stars from hottest to coolest is as follows:
...
### 3() — 2 marks
(c) Stars like the Sun are formed when:
...
### 3() — 3 marks
(c) The white dwarf is in position:
...
### 1() — 2 marks
(a) The similarities between main sequence stars are:
...
### 2() — 2 marks
(b) A table with ticks (✔) in the correct place to identify the correct statements regarding the relationship between a star's colour and its surface temperature looks like this:
...
### 1() — 2 marks
(a) The absolute magnitude scale is:

- A measure of the luminosity of an astronomical object; **[1 mark]**

Any **one **from

- In relation to a standard distance; **[1 mark]**
...
### 2() — 2 marks
(b) Two statements that correctly describe the relationship between the absolute magnitude of a star and its brightness are:

- The brighter / more luminous the star, the smaller / lower the absolute magnitude; **[1 mark]**
- The dimmer / less bright the star, the larger / greater the absolute magnitude; **[1 mark]**

**[Total: 2 marks]**

### 3() — 3 marks
(c) Objects placed correctly on the apparent brightness scale should look like this:

![apparent-magnitude-scale-edexcel-igcse-ma](assets/002-apparent-magnitude-scale-edexcel-igcse-ma.png)
...
### 1() — 4 marks
(a) A correctly labelled diagram that would score 4 marks should look like this:

![hr-fill-in-axis-sq-edexcel-igcse-ma1](assets/009-hr-fill-in-axis-sq-edexcel-igcse-ma1.png)

- Horizontal axis labelled with surface temperature / K; **[1 mark]**
- Vertical axis labelled with luminosity (compared to the Sun) / L<sub>Sun</sub>; **[1 mark]**
...
### 2() — 4 marks
(b) The types of star each of the letters represent are as follows:

A is a:

- <u>Red supergiant</u> where the <u>outer part expands</u> and the <u>outer surface cools</u>; **[1 mark]**

B is a:

- <u>Red giant</u> where the <u>outer part expands</u> and the <u>outer surface cools</u>; **[1 mark]**

C is a:

- <u>Main sequence</u> star where <u>fusion reactions</u> occur in its core; **[1 mark]**

D is a:

- <u>White dwarf</u> that <u>cools down</u> and emits less and less energy; **[1 mark]**
...
![hr-fill-in-axis-sq-edexcel-igcse-ma2](assets/010-hr-fill-in-axis-sq-edexcel-igcse-ma2.png)
...
![hr-fill-in-axis-sq-edexcel-igcse-ma3](assets/011-hr-fill-in-axis-sq-edexcel-igcse-ma3.png)
...
### 2() — 1 marks
**Correct answer: C** — 10<sup>9</sup> to 10<sup>11</sup> years
...
- This stage can last anywhere from
  ...
  - A few billion years (for solar mass stars) - about 10<sup>9</sup> years
  - Up to hundreds of billions of years (for stars with much lower masses than solar mass) - about 10<sup>11</sup> years

- So, for a low-mass star, the timescale of stage 3 is anywhere between 10<sup>9</sup> to 10<sup>11</sup> years

  - This is option **C**

### 3() — 2 marks
(c) The star in stage 3 remains stable for billions of years because:
...
### 4() — 5 marks
(d) Compare and contrast the final stages in the life cycles of low-mass and high-mass stars:
...
### 2() — 5 marks
(b) The evolution of the Sun & Proxima Centauri after they leave the main sequence:
...
### 1() — 2 marks
(a) The correct positions of S, X and Y are as follows:

![hr-diagram-colour-abs-maganitude-sq-igcse-ma](assets/007-hr-diagram-colour-abs-maganitude-sq-igcse-ma.png)
...
### 2() — 6 marks
(b) The evolutionary stages of a star with a similar mass to the Sun:
...
### 1() — 6 marks
(a) A suitable graph for the data would be:

![temp-abs-magnitude-graph-sq-igcse-ma](assets/015-temp-abs-magnitude-graph-sq-igcse-ma.png)

- Horizontal axis labelled 'surface temperature / K' **OR** 'colour'; **[1 mark]**
- Vertical axis labelled 'absolute magnitude' **OR** 'luminosity / L<sub>Sun</sub>'; **[1 mark]**
- Sensible (log) scales for surface temperature used (1000, 5000, 10 000) **OR **colours in correct order; **[1 mark]**
- Sensible (log) scales for absolute magnitude used (multiples of 1, 2 or 5) **OR** luminosity relative to the Sun (1, 10<sup>2</sup>, 10<sup>4</sup> etc); **[1 mark]**
...
![temp-abs-magnitude-graph-sq-igcse-comm](assets/016-temp-abs-magnitude-graph-sq-igcse-comm.png)
...
![temp-abs-magnitude-graph-sq-igcse-ma1](assets/017-temp-abs-magnitude-graph-sq-igcse-ma1.png)
...
![temp-abs-magnitude-graph-sq-igcse-ma2](assets/018-temp-abs-magnitude-graph-sq-igcse-ma2.png)
...
### 2() — 2 marks
(b) The relationship between the colours and the numbers on the line is as follows:
...
![hr-diagram-temperature-luminosity-mcq-igcse-ma](assets/021-hr-diagram-temperature-luminosity-mcq-igcse-ma.png)
...
| Proxima Centauri | M6 | **7.6** | 15.6 |
| 61 Cygni | K5 | **6.5** | 7.5 |
| Betelgeuse | M1 | **7.1** | −5.9 |
| Rigel | B8 | **2.8** | −7.8 |
| Bellatrix | B2 | **2.2** | −2.8 |
| Vega | A0 | **3.0** | 0.6 |
| Barnard's Star | M4 | **7.4** | 13.2 |
| Procyon B | F5 | **4.5** | 13 |
...
![hr-diagram-plot-sq-igcse-ma](assets/004-hr-diagram-plot-sq-igcse-ma.png)
...
![hr-diagram-regions-sq-igcse-ma](assets/005-hr-diagram-regions-sq-igcse-ma.png)
