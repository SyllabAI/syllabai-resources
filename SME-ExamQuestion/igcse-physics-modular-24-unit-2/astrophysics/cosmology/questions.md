...
> Source: [https://www.savemyexams.com/igcse/physics/edexcel/modular/24/unit-2/topic-questions/astrophysics/cosmology/exam-questions/](https://www.savemyexams.com/igcse/physics/edexcel/modular/24/unit-2/topic-questions/astrophysics/cosmology/exam-questions/) · 16 questions · total 138 marks
...
![A light bulb at the centre of a set of concentric circular wavefronts. The circles are bunched close together on the right-hand side and stretched further apart on the left, because the bulb is moving to the right, shown by an arrow along the bottom labelled Direction of motion. A person stands at the far left and another at the far right. A wavy arrow with a long wavelength travels left towards the first person and a wavy arrow with a short wavelength travels right towards the second. Four empty boxes are waiting to be labelled: one above each person, and one on each side of the bulb.](assets/001-a-light-bulb-at-the-centre-of-a-set-of-concentri.png)
...
### 1() — 3 marks — command: define — structured
...
### 4() — 7 marks — command: complete — structured
...
| **stretch out     slower     expanding     moving towards     red**<br><br>**receding     faster     black hole     doppler    blue** |
|---|
...
### 3() — 6 marks — command: complete — structured
...
- **D.** stars form from large clouds of dust and gas
...
- **A.** the galaxy is moving towards the Earth
- **B.** the galaxy is moving away from the Earth
- **C.** the galaxy is not moving relative to the Earth
- **D.** the galaxy is expanding

### 3() — 1 mark — multiple_choice
The diagram shows some wavelengths that were observed using light from a source in a laboratory:

![8-3-4c-e-hydrogen-spectrum-redshift-mcq-igcse](assets/005-8-3-4c-e-hydrogen-spectrum-redshift-mcq-igcse.png)
...
- **B.** all the lines move towards the 'long λ' side by different amounts
...
### 3() — 5 marks — command: place — structured
...
- **A.** When a galaxy moves towards the Earth the spectral absorption lines observed will have a longer wavelength
- **B.** When a car starts to move away from an observer, the sound from the exhaust appears at a lower frequency to the observer than the driver
- **C.** When a train moves towards a station, it's horn will sound lower to the passengers on the platform compared to the passengers in the train
- **D.** Light from a star moving towards the Earth is redshifted
...
The same spectral line is emitted by a galactic source that is moving away from Earth at speed of 6 × 10<sup>7</sup> m/s.

The speed of light is 3.0 × 10<sup>8</sup> m/s.
...
- **A.** Redshift led to the idea that galaxies are expanding
- **B.** A greater redshift means a faster speed of recession
- **C.** Redshift shows a few of the galaxies in the universe are moving away from a single point
- **D.** Redshift causes electromagnetic waves to change frequency and speed.
...
Light emitted from a distant galaxy is measured on Earth to have a wavelength $λ$ of 400 nm. The same wavelength is measured in the laboratory to have a wavelength $λ_{0}$ of 300 nm.

The speed of light in space, $c$ = 3.00 × 10<sup>8</sup> m/s.
...
The galaxy is observed to be moving away from the Earth with a velocity of 2.0 × 10<sup>4</sup> m/s.
...
Light from distant galaxies shows red-shift.
...
A galaxy emits light with a reference wavelength of 500.0 nm.

The wavelength of this light observed on Earth is 531.0 nm.

Show that the velocity of the galaxy is approximately 19 000 km/s.

[speed of light = 3.0 × 10<sup>5</sup> km/s]
...
Speed of light, *c* = 3.0 × 10<sup>8</sup> m/s
...
The speed of light is *c *= 3.0 × 10<sup>8</sup> m/s
...
![8-3-q3a-5-h-hydrogen-spectrum-lab-mcq-igcse](assets/003-8-3-q3a-5-h-hydrogen-spectrum-lab-mcq-igcse.png)
...
Where $H_{0}$ is a constant known as the 'Hubble constant'.

A spectral line corresponds to a wavelength *λ*<sub>*1*</sub> in the laboratory. The same spectral line observed in the spectrum of a receding galaxy corresponds to a wavelength *λ*<sub>*2*</sub>.

The speed of light in a vacuum is *c*.

Which of the following is the correct expression for the Hubble constant $H_{0}$?
- **A.** `H subscript 0 space end subscript equals space fraction numerator c open parentheses lambda subscript 2 space end subscript minus space lambda subscript 1 close parentheses over denominator d space lambda subscript 1 end fraction`
- **B.** `H subscript 0 space end subscript equals space fraction numerator c lambda subscript 1 over denominator d space open parentheses lambda subscript 2 space end subscript minus space lambda subscript 1 close parentheses end fraction`
- **C.** $H_{0}=\frac{cλ_{2}}{dλ_{1}}$
- **D.** $H_{0}=\frac{cλ_{1}}{dλ_{2}}$
