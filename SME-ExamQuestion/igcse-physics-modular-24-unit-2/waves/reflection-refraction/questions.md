# Exam Questions — Reflection & Refraction
**5. Waves** · Edexcel IGCSE Physics (Modular) (4XPH1) — 24/Unit 2
> Source: [https://www.savemyexams.com/igcse/physics/edexcel/modular/24/unit-2/topic-questions/waves/reflection-refraction/exam-questions/](https://www.savemyexams.com/igcse/physics/edexcel/modular/24/unit-2/topic-questions/waves/reflection-refraction/exam-questions/) · 23 questions · total 184 marks


## Q1 — easy — 1 marks · exam-questions

### 6((a)) — 1 mark — multiple_choice — from paper 2016 January · 1P
The diagram shows changes to light waves passing from air into glass.

![wavefronts](assets/026-wavefronts.png)
...
### 11((a)) — 1 mark — multiple_choice — from paper 2015 January · 1P
Which diagram shows the reflection of a ray of light at a plane mirror?

![refection](assets/024-refection.png)
- **A.** 
- **B.** 
- **C.** 
- **D.** 
...
### 3((a)) — 1 mark — multiple_choice — from paper 2015 June · 1PR
A student plans to measure the refractive index of glass.

She traces a ray of light through a glass block as shown in the diagram.

![block-2](assets/030-block-2.png)
...
### 3((a)) — 2 marks — command: state — structured — from paper 2015 June · 1PR
The diagram shows changes to light waves passing from air into glass.
...
### 3((b)) — 2 marks — command: multiple — structured — from paper 2015 June · 1PR
Using the diagram in part (a)
...
### 2((a)) — 3 marks — command: multiple — structured — from paper 2012 June · 1P
The diagram shows a light ray passing though a semicircular block of glass.

![tir2](assets/027-tir2.png)
...
### 2((b)) — 3 marks — command: complete — structured — from paper 2012 June · 1P
The diagram shows another light ray entering a right-angled glass It hits the inside surface at Y as shown.

![prism-4](assets/028-prism-4.png)

Add to the diagram to complete the path of the ray.

## Q6 — medium — 7 marks · exam-questions

### 12((a)) — 4 marks — command: multiple — structured — from paper 2015 June · 1P
A light ray can undergo total internal reflection.
...
### 12((b)) — 3 marks — command: multiple — structured — from paper 2015 June · 1P
The diagram shows a ray of light entering a glass block and travelling towards point **O**.

![file-000-26](assets/070-file-000-26.png)
...
### 11((a)) — 2 marks — command: explain — structured — from paper 2013 June · 1P
A ray of light enters a glass block and is refracted as shown in Figure 1.

![figure-1](assets/039-figure-1.png)

Explain why the ray of light is refracted towards the normal.

### 11((b)) — 6 marks — command: multiple — structured — from paper 2013 June · 1P
Opals and diamonds are transparent stones used in jewellery.
...
![prism-3](assets/040-prism-3.png)
...
### 1((a)) — 1 mark — command: what — structured — from paper 2013 June · 1PR
The diagram shows one of two 45° prisms used in an optical instrument.

The second prism is not shown.

The path of a ray of light is partly shown.

![PNC6Y6v5_4](assets/036-pnc6y6v5-4.png)

What is the effect shown at point A?

### 1((b)) — 2 marks — command: multiple — structured — from paper 2013 June · 1PR
The ray of light exits from the second prism along the line CD.
...
### 6((a)) — 6 marks — command: multiple — structured — from paper 2016 January · 1P
The diagram below shows a ray of light as it passes from air into a glass.

The angle of incidence is 43° and the light is refracted as shown.

![block](assets/013-block.png)
...
### 6((b)) — 4 marks — command: multiple — structured — from paper 2016 January · 1P
The diagram shows how light can travel in a glass fibre.

![optic](assets/016-optic.png)
...
### 2((a)) — 3 marks — command: add — structured — from paper 2014 January · 1P
...
![ghost](assets/005-ghost.png)

Add a ray diagram to show how light from the actor appears to come from the image.

### 2((b)) — 1 mark — command: state — structured — from paper 2014 January · 1P
The image formed by the glass is a virtual

State what is meant by the term **virtual image**.

### 2((c)) — 4 marks — command: multiple — structured — from paper 2014 January · 1P
...
### 2((a)) — 4 marks — command: multiple — structured — from paper 2013 January · 1P
This question is about the reflection of light.
...
### 2((b)) — 5 marks — command: multiple — structured — from paper 2013 January · 1P
Light can also reflect along optical fibres by total internal reflection.

(i) Complete the diagram to show the path of the ray of light as it enters and passes through the optical fibre.

**(2)**

![fibre](assets/034-fibre.png)
...
### 4((a)) — 1 mark — command: what — structured — from paper 2012 January · 1P
A student is investigating refraction of light.

What is refraction?

### 4((b)) — 2 marks — command: add — structured — from paper 2012 January · 1P
The diagram shows a ray of light travelling from air to glass.

![block-3](assets/021-block-3.png)

Add labels to show the angle of incidence, *i* and the angle of refraction, *r*.

### 4((c)) — 7 marks — command: multiple — structured — from paper 2012 January · 1P
The student wants to find the refractive index of the glass.
...
![experiment](assets/023-experiment.png)
...
### 6((a)) — 8 marks — command: multiple — structured — from paper 2016 June · 2P
A student investigates refraction using a glass block.
...
![refraction-4](assets/059-refraction-4.png)

The table shows her results.

![table8](assets/060-table8.png)
...
![graph6](assets/061-graph6.png)

(iii) Use your graph to find the refractive index of the glass.

**(2)**

### 6((b)) — 2 marks — command: suggest — structured — from paper 2016 June · 2P
Suggest two reasons why using a graph to find the refractive index is a better method than simply calculating it using a pair of angles from the table.

## Q14 — medium — 11 marks · exam-questions

### 5((a)) — 4 marks — command: draw — structured — from paper 2016 June · 2P
...
![refraction-5](assets/071-refraction-5.png)
...
### 5((b)) — 4 marks — command: multiple — structured — from paper 2016 June · 2P
The student measures values for the angle of incidence (*i*) and the angle of refraction (*r*).

![table9](assets/073-table9.png)
...
### 5((c)) — 3 marks — command: how — structured — from paper 2016 June · 2P
How should the student continue the investigation to obtain a more accurate value for the refractive index of glass?

## Q15 — medium — 9 marks · exam-questions

### 6((a)) — 6 marks — command: multiple — structured — from paper 2014 January · 2P
A student wants to find the refractive index of a glass block.
...
### 6((b)) — 3 marks — command: multiple — structured — from paper 2014 January · 2P
The diagram shows a section through a bicycle reflector.

A ray of light is incident on the flat surface of the reflector.

![reflector](assets/019-reflector.png)
...
The diagram shows a beam of light from a laser passing through air and reaching the surface of a glass block at an angle.

![A glass block in air. A light ray hits the glass-air boundary from above, but at an angle such that the incident ray points diagonally down and right.](assets/001-a-glass-block-in-air-a-light-ray-hits-the-glass-.png)
...
A student measured the angle of incidence as 46° and the angle of refraction as 28°.

Calculate the refractive index of the glass.

### 3() — 2 marks — command: describe — structured
Describe what would happen to the incident ray in (a) if the glass block were replaced with a plane mirror.

## Q17 — hard — 1 marks · exam-questions

### 12((b)) — 1 mark — multiple_choice — from paper 2015 June · 1P
The diagram shows a ray of light entering a glass block and travelling towards point **O**.

![tir](assets/025-tir.png)
...
![refraction-2](assets/042-refraction-2.png)

### 7((b)) — 3 marks — command: complete — structured — from paper 2016 June · 1PR
Jewellers cut jewels so that total internal reflection is more likely.
...
![jewel](assets/044-jewel.png)

Complete the path of the light through the jewel.

### 7((c)) — 5 marks — command: multiple — structured — from paper 2016 June · 1PR
...
### 7((d)) — 4 marks — command: multiple — structured — from paper 2016 June · 1PR
The graph shows how critical angle varies with refractive index.

![graph-2](assets/046-graph-2.png)
...
### 7((a)) — 3 marks — command: list — structured — from paper 2016 June · 1PR
A student uses a semicircular glass block to investigate refraction in glass.

List three other pieces of equipment that he needs for this investigation.

### 7((b)) — 5 marks — command: multiple — structured — from paper 2016 June · 1PR
He shines a ray of light into the block at point P, as shown.
...
### 7((c)) — 8 marks — command: multiple — structured — from paper 2016 June · 1PR
The student varies the angle of incidence and obtains this table of results.

![snell-2](assets/077-snell-2.png)

(i) Plot a graph of sin i against sin r.

**(4)**

![graph-3](assets/055-graph-3.png)
...
### 4((a)) — 9 marks — command: multiple — structured — from paper 2014 June · 1PR
A student investigates refraction of light by using a salt solution in a hollow prism.
...
![prism-2](assets/051-prism-2.png)
...
### 4((b)) — 10 marks — command: multiple — structured — from paper 2014 June · 1PR
A technician working in a soft drinks factory uses refraction of light to measure sugar concentration in drinks.
...
![refractometer](assets/054-refractometer.png)
...
### 11((b)) — 4 marks — command: explain — structured — from paper 2015 January · 1P
...
### 15((a)) — 2 marks — command: complete — structured — from paper 2015 January · 1P
In 1969, astronauts left a reflector on the surface of the Moon.

![moon](assets/065-moon.png)
...
![rays](assets/066-rays.png)

### 15((b)) — 3 marks — command: show — structured — from paper 2015 January · 1P
...
### 15((c)) — 4 marks — command: multiple — structured — from paper 2015 January · 1P
Scientists measure the time for the light to travel to the Moon and back very accurately, but the time is different every day.

The graph shows how these times change over the period of one month.

![graph5](assets/069-graph5.png)
...
### 7((a)) — 3 marks — command: describe — structured — from paper 2012 January · 1P
A teacher and two students are measuring the speed of sound. The teacher makes a loud sound by hitting two cymbals together.

![sound](assets/008-sound.png)
...
### 7((b)) — 5 marks — command: multiple — structured — from paper 2012 January · 1P
The students repeat the experiment and record their readings in a table.

![results](assets/009-results.png)
...
![results2](assets/010-results2.png)

Give your answers to an appropriate number of significant figures.

**(3)**

### 7((c)) — 5 marks — command: evaluate — structured — from paper 2012 January · 1P
The students look in a data book and find that the speed of sound in air is given as 341 m/s.

The students discuss their results.

![results3](assets/012-results3.png)
