...
![7-2-sqs-q5-markscheme](assets/002-7-2-sqs-q5-markscheme.png)
...
![7-2-sqs-q5b-markscheme](assets/005-7-2-sqs-q5b-markscheme.png)
...
### 1() — 2 marks
(a) Precautions that hospital staff might take when working with radioactivity are:
...
### 2() — 2 marks
(b) Other uses of radioactivity are:
...
### 3() — 3 marks
(c) Correctly completed sentences are:
...
- Beta particles are used because they **can** pass through aluminium; **[1 mark]**

**[Total: 3 marks]**

### 4() — 2 marks
(d) Gamma is the most suitable type of radiation for sterilising medical equipment because:
...
### 3() — 1 marks
(c) State the half-life of the substance:
...
### 4() — 2 marks
(d) Define and state the unit for the activity of a radioactive sample:
...
To explain why alpha particles from radon are a greater risk to health then the alpha particles from americium:

Any **two** from:

- The range of alpha radiation is low; **[1 mark]**
- Radon (is a gas) so the particles are mobile / Americium (is solid so) particles stay in place; **[1 mark]**
- Radon can be inhaled / americium stays in the smoke detector; **[1 mark]**
...
![7-1-sqs-q4b-answer](assets/032-7-1-sqs-q4b-answer.png)
...
![7-1-sqs-q4b-answer-diagram-part-iii](assets/033-7-1-sqs-q4b-answer-diagram-part-iii.png)
...
![0_70396Y_7-2-sq-8b-question-markscheme-diagram-1](assets/021-0-70396y-7-2-sq-8b-question-markscheme-diagram-1.png)
...
![correction](assets/022-correction.png)
...
### 6((c)) — 3 marks
(c) The isotope technitium-99 is suitable for use as a tracer because:
...
### 7((a)) — 2 marks
(a) A correctly completed equation would look like:

![7-2-sqs-q9a-markscheme](assets/029-7-2-sqs-q9a-markscheme.png)
...
![The same activity against time decay curve with construction lines added in green. A horizontal green line runs from 1200 Bq on the vertical axis across to meet the curve, and a green vertical arrow runs from that point on the curve straight down to the time axis, meeting it at about 56 s.](assets/014-the-same-activity-against-time-decay-curve-with-.png)
...
![7-1-q11-b-answer](assets/017-7-1-q11-b-answer.png)
...
- Idea that I-131 has a short half-life; **[1 mark]**
...
![The same activity against time graph with the read-off construction drawn on in green. A horizontal line runs from 600 counts per minute on the vertical axis across to the point where it meets the curve, and a vertical arrow then drops from that point on the curve down to the horizontal axis at about 13.5 years.](assets/024-the-same-activity-against-time-graph-with-the-re.png)
...
Explain why isotopes which emit alpha particles and beta particles are not suitable for this use:
...
![WW~3Wsnw_7-2-sqs-q1a-markscheme](assets/026-ww-3wsnw-7-2-sqs-q1a-markscheme.png)
...
![7-2-sq-7b-markscheme](assets/011-7-2-sq-7b-markscheme.png)
...
(iv) To find the half-life of the radioactive source:

Draw on the graph to find the time for the count rate to reduce by half; **[1 mark]**

![7-2-sq-7b-markscheme-diagram-2](assets/012-7-2-sq-7b-markscheme-diagram-2.png)
