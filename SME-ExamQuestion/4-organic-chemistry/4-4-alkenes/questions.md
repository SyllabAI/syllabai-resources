...
> Source: [https://www.savemyexams.com/igcse/chemistry/edexcel/19/topic-questions/4-organic-chemistry/4-4-alkenes/exam-questions/](https://www.savemyexams.com/igcse/chemistry/edexcel/19/topic-questions/4-organic-chemistry/4-4-alkenes/exam-questions/) · 16 questions · total 128 marks
...
![Chemical reaction diagram of propene polymerisation. Propene structure on left with "n", arrow to polymer structure with repeating carbon chain on right.](assets/001-chemical-reaction-diagram-of-propene-polymerisat.png)
...
![Section of the poly(chloroethene) polymer chain, showing two carbon atoms linked with hydrogen atoms and one chlorine atom attached.](assets/003-section-of-the-poly-chloroethene-polymer-chain-s.png)
...
Complete the table by giving the missing information about the alkene with the molecular formula C<sub>3</sub>H<sub>6</sub>

| ** Molecular formula** | C<sub>3</sub>H<sub>6</sub> |
|---|---|
| ** Name** |   |
| ** Empirical formula** |   |
| ** General formula** |   |
...
When the alkane methane reacts with chlorine, the products are chloromethane (CH<sub>3</sub>Cl) and hydrogen chloride gas.
...
When ethane reacts with chlorine, one of the products of the reaction has the formula C<sub>2</sub>H<sub>4</sub>Cl<sub>2</sub> There are two isomers with this formula.

i) State what is meant by the term isomers.

(2)

ii) Draw the displayed formulae of the two isomers with the formula C<sub>2</sub>H<sub>4</sub>Cl<sub>2</sub>
...
![aqa-gcse-7-1e-tq4a-alkane-alkene](assets/008-aqa-gcse-7-1e-tq4a-alkane-alkene.png)
...
![screen-shot-2023-01-25-at-08-34-52](assets/009-screen-shot-2023-01-25-at-08-34-52.png)

### 4 — 1 mark — command: what — structured
...
### 5 — 1 mark — command: which — structured
...
- **A.** C<sub>2</sub>H<sub>2</sub>Br<sub>2</sub>
- **B.** C<sub>2</sub>H<sub>4</sub>Br<sub>2</sub>
- **C.** C<sub>2</sub>H<sub>6</sub>Br<sub>2</sub>
- **D.** C<sub>2</sub>H<sub>5</sub>Br
...
![ethene-q-image](assets/013-ethene-q-image.png)
...
CH<sub>2</sub>CH<sub>2</sub> (g) + H<sub>2</sub>O (g) → CH<sub>3</sub>CH<sub>2</sub>OH (l)
...
![screen-shot-2022-10-17-at-08-00-03](assets/014-screen-shot-2022-10-17-at-08-00-03.png)
...
![screen-shot-2022-10-17-at-08-04-52](assets/015-screen-shot-2022-10-17-at-08-04-52.png)
...
2C<sub>4</sub>H<sub>6</sub> + 11O<sub>2</sub> → 8CO<sub>2</sub> + 6H<sub>2</sub>O
...
![screen-shot-2022-10-17-at-08-22-08](assets/017-screen-shot-2022-10-17-at-08-22-08.png)
...
![4-4-q4-edexcel-igcse-chemistry](assets/019-4-4-q4-edexcel-igcse-chemistry.png)
...
![4-4-3a-h-isomers-c5h10](assets/020-4-4-3a-h-isomers-c5h10.png)
...
For example, propene, CH<sub>3</sub> –CH=CH<sub>2</sub>, would produce ethanoic acid, CH<sub>3</sub> –COOH, and methanoic acid, H–COOH. Deduce the formulae of the alkenes which would produce the following carboxylic acids when oxidised.
...
![4-4-3d-h-cyanoethene](assets/021-4-4-3d-h-cyanoethene.png)

## Q9 — easy — 1 marks

### 10 — 1 mark — multiple_choice
Which of the following molecules is an alkene?
- **A.** C<sub>6</sub>H<sub>10</sub>
- **B.** C<sub>4</sub>H<sub>10</sub>
- **C.** C<sub>5</sub>H<sub>10</sub>
...
- **B.** C<sub>9</sub>H<sub>20</sub>
- **C.** C<sub>6</sub>H<sub>16</sub>
...
Calculate the relative formula mass (*M*<sub>r</sub>) of ocimene.
...
![ocimene](assets/023-ocimene.png)
...
ii) Many alkenes have the general formula C<sub>n</sub>H<sub>2n</sub>
...
![organic-compounds-table](assets/024-organic-compounds-table.png)

i) Give the letter of a compound not shown as a displayed formula.

(1)

ii) Give the letter of a saturated compound with the general formula C<sub>n</sub>H<sub>2n</sub>
...
Show by calculation that the empirical formula of compound G is C<sub>2</sub>H<sub>4</sub>Cl

(3)

ii) The relative formula mass (*M*<sub>r</sub>) of G is 127
...
![polymerisation-of-compound-e](assets/025-polymerisation-of-compound-e.png)
...
| C<sub>10</sub>H<sub>22</sub><br><br>decane | → | ................ | + | ................. |
|---|---|---|---|---|
...
![4-4-5b-h-isomers-c4h8](assets/028-4-4-5b-h-isomers-c4h8.png)
...
### 15 — 8 marks — command: compare — structured
The structures of an alkane and an alkene are shown below.

![aqa-gcse-7-2h-tq5b-propene-and-propane](assets/029-aqa-gcse-7-2h-tq5b-propene-and-propane.png)
...
### 15 — 2 marks — command: write — structured
...
CH<sub>3</sub>–CH=CH<sub>2</sub> + Br<sub>2</sub> → ....................................
...
moles of alkene : moles of O<sub>2</sub> : moles of CO<sub>2</sub>
...
![kiqUd87q_hydrocarbons](assets/031-kiqud87q-hydrocarbons.png)
