...
> Source: [https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-1/topic-questions/structure-and-functions-in-living-organisms-part-1/movement-of-substances-into-and-out-of-cells/exam-questions/](https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-1/topic-questions/structure-and-functions-in-living-organisms-part-1/movement-of-substances-into-and-out-of-cells/exam-questions/) · 15 questions · total 136 marks
...
![diffusion-1](assets/027-diffusion-1.png)
...
![osmosis-1](assets/025-osmosis-1.png)
...
![adapted-for-diffusion-1](assets/021-adapted-for-diffusion-1.png)
...
![osmosis-in-plant-cells-1](assets/022-osmosis-in-plant-cells-1.png)
...
![potatos-and-sucrose-1](assets/024-potatos-and-sucrose-1.png)
...
Complete the table to place the steps in the correct order by adding numbers** 2** to **5** into the left hand column of the table. The first stage has been labelled for you.
...
![osmosis-and-salt-1](assets/020-osmosis-and-salt-1.png)

Identify the salt solution where the mass of the chip increases after one hour.
...
The scientist concluded that the best solution for storing chips in would be 0.5 mol dm<sup>-3</sup> salt solution because there would be no net (overall) movement of water into or out of the potato chips.
...
3. Five beakers were set up; four with 200 cm<sup>3</sup> of a salt solution of a particular concentration and one with water (0.0 mol dm<sup>-3</sup>).
...
| **Concentration of salt solution (mol dm**<sup>**-3**</sup>**)** | **Mass of egg without shell in grams** | **Mass of egg after 1 hour in solution in grams** |
|---|---|---|
| 0.0 | 74.5 | 79.2 |
| 0.2 | 73.0 | 75.8 |
| 0.4 | 74.2 | 75.5 |
...
Calculate the percentage change of the egg placed in the 0.4 mol dm<sup>-3</sup> salt solution.
...
![IEd2VoOi_1](assets/018-ied2vooi-1.png)
...
![dI5lPy6L_3](assets/017-di5lpy6l-3.png)
...
![tLUz2D1F_cubes-of-jelly-sq](assets/014-tluz2d1f-cubes-of-jelly-sq.png)

Complete the table by calculating the missing numbers showing the dimensions of the three cubes.

| **Length of one side of the cube (cm)** | **Surface area of cube (cm**<sup>**2**</sup>**)** | **Volume of cube (cm**<sup>**3**</sup>**)** | **Surface area : Volume Ratio** |
|---|---|---|---|
| 1 | 6 | 1 | 6:1 |
| 2 | 24 |   |   |
| 3 |   | 27 | 2:1 |
...
![VSVr_nne_diffusion-experiment-with-labels-sq](assets/016-vsvr-nne-diffusion-experiment-with-labels-sq.png)
...
(iii) Explain how the student could improve their experiment to increase the reliability of the conclusion.
...
![VxF4C6HN_ciliated-epithelial-cell-sq](assets/013-vxf4c6hn-ciliated-epithelial-cell-sq.png)
...
### 4() — 4 marks — command: describe — structured
Describe the similarities and differences between active transport and osmosis.
...
- Place 1 cm<sup>3</sup> of the diluted blood into each of three test tubes labelled A, B and C
- Add 10 cm<sup>3</sup> of water to tube A
- Add 10 cm<sup>3</sup> of 1 % sodium chloride solution to tube B
- Add 10 cm<sup>3</sup> of 5 % sodium chloride solution to tube C
...
![bT37XAbR_untitled-6](assets/011-bt37xabr-untitled-6.png)
...
![screenshot-2022-10-26-15-16-59](assets/012-screenshot-2022-10-26-15-16-59.png)
...
Explain which of the sugars in the table are absorbed by active transport.
...
Explain whether this statement is correct or incorrect.
...
![osmosis-and-partially-permeable-membraneosmosis-and-partially-permeable-membrane-2](assets/006-osmosis-and-partially-permeable-membraneosmosis-.png)
...
![osmosis-and-potatos-1](assets/008-osmosis-and-potatos-1.png)
...
![7vNW9Erc_h-3a](assets/004-7vnw9erc-h-3a.png)
...
![monoglycerides-1](assets/005-monoglycerides-1.png)
...
1. Add 20 cm<sup>3 </sup>of distilled water to a boiling tube.
2. Repeat step **1** with equal volumes of 0.2, 0.4, 0.6 and 0.8 mol dm<sup>−3</sup> sugar solutions.
...
| **Concentration of sugar solution in mol dm**<sup>**−3**</sup> | **Starting mass in g** | **Final mass in g** | **Change of mass in g** | **Percentage (%) change** |
|---|---|---|---|---|
...
(i) Calculate the missing value of % change in mass for the 0.6 mol dm<sup>-3 </sup>sugar solution.
...
Give your answer in mol dm<sup>-3</sup>.
