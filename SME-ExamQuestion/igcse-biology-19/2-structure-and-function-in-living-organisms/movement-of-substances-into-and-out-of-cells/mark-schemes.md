...
![diffusion-ma-sq](assets/010-diffusion-ma-sq.png)
...
![osmosis-ma-sq](assets/008-osmosis-ma-sq.png)
...
![plant-cell-osmosis-ma-sq](assets/003-plant-cell-osmosis-ma-sq.png)
...
- 0 mol dm<sup>-3</sup> / distilled water; **[1 mark]**
...
- The mass (of the chip in 0.5 mol dm<sup>-3</sup> salt solution) remained the same after 1 hour; **[1 mark]**
...
### 1() — 2 marks
The percentage change of the egg placed in the 0.4 mol dm<sup>-3</sup> salt solution is:
...
![osmosis-potato-percentage-change-ma](assets/022-osmosis-potato-percentage-change-ma.png)

### 2() — 2 marks
The mass of the eggs in some solutions decreased because:

- Water moved out of the egg by <u>osmosis</u>;** [1 mark]**
- The surrounding solution had a higher solute concentration than the contents of the egg **OR** the contents of the egg were more dilute than the surroundings **OR** the contents of the egg had a higher water concentration than the surroundings; **[1 mark]**

Accept reverse statements for marking point 2, e.g. "the contents of the egg had a lower solute concentration than the surroundings"
...
![sa-vol-calculations-ma](assets/025-sa-vol-calculations-ma.png)

### 4() — 4 marks
(i) An explanation of the results of the experiment is...

- As the surface area : volume ratio decreases, it takes longer for the diffusion to occur / the cube to turn colourless;** [1 mark]**
...
- Volume of (diluted) blood/solution (this is always 1 cm<sup>3</sup>); **[1 mark]**
...
![osmosis-beaker-ma-sq](assets/012-osmosis-beaker-ma-sq.png)
...
![-increase-in-mass-ma-sq](assets/014-increase-in-mass-ma-sq.png)
...
![temperature-and-osmosis-ma-sq](assets/015-temperature-and-osmosis-ma-sq.png)
...
### 1() — 3 marks
(i) The % change in mass for the 0.6 mol dm<sup>-3</sup> sugar solution is...
...
![percentage-change-in-mass-of-potato-osmosis-ma](assets/018-percentage-change-in-mass-of-potato-osmosis-ma.png)
...
- Axes 2: with units; X = mol dm<sup>-3</sup> and Y = %; **[1 mark]**
- Points: plotted correctly; **[1 mark]**

![osmosis-potato-experiment-graph-ma](assets/019-osmosis-potato-experiment-graph-ma.png)
...
![osmosis-potato-experiment-graph-ma-2](assets/020-osmosis-potato-experiment-graph-ma-2.png)
