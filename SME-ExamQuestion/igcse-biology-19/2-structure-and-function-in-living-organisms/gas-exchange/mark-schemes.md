...
> *Be careful with questions that ask you to identify **visible** features**. There are other characteristics of the alveoli and breathing system which aid gas exchange, e.g. **many alveoli together** increase the surface area, but we can only see a single alveolus in the image so no credit can be awarded.*
...
![alveolus-ma-sq](assets/012-alveolus-ma-sq.png)
...
- 4.2 (m<sup>2</sup>) × 20 **OR** 4.2 (m<sup>2</sup>) ÷ <sup>1</sup>/<sub>20</sub> ; **[1 mark]**
- 84 m<sup>2</sup>; **[1 mark]**

**[Total: 2 marks]**

![11-1-q1de---ma](assets/013-11-1-q1de-ma.png)

> *This equates to the often-quoted statistic that the adult lungs' surface area is about half the size of a tennis court; a singles tennis court is about 196 m*<sup>*2*</sup>* in area. *
...
![img-1222](assets/016-img-1222.jpg)
...
*Allow 1 mark if it is stated that the limewater goes cloudy in both flasks (due to the presence of CO*<sub>*2*</sub>*).*

*Ignore reference to no CO*<sub>*2*</sub>* in inhaled air.*
...
### 1() — 6 marks
Participants of different ages should be used, such as children, teenagers and adults. Several people should be included in each age group to calculate a mean recovery time. The resting heart rate of each participant should be measured before exercise (by measuring pulse for 1 minute). Each participant should complete the same exercise, such as running on the spot, for the same period of time. After completing the exercise, the heart rate should be measured every minute until it returns to the resting rate. The time taken for heart rate to return to resting can be calculated.

> **[mark-scheme]**
> One mark available for each of the following:
> 
> - **C** – Change (the independent variable): use individuals of different ages / divide participants into different age groups **[1 mark]**
> - **R** – Repeat: with several participants in each age group and calculate a mean recovery time **[1 mark]**
> - **M1** – Measure (the dependent variable): the resting heart rate before exercise and after completing exercise until it returns to resting rate (for each individual) **[1 mark]**
> - **M2** – Calculate the time taken for heart rate to return to resting rate (in minutes) **[1 mark]**
> - **S1** – Same (the control variables): the exercise is the same for everyone, e.g. running on the spot **[1 mark]**
> - **S2** – The duration of the exercise (e.g. 2 minutes) **[1 mark]**
> 
> Other acceptable control variables (1 mark each, in place of S1 or S2):
> 
> - Participants rested before starting
> - Similar fitness levels
> - Same environmental conditions
> - Same method of measuring heart rate (pulse count / heart rate monitor)
> 
> Note that the **O** mark (for organism) isn’t relevant in this question.

> **[exam-tip]**
> This is a classic 6 mark Edexcel IGCSE CORMMSS question:
> 
> - **C**: what you will change (the independent variable)
> - **O**: what organism is being used (not relevant here as context is exercise in humans)
> - **R**: repeats to calculate a mean
> - **M**: measure 1  - what you will measure (the dependent variable)
> - **M**: measure 2 - more detail about what you will measure
> - **S**: same 1 - what you will keep the same (control variables)
> - **S**: same 2 - a second factor you will keep the same
> 
> Structure your answer around the headings to ensure you cover all the marking points.
...
![ma-for-jan-22-1b-q4a](assets/006-ma-for-jan-22-1b-q4a.png)
...
![4bi1br-nov-2020-q8a-e-cigs---ma](assets/004-4bi1br-nov-2020-q8a-e-cigs-ma.png)
...
![4bi1br-nov-2020-q8c-e-cigs---ma](assets/005-4bi1br-nov-2020-q8c-e-cigs-ma.png)
...
![untitled-19](assets/008-untitled-19.png)

> *A stacked bar chart would be as follows...*

![stacked-bar-chart-q9ai](assets/009-stacked-bar-chart-q9ai.png)
...
![calculation-for-9aii](assets/010-calculation-for-9aii.png)
