...
> Source: [https://www.savemyexams.com/igcse/biology/edexcel/19/topic-questions/2-structure-and-function-in-living-organisms/excretion/exam-questions/](https://www.savemyexams.com/igcse/biology/edexcel/19/topic-questions/2-structure-and-function-in-living-organisms/excretion/exam-questions/) · 13 questions · total 108 marks
...
![human-3](assets/013-human-3.png)
...
![q8B9tmM5_glands](assets/005-q8b9tmm5-glands.png)
...
![xEHxvlx__image-2](assets/004-xehxvlx-image-2.png)
...
![screenshot-2022-10-24-15-42-18](assets/011-screenshot-2022-10-24-15-42-18.png)

The table gives the concentration of glucose and urea at X, Y and Z.

| **Area of nephron** | **Concentration of glucose in mg per 100 cm**<sup>**3**</sup> | **Concentration of urea in mg per 100 cm**<sup>**3**</sup> |
|---|---|---|
| X | 90 | 32 |
| Y | 0 | 440 |
| Z | 0 | 1700 |
...
![jan2021p2bq2a](assets/006-jan2021p2bq2a.png)
...
- Drink 600 cm<sup>3</sup> of water in the morning
- Measure the volume of urine produced during the next two hours
- Drink 600 cm<sup>3</sup> of 0.8 % salt (NaCl) solution at the same time the following morning
- Measure the volume of urine produced during the next two hours

The table shows the scientist’s results.

| **Liquid** | **Volume of urine produced during two hours in cm**<sup>**3**</sup> |
|---|---|
| Water | 560 |
| Salt solution | 254 |
...
![edexcel-igcse-2b-nov-21-q3a](assets/009-edexcel-igcse-2b-nov-21-q3a.png)
...
### 2((a)) — 3 marks — command: which — structured — from paper Jan 2022 · 4BI1/2BR
#### Separate: Biology Only

The diagram shows a nephron from a human kidney.

![screenshot-2022-10-26-11-41-22](assets/002-screenshot-2022-10-26-11-41-22.png)
...
![23e5DFwJ_p2bq6a](assets/008-23e5dfwj-p2bq6a.png)
...
The maximum concentration that the human kidneys can produce is 1400 milliosmoles per dm<sup>3</sup>.
...
The kidneys carry out two main functions to help maintain the body’s internal environment. One function is excretion.

Identify the other function.
...
![Diagram of the nephron’s structure with labelled parts: P (glomerulus), Q (Bowman’s capsule), R (loop of Henle), S (distal tubule), T (collecting duct), U (ureter).](assets/001-diagram-of-the-nephron-s-structure-with-labelled.png)

(i) Which row of the table is correct?

|   | Glomerulus | Where selective reabsorption takes place | Where most water is reabsorbed |
|---|---|---|---|
| **A** | P | Q | R |
| **B** | Q | S | R |
| **C** | P | R | U |
...
(ii) Blood entering structure P is under high pressure.

Describe what happens at structure P in the nephron.

## Q13 — hard — 5 marks · exam-questions

### 1() — 5 marks — command: multiple — structured
Two patients had their urine tested.

The relative concentration of four substances was analysed. The results are in the table below.

The results for the concentration of glucose are missing.

|   | Concentration in urine (g per 100 cm<sup>3</sup>) |   |
|---|---|---|
| Patient 1 | Patient 2 |   |
| Urea | 1.70 | 1.90 |
| Protein | 0.50 | 0.00 |
...
The table shows the results of the Benedict’s test on urine from both patients.

|   | Result from Benedict’s test |
|---|---|
| Patient 1 | blue |
| Patient 2 | orange |

(i) Suggest a value for patient 1’s glucose.

(ii) Describe the health of the two patients. Use information from both tables in your answer.
