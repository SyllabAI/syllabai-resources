...
![chloroplast-magnification-calculation-sq](assets/024-chloroplast-magnification-calculation-sq.png)
...
- X = cell membrane / cell surface membrane; **[1 mark]**
- Y = vacuole / permanent vacuole; **[1 mark]**
- Z = nucleus; **[1 mark]**
...
![Specialised cells SQ MA](assets/020-specialised-cells-sq-ma.png)
...
### 1() — 2 marks
The actual diameter of the cell can be calculated as follows:

- Use the ruler to determine the diameter of the cell in the image

  - **5.3** cm
- Convert the value in cm into mm

  - There are 10 mm per cm

5.3 x 10 = **53** mm

- Use formula:

actual diameter = 53 ÷ 6000
...
> - 0.009 (mm); **[1 mark]**
> 
> Accept 0.0088 or 0.00883
> 
> Award full marks for the correct answer with no additional calculations
...
### 1() — 2 marks
To calculate the magnification, use the equation:

$\text{magnification} = \frac{\text{image size}}{\text{actual size}}$

First, convert the measured image length into $μ \text{m}$:

$1 μ \text{m} = 0 . 001 \text{mm}$

$45 \text{mm} \times 1000 = 45 , 000 μ \text{m}$ **[1 mark]**
...
> **[mark-scheme]**
> 1 mark for correctly converting the image size into $μ \text{m}$ (or converting the actual size into mm)
> 
> 1 mark for the correct final answer of $30 , 000$ (no units)
> 
> Alternative route: converting $1 . 5 μ \text{m}$ into mm gives $0 . 0015 \text{mm}$, then $M = 45 \div 0 . 0015 = 30 , 000$
> 
> If the image length measured by the student differs from 45 mm, award marks for correct working using their measured value (error carried forward)

> **[exam-tip]**
> Make sure you convert both measurements to the same unit before dividing — this is where most students lose marks. It does not matter whether you convert both to mm or both to µm, as long as they match.
> 
> Remember that magnification has no units. If your final answer includes a unit, you have made an error somewhere.
> 
> A useful check: if the image is bigger than the actual object, the magnification should be greater than 1.
...
![051aa3f3-1676-4f2a-a88e-8492eccff7fc_1_201_a](assets/011-051aa3f3-1676-4f2a-a88e-8492eccff7fc-1-201-a.jpeg)
...
![untitled-15](assets/008-untitled-15.png)
...
![untitled-4](assets/005-untitled-4.png)
...
![untitled](assets/028-untitled.png)

### 3() — 4 marks
(i) **The correct answer is ****A ****because...**

The table tells us that there are 5 000 mitochondria in a typical heart muscle cell, the volume of which is 15 000 µm<sup>3</sup>. To calculate the number of mitochondria per µm<sup>3</sup>, we divide 5 000 by 15 000 µm<sup>3</sup>, which gives an answer of 0.33 mitochondria per µm<sup>3</sup>.

**B** is incorrect because the division has been performed the wrong way around.

**C** and **D** are also mathematically incorrect.

![4bi1b-nov-2020-q3c-mitoch-per-cell-calc---ma](assets/029-4bi1b-nov-2020-q3c-mitoch-per-cell-calc-ma.png)
...
- The sperm has more mitochondria per unit volume / per μm<sup>3</sup>; **[1 mark]**
...
- 65 000 ÷ 7 500/7.5 x 10<sup>3</sup>; **[1 mark]**
- 8.7/8.67 (μm); **[1 mark]**
...
![RBLA_n9Z_untitled-9](assets/022-rbla-n9z-untitled-9.png)
...
![untitled-10](assets/014-untitled-10.png)
...
![untitled-13](assets/032-untitled-13.png)
