...
> Source: [https://www.savemyexams.com/igcse/biology/edexcel/19/topic-questions/4-ecology-and-the-environment/human-influences-on-the-environment/exam-questions/](https://www.savemyexams.com/igcse/biology/edexcel/19/topic-questions/4-ecology-and-the-environment/human-influences-on-the-environment/exam-questions/) · 16 questions · total 124 marks
...
![pollution-q-1](assets/010-pollution-q-1.png)
...
State **two **reasons why deforestation is contributing to an increase in atmospheric CO<sub>2</sub> levels.
...
State and explain the action that carbon dioxide (CO<sub>2</sub>) and methane (CH<sub>4</sub>) both have on the atmosphere that causes them to be greenhouses gases.

### 4() — 1 mark — command: name — structured
Other than CO<sub>2</sub> and CH<sub>4</sub>, name **one **other greenhouse gas.
...
![4bi1br-nov-2020-q10b-fertiliser---sq](assets/007-4bi1br-nov-2020-q10b-fertiliser-sq.png)
...
Data from the United Nations suggests that globally, we are losing 88 000 km<sup>2</sup> of natural forest every year to timber and paper production, and to clearance of land for crops and livestock grazing.

A football pitch has an area of 7 140 m<sup>2</sup>.
...
![greenhouse-gas-emission-graph-europe-and-china-sqgreenhouse-gas-emission-graph-europe-and-china-sq](assets/006-greenhouse-gas-emission-graph-europe-and-china-s.png)
...
![ecuador-deforestation-1](assets/001-ecuador-deforestation-1.png)
...
Cutting down trees, known as deforestation, causes an increase in the level of carbon dioxide (CO<sub>2</sub>) in the atmosphere.

Give **two **reasons why deforestation causes an increase in atmospheric CO<sub>2</sub>.
...
The table below gives data about how the carbon dioxide (CO<sub>2</sub>) concentration of the earth's atmosphere has changed over time.

| **Year** | **CO**<sub>**2**</sub>** concentration in parts per million** |
|---|---|
| 1800 | 282 |
| 1900 | 295 |
| 1950 | 310 |
...
![blank-graph-paper-7x8-big-squares](assets/002-blank-graph-paper-7x8-big-squares.png)
...
In 2022 a climate activist claimed that, to arrest global warming, the atmospheric CO<sub>2</sub> level should be brought back to the level of the year 1900.

Using the data from the table in part (a), calculate the percentage decrease that the climate activist claims would be needed to return the atmospheric CO<sub>2</sub> level to its 1900 level.

## Q13 — hard — 10 marks · exam-questions

### 1() — 2 marks — command: explain — structured
When fossil fuels are burned sulfur dioxide gas (SO<sub>2</sub>) can also be released into the atmosphere.
...
Ca(OH)<sub>2(s)</sub> + SO<sub>2(g)</sub> → CaSO<sub>3(s)</sub> + H<sub>2</sub>O<sub>(l)</sub>
...
| Generates CO<sub>2</sub> and methane as organic waste decays | Generates a lot of CO<sub>2</sub> |
...
### 1() — 8 marks — command: multiple — structured
A scientist investigates how increasing nitrate concentration affects algal growth and oxygen levels in pond water.

This is the scientist’s method:

- Prepare four tanks, each containing 10 dm³ of pond water that contains microorganisms
- Add nitrate solution to give concentrations of 0, 10, 20 and 40 mg per dm³
- Add the same volume of algae culture to each tank
- Measure algal biomass (as dry mass) and dissolved oxygen concentration after 20 days

The results after 20 days are shown in the table.

| Nitrate concentration (mg per dm³) | Algal biomass (g) | Dissolved oxygen (mg per dm³) |
|---|---|---|
| 0 | 2.0 | 8.2 |
| 10 | 3.8 | 7.0 |
| 20 | 6.5 | 4.6 |
...
The average dissolved oxygen concentration at day 0 in all four tanks was 8.3 mg per dm³.

(i) Describe and explain the relationship between nitrate concentration and dissolved oxygen concentration after 20 days.

(ii) Suggest why, after 20 days, the algal biomass in the tank with a nitrate concentration of 20 mg per dm³ is higher than in the tank with a nitrate concentration of 40 mg per dm³

## Q15 — hard — 2 marks · exam-questions

### 1() — 2 marks — command: explain — structured
Deforestation can increase the amount of nitrate ions entering rivers.
...
### 1() — 2 marks — command: explain — structured
Farmers use fertilisers containing nitrate ions to increase crop yield.

Heavy rainfall can cause nitrate ions to leach into rivers and lakes.
