...
> Source: [https://www.savemyexams.com/igcse/biology/edexcel/19/topic-questions/5-use-of-biological-resources/genetic-modification-genetic-engineering/exam-questions/](https://www.savemyexams.com/igcse/biology/edexcel/19/topic-questions/5-use-of-biological-resources/genetic-modification-genetic-engineering/exam-questions/) · 11 questions · total 107 marks


## Q1 — easy — 7 marks · exam-questions

### 2((a)) — 1 mark — command: identify — structured — from paper Nov 2020 · 4BI1/1BR
Bacteria are genetically modified to make human proteins.

Identify which part of a bacterium is used in genetic modification
...
(i) Give the meaning the term **vector** when used in the context of genetic engineering.
...
Give the meaning of the term **transgenic**.
...
![KAEBbcVO_graph](assets/006-kaebbcvo-graph.png)
...
![~kBTm4Cw_e-3a](assets/009-kbtm4cw-e-3a.png)
...
Drought-resistant maize plants can be produced using genetic modification (genetic engineering).

They are modified using a bacterium called *Agrobacterium*.

This bacterium has a plasmid that contains recombinant DNA.

Describe how scientists would produce a recombinant plasmid containing the drought-resistance gene.

## Q9 — hard — 14 marks · exam-questions
...
![producing-hep-b-vaccine--1](assets/001-producing-hep-b-vaccine-1.png)
...
### 4() — 7 marks — command: multiple — structured
...
![Types of vaccine hepatitits B GM yeast graph SQ](assets/002-types-of-vaccine-hepatitits-b-gm-yeast-graph-sq.png)
...
## Q11 — hard — 19 marks · exam-questions
...
![soybean-meal](assets/004-soybean-meal.png)
