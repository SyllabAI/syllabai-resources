...
**1. The Nature & Variety of Living Organisms** · Edexcel IGCSE Biology (4BI1)
> Source: [https://www.savemyexams.com/igcse/biology/edexcel/19/topic-questions/1-the-nature-and-variety-of-living-organisms/characteristics-of-living-organisms/exam-questions/](https://www.savemyexams.com/igcse/biology/edexcel/19/topic-questions/1-the-nature-and-variety-of-living-organisms/characteristics-of-living-organisms/exam-questions/) · 17 questions · total 153 marks
...
![mrs-c-gren-sq](assets/015-mrs-c-gren-sq.png)
...
One example of a virus pathogen is tobacco mosaic virus (TMV), which prevents the development of chloroplasts in the leaves of plants.
...
### 2() — 4 marks — command: name — structured
All living organisms carry out excretion, including plants.

(i) Name two examples of excretory waste produced by plants.
...
![yeast-sq](assets/020-yeast-sq.png)
...
![Fungi Mycelium SQ](assets/021-fungi-mycelium-sq.png)
...
One difference between plant and fungal cells is that plant cells contain chloroplasts and gain their nutrition through the process of photosynthesis, while fungal cells do not.

Describe how fungi gain their nutrients.
...
(i) Which of the following features are present in a typical *S. aureus *cell?
...
| D | absent | absent | present |

(ii) *S. aureus* can cause infections if it enters the body through a cut in the skin or during a medical procedure.

Which of the following terms is the definition for a microorganism that causes disease?
...
Describe the different types of pathogen. Refer to a disease that each type of pathogen causes in your answer.

## Q8 — medium — 10 marks · exam-questions

### 1() — 6 marks — command: describe — structured
Describe the similarities and differences between the structure of a plant cell and the structure of a bacterial cell.
...
![bacteria-magnification-sq](assets/010-bacteria-magnification-sq.png)
...
![amoeba-sq-1](assets/022-amoeba-sq-1.png)
...
(i) Describe the differences of this process in comparison with saprotrophic nutrition in fungi.

**(3)**

(ii) As well as nutrition, name other life process is being demonstrated during this process.

**(1)**

### 3() — 1 mark — command: name — structured
The *Amoeba* is found in fresh water and must control its internal conditions by balancing the amount of water that moves in and out of the cell across the cell membrane.  The *Amobea* contains a structure called a contractile vacuole, which expels excess water from the cell. As well as excess water, they also remove waste materials from the cell.

Name the life processes that the contractile vacuole carries out.
...
![800px-anopheles-albimanus-mosquito](assets/013-800px-anopheles-albimanus-mosquito.jpg)

Photo Credit: James Gathany Content Providers(s): CDC, Public domain, via Wikimedia Commons

(i) State **three **features of organisms, such as this mosquito, which allow them to be identified as animals.

**(3)**

(ii) Mosquitoes can spread diseases with their bite. Explain why the mosquito is not classed as a pathogen.
...
![e7KzqgXP_plasmodium-with-labels-sq](assets/014-e7kzqgxp-plasmodium-with-labels-sq.png)

(i) State the name of the group of organisms that *Plasmodium *belongs to.
...
![virus-examples-sq](assets/008-virus-examples-sq.png)
...
State **three **other ways pathogens can spread between people.

### 3() — 3 marks — command: explain — structured
When someone is infected with HIV they can develop a condition called AIDS.
...
(i) HIV infects the white blood cells of the infected person and stops them from working.

Explain why this might cause people to be more susceptible to infections.

**(1)**

(ii) One way of preventing this from occurring is for people with HIV to take medication to prevent the viruses from replicating.
...
![aids-deaths-graph-sq-1](assets/009-aids-deaths-graph-sq-1.png)
...
Mucor is a type of fungus that grows on bread and other food sources.

(i) Which row in the table is correct for fungi?

|   | **cell wall made from** | **stores carbohydrate as** |
|---|---|---|
| **A** | chitin | starch |
...
### 1() — 2 marks — command: explain — structured
Explain how *Mucor* obtains its nutrients from bread.

## Q14 — medium — 3 marks · exam-questions

### 1() — 3 marks — command: describe — structured
A different fungus, yeast, is used in the production of bread.

Describe the role of respiration in the production of bread by yeast.
...
![plant-sensitivity-experiment-sq-1](assets/002-plant-sensitivity-experiment-sq-1.png)
...
![plant-sensitivity-experiment-results-sq-1](assets/003-plant-sensitivity-experiment-results-sq-1.png)
...
![graph-paper](assets/004-graph-paper.png)
...
![starch-and-glycogen-sq-1](assets/018-starch-and-glycogen-sq-1.png)

(i) Using the information provided in the diagram, describe the similarities and differences between the structure of starch and glycogen.
...
Using the data in the table, calculate which carbohydrate molecule (starch or glycogen) will take the **least **amount of time to be fully hydrolysed.

### 4() — 3 marks — command: multiple — structured
Another type of carbohydrate that can be found in many types of cells is cellulose.

(i) State the function of cellulose in the cell.
...
![Go6smHn2_bacteria-growth-curve-sq](assets/007-go6smhn2-bacteria-growth-curve-sq.png)
