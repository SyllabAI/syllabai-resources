...
![file-000-19](assets/030-file-000-19.png)
...
- The particles which flow in the wires of a circuit are **electrons**
...
![2-1-q5b-e-incomplete-circuit-diagram-sq-igcse-ma1](assets/014-2-1-q5b-e-incomplete-circuit-diagram-sq-igcse-ma.png)

- Ammeter drawn in series with the power supply; **[1 mark]**

(ii) To vary the current in lamp B only:

![2-1-q5b-e-incomplete-circuit-diagram-sq-igcse-ma2](assets/015-2-1-q5b-e-incomplete-circuit-diagram-sq-igcse-ma.png)

- Variable resistor drawn in series with lamp B; **[1 mark]**

(iii) To measure the voltage across lamp B:

![2-1-q5b-e-incomplete-circuit-diagram-sq-igcse-ma3](assets/016-2-1-q5b-e-incomplete-circuit-diagram-sq-igcse-ma.png)
...
![NWUDHH6Z_file-000-16](assets/017-nwudhh6z-file-000-16.png)
...
![file-000-20](assets/002-file-000-20.png)
...
### 5((a)) — 1 marks
(b) The relationship between voltage, current and resistance is:
...
![file-000-26](assets/005-file-000-26.png)
...
### 1() — 3 marks
(a) The correct circuit, with an ammeter and voltmeter, is as follows:

![2-1-q5a-m-incomplete-circuit-diagram-sq-igcse-m-ma](assets/028-2-1-q5a-m-incomplete-circuit-diagram-sq-igcse-m-.png)
...
- Current,* I* = 0.8 mA = 0.8 × 10<sup>−3</sup> A
- Resistance, *R* = 5 kΩ = 5 × 10<sup>3</sup> Ω

Use the relationship between voltage, current and resistance to calculate voltage:

- *V* = *I* × *R* = (0.8 × 10<sup>−3</sup>) × (5 × 10<sup>3</sup>) **[1 mark]**
- Voltage = 4 V **[1 mark]**

**[Total: 3 marks]**

### 3() — 3 marks
(c) Determine if the voltage reading is consistent with the manufacturer's value of resistance:
...
- Total current in circuit, $I_{total}$ = 45 mA = 45 × 10<sup>−3</sup> A
...
![NS_2PzOa_13-3-6-bi-ms](assets/026-ns-2pzoa-13-3-6-bi-ms.png)
...
- An advantage of series circuits is that they have lower resistance values;**[1 mark]**
...
### 1() — 3 marks
(a) Calculate the energy transferred to an electron when it passes through a voltage of 180 kV:

List the known quantities:

- Charge of an electron, *q* = 1.6 × 10<sup>–19</sup> C
...
- *E* = (1.6 × 10<sup>–19</sup>) × 180 000 **[1 mark]**
- Energy transferred = 2.9 × 10<sup>–14</sup> J **[1 mark]**
...
- Charge of an electron, *q* = 1.6 × 10<sup>–19</sup> C
- Total charge, *Q* = 3.5 × 10<sup>–8</sup> C
- Time taken, *t* = 0.56 ms = 0.56 × 10<sup>–3</sup> s
...
- Number of electrons = 2.2 × 10<sup>11</sup> **[1 mark]**
...
- Mean current = 6.3 × 10<sup>–5</sup> [1 mark] A **[1 mark]** **OR**
...
![current-voltage-graph-lamp-resistor-mcq-sq-igcse-ma1](assets/008-current-voltage-graph-lamp-resistor-mcq-sq-igcse.png)
...
![current-voltage-graph-lamp-resistor-mcq-sq-igcse-ma2](assets/009-current-voltage-graph-lamp-resistor-mcq-sq-igcse.png)
...
![Z4uNwjHc_current-voltage-graph-lamp-resistor-mcq-sq-igcse-ma4](assets/010-z4unwjhc-current-voltage-graph-lamp-resistor-mcq.png)
...
![l9dvbunc_current-voltage-graph-lamp-resistor-mcq-sq-igcse-ma3](assets/011-l9dvbunc-current-voltage-graph-lamp-resistor-mcq.png)
...
### 4() — 2 marks
(d) Calculate the total voltage across the lamp and the resistor in series:
...
![3Fw6djly_current-voltage-graph-lamp-resistor-mcq-sq-igcse-ma5](assets/012-3fw6djly-current-voltage-graph-lamp-resistor-mcq.png)
...
### 1() — 4 marks
(a) Draw a circuit diagram showing an LED in series with a battery and a fixed resistor:

![sRgxyQ7T_file-000-40](assets/019-srgxyq7t-file-000-40.png)
...
![circuit-led](assets/020-circuit-led.png)
