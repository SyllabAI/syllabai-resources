...
![file-000---2022-10-05t125601-542](assets/062-file-000-2022-10-05t125601-542.png)
...
### 3() — 2 marks
(c) The correct advantages of series circuits are:
...
### 4() — 2 marks
(d) The correct advantages of parallel circuits are:
...
### 7((a)) — 1 marks
(a) The correct symbol for a thermistor is:

![thermistor](assets/065-thermistor.png)
...
### 2() — 3 marks
(b) The graph of resistance against light intensity for an LDR is:

![resistance-light-intensity-blank-axes-sq-igcse-ma](assets/067-resistance-light-intensity-blank-axes-sq-igcse-m.png)
...
| **S**<sub>**1**</sub>** position** | **S**<sub>**2**</sub>** position** | **Lamp lit (✓ or х)** |
|---|---|---|
| W | X | **✓** |
| W | Y | **х** |
| Z | X | **х** |
...
- Resistance of A decreases with temperature; **[1 mark]**

**   OR**

- When the temperature of A is low the resistance is high; **[1 mark]**
- The largest slope / rate of change is at a lower temperature; **[1 mark]**

**   OR**

- The smallest slope / rate of change is at a higher temperature; **[1 mark]**
- A represents a thermistor; **[1 mark]**

At least **one **and maximum** three** from:

About B:

- Resistance of B increases with temperature

**   OR **

- When the temperature of B is low the resistance is low; **[1 mark]**
- The largest slope / rate of change is at a higher temperature
...
- There are more results for A / fewer results for B; **[1 mark]**
...
![2-2--q5-a](assets/059-2-2-q5-a.png)
...
![2-2-9a-ii](assets/011-2-2-9a-ii.png)
...
![2-2-9a-iii](assets/012-2-2-9a-iii.png)
...
### 10((b)) — 1 marks
(b) To suggest why she keeps the temperature of the wire constant throughout the investigation:
...
![iv-graph-finding-current-sq-edexcl-igcse](assets/036-iv-graph-finding-current-sq-edexcl-igcse.png)
...
![file-000---2022-10-04t135300-891](assets/030-file-000-2022-10-04t135300-891.png)
...
![file-000---2022-10-04t140850-593](assets/031-file-000-2022-10-04t140850-593.png)
...
![Graph showing current in amps against potential difference in volts, with six data points from (0.5, 0.2) to (5.5, 1.0). Gradient is initially positive but decreases as current and potential difference increase.](assets/003-graph-showing-current-in-amps-against-potential-.png)
...
![Line of best fit through the points on the graph above. A curve passing through the origin with a slightly decreasing gradient as potential difference increases. The curve passes through, or near to, most points.](assets/004-line-of-best-fit-through-the-points-on-the-graph.png)
...
![Symbol for a bulb, a circle with two crossed diagonal lines through it.](assets/005-symbol-for-a-bulb-a-circle-with-two-crossed-diag.png)
...
![ENb0itRv_2-2-1a](assets/017-enb0itrv-2-2-1a.png)
...
![kFwyNi7J_2-2-1a-ii](assets/018-kfwyni7j-2-2-1a-ii.png)
...
![thermistor-commentary](assets/019-thermistor-commentary.png)
...
![cell-commentary](assets/020-cell-commentary.png)
...
- The straight line has four points above and four points below the line **AND**
- So it is a reasonable average of the trend shown by the data;**[1 mark]**

**   OR**

- The curve has more of the points lying closer to the line / fits more points **AND**
- Theory states that it should not be a curve (the resistance will not be zero at 100°C); **[1 mark]**
...
(i) A metal wire at constant temperature would be graph **L**

(ii) A diode would be graph **J**

(iii) The filament lamp would be graph **K**
...
![2-2-q4-ii](assets/041-2-2-q4-ii.png)

- Point at (60, 2350) is circled;**[1 mark]**

(iii)

A curve of best fit which would score **one** mark would look like:

![2-2-q4-iii](assets/042-2-2-q4-iii.png)
...
![2-2-6c-i](assets/051-2-2-6c-i.png)
...
![2-2-6c-ii](assets/052-2-2-6c-ii.png)
