...
> Source: [https://www.savemyexams.com/igcse/chemistry/edexcel/19/topic-questions/2-inorganic-chemistry/2-5-extraction-and-uses-of-metals/exam-questions/](https://www.savemyexams.com/igcse/chemistry/edexcel/19/topic-questions/2-inorganic-chemistry/2-5-extraction-and-uses-of-metals/exam-questions/) · 16 questions · total 106 marks


## Q1 — medium — 14 marks

### 2 — 4 marks — command: multiple — structured
Titanium metal is extracted by heating titanium(IV) chloride with sodium at 1000 <sup>o</sup>C.

The equation for the reaction is:

TiCl<sub>4</sub> + 4Na → 4NaCl + Ti

Some information about the reactants and products is given in the table:

| Substance | Melting point <sup>o</sup>C | Boiling point <sup>o</sup>C | Physical state at 1000 <sup>o</sup>C |
|---|---|---|---|
| TiCl<sub>4</sub> | -24 | 136 |   |
| Na | 98 | 883 |   |
| NaCl | 801 | 1413 |   |
| Ti | 1668 | 3287 |   |

i) Suggest a reason why titanium cannot be extracted from TiCl<sub>4</sub> by heating with carbon.

[1]

ii) Suggest a reason why titanium cannot be extracted from TiCl<sub>4</sub> using electrolysis.

[2]

iii) Give the physical state of each substance at 1000 <sup>o</sup>C by completing the column in the table.

[1]

### 2 — 3 marks — command: calculate — structured
Calculate the mass of sodium, in kg, needed to produce 1 kg of titanium from this extraction process.

Give your answer to two significant figures.

(*A*<sub>*r *</sub>of Ti = 48)

### 2 — 2 marks — command: multiple — structured
Titanium metal is often combined with aluminium to produce alloys.

i) State the meaning of the term alloy.

[1]

ii) Explain the purpose of making alloys.

[1]

### 2 — 4 marks — command: explain — structured
Aluminium is a metal with a wide range of applications.

It is malleable, conducts heat and electricity efficiently, and has a lower density than most other metals.

Describe two uses of aluminium and explain how each use is linked to its properties

### 2 — 1 mark — command: multiple — structured
Aluminium is extracted by electrolysis.

i) Write a half-equation to show the extraction of aluminium.

[1]

ii) Describe this reaction in terms of redox.
...
Copper ore contains copper carbonate, CuCO<sub>3</sub>.
...
### 6 — 4 marks — command: draw — structured
The diagram shows the arrangement of the particles in a pure metal.

![screen-shot-2022-10-14-at-14-59-52](assets/001-screen-shot-2022-10-14-at-14-59-52.png)
...
### 11 — 2 marks — command: write — structured
Tungsten is a useful metal. It has the chemical symbol W.

One method of extracting tungsten involves heating a tungsten compound, WO<sub>3</sub>, with hydrogen. Write the balanced symbol equation for this reaction.
...
### 11 — 4 marks — command: calculate — structured
...
2. Titanium chloride is placed in a reactor with magnesium at 900 <sup>o</sup>C in a sealed container for 3 days
...
### 12 — 3 marks — command: calculate — structured
...
### 12 — 4 marks — command: explain — structured
...
### 13 — 3 marks — command: state — structured
...
![fig-14-q9-1cho-1f-paper-1-june-2018](assets/004-fig-14-q9-1cho-1f-paper-1-june-2018.png)
...
ii) The formula of the iron oxide is Fe<sub>2</sub>O<sub>3</sub>.

Calculate the maximum mass of iron that can be obtained from 240 tonnes of iron oxide, Fe<sub>2</sub>O<sub>3</sub>.
...
Aluminium is extracted from aluminium oxide (Al<sub>2</sub>O<sub>3</sub>) by electrolysis.
...
ii) Aluminium is produced at the negative electrode. The ionic half-equation for the reaction is:  Al<sup>3+</sup> + 3e<sup>−</sup> → Al
...
![Aeroplane](assets/006-aeroplane.png)
...
### 17 — 1 mark — command: why — structured
...
### 17 — 2 marks — command: calculate — structured
Bauxite contains a high percentage of aluminium oxide. Calculate the percentage by mass of aluminium in aluminium oxide, Al<sub>2</sub>O<sub>3</sub>.

(*A*<sub>r</sub>: Al = 27, O = 16)
