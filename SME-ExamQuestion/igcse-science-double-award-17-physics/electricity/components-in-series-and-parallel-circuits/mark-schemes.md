...
![file-000---2022-10-05t125601-542](assets/053-file-000-2022-10-05t125601-542.png)
...
![thermistor](assets/022-thermistor.png)
...
![resistance-light-intensity-blank-axes-sq-igcse-ma](assets/024-resistance-light-intensity-blank-axes-sq-igcse-m.png)
...
![2-2--q5-a](assets/032-2-2-q5-a.png)
...
![2-2-9a-ii](assets/038-2-2-9a-ii.png)
...
![2-2-9a-iii](assets/039-2-2-9a-iii.png)
...
- The variable resistor is in series with the lamp and the ammeter and the power supply **OR **
...
- The gradient of the graph changes (the voltage increases more rapidly than the current); **[1 mark]** **OR**
- Line is curved / not a straight line; **[1 mark]** **OR **
...
- Range of values (of I and V obtained) by altering the variable resistor **OR **
...
![iv-graph-finding-current-sq-edexcl-igcse](assets/011-iv-graph-finding-current-sq-edexcl-igcse.png)
...
![file-000---2022-10-04t135300-891](assets/027-file-000-2022-10-04t135300-891.png)

- Use of a suitable scale using at least half the grid in both directions; **[1 mark]**
- A smooth curve of best fit; **[1 mark]**
- 5 points plotted correctly; **[1 mark]** **OR**
...
![file-000---2022-10-04t140850-593](assets/028-file-000-2022-10-04t140850-593.png)
...
- Resistance is constant at first **OR**
- Voltage and current are proportional at first **OR**
- The component obeys Ohm's law at first; **[1 mark]**

**Graph overall**

- Resistance is not constant (overall) **OR**
- Voltage and current are not proportional **OR**
- The component does not obey Ohm's Law; **[1 mark]**

**Reason**

- Because the component gets hotter **OR**
...
![ENb0itRv_2-2-1a](assets/016-enb0itrv-2-2-1a.png)
...
![kFwyNi7J_2-2-1a-ii](assets/017-kfwyni7j-2-2-1a-ii.png)
...
![thermistor-commentary](assets/018-thermistor-commentary.png)
...
![cell-commentary](assets/019-cell-commentary.png)
...
- The straight line has four points above and four points below the line **OR**

  - So it is a reasonable average of the trend shown by the data; **[1 mark]**
- The curve has more of the points lying closer to the line / fits more points; **[1 mark]**
...
(ii) A diode would be graph **K**

(iii) The filament lamp would be graph **J**
...
- The beaker of water provides more gradual heat / cooling; **[1 mark]** **OR **
...
![2-2-q4-ii](assets/050-2-2-q4-ii.png)

- Point at (60, 2350) is circled; **[1 mark]**

(iii) A curve of best fit which would score **one** mark would look like:

![2-2-q4-iii](assets/051-2-2-q4-iii.png)

- The line of best fit should go through the point (60, 1750) **AND**
...
- Measure the current / take the current reading **OR**
- Measure the (number of) amperes / take the ampere reading; **[1 mark]**
- Divide the voltage (reading) / number of volts by the current (reading) / number of amperes **OR **
...
![2-2-6c-i](assets/006-2-2-6c-i.png)
...
![2-2-6c-ii](assets/007-2-2-6c-ii.png)

- The line of best fit should be a smooth curve **AND **
