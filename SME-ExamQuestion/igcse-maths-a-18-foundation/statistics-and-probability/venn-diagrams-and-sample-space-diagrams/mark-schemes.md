...
![simple-probability-diagrams-medium-7-2](assets/005-simple-probability-diagrams-medium-7-2.png)
...
![Venn diagram with two overlapping circles A and B. Numbers 6, 12 in intersection; 18, 24, 30 in A; 2, 4, 20 in B; 8, 10, 14, 16, 22, 26, 28 outside.](assets/002-venn-diagram-with-two-overlapping-circles-a-and-.png)
...
### 2() — 1 marks
Write down the probability of all numbers not in set A
...
![Venn diagram with sets A and B; numbers 1, 5, 6, 8, 9 in A; 2, 6, 9 in B; 6, 9 overlap; 3, 4, 7 outside both sets in universe E.](assets/007-venn-diagram-with-sets-a-and-b-numbers-1-5-6-8-9.png)
...
![simple-probability-diagrams-easy-7-1](assets/012-simple-probability-diagrams-easy-7-1.png)
...
![simple-probability-diagrams-easy-7-2](assets/013-simple-probability-diagrams-easy-7-2.png)
...
![simple-probability-diagrams-easy-7-3](assets/014-simple-probability-diagrams-easy-7-3.png)
...
![AVUGCoO2_simple-probability-diagrams-easy-7-4](assets/015-avugcoo2-simple-probability-diagrams-easy-7-4.png)
...
| + | 1 | 2 | 3 | 4 | 5 | 6 |
|---|---|---|---|---|---|---|
| 1 | **Final answer:** **2** | **Final answer:** **3** | **Final answer:** **4** | **Final answer:** **5** | **Final answer:** **6** | **Final answer:** **7** |
| 2 | **Final answer:** **3** | **Final answer:** **4** | **Final answer:** **5** | **Final answer:** **6** | **Final answer:** **7** | **Final answer:** **8** |
| 3 | **Final answer:** **4** | **Final answer:** **5** | **Final answer:** **6** | **Final answer:** **7** | **Final answer:** **8** | **Final answer:** **9** |
| 4 | **Final answer:** **5** | **Final answer:** **6** | **Final answer:** **7** | **Final answer:** **8** | **Final answer:** **9** | **Final answer:** **10** |
| 5 | **Final answer:** **6** | **Final answer:** **7** | **Final answer:** **8** | **Final answer:** **9** | **Final answer:** **10** | **Final answer:** **11** |
| 6 | **Final answer:** **7** | **Final answer:** **8** | **Final answer:** **9** | **Final answer:** **10** | **Final answer:** **11** | **Final answer:** **12** |

**[M1 A1]**

> **[mark-scheme]**
> **M1: **For at least 6 correct totals.
> 
> **A1: **For all correct totals.

### 2() — 2 marks
(i)

Count the number of 4's and write over the total possibilities

**Final answer:** $\frac{3}{36}$** or **$\frac{1}{12}$

**[B1]**

(ii)

Count the number of scores that are more than 9 and write over the total possibilities

**Final answer:** $\frac{6}{36}$** or **$\frac{1}{6}$
