...
![Bar chart showing annual rice production in million tonnes: Indonesia 71, Vietnam 45, Thailand 40, Bangladesh 35, Japan 12, Pakistan 10.](assets/003-bar-chart-showing-annual-rice-production-in-mill.png)
...
![Table showing fruit tally and frequency: apple 6, banana 2, grape 4, peach 3, orange 6.](assets/008-table-showing-fruit-tally-and-frequency-apple-6-.jpg)

> *Count the tally for each fruit to fill in the frequency*

![Table showing fruit tally and frequency: apple 5, banana 2, grape 4, peach 3, orange 6, with tally marks representing each count.](assets/009-table-showing-fruit-tally-and-frequency-apple-5-.jpg)
...
![Blank bar chart for fruit frequencies with horizontal categories: apple, banana, grape, peach, orange; vertical axis labelled frequency 0 to 9.](assets/011-blank-bar-chart-for-fruit-frequencies-with-horiz.png)
...
![Bar chart displaying fruit frequencies: Apple 5, Banana 2, Grape 4, Peach 3, Orange 6. Frequency on vertical axis, fruits on horizontal axis.](assets/012-bar-chart-displaying-fruit-frequencies-apple-5-b.png)
...
![Table showing dog count per weekday using circle fractions. Monday: 3.5, Tuesday: 2.25, Wednesday: 1.5, Thursday: 2.5, Friday: 2.25. Key: full circle is 8 dogs.](assets/007-table-showing-dog-count-per-weekday-using-circle.jpg)
...
![Bar chart showing numbers of international students in thousands: Australia 420, Canada 440, Germany 260, Japan 210, France 340, Spain 120.](assets/016-bar-chart-showing-numbers-of-international-stude.png)
...
![Weekly schedule with blocks representing tasks for each weekday. Monday, Thursday, and Friday have more blocks; Tuesday and Wednesday have fewer.](assets/014-weekly-schedule-with-blocks-representing-tasks-f.png)
...
### 1() — 1 marks
There are 10 squares between 20 and 25

- 2 squares is one degree
...
> **[mark-scheme]**
> **B1**: Correct answer. You do not need units.

### 2() — 1 marks
There are 8 squares between 9am and 11am

- 4 squares is 1 hour
- 1 square is 15 minutes

**Final answer:** **10:45am**

**[B1]**

### 3() — 1 marks
Find the temperatures at those times and subtract them
