---
note_id: "rn_wGRGtCn4tbqNwCym"
title: "Core Practical: Determining Density"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/physics-unit-1/revision-notes/solids-liquids-gases/density-pressure/determining-density
path: solids-liquids-gases/density-pressure/determining-density
updated_at: "2026-02-17T13:13:33.315Z"
spec_point_ids: ["spcpt_CVpKJQK5qDsyH6ph"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_CVpKJQK5qDsyH6ph` · Core practical 9: investigate density using direct measurements of mass and volume

## Practical: Determining density
...
![Required Practical Regular Objects, downloadable IGCSE & GCSE Physics revision notes](../../../assets/3f2ce8b8c265-3-1-3-required-practical-regular-objects.png)
...
![Determining Density Table 1, downloadable IGCSE & GCSE Physics revision notes](../../../assets/7e1879ead614-3-1-3-determining-density-table-1-1.png)
...
- Then use the formula for density to calculate the density of each object
  ...
  - The formulae for volume and density are explained in the revision note [Density](https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/physics-unit-1/revision-notes/solids-liquids-gases/density-pressure/density/)
...
![Eureka-can, IGCSE & GCSE Physics revision notes](../../../assets/a27f93d30b8b-eureka-can.png)
...
| **Object** | **Mass of object / g** | **Average mass / kg** | **Volume of water displaced / m**<sup>**3**</sup> | **Average volume of water displaced / m**<sup>**3**</sup> |   |   |   |   |
|---|---|---|---|---|---|---|---|---|
| **1** | **2** | **3** | **1** | **2** | **3** |   |   |   |
| 100 |   |   |   |   |   |   |   |   |
| 120 |   |   |   |   |   |   |   |   |
...
![density-liquid, IGCSE & GCSE Physics revision notes](../../../assets/1d3c23021bc9-density-liquid.png)
...
| **Mass of cylinder before / g** | **Average mass / kg** | **Volume of water added / m**<sup>**3**</sup> | **Mass of cylinder with water / g** | **Average mass of cylinder with water / kg** |   |   |   |   |
|---|---|---|---|---|---|---|---|---|
| **1** | **2** | **3** | **1** | **2** | **3** |   |   |   |
|   |   |   |   |   |   |   |   |   |
|   |   |   |   |   |   |   |   |   |
...
- Once the mass and volume of the liquid are known, the density can be calculated using the equation for calculating density
  ...
  - This is explained in the revision note [Density](https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/physics-unit-1/revision-notes/solids-liquids-gases/density-pressure/density/)
