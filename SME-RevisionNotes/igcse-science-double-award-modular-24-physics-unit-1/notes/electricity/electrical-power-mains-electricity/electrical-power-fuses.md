---
note_id: "rn_KD3nKhzYSHxwHMPJ"
title: "Electrical Power & Fuses"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/physics-unit-1/revision-notes/electricity/electrical-power-mains-electricity/electrical-power-fuses
path: electricity/electrical-power-mains-electricity/electrical-power-fuses
updated_at: "2026-02-17T10:46:35.732Z"
spec_point_ids: ["spcpt_bznP9nrpwX78yPZ7", "spcpt_KhMWG3ThJFNfpg7s"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_bznP9nrpwX78yPZ7` · know and use the relationship between power, current and voltage: power = current × voltage
P = I × V
...
![PIV triangle (2), IGCSE & GCSE Physics revision notes](../../../assets/2c7dc7ab465a-piv-triangle-2.png)
...
> **Spec point** — `spcpt_KhMWG3ThJFNfpg7s` · apply the relationship (power = current × voltage) to the selection of appropriate fuses
...
![Fuse, IGCSE & GCSE Physics revision notes](../../../assets/825aecace7da-fuse.png)
