---
note_id: "rn_nf928FV85hGdVpSh"
title: "Charge & Current"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/physics-unit-1/revision-notes/electricity/current-potential-difference-resistance/charge-current
path: electricity/current-potential-difference-resistance/charge-current
updated_at: "2026-02-17T10:40:46.536Z"
spec_point_ids: ["spcpt_4rxjthyppJFv6SyN", "spcpt_N9h3qKrFKxwdWQCb", "spcpt_jcF42grJp6hJrcNn"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_4rxjthyppJFv6SyN` · know that current is the rate of flow of charge
...
![current-in-a-circuit](../../../assets/3f6fa0dffa02-current-in-a-circuit.png)
...
![Measuring current, IGCSE & GCSE Physics revision notes](../../../assets/c6ecdbfb57ab-measuring-current.png)

***An ammeter can be used to measure the current around a circuit***

## Charge

> **Spec point** — `spcpt_N9h3qKrFKxwdWQCb` · know that electric current in solid metallic conductors is a flow of negatively charged electrons
...
![electrons-and-current, IGCSE & GCSE Physics revision notes](../../../assets/3ed8a46542ef-electrons-and-current.png)
...
> 
> ![flow-of-charge-in-a-circuit](assets/d75bfa1a089e-flow-of-charge-in-a-circuit.png)

## Calculating electric charge

> **Spec point** — `spcpt_jcF42grJp6hJrcNn` · know and use the relationship between charge, current and time: charge = current × time 
Q = I × t
...
![Current charge time triangle, IGCSE & GCSE Physics revision notes](../../../assets/5ba51ff45aef-current-charge-time-triangle.png)
...
> 
> Check out this revision note on [speed, distance and time](https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/physics-unit-1/revision-notes/forces-motion/movement-position/speed/) if you need a reminder on how to use formula triangles.
