---
note_id: "rn_C3WbXvbCZ9NRm8bj"
title: "Electrical Components"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/physics-unit-1/revision-notes/electricity/components-in-series-parallel-circuits/electrical-components
path: electricity/components-in-series-parallel-circuits/electrical-components
updated_at: "2024-08-27T04:43:41.782Z"
spec_point_ids: ["spcpt_9ww95GSXHxdpFrmN", "spcpt_2FZqBvW7jNw49VVm"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_9ww95GSXHxdpFrmN` · describe the qualitative variation of resistance of light-dependent resistors (LDRs) with illumination and thermistors with temperature
...
![Thermistor, IGCSE & GCSE Physics revision notes](../../../assets/d581a5f19895-thermistor.png)

***The resistance of a thermistor depends on its temperature***

- The relationship between resistance and temperature for a thermistor can be shown on a graph

![thermistor-graph](../../../assets/fa45225c39d1-thermistor-graph.png)
...
![LDR & Light Intensity, downloadable IGCSE & GCSE Physics revision notes](../../../assets/a1053b665910-2-1-8-ldr-light-intensity.png)
...
![ldr-resistance-light-intensity](../../../assets/cafe9e6fd198-ldr-resistance-light-intensity.png)
...
> **Spec point** — `spcpt_2FZqBvW7jNw49VVm` · know that lamps and LEDs can be used to indicate the presence of a current in a circuit
...
![](../../../assets/7201e22403cd-24-2-led-circuit-symbol.png)
