---
note_id: "rn_t5JpRMQTMvwVBgrK"
title: "Contamination & Irradiation"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/physics/revision-notes/radioactivity-and-particles/radioactivity-uses-and-dangers/contamination-and-irradiation
path: radioactivity-and-particles/radioactivity-uses-and-dangers/contamination-and-irradiation
updated_at: "2026-07-08T13:38:08.133Z"
spec_point_ids: ["spcpt_67GSVDH9pkxpmMpy"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_67GSVDH9pkxpmMpy` · describe the difference between contamination and irradiation 

## Contamination & irradiation

### Contamination

- Contamination is defined as: **The accidental transfer of a radioactive substance onto or into a material**
...
- Irradiation is defined as: **The process of exposing a material to ionising radiation**
...
![Radiation-Hazard, IGCSE & GCSE Physics revision notes](../../../assets/65c762b5c164-radiation-hazard.png)
...
- To reduce the effects of irradiation, minimise the exposure time near a source and maximise the distance to the radioactive source
...
![Diagram of a full-body yellow radiation suit with visor, gloves and boots, labelled as providing protection from contamination.](../../../assets/41b9323b9e8f-32856-4-2-11-safety-wear.png)

***Contamination carries much greater risks than irradiation***
...
| prevention | reduced by minimising the exposure time and maximising the distance to the radioactive source | radiation cannot be blocked once an object is contaminated, but can be prevented by handling the source safely |
