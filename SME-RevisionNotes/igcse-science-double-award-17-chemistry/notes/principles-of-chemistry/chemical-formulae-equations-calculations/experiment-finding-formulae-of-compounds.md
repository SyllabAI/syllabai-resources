---
note_id: "rn_pWzTTBv3B4yGFfj3"
title: "Experiment: Finding Formulae of Compounds"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/chemistry/revision-notes/principles-of-chemistry/chemical-formulae-equations-calculations/experiment-finding-formulae-of-compounds
path: principles-of-chemistry/chemical-formulae-equations-calculations/experiment-finding-formulae-of-compounds
updated_at: "2024-10-22T18:45:38.009Z"
spec_point_ids: ["spcpt_QMWD2Cg3hJxkKCkc"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_QMWD2Cg3hJxkKCkc` · understand how the formulae of simple compounds can be obtained experimentally, including metal oxides, water and salts containing water of crystallisation
...
- To determine the formula of hydrated copper sulfate, CuSO<sub>4</sub>. *x*H<sub>2</sub>O

#### Diagram:

![Water of Crystallisation, downloadable IGCSE & GCSE Chemistry revision notes](../../../assets/aad49939ebf1-1-5-6-water-of-crystallisation.png)
...
- **Mass of water**
  ...
  |---|---|---|
  | Mass | a | b |
  | Moles **(Step 1)** | a / *M*<sub>r</sub> <br>= y | b / *M*<sub>r</sub> <br>=x |
  | Ratio **(Step 2)** | 1 : | x |
  - **Step 3 – **Represent the ratio in the form ‘salt.xH<sub>2</sub>O’
