---
note_id: "rn_KpvF2TWr5fYHk2Jz"
title: "Simple Molecular Structures"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/chemistry/revision-notes/principles-of-chemistry/covalent-bonding/simple-molecular-structures
path: principles-of-chemistry/covalent-bonding/simple-molecular-structures
updated_at: "2024-12-09T09:48:48.554Z"
spec_point_ids: ["spcpt_h8VYczG6KjVpWxNf", "spcpt_PqMbFj8Wwq5fxmVy", "spcpt_2YWCbjWF3fHMPpR8"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_h8VYczG6KjVpWxNf` · explain why substances with a simple molecular structures are gases or liquids, or solids with low melting and boiling points the term intermolecular forces of attraction can be used to represent all forces between molecules.
explain how the structure of C60 fullerene influences its physical properties, including electrical conductivity and hardness
...
![Intermolecular Forces Vs Covalent Bonds, downloadable IGCSE & GCSE Chemistry revision notes](../../../assets/3e82430107bc-2-2-5-intermolecular-forces-vs-covalent-bonds.png)
...
- C<sub>60</sub> is a **simple molecular structure**

  - C<sub>60</sub> can not conduct electricity
  
    - Although the fourth electron in C<sub>60</sub> is not bonded, the electrons are only freely moving within the buckyballs and cannot migrate from one buckyball to another, so C<sub>60</sub> does not conduct electricity
...
![The structure of Buckminsterfullerene](../../../assets/cb17c2f79e81-4-1-11-the-structure-of-buckminsterfullerene-1.png)
...
> **Spec point** — `spcpt_PqMbFj8Wwq5fxmVy` · explain why the melting and boiling points of substances with simple molecular structures increase, in general, with increasing relative molecular mass
...
![Alkanes Boiling Point](../../../assets/e81c57c28b08-10-1-1-alkanes-boiling-point-graph.png)

***As the molecular mass increases, so does the boiling point***

## Conductivity & Covalent Compounds

> **Spec point** — `spcpt_2YWCbjWF3fHMPpR8` · know that covalent compounds do not usually conduct electricity
...
![Electrical wire insulator, IGCSE & GCSE Chemistry revision notes](../../../assets/ed6b00507fcf-electrical-wire-insulator.png)
