---
note_id: "rn_t68QRDhwR6r5gxYX"
title: "Reversible Reactions"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/chemistry/revision-notes/physical-chemistry/reversible-reactions-and-equilibria/reversible-reactions
path: physical-chemistry/reversible-reactions-and-equilibria/reversible-reactions
updated_at: "2024-12-10T08:25:54.720Z"
spec_point_ids: ["spcpt_tbzcnKqMXvrvqrkM"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_tbzcnKqMXvrvqrkM` · know that some reactions are reversible and this is indicated by the symbol ⇌ in equations
...
- The hydrated salt is copper(II) sulfate pentahydrate, CuSO<sub>4</sub>•5H<sub>2</sub>O

  - These are usually seen as **blue crystals**
  - The hydrated salt can be heated / dehydrated to form anhydrous copper(II) sulfate, CuSO<sub>4</sub>
...
- The anhydrous salt is copper(II) sulfate
  ...
  - Adding water to the anhydrous salt forms the hydrated copper(II) sulfate pentahydrate, CuSO<sub>4</sub>•5H<sub>2</sub>O
  - This reaction is highly exothermic

#### The dehydration of hydrated copper(II) sulfate

![Energy Changes & Reversible Reactions, downloadable IGCSE & GCSE Chemistry revision notes](../../../assets/6a98f5a0c76f-6-2-2-energy-changes-reversible-reactions.png)
