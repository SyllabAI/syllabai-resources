---
note_id: "rn_dTP52nzhYb96XrJx"
title: "Indicators"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/chemistry/revision-notes/inorganic-chemistry/acids-alkalis-and-titrations/indicators
path: inorganic-chemistry/acids-alkalis-and-titrations/indicators
updated_at: "2024-11-03T23:07:59.064Z"
spec_point_ids: ["spcpt_rYzbG6hkVWMJf2tg", "spcpt_gDp2jhdKxrsXsbYy", "spcpt_GKK32nmTSN4cK4KX"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_rYzbG6hkVWMJf2tg` · describe the use of litmus, phenolphthalein and methyl orange to distinguish between acidic and alkaline solutions
...
> **Spec point** — `spcpt_gDp2jhdKxrsXsbYy` · understand how to use the pH scale, from 0–14, can be used to classify solutions as strongly acidic (0–3), weakly acidic (4–6), neutral (7), weakly alkaline (8–10) and strongly alkaline (11–14)
...
> **Spec point** — `spcpt_GKK32nmTSN4cK4KX` · describe the use of universal indicator to measure the approximate pH value of an aqueous solution
...
![Universal-indicator-and-the-pH-scale2, IGCSE & GCSE Chemistry revision notes](../../../assets/9ac22038140d-universal-indicator-and-the-ph-scale2.png)
