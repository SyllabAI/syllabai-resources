---
note_id: "rn_WJD4ZN4kQfzJNSPV"
title: "Practical: Determine the % of Oxygen in Air"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/chemistry/revision-notes/inorganic-chemistry/gases-in-the-atmosphere/practical-determine-the-per-cent-of-oxygen-in-air
path: inorganic-chemistry/gases-in-the-atmosphere/practical-determine-the-per-cent-of-oxygen-in-air
updated_at: "2026-07-31T16:47:22.798Z"
spec_point_ids: ["spcpt_X3HSSwCSZBMNbGFX"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_X3HSSwCSZBMNbGFX` · practical: determine the approximate percentage by volume of oxygen in air using a metal or a non-metal
...
![Investigating-Percentage-of-Oxygen-in-Air, IGCSE & GCSE Chemistry revision notes](../../../assets/7034d031be6a-investigating-percentage-of-oxygen-in-air.png)
...
initial volume = (50.0 + 3.8) - 2.6 = 51.2 mL

- Calculate the final volume of air:
...
percentage of oxygen = $\frac{\mathrm{volume} \mathrm{of} \mathrm{oxygen}}{\mathrm{initial} \mathrm{volume} \mathrm{of} \mathrm{air}}$ x 100

percentage of oxygen = $\frac{10.1}{51.2}$ x 100

percentage of oxygen = **19.7%**
