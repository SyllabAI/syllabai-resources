---
note_id: "rn_sX8yyBxHn8bS7t46"
title: "Oxidation & Reduction"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/chemistry/revision-notes/inorganic-chemistry/reactivity-series/oxidation-and-reduction
path: inorganic-chemistry/reactivity-series/oxidation-and-reduction
updated_at: "2024-10-23T05:18:05.762Z"
spec_point_ids: ["spcpt_fhFyVJC52gfymzCF", "spcpt_msKxhyRzxt7pz78K"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_fhFyVJC52gfymzCF` · understand the terms: in terms of gain or loss of oxygen and loss or gain of electrons. 
• oxidation 
• reduction 
• redox 
• oxidising agent
...
**Mg (s) + Cu**<sup>**2+**</sup>** (aq) + SO**<sub>**4**</sub><sup>**2-**</sup>** (aq) → Mg**<sup>**2+**</sup>** (aq) + SO**<sub>**4**</sub><sup>**2-**</sup>** (aq) + Cu (s)**

- The sulfate ions, SO<sub>4</sub><sup>2-</sup>, appear on both sides of the equation unchanged hence they are **spectator ions** and do not participate in the chemistry of the reaction so can be omitted:
...
- Cu<sup>2+</sup> is **reduced** as it **gain** electrons
...
- In the following example Fe has been oxidised and Cu<sup>2+</sup> has been reduced
- Therefore Cu<sup>2+</sup> is the **oxidising agent**

#### The redox reaction between Fe and Cu<sup>2+</sup>

![oxidation-and-reduction-electrons](../../../assets/d36c1937612f-oxidation-and-reduction-electrons.png)

***The Fe atom is oxidised (loses electrons) and the Cu***<sup>***2+***</sup>*** ion is reduced (gains electrons). Cu***<sup>***2+ ***</sup>***is the oxidising agent***

![OILRIG, downloadable AS & A Level Biology revision notes](../../../assets/d4df00a71f5e-oilrig.png)
...
> 
> **V**<sup>**3+**</sup>** + Fe**<sup>**3+**</sup>**  → V**<sup>**4+**</sup>** + Fe**<sup>**2+**</sup>
> 
> **Answer:**
> 
> - **Step 1 **- Identify the changes for each species
> 
>   - V<sup>3+ </sup>to V<sup>4+</sup>
>   - V<sup>3+</sup> has lost 1 electron
>   - Fe<sup>3+ </sup>to Fe<sup>2+</sup>
>   - Fe<sup>3+</sup> has gained 1 electron
> 
> - **Step 2 **- Identify each change as either oxidation and reduction
> 
>   - V<sup>3+ </sup>to V<sup>4+ </sup>is oxidation
>   - Fe<sup>3+ </sup>to Fe<sup>2+</sup> is reduction
>   - Therefore, V<sup>3+</sup> has been oxidised

## Redox reactions

> **Spec point** — `spcpt_msKxhyRzxt7pz78K`
