---
note_id: "rn_kJg2gwF77vdFZZ2H"
title: "Tests for Anions"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award/17/chemistry/revision-notes/inorganic-chemistry/chemical-tests/tests-for-anions
path: inorganic-chemistry/chemical-tests/tests-for-anions
updated_at: "2024-10-23T05:39:34.645Z"
spec_point_ids: ["spcpt_dcqNwkhJ7ZqZcNVy"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_dcqNwkhJ7ZqZcNVy` · describe tests for these anions: 
• Cl– , Br– and I– using acidified silver nitrate solution 
• SO4 2– using acidified barium chloride solution 
• CO3 2– using hydrochloric acid and identifying the gas evolved.
...
- You must be able to **describe **the tests for the following ions:
  ...
  - Halide ions, Cl<sup>–</sup> , Br<sup>–</sup> , I<sup>–</sup>
  - Sulfate ions, SO<sub>4</sub><sup>2–</sup>

### Test for carbonate ions

- Carbonate compounds contain the carbonate ion, CO<sub>3</sub><sup>2-</sup>
...
- If a carbonate compound is present then fizzing / effervescence should be seen as **CO**<sub>**2**</sub> gas is produced, which forms a white precipitate of calcium carbonate when bubbled through limewater:

**CO**<sub>**3**</sub><sup>**2- **</sup>**(aq) + 2H**<sup>**+ **</sup>**(aq) → CO**<sub>**2 **</sub>**(g) + H**<sub>**2**</sub>**O (l)**

**CO**<sub>**2 **</sub>**(g) + Ca(OH)**<sub>**2**</sub>** (aq) → CaCO**<sub>**3**</sub>**(s) + H**<sub>**2**</sub>**O(l)**

- The white precipitate turns limewater** cloudy **

#### Testing for carbonate ions

![The diagram shows carbon dioxide being bubbled through limewater, and the limewater turning milky / cloudy to confirm the presence of carbon dioxide](../../../assets/d65f6d5545fd-40058-test-for-carbon-dioxide.png)
...
- The test for the halide ions is:
  ...
  - Add **silver nitrate solution,** AgNO<sub>3</sub>, ** **
...
**KCl (aq)   +     AgNO**<sub>**3**</sub>** (aq)   →  KNO**<sub>**3**</sub>** (aq)  +  AgCl (s) **
...
**KBr (aq)   +     AgNO**<sub>**3**</sub>** (aq)   →  KNO**<sub>**3**</sub>** (aq)  +  AgBr (s) **
...
**KI (aq)   +     AgNO**<sub>**3**</sub>** (aq)   →  KNO**<sub>**3**</sub>** (aq)  +  AgI (s) **

#### Testing for halide ions

![The diagram shows chloride ions forming a whilte precipitate, bromide ions forming a cream precipitate and iodide ions forming a yellow precipitate](../../../assets/6ff6156483ea-45106-the-silver-halide-precipitates.png)
...
- Sulfate compounds contain the sulfate ion, SO<sub>4</sub><sup>2-</sup>
...
![The diagram shows barium chloride solution being added to a sample, which forms a white precipitate if sulfate ions are present](../../../assets/bab89e9c2673-12032-sulfate-ion-test.png)
