---
note_id: "rn_TXdW5n435HYWyhgP"
title: "Classifying Stationary Points"
source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-2/revision-notes/functions-graphs-and-differentiation/differentiation-and-gradients/classifying-stationary-points
path: functions-graphs-and-differentiation/differentiation-and-gradients/classifying-stationary-points
updated_at: "2026-02-12T14:50:47.344Z"
spec_point_ids: ["spcpt_2KkPGzKqGcx5jPkt"]
spec_point_codes: []
guided_study: false
---
...
![Two graphs, the first has a maximum point labelled and the second has a minimum point labelled.](../../../assets/43b4052ffcd6-61930-turn-pts-notes-fig3.png)
...
- To** classify the turning point** on a** quadratic curve** (parabola), remember that:
  ...
  - A **positive** quadratic (**positive** ***x***<sup>**2**</sup> term) must have a **minimum** point
  - A **negative** quadratic (**negative** ***x***<sup>**2**</sup> term) must have a **maximum** point

![Two graphs. The first graph is a negative quadratic where a<0, and has the maximum point labelled. The second graph is a positive quadratic where a>0, and has the minimum point labelled.](../../../assets/49a34b096a79-4607-turn-pts-notes-fig5.png)
...
![Turn Pts Notes fig6, downloadable IGCSE & GCSE Maths revision notes](../../../assets/cd0ce616a181-25056-turn-pts-notes-fig6.png)
...
> 
> ![Graph of the curve with equation y=2x³+2x²-12x+1.](assets/8555f53c582f-34867-graph-of-the-curve-with-equation-y-equals-.png)
> 
