---
note_id: "rn_53P4HbjyHbKYvwzJ"
title: "Reflections of Graphs"
source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-2/revision-notes/functions-graphs-and-differentiation/transformations-of-graphs/reflections-of-graphs
path: functions-graphs-and-differentiation/transformations-of-graphs/reflections-of-graphs
updated_at: "2026-01-21T18:01:37.808Z"
spec_point_ids: ["spcpt_qNDqnmZtzYttZDnz"]
spec_point_codes: []
guided_study: true
---
...
![Two graphs showing curves and their reflections. The curve is reflected in the x-axis (left) and y-axis (right).](../../../assets/4e13090ad804-5523-reflections-of-graphs-1.png)
...
![Graph showing the reflection of a parabola y=f(x) in the x-axis to y=-f(x). Key points are (2,-3) reflecting to (2,3), demonstrating y-coordinate change only.](../../../assets/ce5d383201fd-8985-reflections-of-graphs-2.png)
...
![Graph showing function y=f(x) reflected in the y-axis to y=f(-x). Points on graph change x-coordinates but retain y-coordinates; points on y-axis remain affected.](../../../assets/1eda0f50db70-32760-reflections-of-graphs-3.png)
...
![When a graph is reflected, any asymptotes are reflected too](../../../assets/7865ce9fc4fb-47062-reflections-of-graphs-4.png)
...
> 
> ![A positive cubic graph f(x)](assets/4a84ff009226-36035-reflections-of-graphs-we-1.png)
> 
...
> 
> ![Graph of y = f(-x) showing a curve with labelled points (-1, -3) at the minimum and (2, 6) at the maximum.](assets/ca3483ef53c3-39261-reflections-of-graphs-we-2.png)
