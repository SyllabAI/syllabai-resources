---
note_id: "rn_6TKDbD4nSbBxm6BB"
title: "Domain & Range"
source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-2/revision-notes/functions-graphs-and-differentiation/functions/domain-and-range
path: functions-graphs-and-differentiation/functions/domain-and-range
updated_at: "2026-02-12T11:33:47.284Z"
spec_point_ids: ["spcpt_2w6yB8pYShK9mGRb"]
spec_point_codes: []
guided_study: true
---
...
![Graph of linear function f(x)=2x+5 and quadratic function g(x)=x²-7x+10.](../../../assets/011f3c46968e-21163-domain-and-range-how-are-functions-related.png)
...
![Example of the function f(x)=4/(x+2), which has a domain of x≠-2 and the function g(t)=6sin(2t) with domain 0≤t<24.](../../../assets/9c2644c4286d-17566-what-are-restricted-domains-and-values-exc.png)
...
- Examples of ranges are below:
  ...
  - `straight f open parentheses x close parentheses equals x squared` with domain "all values of *x*"
    ...
    - (0 goes in and comes out as 0<sup>2</sup> = 0)
...
![Example of sketching the graph of a restricted function.](../../../assets/eff60e0e62c5-34956-how-can-i-use-graphs-to-find-ranges.png)

![Example of an exam question on domain and range.](../../../assets/f9eb9cea6fce-45147-how-can-i-use-graphs-to-find-ranges-2.png)
