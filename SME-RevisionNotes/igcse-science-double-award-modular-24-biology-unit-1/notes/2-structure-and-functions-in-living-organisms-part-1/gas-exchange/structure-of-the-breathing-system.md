---
note_id: "rn_CpCCPYCRk4WBGrNs"
title: "Structure of the Breathing System"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/biology-unit-1/revision-notes/2-structure-and-functions-in-living-organisms-part-1/gas-exchange/structure-of-the-breathing-system
path: 2-structure-and-functions-in-living-organisms-part-1/gas-exchange/structure-of-the-breathing-system
updated_at: "2026-07-02T08:19:35.141Z"
spec_point_ids: ["spcpt_zDmyZnfnwwDNGVvR"]
spec_point_codes: []
guided_study: true
---
...
![Diagram of the human respiratory system showing the nasal cavity, trachea, lungs, bronchi, bronchioles, alveoli, pleural membrane, ribs, intercostal muscles, and diaphragm.](../../../assets/496cd46a9c84-50403-structures-in-the-human-breathing-system.png)
...
| Bronchi | Large tubes branching off the trachea that connect to the bronchioles. The human lungs contain two bronchi, each tube is known as a bronchus:<br><br>- **Bronchi** (plural)<br>- **Bronchus** (singular) |
| Bronchioles | Smaller tubes that connect the bronchi to the alveoli |
| Alveoli | Tiny, balloon-like air sacs found at the ends of the bronchioles in the lungs. The alveoli are the **specialised gas exchange surfaces** where oxygen diffuses into the blood and carbon dioxide diffuses out.<br><br>- **Alveoli** (plural)<br>- **Alveolus** (singular) |
