---
note_id: "rn_V4Y92rRKJVRS6xsP"
title: "Codominance"
source: https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-2/revision-notes/reproduction-and-inheritance/inheritance/codominance
path: reproduction-and-inheritance/inheritance/codominance
updated_at: "2026-07-02T08:19:34.352Z"
spec_point_ids: ["spcpt_MDknpVCYhn4zMmpY"]
spec_point_codes: []
guided_study: true
---
...
- Inheritance of blood group is an example of **codominance**
  ...
  - Alleles I<sup>A</sup> and I<sup>B</sup> are **codominant**, but both are dominant to I<sup>O</sup>
  - I<sup>A</sup> results in the production of **antigen A** in the blood
  - I<sup>B</sup> results in the production of **antigen B** in the blood
  - I<sup>O</sup> results in **no antigens** being produced in the blood
- These three possible alleles can give us the following genotypes and phenotypes

#### Codominance in blood types table

![Inheritance of Blood Group table, IGCSE & GCSE Biology revision notes](../../../assets/b3818ecd0ffd-17-6-inheritance-of-blood-group-table.png)
...
![Blood group inheritance, IGCSE & GCSE Biology revision notes](../../../assets/dc21a5092281-blood-group-inheritance.png)

***Punnett square shows the inheritance of Blood Group***

#### Interpreting the genetic diagram

- The parent with blood group A has the genotype I<sup>A</sup>I<sup>O</sup>
- The parent with the blood group B has the genotype I<sup>B</sup>I<sup>O</sup>
