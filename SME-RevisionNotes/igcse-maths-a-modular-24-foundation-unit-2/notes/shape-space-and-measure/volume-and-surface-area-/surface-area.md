---
note_id: "rn_gbtG27fJNCvynpYV"
title: "Surface Area"
source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/foundation-unit-2/revision-notes/shape-space-and-measure/volume-and-surface-area-/surface-area
path: shape-space-and-measure/volume-and-surface-area-/surface-area
updated_at: "2026-01-19T16:31:10.340Z"
spec_point_ids: ["spcpt_ncwVDtmPBNzrxjvH"]
spec_point_codes: []
guided_study: true
---
...
![Net of a square-based pyramid](../../../assets/1bfaee477092-25405-surface-area-1.png)

### How do I find the surface area of a cylinder?

- A cylinder has **two flat surfaces** (the top and the base) and** one curved surface**
- The **net** of a cylinder consists of** two circles** and a **rectangle** ![A cylinder and its net](assets/ec94c591acff-52892-surface-area-2.png)
...
- The **total surface area **of a cylinder, *A*<sub>*Total*</sub>, can be found using the formula
...
![A cone and its net](../../../assets/f32e472a61c7-35003-surface-area-3.png)
...
- The **total surface area** of a cone, *A*<sub>*Total*</sub>, can be found using the formula
...
![A sphere](../../../assets/196af2bddcc6-16568-surface-area-4.png)
...
> 
> ![q7-1-4-7-medium-edexcel-gcse-maths](assets/95300af5888f-37815-surface-area-5.png)
> 
> **Answer:**
> 
> > *Find the area of the face at the front*
> 
> *2 cm × 10 cm = 20 cm**<sup>2</sup>** *
> 
> > *Find the area of the face at the side*
> 
> *2 cm × 15 cm = 30 cm**<sup>2</sup>** *
> 
> > *Find the area of the face at the top*
> 
> *10 cm × 15 cm = 150 cm**<sup>2</sup>** *
> 
