---
note_id: "rn_w8zxNv9F8jvqsHqK"
title: "Enlargements"
source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/foundation-unit-2/revision-notes/shape-space-and-measure/transformations/enlargements
path: shape-space-and-measure/transformations/enlargements
updated_at: "2026-03-10T10:56:32.783Z"
spec_point_ids: ["spcpt_YNj6M7JXVsR9FgMG", "spcpt_sZKHSVfR29sK8S8B"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_YNj6M7JXVsR9FgMG`
...
> 
> ![Enlargement-Q1, IGCSE & GCSE Maths revision notes](assets/fafc676c4614-31034-enlargements-1.png)
> 
> **Answer:**
> 
...
> 
> ![Enlargement-Q1-working, IGCSE & GCSE Maths revision notes](assets/88b1ed18664d-23475-enlargements-2.png)
> 
...
> 
> ![Enlargement-Q1-Final-Answer, IGCSE & GCSE Maths revision notes](assets/28a6cdf39514-59037-enlargements-3.png)
...
- For a shape enlarged by a scale factor of 3 with centre of enlargement (-1, 6)
  ...
  - The **reverse transformation** is
    ...
    - an enlargement of scale factor $\frac{1}{3}$
    - with centre of enlargement (-1, 6)

> **Worked Example**
> Describe fully the single transformation that creates shape B from shape A.
> 
> ![Enlargement-Q2, IGCSE & GCSE Maths revision notes](assets/21aa77ce3699-20317-enlargements-4.png)
> 
> **Answer:**
> 
...
> 
> $\therefore\mathrm{Scale} \mathrm{Factor}=\frac{9}{3}=3$
> 
...
> 
> ![Enlargement-Q2-Working, IGCSE & GCSE Maths revision notes](assets/6e7b61c7e22c-45515-enlargements-5.png)
> 
> **Final answer:** **Shape A has been enlarged using a scale factor of 3 and a centre of enlargement (9, 7) to create shape B**

## Fractional Enlargements

> **Spec point** — `spcpt_sZKHSVfR29sK8S8B`
...
> **Worked Example**
> On the grid below enlarge shape C using scale factor $\frac{1}{2}$ and centre of enlargement (4, 2).
> 
> Write down the four vertices of your enlarged shape.
> 
> ![cie-igcse-core-fractional-enlargements-rn-we-a1-image](assets/1e7694384d75-20652-enlargements-6.png)
> 
> **Answer:**
> 
...
> 
> ![cie-igcse-core-fractional-enlargements-rn-we-a2-image](assets/4e41eb65c62f-63088-enlargements-7.png)
> 
> > *Multiply these distance by the scale factor, *$\frac{1}{2}$
> 
> *6 'right *$\times\frac{1}{2}=3$* 'right'*
> 
> *2 'down' *$\times\frac{1}{2}=1$* 'down'*
> 
...
> 
> ![cie-igcse-core-fractional-enlargements-rn-we-a3-image](assets/d87f9895f186-7210-enlargements-8.png)
> 
> **Final answer:** **The four vertices of the enlarged shape are (0, 0), (0, 4),  (1, 3) and (1, 1)**
...
### How do I reverse a fractional enlargement?

- If a shape has undergone a **fractional enlargement**, you can perform a single transformation to **return the shape** to its **original size and position**
- An enlargement can be **reversed** by multiplying the enlarged shape by the **reciprocal of the original scale factor**

  - the centre of enlargement is the same
- For a shape enlarged by a scale factor of  $\frac{1}{2}$ with centre of enlargement (0, 5)
...
> **Exam Hint**
> - **Multiplying** by the fraction $\frac{1}{n}$ is the same as **dividing** by $n$
> 
>   - $6\times\frac{1}{2}$ is the same as $6\div2$
>   - This can make the calculations quicker on the **non-calculator paper**

> **Worked Example**
> Describe fully the single transformation that creates shape B from shape A.
> 
> ![cie-igcse-core-fractional-enlargements-rn-we-b1-image](assets/2d49043f601c-2581-enlargements-9.png)
> 
> **Answer:**
> 
...
> 
> *scale factor = *$\frac{\mathrm{new} \mathrm{edge}}{\mathrm{old} \mathrm{edge}}=\frac{2}{6}=\frac{1}{3}$
> 
...
> 
> ![cie-igcse-core-fractional-enlargements-rn-we-b2-image](assets/ebb509e24f6c-1974-enlargements-10.png)
> 
> **Final answer:** **Shape A has been enlarged using a scale factor of **$\frac{1}{3}$**and a centre of enlargement (3, -3.5) to create shape B**
