---
note_id: "rn_MSGSwPTwN9d95xHC"
title: "Constructing Triangles"
source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/foundation-unit-2/revision-notes/shape-space-and-measure/bearings-scale-drawing-and-constructions-/constructing-triangles-
path: shape-space-and-measure/bearings-scale-drawing-and-constructions-/constructing-triangles-
updated_at: "2026-01-19T15:57:12.905Z"
spec_point_ids: ["spcpt_RXP6GyfJydf7Kggr"]
spec_point_codes: []
guided_study: true
---
...
![constructing an SSS triangle](../../../assets/33cbaa0cd244-59786-constructing-triangles-1.png)
...
> 
> ![Construction of an SSS triangle](assets/0dab550d9c4b-48738-constructing-triangles-2.png)
...
![Constructing an SAS triangle](../../../assets/97c6582ef1b4-50482-constructing-triangles-3.png)

*Constructing an SAS triangle*

> **Worked Example**
> Using a **ruler and a protractor **only, construct a triangle with sides 9 cm and 6 cm and an included angle of 62<sup>o</sup>.
> 
> **Answer:**
> 
> > *Draw the 9 cm line as the horizontal base*
> 
> ![measuring a 9 cm line with a ruler](assets/419c75de850b-25914-constructing-triangles-4.png)
> 
> > *Place the centre of the protractor at one end of the horizontal line and measure 62*<sup>*o*</sup>
> 
> ![measuring 62 degrees with a protractor](assets/aa2641785409-47990-constructing-triangles-5.png)
> 
> > *Measure 6 cm along the new line and indicate it with a mark*
> 
> ![measure-6-cm-along-line-and-mark](assets/2dcb749f79e8-47525-constructing-triangles-6.png)
> 
...
> 
> ![completed SAS triangle construction](assets/e4abb85bbbc3-25012-constructing-triangles-7.png)
...
![Constructing an ASA triangle](../../../assets/74099bc2706e-9780-constructing-triangles-8.png)
...
> **Worked Example**
> Using a **ruler and a protractor **only, construct a triangle with angles 36<sup>o</sup> and 59<sup>o</sup> and an included side of length 8 cm.
> 
> **Answer:**
> 
> > *Draw the 8 cm line as the horizontal base*
> 
> ![measuring an 8 cm line with a ruler](assets/2353cd22af41-39525-constructing-triangles-9.png)
> 
> > *Place the centre of the protractor at one end of the horizontal line and measure 36*<sup>*o*</sup>
> 
> ![measuring 36 degrees with protractor](assets/3aa20a7d78fb-42991-constructing-triangles-10.png)
> 
> > *Put the centre of the protractor over the other end of the horizontal line and measure 59*<sup>*o*</sup>
> 
> ![measuring 59 degrees with protractor](assets/011a59f83faf-32746-constructing-triangles-11.png)
> 
...
> 
> ![completed ASA triangle construction](assets/f7e8038fca1b-64648-constructing-triangles-12.png)
