---
note_id: "rn_N4ZVnQsrjXBFDjcD"
title: "Solving Quadratic Inequalities"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/revision-notes/2-equations-formulae-and-identities/solving-inequalities/solving-quadratic-inequalities
path: 2-equations-formulae-and-identities/solving-inequalities/solving-quadratic-inequalities
updated_at: "2026-01-27T15:06:22.875Z"
spec_point_ids: ["spcpt_dnkHMPkqhhdDxPkZ"]
spec_point_codes: []
guided_study: false
---
...
![Graph of quadratic inequality (x-2)(x-5) ≥ 0, showing shading for x ≤ 2 and x ≥ 5, and the quadratic function y = (x-2)(x-5) plotted, crossing x at 2 and 5.](../../../assets/b6ea98fb89cf-4010-quadratic-inequality-1.png)
...
![Graph depicting the quadratic inequality (x - 2)(x - 5) ≤ 0. The highlighted area shows y = (x - 2)(x - 5) between x = 2 and x = 5, inclusive.](../../../assets/fccf7a41d20c-63132-quadratic-inequality-2.png)
...
![Graph of quadratic inequality 4 - x^2 > 0. The shaded region above y = 4 - x^2 shows valid x values between -2 and 2, excluding the endpoints.](../../../assets/c2f2c99f8f8e-17867-quadratic-inequality-3.png)
...
> 
> ![Graph of a red zigzag line in a U-shape, crossing the x-axis at -1 and 2, on a coordinate plane with arrows showing positive axes directions.](assets/956049693a94-45104-solving-quadratic-inequalities-we-graph.png)
> 
> $x<-1\mathrm{or}x>2$
