---
note_id: "rn_tCgNcbC2N8N4M7MY"
title: "Basic Fractions"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/revision-notes/1-numbers-and-the-number-system/fractions/basic-fractions
path: 1-numbers-and-the-number-system/fractions/basic-fractions
updated_at: "2026-06-10T14:13:59.108Z"
spec_point_ids: ["spcpt_339DNssRW9x2NPKk"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_339DNssRW9x2NPKk`
...
- A fraction is **more **than 1 if the numerator is **bigger **than the denominator
...
- To find an equivalent fraction, **multiply the top and bottom** of a fraction by the same number
  ...
  - $\frac{5}{6}$ is equivalent to $\frac{5\times2}{6\times2}=\frac{10}{12}$ and $\frac{5\times3}{6\times3}=\frac{15}{18}$ and $\frac{5\times4}{6\times4}=\frac{20}{24}$etc.
