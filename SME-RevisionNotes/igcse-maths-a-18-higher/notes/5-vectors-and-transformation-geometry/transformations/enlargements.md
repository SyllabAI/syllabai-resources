---
note_id: "rn_rXjnP6pbGxRsS5qg"
title: "Enlargements"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/revision-notes/5-vectors-and-transformation-geometry/transformations/enlargements
path: 5-vectors-and-transformation-geometry/transformations/enlargements
updated_at: "2025-11-28T05:27:40.711Z"
spec_point_ids: ["spcpt_c3ZTz62W4HKyb4zk"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_c3ZTz62W4HKyb4zk`
...
> 
> ![An object labelled C with vertices at (4, 2), (4, 4), (5, 4), (5, 5), (6, 5), (6, 3), (5, 3) and (5, 2).](assets/5df27c631a75-enlargement-q1.png)
> 
> **Answer:**
> 
...
> 
> ![An object labelled C with the COE marked at (2, 1) and a line going through the COE and one vertex on the shape.](assets/5bacf2b2af87-enlargement-q1-working.png)
> 
...
> 
> ![An object labelled C with the enlarged image (COE = (2, 1) and SF = 2) labelled C'.](assets/e59dbb7f1cfc-enlargement-q1-final-answer.png)
> 
> (b) Describe fully the single transformation that creates shape B from shape A.
> 
> ![An H-shaped object labelled A and a larger H-shaped object marked B.](assets/9e2924a70763-enlargement-q2.png)
> 
> **Answer:**
> 
...
> 
> ![An H-shaped object labelled A and a lager H-shaped object labelled B. Straight lines between corresponding vertices on the shape show that the COE is at (9, 9).](assets/e18ee3c927ae-enlargement-q2-working.png)
> 
> **Final answer:** **Shape A has been enlarged using a scale factor of 3 and a centre of enlargement (9, 9) to create shape B**

> **Worked Example**
> (a) On the grid below enlarge shape C using scale factor $\frac{1}{2}$ and centre of enlargement (4, 2).
> 
> Write down the four vertices of your enlarged shape.
> 
> ![A trapezium with vertices at points (-4, -2), (-2, 0), (-2, 4) and (-4, 6).](assets/09c163f03ecb-cie-igcse-core-fractional-enlargements-rn-we-a1-.png)
> 
> **Answer:**
> 
...
> 
> ![Trapezium with the centre of enlargement identified at point (4, 2).](assets/e6832d4fa4d8-cie-igcse-core-fractional-enlargements-rn-we-a2-.png)
> 
...
> 
> ![A trapezium with an enlarged image shown (COE = (4, 2), SF = 1/2).](assets/b90e7d2ff332-cie-igcse-core-fractional-enlargements-rn-we-a3-.png)
> 
> **Final answer:** **The four vertices of the enlarged shape are (0, 0), (0, 4),  (1, 3) and (1, 1)**
> 
> (b) Describe fully the single transformation that creates shape B from shape A.
> 
> ![An object labelled A with a smaller enlarged object labelled B.](assets/866a20282bc8-cie-igcse-core-fractional-enlargements-rn-we-b1-.png)
> 
> **Answer:**
> 
...
> 
> ![An object A and its enlarged object B with the COE marked on at point (3, -3).](assets/841e33021bb4-cie-igcse-core-fractional-enlargements-rn-we-b2-.png)
> 
