---
note_id: "rn_HDg3McZPbpyTZBYx"
title: "Intersecting Chord Theorem"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/revision-notes/4-geometry-and-trigonometry/circle-theorems/intersecting-chord-theorem
path: 4-geometry-and-trigonometry/circle-theorems/intersecting-chord-theorem
updated_at: "2026-02-12T16:18:49.073Z"
spec_point_ids: ["spcpt_znWXTZjqCR7PspTc", "spcpt_syhVK6wH6NDDfgdB"]
spec_point_codes: []
guided_study: false
---
...
![Chords AB and CD intersect at point P inside a circle.  AP x PB = CP x PD and ab = cd.](../../../assets/926583935dae-37745-intersecting-chord-theorem.png)
...
![Diagram of a circle with intersecting chords AB and CD. Lengths AP = 12, PB = 5, CP = 4, and PD = x. Solution shows x = 15 using ratios and multiplication rules.](../../../assets/26eaac3d72ad-24342-use-the-intersecting-chord-theorem.png)
...
![algebraic solution using intersecting chord theorem](../../../assets/9fabbb8a56d4-19680-intersection-chord-theorem-example.png)

> **Worked Example**
> The diagram below shows a circle with centre *O* and two chords, *PQ* and *RS*.
> 
> ![Diagram of intersecting chord theorem for worked example](assets/f3cdcb6305b3-12227-diagram-of-intersecting-chord-theorem-for-.png)
> 
...
![Diagram illustrating the external intersecting chord theorem, showing circle with chords AB, CD intersecting at external point P, and relevant equations.](../../../assets/c3d54fd3f424-38534-intersecting-chord-theorem-external.png)
...
> 
> ![diagram for worked example for intersecting chord theorem ](assets/a77f43662868-30540-igcse-intersecting-chord-theorem-external-.png)
> 
...
- A special case of the intersecting secant theorem is when one of the lines is a **tangent**, rather than a secant
  ...
  - In this case,** one of the lengths becomes zero**
    ...
    - **BP(AB + BP) = DP(0 + DP) **
    - **BP(AB + BP) = DP**<sup>**2**</sup>

![A diagram illustrating the intersecting chord theorem when one of the chords is a tangent. Equations: (a+b)b = d^2 and (AB+BP)BP = DP^2.](../../../assets/7cb8920f0753-61289-igcse-intersecting-chord-theorem-extrenal-.png)

> **Worked Example**
> In the diagram below, *A, B, *and *C* are points on a circle.
> 
> ![diagram for worked example for special case of intersecting chord theorem where one chord is a tangent](assets/0bd65e8afcd5-20371-igcse-intersecting-chord-theorem-external-.png)
> 
