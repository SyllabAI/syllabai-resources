---
note_id: "rn_WPtkrFgbhX8phHn4"
title: "Drawing Straight Line Graphs"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/revision-notes/3-sequences-functions-and-graphs/linear-graphs-y-equals-mx-plus-c/drawing-straight-line-graphs
path: 3-sequences-functions-and-graphs/linear-graphs-y-equals-mx-plus-c/drawing-straight-line-graphs
updated_at: "2026-01-20T16:27:02.515Z"
spec_point_ids: ["spcpt_h8QyRmzX5mCJb3X9"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_h8QyRmzX5mCJb3X9`
...
- For example, plot *y* = 2*x* + 1 on axes from *x* = 0 to *x* = 10
...
- Make sure you only have 1 *y* on one side, rather than say, 5*y*
...
> **Answer:**
> 
> > *Rearrange *$\frac{y+1}{3}=x$* into the form *$y=mx+c$* to make it easier to plot*
> 
...
> 
> ![Plotting the straight lines y=3x-1 and y=(-3/5)x+3 on the same axes](assets/2da8c559e642-27298-3x-1-and-3x5y15.png)
