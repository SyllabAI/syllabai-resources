---
note_id: "rn_MGjCwtvvntZ658xx"
title: "Parallel Lines"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/revision-notes/3-sequences-functions-and-graphs/linear-graphs-y-equals-mx-plus-c/parallel-lines
path: 3-sequences-functions-and-graphs/linear-graphs-y-equals-mx-plus-c/parallel-lines
updated_at: "2026-01-19T12:15:48.934Z"
spec_point_ids: ["spcpt_qPRh2fycSMYwytcV"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_qPRh2fycSMYwytcV`
...
- For example, to find the** equation** of the line **parallel** to *y * = 2*x * + 1 which **passes through** the **point **(3, 14)
  ...
  - **solve** to **find *****d***
    ...
    - *d * = 8
  - The equation is *y * = 2*x*  + 8

> **Worked Example**
> Find the equation of the line that passes through the point (2, 1), which is parallel to the straight line $y=3x+7$.
> 
> **Answer:**
> 
