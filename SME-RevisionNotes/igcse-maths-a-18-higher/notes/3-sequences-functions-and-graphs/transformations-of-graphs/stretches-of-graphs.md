---
note_id: "rn_xnhSTDrvnxKPF7rW"
title: "Stretches of Graphs"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/revision-notes/3-sequences-functions-and-graphs/transformations-of-graphs/stretches-of-graphs
path: 3-sequences-functions-and-graphs/transformations-of-graphs/stretches-of-graphs
updated_at: "2026-05-17T08:08:39.366Z"
spec_point_ids: ["spcpt_YcMPxJgtrjtBzMkV"]
spec_point_codes: []
guided_study: false
---
...
![A graph being stretched vertically (on the left) or horizontally (on the right).](../../../assets/6269561ee89c-47512-2-9-2-stretches-what-is.png)
...
![Graph showing the function y = f(x) and its transformation y = (1/3)f(x), indicating vertical stretch by a factor of 1/3. Points (2, -3) and (2, -1) shown.](../../../assets/a226352e10bc-63108-stretches-statement-vert-illustration.png)
...
![Stretching a graph horizontally by scale factor one half. y-coordinates stay in same place, x-coordinates change](../../../assets/2d6019b89aed-53520-2-9-2-stretches-statement-horiz-illustrati.png)
...
![A diagram shows transformations of the function y = f(x). It illustrates vertical and horizontal stretches, their effects on asymptotes, and coordinate changes.](../../../assets/0bb160b4697d-45936-59883-2-9-2-stretches-asymptotes-illustrat.png)
...
> 
> ![A positive cubic graph f(x)](assets/7c58999f4731-41534-19025-43755-worked-example-graph-1.png)
> 
...
> 
> ![Graph of the function y = f(x/3) with key points labeled (-6, 6) and (3, -3). ](assets/c4b674c96e84-19803-27247-we-stretches-1.png)
> 
> > *Now apply a vertical stretch of scale factor 2*
> 
> ![Graph of the function y=2f(x/3) showing a curve with marked points at (-6,12) and (3,-6) and vertical stretches by a factor of 2 along y-axis.](assets/326a89aa7313-7804-63805-50053-we-stretches-2.png)
> 
> > *Show the coordinates of the new points clearly*
> 
> ![Graph of the function y = 2f(x/3) with a peak at (-6,12) and a trough at (3,-6), crossing the y-axis at 0. Axes labelled x and y.](assets/11cd4ac09ed2-43514-54077-we-stretches-3.png)
