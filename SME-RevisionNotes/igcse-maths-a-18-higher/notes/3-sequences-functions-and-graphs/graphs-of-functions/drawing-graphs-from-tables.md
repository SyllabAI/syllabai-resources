---
note_id: "rn_VxfsMdWbm7qp9MSt"
title: "Drawing Graphs from Tables"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/revision-notes/3-sequences-functions-and-graphs/graphs-of-functions/drawing-graphs-from-tables
path: 3-sequences-functions-and-graphs/graphs-of-functions/drawing-graphs-from-tables
updated_at: "2026-01-20T16:32:32.550Z"
spec_point_ids: ["spcpt_SwbJdpQTQxGXry8M"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_SwbJdpQTQxGXry8M`
...
- For **quadratic** graphs, be careful substituting in **negative** numbers
  ...
  - Always put **brackets** around negative values and use **BIDMAS**
    ...
    - For example, substitute *x* = -3 into *y* = -*x*<sup>2</sup> + 8*x*
    - This becomes *y* = -(-3)<sup>2</sup> + 8(-3)
