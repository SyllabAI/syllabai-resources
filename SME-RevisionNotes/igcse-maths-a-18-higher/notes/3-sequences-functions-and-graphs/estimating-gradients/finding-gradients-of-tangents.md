---
note_id: "rn_HJhx3FGHXMpsTRgF"
title: "Finding Gradients of Tangents"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/higher/revision-notes/3-sequences-functions-and-graphs/estimating-gradients/finding-gradients-of-tangents
path: 3-sequences-functions-and-graphs/estimating-gradients/finding-gradients-of-tangents
updated_at: "2026-02-18T14:52:38.418Z"
spec_point_ids: ["spcpt_zrrC3yxSp579jY7k"]
spec_point_codes: []
guided_study: true
---
...
![A quadratic with two tangents drawn on it. The gradient of the curve at the point x=1 will be equal to the gradient of the purple tangent. The gradient of the curve at th epoint x=6 will be equal to the gradient of the green tangent.](../../../assets/0fd3f4b5dc03-28008-finding-gradients-of-tangents-1.png)

### How do I estimate the gradient of a curve using a tangent?

- To find an **estimate **for the **gradient **of a curve **at a point**: ![A curve with a tangent drawn on at a point on the curve (4, 2.5). The rise of the tangent is 2.5 and the run is 4.](assets/de304d1bd5ac-42517-finding-gradients-of-tangents-2.png)
...
- Consider the quantities used for the axes to determine the meaning of the gradient
  ...
  - In a **speed-time graph**, the gradient is the rate of change of speed with time
    ...
    - Common units for acceleration are metres per second per second (metres per second<sup>2</sup>)
  - In a **graph of volume against radius**, e.g. as a balloon is inflated, the gradient is the rate of change of volume as the radius increases
    ...
    - This could be measured in m<sup>3</sup> per m, which is equivalent to m<sup>2</sup>
...
> 
> ![Graph of y=cube root of x between 0 and 1](assets/e9eef8678e9e-4340-finding-gradients-of-tangents-we-1.png)
> 
> **Answer:**
> 
> > *Draw a tangent to the curve at the point where **x **= 0.5*
> 
> ![Tangent to curve at x=0.5](assets/a9a8ea9dfae4-9563-finding-gradients-of-tangents-we-2.png)
> 
...
> 
> ![Finding gradient of tangent](assets/644991c910ab-61453-finding-gradients-of-tangents-we-3.png)
> 
