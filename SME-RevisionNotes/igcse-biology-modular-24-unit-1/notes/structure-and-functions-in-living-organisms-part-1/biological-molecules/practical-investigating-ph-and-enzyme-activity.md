---
note_id: "rn_kwZSCXKYc7tWwWsK"
title: "Practical: Investigating pH & Enzyme Activity"
source: https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-1/revision-notes/structure-and-functions-in-living-organisms-part-1/biological-molecules/practical-investigating-ph-and-enzyme-activity
path: structure-and-functions-in-living-organisms-part-1/biological-molecules/practical-investigating-ph-and-enzyme-activity
updated_at: "2026-07-02T08:19:34.325Z"
spec_point_ids: ["spcpt_PnXQ4xtdyRTHqtKP"]
spec_point_codes: []
guided_study: true
---
...
- Use a syringe to place 2 cm<sup>3</sup> of **amylase** into a test tube
- Add 1cm<sup>3</sup> of **buffer solution** (at pH 3) to the test tube using a syringe
- Use another test tube to add 2 cm<sup>3 </sup>of **starch solution** to the amylase and buffer solution, start the stopwatch whilst mixing using a pipette
...
![Investigating effect pH on enzyme activity, IGCSE & GCSE Chemistry revision notes](../../../assets/6e6d54beecfc-investigating-effect-ph-on-enzyme-activity.png)
...
![Graph showing effect of pH on rate of activity for an enzyme from duodenum, IGCSE & GCSE Biology revision notes](../../../assets/93dea9454620-graph-showing-effect-of-ph-on-rate-of-activity-f.png)
