---
note_id: "rn_yySm7WrX6RT6F2St"
title: "Practical: The Effect of Light on Gas Exchange in Plants"
source: https://www.savemyexams.com/igcse/biology/edexcel/modular/24/unit-1/revision-notes/structure-and-functions-in-living-organisms-part-1/gas-exchange/practical-the-effect-of-light-on-gas-exchange-in-plants-
path: structure-and-functions-in-living-organisms-part-1/gas-exchange/practical-the-effect-of-light-on-gas-exchange-in-plants-
updated_at: "2026-07-02T08:19:34.303Z"
spec_point_ids: ["spcpt_Ty9RzrjPnk7TjrtH"]
spec_point_codes: []
guided_study: true
---
...
- Measure out 20 cm<sup>3 </sup>**hydrogen-carbonate indicator** into each of 4 boiling tubes
...
![Four test tubes labelled A to D, with hydrogen carbonate indicator. Tube B, C, D have leaves. Tube C is wrapped in foil; D is wrapped in gauze and cotton wool.](../../../assets/cea3e195a2e4-45191-light-and-gas-exchange-with-hydrogencarbon.png)
...
![Light and gas exchange with hydrogencarbonate indicator results, downloadable IGCSE & GCSE Biology revision notes](../../../assets/6e126e735cc7-light-and-gas-exchange-with-hydrogencarbonate-in.png)
...
|---|---|---|---|---|
| **Tube A** | No leaf (control) | Orange | Orange | No respiration or photosynthesis so no net movement of CO<sub>2 </sub> |
| **Tube B** | Leaf in sunlight | Orange | Purple | Photosynthesis > respiration.<br><br>There is a net intake of CO<sub>2 . </sub>The level of CO<sub>2  </sub>decreases.<sub> </sub> |
| **Tube C** | Leaf wrapped in aluminium foil | Orange | Yellow | No photosynthesis due to lack of light, only respiration occurs. <br>There is a net release of CO<sub>2</sub>. The level of<sub> </sub>CO<sub>2 </sub>increases. |
| **Tube D** | Leaf wrapped in muslin (cotton cloth) | Orange | Orange/slightly purple | Photosynthesis and respiration are relatively balanced. Net exchange of gas is small, although photosynthesis may exceed respiration so a small net update of CO<sub>2</sub> may happen (level of CO<sub>2 </sub>decreases) |
