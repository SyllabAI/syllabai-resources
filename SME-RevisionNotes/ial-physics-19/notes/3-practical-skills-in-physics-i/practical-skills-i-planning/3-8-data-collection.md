---
note_id: "rn_jv9CMWSJTYtYxyQd"
title: "Data Collection"
source: https://www.savemyexams.com/international-a-level/physics/edexcel/19/revision-notes/3-practical-skills-in-physics-i/practical-skills-i-planning/3-8-data-collection
path: 3-practical-skills-in-physics-i/practical-skills-i-planning/3-8-data-collection
updated_at: "2026-07-02T08:19:39.290Z"
spec_point_ids: ["spcpt_BFHcsTM9HtDNVXmV"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_BFHcsTM9HtDNVXmV`
...
![Equation of a Straight Line Notes Diagram 1](../../../assets/3703eca96a29-3-1-3-equation-of-a-straight-line-notes-diagram-.png)
...
- Often, physical quantities will be presented in standard form
  ...
  - For example, the speed of light in a vacuum equal to 3.00 × 10<sup>8</sup> m s<sup>−1</sup>This makes it easier to present numbers that are very large or very small without having to repeat many zeros
- It will also be necessary to know the **prefixes** for the numbers of ten

**Prefixes Table**

![Prefixes Table](../../../assets/eaff19a12207-1-1-1-prefixes-table.png)

#### Using Significant Figures

- Calculations must be reported to an appropriate number of signiﬁcant ﬁgures
- Also, all the data in a column should be quoted to the **same** number of signiﬁcant ﬁgures

![Significant Figures Table, downloadable AS & A Level Physics revision notes](../../../assets/710821e85abf-1-2-2-significant-figures-table.png)
...
![Calculating Mean Values, downloadable AS & A Level Physics revision notes](../../../assets/d60e2e39f36a-1-2-2-calculating-mean-values.png)
...
> 
> ![Required Practical 12 WE Table 1, downloadable AS & A Level Physics revision notes](assets/beea0a49d0b1-8-1-7-required-practical-12-we-table-1.png)
> 
...
> 
> ![Required Practical 12 WE Table 2, downloadable AS & A Level Physics revision notes](assets/f18b560a085e-8-1-7-required-practical-12-we-table-2.png)
> 
> Use this data to determine if the student’s data follows an inverse square law.
> 
> ![Required Practical 12 Worked Example, downloadable AS & A Level Physics revision notes](assets/e3c2f3aba92d-8-1-7-required-practical-12-worked-example.png)
> 
> **Answer:**
> 
> **Step 1: Determine a mean value of background radiation**
> 
> ![](assets/a61f1742c9b1-required-practical-12-we-1.jpeg)
> 
...
> 
> ![Intensity Equation](assets/8eb9708427c6-8-1-7-intensity-equation.png)
> 
> - Intensity is proportional to the corrected count rate, C, so
> 
> ![](assets/ab39904f1105-processing-data.jpeg)
> 
> - The graph provided is of the form 1/*C*<sup>–1/2 </sup>against *x*
> - Comparing this to the equation of a straight line, y = mx
> 
>   - y = 1/*C*<sup>–1/2</sup> (counts min<sup>–1/2</sup>)
>   - x = x (m)
>   - Gradient = constant, k
...
> 
> **Step 3: Calculate C (corrected average count rate) and C**<sup>**–1/2**</sup>** **
> 
> ![Required Practical 12 WE Table 3, downloadable AS & A Level Physics revision notes](assets/8b212f282654-8-1-7-required-practical-12-we-table-3.png)
> 
> **Step 4: Plot a graph of C**<sup>**–1/2**</sup>** against x and draw a line of best fit**
> 
> ![Required Practical 12 Worked Example(1), downloadable AS & A Level Physics revision notes](assets/4f5fd1dc7b99-8-1-7-required-practical-12-worked-example1.png)
> 
> - The graph shows C<sup>–1/2</sup> is directly proportional to x, therefore, the data follows an inverse square law
