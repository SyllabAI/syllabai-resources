---
note_id: "rn_WWxhCMXHvSzYCt3N"
title: "3D Pythagoras & Trigonometry"
source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-1/revision-notes/trigonometry/3d-pythagoras-and-trigonometry/3d-pythagoras-and-trigonometry
path: trigonometry/3d-pythagoras-and-trigonometry/3d-pythagoras-and-trigonometry
updated_at: "2026-01-21T18:05:40.037Z"
spec_point_ids: ["spcpt_kX4655D8M3Q3TRzW"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_kX4655D8M3Q3TRzW`
...
![Example showing Pythagoras' theorem used to find the slant height of a cone given its radius and perpendicular height.](../../../assets/6b20aacf85e9-62167-3d-pythagoras-and-trigonometry-1.png)
...
![Example showing Pythagoras' theorem to find the diagonal in a cuboid (3D formula).](../../../assets/9dbc131a3d83-18564-3d-pythagoras-and-trigonometry-2.png)

- However, all 3D situations can be broken into **two 2D problems**

  - Form two right-angle triangles

![Example showing Pythagoras' theorem to find the diagonal in a cuboid (splitting into two 2D triangles).](../../../assets/26a7724e33fa-30742-3d-pythagoras-and-trigonometry-3.png)

![3DPythagTrig Notes fig3 (3), downloadable IGCSE & GCSE Maths revision notes](../../../assets/48caa509dd03-7523-3d-pythagoras-and-trigonometry-4.png)
...
![Example showing SOHCAHTOA to find the angle between the base and the slant height of a cone , given its radius and perpendicular height.](../../../assets/88e64f4fd686-36187-3d-pythagoras-and-trigonometry-5.png)
...
![Diagram showing how to find the angle between a line and a plane.](../../../assets/dd83e8613318-15252-3d-pythagoras-and-trigonometry-6.png)
...
![Example showing SOHCAHTOA to find the angle between a line and the base of a triangular prism. (Image 1).](../../../assets/d4f35c853e7e-59348-3d-pythagoras-and-trigonometry-7.png)
...
> 
> ![A cuboid ABCDEFGH. AB = 3 cm, AD = 4 cm, DG = 6 cm.](assets/28e71cc70f91-9470-3d-pythagoras-and-trigonometry-8.png)
> 
...
> 
> ![Cuboid ABCDEFGH with a right-angled triangle ABF highlighted and another right-angled triangle BEF also highlighted.](assets/7c6709083c2e-36773-3d-pythagoras-and-trigonometry-9.png)
> 
> **Method 1**
> 
...
> 
> ![Triangle BEF, BE = 6 cm, EF = 4 cm, BF = a cm.](assets/49cf3762105f-10636-3d-pythagoras-and-trigonometry-10.png)
> 
> $a^{2}=4^{2}+6^{2}\,a^{2}=16+36\,a^{2}=52$
> 
> > *Draw triangle ABF flat and use Pythagoras' theorem to calculate AF *
> 
> ![Triangle ABF. AB = 3 cm, BF = a cm and AF = b cm.](assets/11522c51cf53-38350-3d-pythagoras-and-trigonometry-11.png)
> 
...
> 
> ![Cuboid ABCDEFGH with a right-angled triangle ABF highlighted and another right-angled triangle BEF also highlighted.](assets/184ab2b031e2-56890-3d-pythagoras-and-trigonometry-12.png)
> 
...
> 
> ![Triangle ABF with sides AB (opposite) = 3 cm, BF (adjacent) = √52 cm and AF (hypotenuse) = √61 cm.](assets/d3a008e713dc-24816-3d-pythagoras-and-trigonometry-13.png)
> 
> > *This is now ready for SOHCAHTOA*
> *We know all three sides so could use any trig ratio, for example  *$\mathrm{tan}θ=\frac{O}{A}$
...
> 
> **Final answer:** **The angle between plane BEFC  and the pencil is 22.6º (1 d.p.)**
