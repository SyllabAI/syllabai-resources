---
note_id: "rn_H6c93DKZVrzyK5yj"
title: "Solving Equations from Graphs"
source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/higher-unit-1/revision-notes/graphs-and-coordinates/graphs-of-functions/solving-equations-from-graphs
path: graphs-and-coordinates/graphs-of-functions/solving-equations-from-graphs
updated_at: "2026-01-22T17:26:47.484Z"
spec_point_ids: ["spcpt_sHCB9WZbDMyTFqCP"]
spec_point_codes: []
guided_study: true
---
...
- For example, plot* y*  = *x*<sup>2</sup> + 3*x* + 1 and *y* = 2*x* + 1 on the same axes

  - They meet twice, as shown
  - The **coordinates** of** intersection** are (-1, -1) and (0, 1)

![Points of intersection between a curve and a line](../../../assets/52e3ad7a8594-12672-solving-equations-using-graphs-1.png)
...
![Solving simultaneous equations graphically](../../../assets/55a239ed49fa-44696-solving-equations-graphically-notes-diagra.png)
...
> 
> ![The graph of y = 10 - x^2](assets/ca6a9a537819-4225-the-graph-of-y-equals-10-x2.png)
> 
> (a) $10-8x^{2}=0$
> 
> **Answer:**
...
> 
> ![The graph of y = x^3 + x^2 - 3x - 1 ](assets/19f10f037508-7955-cubic-linear-intersections-before.png)
> 
> **Answer:**
> 
...
> 
> ![The graph of y = x^3 + x^2 - 3x - 1  and the line y = x - 1](assets/87bc44eb4da0-58371-cubic-linear-intersections-after.png)
> 
