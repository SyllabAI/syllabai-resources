---
note_id: "rn_FNjRvHK4sF2R566f"
title: "Organic Compounds"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/chemistry-unit-1/revision-notes/organic-chemistry/introduction-to-organic-chemistry/organic-compounds
path: organic-chemistry/introduction-to-organic-chemistry/organic-compounds
updated_at: "2026-02-10T09:39:54.183Z"
spec_point_ids: ["spcpt_TpSDkFKJpdk9yFZY", "spcpt_kTY9CHD6JdNZF6pJ"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_TpSDkFKJpdk9yFZY`
...
- For example: Hydrogen peroxide is H<sub>2</sub>O<sub>2</sub> but the empirical formula is HO
...
![The Molecular Formulae of Butane and Butene, downloadable IB Chemistry revision notes](../../../assets/b46523d33944-10-1-2-the-molecular-formulae-of-butane-and-bute.png)
...
- The** general formula** shows a ratio of atoms in a family of compounds in terms of 'n' where n is a varying whole number
  ...
  - For example, the general formula of a molecule that belong to the alkane family is C<sub>n</sub>H<sub>2n+2</sub>
...
![The Structural Formulae of-2-methylbutane, downloadable IB Chemistry revision notes](../../../assets/1d876e6efd95-10-1-2-the-structural-formulae-of-2-methylbutane.png)
...
![Representing Condensed Structrual Formulae of Straight Chains, downloadable IB Chemistry revision notes](../../../assets/acb9ed5fb839-10-1-2-representing-condensed-structrual-formula.png)
...
> **Spec point** — `spcpt_kTY9CHD6JdNZF6pJ`
...
![Names and structures of the functional groups table, IGCSE & GCSE Chemistry revision notes](../../../assets/07dfe5f531fa-14-1-3-names-and-structures-of-the-functional-gr.png)
...
![An Introduction to AS Level Organic Chemistry Propene and Cyclopropane, downloadable AS & A Level Chemistry revision notes](../../../assets/d26bb8fa1419-3-1-an-introduction-to-as-level-organic-chemistr.png)

***Isomers of C***<sub>***3***</sub>***H***<sub>***6 ***</sub>***show the same molecular formula but different structures. Isomers can show similar physical and chemical properties or if they have different functional groups, the properties can be different.***
