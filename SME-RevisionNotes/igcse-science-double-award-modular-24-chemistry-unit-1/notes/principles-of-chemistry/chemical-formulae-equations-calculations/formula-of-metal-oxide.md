---
note_id: "rn_8pbvkfQnKGz5w7nR"
title: "Practical: Determine The Formula of a Metal Oxide"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/chemistry-unit-1/revision-notes/principles-of-chemistry/chemical-formulae-equations-calculations/formula-of-metal-oxide
path: principles-of-chemistry/chemical-formulae-equations-calculations/formula-of-metal-oxide
updated_at: "2026-09-10T12:50:05.253Z"
spec_point_ids: ["spcpt_dc3ZfsNP4tdPx8HC", "spcpt_Jk8FnzPKt64j8D2r"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_dc3ZfsNP4tdPx8HC`
...
![Diagram of apparatus needed to find the formula of magnesium oxide](../../../assets/bdb5379b2054-1-5-7-finding-the-formula-of-magnesium-oxide.png)
...
|---|---|---|
| mass | a | b |
| moles | a / *A*<sub>r</sub> | b / *A*<sub>r</sub> |
|   | x | y |

Ratio = x : y

- **Step 3 – **Represent the ratio in the form ‘M<sub>x</sub>O<sub>y</sub>‘ E.g, MgO

## Practical: Determine the Formula of Copper(II)Oxide

> **Spec point** — `spcpt_Jk8FnzPKt64j8D2r`
...
![Diagram to show the apparatus needed to determine the formula of copper(II) oxide](../../../assets/1ae7b82306a1-1-5-7-finding-the-formula-of-copperiioxide.png)
...
|---|---|---|
| mass | a | b |
| moles | a / *M*<sub>r</sub> | b / *M*<sub>r</sub> |
| Ratio | x | y |

- **Step 3 – **Represent the ratio in the form ‘M<sub>x</sub>O<sub>y</sub>‘ E.g, CuO
