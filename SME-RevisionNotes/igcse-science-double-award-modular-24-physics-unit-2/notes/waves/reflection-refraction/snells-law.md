---
note_id: "rn_dp8snfYgjfwBP9Yz"
title: "Snell's Law"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/physics-unit-2/revision-notes/waves/reflection-refraction/snells-law
path: waves/reflection-refraction/snells-law
updated_at: "2026-02-17T11:37:44.049Z"
spec_point_ids: ["spcpt_mkDnwkbVvY23ND8y"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_mkDnwkbVvY23ND8y` · know and use the relationship between refractive index, angle of incidence and angle of refraction: 
n = sin i / sin r
...
- You can revise the concept of refraction using the revision notes [Reflection & refraction](https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/physics-unit-2/revision-notes/waves/reflection-refraction/reflection-refraction/)

#### A formula triangle can help rearrange the snell's law equation

![Snell triangle (2), IGCSE & GCSE Physics revision notes](../../../assets/85c4b447a418-snell-triangle-2.png)
...
> 
> When calculating the value of *i* or *r* start by calculating the value of sin* i* or sin* r. *You can then use the **inverse sin** function (sin<sup>–1</sup> on most calculators by pressing 'shift' then 'sine') to find the angle.
> 
