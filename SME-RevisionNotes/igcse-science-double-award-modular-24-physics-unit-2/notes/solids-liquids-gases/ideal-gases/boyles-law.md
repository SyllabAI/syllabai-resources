---
note_id: "rn_sHBQ4YWjPvCywsjG"
title: "Boyle's Law"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/physics-unit-2/revision-notes/solids-liquids-gases/ideal-gases/boyles-law
path: solids-liquids-gases/ideal-gases/boyles-law
updated_at: "2024-08-29T19:29:15.337Z"
spec_point_ids: ["spcpt_Ds2vDWTqqSD2tjr9"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_Ds2vDWTqqSD2tjr9` · use the relationship between the pressure and volume of a fixed mass of gas at constant temperature: 
p1 V1 = p2 V2
...
![Gas Laws Molecular Model (1), downloadable AS & A Level Physics revision notes](../../../assets/b01a6a8acdaf-6-5-2-gas-laws-molecular-model-1.png)
...
- Where:
  ...
  - *p*<sub>*1 *</sub>= initial pressure in pascals (Pa)
  - *V*<sub>*1 *</sub>= initial volume in metres cubed (m<sup>3</sup>)
  - *p*<sub>*2 *</sub>= final pressure in pascals (Pa)
  - *V*<sub>*2 *</sub>= final volume in metres cubed (m<sup>3</sup>)

- This equation is sometimes referred to as **Boyle's Law**

![Pressure-vs-Volume, IGCSE & GCSE Physics revision notes](../../../assets/f34dd7dbd072-pressure-vs-volume.png)

***Initial pressure and volume, p***<sub>***1***</sub>*** and V***<sub>***1***</sub>***, and final pressure and volume, p***<sub>***2***</sub>*** and V***<sub>***2***</sub>***. When volume decreases, pressure increases***
...
> 
> - Initial volume,* V*<sub>*1*</sub> = 0.70 m<sup>3</sup>
> - Initial pressure, *p*<sub>*1*</sub> = 200 Pa
> - Final volume, *V*<sub>*2*</sub> = 0.15 m<sup>3</sup>
> 
> **Step 2: Write the relevant equation**
> 
> $p_{1}V_{1}=p_{2}V_{2}$
> 
> **Step 3: Rearrange for the final pressure, *****p***<sub>***2***</sub>
> 
> - Divide both sides by *V*<sub>*2*</sub> to get the *p*<sub>*2*</sub> term on its own
> 
