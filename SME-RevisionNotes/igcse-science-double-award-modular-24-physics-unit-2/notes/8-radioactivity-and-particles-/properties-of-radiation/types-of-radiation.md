---
note_id: "rn_ZVtTVgYPFCrrVMMQ"
title: "Types of Radiation"
source: https://www.savemyexams.com/igcse/science/edexcel/double-award-modular/24/physics-unit-2/revision-notes/8-radioactivity-and-particles-/properties-of-radiation/types-of-radiation
path: 8-radioactivity-and-particles-/properties-of-radiation/types-of-radiation
updated_at: "2026-02-17T13:05:55.071Z"
spec_point_ids: ["spcpt_QrvF5m6BwkN68Rfs", "spcpt_hQKxDSVhJF3GgDCb"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_QrvF5m6BwkN68Rfs` · know that alpha (α) particles, beta (β−) particles, and gamma (γ) rays are ionising radiations emitted from unstable nuclei in a random process
...
![Unstable nucleus, downloadable IGCSE & GCSE Physics revision notes](../../../assets/86041bc2da73-4-2-1-unstable-nucleus.png)
...
![Radioactive decay, downloadable IGCSE & GCSE Physics revision notes](../../../assets/a357fc59f0b8-4-2-1-radioactive-decay.png)
...
> **Spec point** — `spcpt_hQKxDSVhJF3GgDCb` · describe the nature of alpha (α) particles, beta (β−) particles, and gamma (γ) rays, and recall that they may be distinguished in terms of penetrating power and ability to ionise
...
![alpha-beta-gamma, IGCSE & GCSE Physics revision notes](../../../assets/598e21c5be98-alpha-beta-gamma.png)
...
![Penetrating Power, IGCSE & GCSE Physics revision notes](../../../assets/d19a7b83b3fd-penetration-increase.png)
