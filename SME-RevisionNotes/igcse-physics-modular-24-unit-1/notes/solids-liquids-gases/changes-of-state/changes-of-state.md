---
note_id: "rn_knqv82Gk96sNkFNj"
title: "Changes of State"
source: https://www.savemyexams.com/igcse/physics/edexcel/modular/24/unit-1/revision-notes/solids-liquids-gases/changes-of-state/changes-of-state
path: solids-liquids-gases/changes-of-state/changes-of-state
updated_at: "2026-05-11T15:22:38.458Z"
spec_point_ids: ["spcpt_ycqQrDRzNvqP2tbd", "spcpt_k2gqZDKJVB7YYCQN"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_ycqQrDRzNvqP2tbd` · describe the changes that occur when a solid melts to form a liquid, and when a liquid evaporates or boils to form a gas (physics only)
...
![Solids liquids gases](../../../assets/c178aa43eec6-solids-liquids-gases.png)

***Changing the temperature of a solid, liquid, or gas changes its state***

## Heat & temperature

> **Spec point** — `spcpt_k2gqZDKJVB7YYCQN` · explain why heating a system will change the energy stored within the system and raise its temperature or produce changes of state (physics only)
...
![Change in internal energy, downloadable AS & A Level Physics revision notes](../../../assets/89b189588fe5-16-1-change-in-internal-energy.png)
...
> 
> ![WE Decrease in mass Question image, downloadable IGCSE & GCSE Physics revision notes](assets/4e9686e19821-14-1-4-we-decrease-in-mass-question-image.png)
> 
