---
note_id: "rn_xxSKHcnsM4bzyjVB"
title: "The Principle of Moments"
source: https://www.savemyexams.com/igcse/physics/edexcel/modular/24/unit-1/revision-notes/forces-motion/moments/principle-of-moments
path: forces-motion/moments/principle-of-moments
updated_at: "2024-08-26T15:14:14.208Z"
spec_point_ids: ["spcpt_FnN867YYPR2BBYSq", "spcpt_FZGSfrRh92sWVG3K"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_FnN867YYPR2BBYSq` · use the principle of moments for a simple system of parallel forces acting in one plane (physics only)
...
![Clockwise and anticlockwise moments](../../../assets/6428c8da4965-4-1-2-1-clockwise-or-anticlockwise-moment.png)
...
![](../../../assets/e6892554aa97-balanced-seesaw-1.png)
...
> 
> ![Principle of Moments Worked Example GCSE, downloadable IGCSE & GCSE Physics revision notes](assets/41b2b375354a-5-4-2-principle-of-moments-worked-example-gcse.png)
> 
...
> 
> - Clockwise force (child), *F*<sub>child</sub> = 140 N
> - Anticlockwise force (adult), *F*<sub>adult</sub> = 690 N
> - Distance of adult from the pivot, *d*<sub>adult</sub> = 0.3 m
> 
...
> 
> Moment of child (clockwise) = *F*<sub>child</sub> × *d*<sub>child</sub>
> 
> Moment of child (clockwise) = 140 × *d*<sub>child</sub>
> 
> **Step 4: Calculate the total anticlockwise moments**
> 
> - The anticlockwise moment is from the adult
> 
> Moment of adult (anticlockwise) = *F*<sub>adult</sub> × *d*<sub>adult</sub>
> 
...
> **Spec point** — `spcpt_FZGSfrRh92sWVG3K` · understand how the upward forces on a light beam, supported at its ends, vary with the position of a heavy object placed on the beam (physics only)
...
![Supporting a Beam (1), downloadable IGCSE & GCSE Physics revision notes](../../../assets/937643933d3b-1-4-2-supporting-a-beam-1.png)

***F***<sub>***1***</sub>*** and F***<sub>***2***</sub>*** upwards balance the weight of the beam downwards***

- As the mass in the above diagram is moved from the left-hand side to the right-hand side of the beam, force *F*<sub>*1*</sub> will **decrease** and force *F*<sub>*2*</sub> will **increase**

![Supporting a Beam (2), downloadable IGCSE & GCSE Physics revision notes](../../../assets/adf13c9ec3b4-1-4-2-supporting-a-beam-2.png)
...
![Supporting a Beam (3), downloadable IGCSE & GCSE Physics revision notes](../../../assets/05c59a549ea9-1-4-2-supporting-a-beam-3.png)
