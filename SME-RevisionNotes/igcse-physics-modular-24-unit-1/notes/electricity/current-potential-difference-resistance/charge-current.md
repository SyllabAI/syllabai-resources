---
note_id: "rn_Zpxy2GTmqmfjrYbf"
title: "Charge & Current"
source: https://www.savemyexams.com/igcse/physics/edexcel/modular/24/unit-1/revision-notes/electricity/current-potential-difference-resistance/charge-current
path: electricity/current-potential-difference-resistance/charge-current
updated_at: "2026-02-17T10:39:49.369Z"
spec_point_ids: ["spcpt_Nh8Ywn6rrQDycQSZ", "spcpt_gMynqWvFHrsFwt9S", "spcpt_3tQrCDDZvGCyyJt7"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_Nh8Ywn6rrQDycQSZ` · know that current is the rate of flow of charge
...
> **Spec point** — `spcpt_gMynqWvFHrsFwt9S` · know that electric current in solid metallic conductors is a flow of negatively charged electrons
...
> **Spec point** — `spcpt_3tQrCDDZvGCyyJt7` · know and use the relationship between charge, current and time: charge = current × time 
Q = I × t
