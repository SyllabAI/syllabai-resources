---
note_id: "rn_tgtnxj2vfCYQqbQy"
title: "Nuclear Reactors"
source: https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/7-radioactivity-and-particles/7-3-fission-and-fusion/7-3-3-nuclear-reactors
path: 7-radioactivity-and-particles/7-3-fission-and-fusion/7-3-3-nuclear-reactors
updated_at: "2026-07-02T08:19:39.046Z"
spec_point_ids: ["spcpt_4tVGbFPBjGdTHyss", "spcpt_r8JFMXSR2TcS65nb", "spcpt_msZmnPzfNRdJRq3W"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_4tVGbFPBjGdTHyss` · describe how a chain reaction can be set up if the neutrons produced by one fission strike other U-235 nuclei 
...
![Chain reaction analogy, downloadable IGCSE & GCSE Physics revision notes](../../../assets/71e41d900cde-4-4-2-chain-reaction-analogy.png)
...
> 
> ![Chain Reaction Worked Example, downloadable IGCSE & GCSE Physics revision notes](assets/fdeae314d2b3-4-4-3-chain-reaction-worked-example.png)
> 
...
> 
> ![chain-reaction, IGCSE & GCSE Physics revision notes](assets/998b27022364-chain-reaction.png)
...
> **Spec point** — `spcpt_r8JFMXSR2TcS65nb` · describe the role played by the control rods and moderator in the fission process 
...
![Nuclear Reactor Components, downloadable AS & A Level Physics revision notes](../../../assets/7d0158adf74f-8-4-6-nuclear-reactor-components.png)
...
> **Spec point** — `spcpt_msZmnPzfNRdJRq3W` · understand the role of shielding around a nuclear reactor 
...
![Shielding, downloadable IGCSE & GCSE Physics revision notes](../../../assets/6be0956add3f-7-3-3-shielding.png)
