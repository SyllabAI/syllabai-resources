---
note_id: "rn_vctGRbxP4NVz34JT"
title: "Efficiency"
source: https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/4-energy-resources-and-energy-transfers/4-1-energy-stores-and-transfers/4-1-3-efficiency
path: 4-energy-resources-and-energy-transfers/4-1-energy-stores-and-transfers/4-1-3-efficiency
updated_at: "2026-07-02T08:19:38.997Z"
spec_point_ids: ["spcpt_qdQt4JMjsKZJXqFc", "spcpt_C4r7Yj6dPrx978Nv"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_qdQt4JMjsKZJXqFc` · know and use the relationship between efficiency, useful energy output and total energy output: 
...
- Efficiency is defined as: **The ratio of the useful energy output from a system to its total energy output**
...
> **Spec point** — `spcpt_C4r7Yj6dPrx978Nv` · describe a variety of everyday and scientific devices and situations, explaining the transfer of the input energy in terms of the above relationship, including their representation by Sankey diagrams 
...
![8-1-2-sankey-diagram-demonstration_sl-physics-rn](../../../assets/97d1ceb3c755-8-1-2-sankey-diagram-demonstration-sl-physics-rn.png)
...
![cie-igcse-1-7-4-phy-rn-sankey-comparison-new](../../../assets/4ed1d0700af2-cie-igcse-1-7-4-phy-rn-sankey-comparison-new.png)
...
> 
> ![WE Sankey Question image, downloadable IGCSE & GCSE Physics revision notes](assets/462fe2156d21-3-1-3-we-sankey-question-image.png)
> 
