---
note_id: "rn_8859pDM2R7Y4qVKc"
title: "Electromagnetic Induction"
source: https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/6-magnetism-and-electromagnetism/6-2-electromagnetic-induction/6-2-1-electromagnetic-induction
path: 6-magnetism-and-electromagnetism/6-2-electromagnetic-induction/6-2-1-electromagnetic-induction
updated_at: "2026-07-02T08:19:39.021Z"
spec_point_ids: ["spcpt_ffqP78rxhbVF9ZTt"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_ffqP78rxhbVF9ZTt` · know that a voltage is induced in a conductor or a coil when it moves through a magnetic field or when a magnetic field changes through it and describe the factors that affect the size of the induced voltage 

## Electromagnetic induction

- Electromagnetic (EM) induction is used to generate electricity
- EM induction is when: **A voltage is induced in a conductor or a coil when it moves through a magnetic field or when a magnetic field changes through it**
...
![](../../../assets/33774e818aef-em-induction-1-1.png)
...
![coil-induction, IGCSE & GCSE Physics revision notes](../../../assets/9a0d388365c9-coil-induction.png)
