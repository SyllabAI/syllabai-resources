---
note_id: "rn_WzQZfyNNFFFFghbF"
title: "IV Graphs"
source: https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/2-electricity/2-2-components-in-series-and-parallel-circuits/2-2-4-iv-graphs
path: 2-electricity/2-2-components-in-series-and-parallel-circuits/2-2-4-iv-graphs
updated_at: "2026-07-02T14:55:22.776Z"
spec_point_ids: ["spcpt_s7rzWKXsttVDYVVC", "spcpt_BY8BNwQqP7HB858B"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_s7rzWKXsttVDYVVC` · describe how current varies with voltage in wires, resistors, metal filament lamps and diodes, and how to investigate this experimentally 
...
![Linear & Non-linear elements, downloadable IGCSE & GCSE Physics revision notes](../../../assets/6112c462d550-2-1-6-linear-non-linear-elements.png)
...
![](../../../assets/babed6564ed4-2-1-6-ohms-law-graph.png)
...
![Filament lamp IV graph, downloadable AS & A Level Physics revision notes](../../../assets/3c93e70b2b26-9-2-3-filament-lamp-iv-graph.png)
...
![](../../../assets/ad680122ff24-2-1-6-diode-i-v-graph.png)

***IV graph for a semiconductor diode***

> **Exam Hint**
> It is a common misconception among students that the gradient of an *IV* graph is equal to the reciprocal of the resistance. This is **only** true for **linear** *IV* graphs with straight lines through the origin.
> 
> To calculate the resistance of a component with a **non-linear** *IV* graph at a given point, read the values of current and voltage for that point and use the definition of resistance as the ratio of voltage to current.
...
![Investigation of Current and Voltage, downloadable IGCSE & GCSE Physics revision notes](../../../assets/879099b5b470-10-2-4-investigation-of-current-and-voltage.png)
...
> **Spec point** — `spcpt_BY8BNwQqP7HB858B` · describe the qualitative effect of changing resistance on the current in a circuit 
...
![Fixed & Variable Resistor, downloadable IGCSE & GCSE Physics revision notes](../../../assets/1984fc789bab-2-1-5-fixed-variable-resistor.png)
