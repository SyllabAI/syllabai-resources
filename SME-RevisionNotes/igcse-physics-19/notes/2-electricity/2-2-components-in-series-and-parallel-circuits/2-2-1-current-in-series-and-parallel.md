---
note_id: "rn_BFQBSmVz2xFZVsB6"
title: "Current in Series & Parallel"
source: https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/2-electricity/2-2-components-in-series-and-parallel-circuits/2-2-1-current-in-series-and-parallel
path: 2-electricity/2-2-components-in-series-and-parallel-circuits/2-2-1-current-in-series-and-parallel
updated_at: "2026-07-08T13:25:44.166Z"
spec_point_ids: ["spcpt_TtzRfVDZ2hwNvKkd", "spcpt_fvpBfKKst5Mh4V6P"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_TtzRfVDZ2hwNvKkd` · understand how the current in a series circuit depends on the applied voltage and the number and nature of other components 
...
![Current in a series circuit, downloadable AS & A Level Physics revision notes](../../../assets/dae9503466e7-10-1-2-1-current-in-a-series-circuit.png)
...
![Current in Series Circuits, downloadable IGCSE & GCSE Physics revision notes](../../../assets/ac44b07389ec-2-2-1-current-in-series-circuits.png)
...
> **Spec point** — `spcpt_fvpBfKKst5Mh4V6P` · understand why current is conserved at a junction in a circuit 
...
![Diagram of circuit junctions showing currents I₁ and I₂ combining to I₁+I₂ and splitting from I₁+I₂ into I₁ and I₂, illustrating conservation of current.](../../../assets/05b08c07b4cb-21019-junctions-current-splitting.png)
...
> 
> ![WE Current Conservation Question image, downloadable IGCSE & GCSE Physics revision notes](assets/cd6a67137986-10-1-5-we-current-conservation-question-image.png)
> 
...
> 
> ![WE Current Conservation Solution image, downloadable IGCSE & GCSE Physics revision notes](assets/ebb017ddd3e0-10-1-5-we-current-conservation-solution-image.png)
> 
...
> 
> ![Flow of charge, downloadable AS & A Level Physics revision notes](assets/7ea6836a6421-9-1-1-1-flow-of-charge.png)
