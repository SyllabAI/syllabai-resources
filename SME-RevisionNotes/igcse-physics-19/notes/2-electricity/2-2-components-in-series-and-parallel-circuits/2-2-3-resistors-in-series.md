---
note_id: "rn_PyxMmTd6S9pMDTt6"
title: "Resistors in Series"
source: https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/2-electricity/2-2-components-in-series-and-parallel-circuits/2-2-3-resistors-in-series
path: 2-electricity/2-2-components-in-series-and-parallel-circuits/2-2-3-resistors-in-series
updated_at: "2026-07-02T08:19:38.983Z"
spec_point_ids: ["spcpt_G6qBQF8fCYTgtC6H"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_G6qBQF8fCYTgtC6H` · calculate the currents, voltages and resistances of two resistive components connected in a series circuit 
...
- For two resistors of resistance *R*<sub>*1*</sub> and *R*<sub>*2*</sub>, the total resistance can be calculated using the equation:
...
![combined-resistance, IGCSE & GCSE Physics revision notes](../../../assets/3aedd078ebf8-combined-resistance.png)
...
> 
> What is the resistance value of *R*<sub>*2*</sub>?
> 
> ![](assets/6ace15c22546-we-resistors-in-series-question-image.png)
> 
...
> 
> 60 Ω = 30 Ω + *R*<sub>*2*</sub> + 10 Ω
> 
> **Step 3: Rearrange for *****R***<sub>***2***</sub>
> 
> *R*<sub>*2*</sub> = 60 Ω – 30 Ω – 10 Ω = **20 Ω**

> **Worked Example**
> Dennis sets up a series circuit as shown below.
> 
> ![WE Series Circuit Question image, downloadable IGCSE & GCSE Physics revision notes](assets/e52a458da067-10-2-1-we-series-circuit-question-image.png)
> 
