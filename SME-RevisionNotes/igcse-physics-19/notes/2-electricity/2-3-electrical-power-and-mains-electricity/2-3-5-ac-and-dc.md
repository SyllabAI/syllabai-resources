---
note_id: "rn_NgxJhPpm5Zs7kFSz"
title: "AC & DC"
source: https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/2-electricity/2-3-electrical-power-and-mains-electricity/2-3-5-ac-and-dc
path: 2-electricity/2-3-electrical-power-and-mains-electricity/2-3-5-ac-and-dc
updated_at: "2026-07-02T08:19:38.991Z"
spec_point_ids: ["spcpt_hQdjVDFdpFhbFxwd"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_hQdjVDFdpFhbFxwd` · know the difference between mains electricity being alternating current (a.c.) and direct current (d.c.) being supplied by a cell or battery 
...
- A direct current (d.c.) is defined as **A steady current, constantly flowing in the same direction in a circuit, from positive to negative**
...
![ac-&-dc, IGCSE & GCSE Physics revision notes](../../../assets/f32a21394813-ac-dc.png)
