---
note_id: "rn_X6gTfQ5T8ytPfDgR"
title: "Doppler Shift"
source: https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/8-astrophysics/8-3-cosmology/8-3-2-doppler-shift
path: 8-astrophysics/8-3-cosmology/8-3-2-doppler-shift
updated_at: "2026-07-02T08:19:39.070Z"
spec_point_ids: ["spcpt_hMBSQJX34yf9SYvY", "spcpt_7My6nZPBPXzfQX7B"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_hMBSQJX34yf9SYvY` · describe that if a wave source is moving relative to an observer there will be  a change in the observed frequency and wavelength (physics only)
...
![doppler-effect, IGCSE & GCSE Physics revision notes](../../../assets/425fe9e83469-doppler-effect-1.png)
...
> **Spec point** — `spcpt_7My6nZPBPXzfQX7B` · use the equation relating change in wavelength, wavelength, velocity of a galaxy and the speed of light: 
...
- Where:
  ...
  - λ<sub>0</sub> = reference wavelength in metres (m)
...
> **Worked Example**
> Light emitted from a star has a wavelength of 435 × 10<sup>-9</sup> m. A distance galaxy emits the same light but has a wavelength of 485 × 10<sup>-9</sup> m.
> 
> Calculate the speed at which the galaxy is moving relative to Earth.
> 
> The speed of light = 3 × 10<sup>8</sup> m/s.
> 
> **Answer:**
> 
> **Step 1: List the known quantities**
> 
> - Observed wavelength, *λ *= 485 × 10<sup>−9</sup> m
> - Reference wavelength, *λ*<sub>0</sub> = 435 × 10<sup>−9</sup> m
> 
...
> **Exam Hint**
> This Doppler effect equation will be provided for you in the exam, but make sure you understand how to use it, in particular, make sure you know the difference between shifted λ and unshifted λ<sub>0</sub> wavelength terms and get lots of practice using it
