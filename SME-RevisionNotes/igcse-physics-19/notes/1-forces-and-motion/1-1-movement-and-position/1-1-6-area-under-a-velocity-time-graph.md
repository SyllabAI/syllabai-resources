---
note_id: "rn_GxNWbSMqkTN4zgZB"
title: "Area under a Velocity-Time Graph"
source: https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/1-forces-and-motion/1-1-movement-and-position/1-1-6-area-under-a-velocity-time-graph
path: 1-forces-and-motion/1-1-movement-and-position/1-1-6-area-under-a-velocity-time-graph
updated_at: "2026-07-03T17:14:09.980Z"
spec_point_ids: ["spcpt_wXfdsrztsj5DkXkg"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_wXfdsrztsj5DkXkg` · determine the distance travelled from the area between a velocity−time graph and the time axis 
...
![Velocity-Time Area graph, downloadable IGCSE & GCSE Physics revision notes](../../../assets/0f339650b920-5-6-12-velocity-time-area-graph.png)
...
![Determining Distance on a V-T graph, downloadable IGCSE & GCSE Physics revision notes](../../../assets/e4772be0849c-5-6-12-determining-distance-on-a-v-t-graph.png)
...
> 
> ![Area Under a V-T graph question, downloadable IGCSE & GCSE Physics revision notes](assets/b33ae2455a14-2-1-8-area-under-a-v-t-graph-question.png)
> 
...
> 
> ![Area Under a V-T graph solution, downloadable IGCSE & GCSE Physics revision notes](assets/4f503377d914-2-1-8-area-under-a-v-t-graph-solution.png)
> 
...
> 
> If the velocity-time graph has a curved line, you can estimate the area under the curve by dividing it into multiple triangles and rectangles similar to the worked example above.
