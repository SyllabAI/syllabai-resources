---
note_id: "rn_9SWwrq7BZFhXQbsT"
title: "Density"
source: https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/5-solids-liquids-and-gases/5-1-density-and-pressure/5-1-1-density
path: 5-solids-liquids-and-gases/5-1-density-and-pressure/5-1-1-density
updated_at: "2026-07-02T15:28:31.561Z"
spec_point_ids: ["spcpt_b3q4sGVfrvw5DGm2"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_b3q4sGVfrvw5DGm2` · know and use the relationship between density, mass and volume: 
density = mass /volume
ρ = m / V
...
- Where:
  ...
  - *ρ *= density, measured in kilograms per metre cubed (kg/m<sup>3</sup>)
  - *m *= mass, measured in kilograms (kg)
  - *V *= volume, measured in metres cubed (m<sup>3</sup>)

#### Formula triangle for density, mass and volume

![Density triangle (2), IGCSE & GCSE Physics revision notes](../../../assets/122b03e55de0-density-triangle-2.png)
...
![Density comparison, downloadable AS & A Level Physics revision notes](../../../assets/465c592f3946-4-2-1-density-comparison.png)
...
![Volume of shapes, downloadable AS & A Level Physics revision notes](../../../assets/b517af5b3607-4-2-1-volume-of-shapes.png)
...
> - Volume of slab, *V* = 0.04 m × 0.5 m × 0.85 m = 0.017 m<sup>3</sup>
> 
