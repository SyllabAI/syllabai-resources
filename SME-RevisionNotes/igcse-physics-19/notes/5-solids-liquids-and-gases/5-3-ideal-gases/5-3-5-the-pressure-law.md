---
note_id: "rn_VrW4vQKk2VCQ2sQd"
title: "The Pressure Law"
source: https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/5-solids-liquids-and-gases/5-3-ideal-gases/5-3-5-the-pressure-law
path: 5-solids-liquids-and-gases/5-3-ideal-gases/5-3-5-the-pressure-law
updated_at: "2026-07-02T08:19:39.014Z"
spec_point_ids: ["spcpt_BPYBBHJhjh9XqTpt"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_BPYBBHJhjh9XqTpt` · use the relationship between the pressure and Kelvin temperature of a fixed mass of gas at constant volume:  P1 /T1 = P2 / T2
...
![Gas Laws Molecular Model (3), downloadable AS & A Level Physics revision notes](../../../assets/8a80507a35f7-6-5-2-gas-laws-molecular-model-3.png)
...
- Where:
  ...
  - *p*<sub>*1*</sub> = initial pressure (Pa)
  - *p*<sub>*2*</sub> = final pressure (Pa)
  - *T*<sub>*1*</sub> = initial temperature (K)
  - *T*<sub>*2*</sub> = final temperature (K)

![Pressure Law, downloadable AS & A Level Physics revision notes](../../../assets/b3aa853a082b-6-5-2-pressure-law.png)
...
> 
> - *p*<sub>*1*</sub>* = *5.10 × 10<sup>5</sup> Pa
> - *T*<sub>*1*</sub> = 279 K
> - *T*<sub>*2*</sub>* = *299 K
> 
> **Step 3: Rearrange for *****p***<sub>***2***</sub>*** *****and substitute values into the pressure law**
> 
> - To make *p*<sub>*2*</sub>* *the subject, multiply both sides by* T*<sub>*2 *</sub>to cancel out the *T*<sub>*2*</sub>* *in the fraction under* p*<sub>*2*</sub>
> 
