---
note_id: "rn_3YZNCXSQQqXTT6HR"
title: "Electrolysis Experiments"
...
path: 1-principles-of-chemistry/1-9-electrolysis/1-9-2-electrolysis-experiments
updated_at: "2026-09-14T13:05:24.035Z"
spec_point_ids: ["spcpt_pFfscNwwwXbrfgbM", "spcpt_6xCnwPWhpR5CttNr"]
spec_point_codes: ["4CH1-1.58C"]
guided_study: true
...
> **Spec point** — `spcpt_pFfscNwwwXbrfgbM` · describe experiments to investigate electrolysis, using inert electrodes, of molten compounds (including lead(II) bromide) and to predict the products
...
![Electrolysis of Lead Bromide, IGCSE & GCSE Chemistry revision notes](../../../assets/d3396430f518-electrolysis-of-lead-bromide.png)
...
> **Spec point** — `spcpt_6xCnwPWhpR5CttNr` · describe experiments to investigate electrolysis, using inert electrodes, of aqueous solutions (including sodium chloride, dilute sulfuric acid and copper(II) sulfate) and to predict the products

## Electrolysis of aqueous solutions

- Aqueous solutions will always contain water molecules (H<sub>2</sub>O)
- In the electrolysis of aqueous solutions, the water molecules dissociate producing H<sup>+</sup> and OH<sup>–</sup> ions:
...
- Negatively charged OH<sup>–</sup> ions and non-metal ions are attracted to the positive electrode
- If halide ions (Cl<sup>-</sup>, Br<sup>-</sup>, I<sup>-</sup>) and OH<sup>-</sup> are present then the halide ion is discharged at the anode, loses electrons and forms a halogen (chlorine, bromine or iodine)
- If no halide ions are present, then OH<sup>-</sup> is discharged at the anode, loses electrons and forms oxygen
- In both cases the other negative ion remains in solution

### What is produced at the cathode?

- Positively charged H<sup>+</sup> and metal ions are attracted to the negative electrode but only one will gain electrons
...
![The basic set-up of an electrolytic cell](../../../assets/db9d8c8e7e72-60569-basics-of-electrolysis.png)
