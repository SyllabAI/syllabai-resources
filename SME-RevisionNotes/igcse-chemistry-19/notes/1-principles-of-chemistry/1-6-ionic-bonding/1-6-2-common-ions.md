...
path: 1-principles-of-chemistry/1-6-ionic-bonding/1-6-2-common-ions
updated_at: "2024-08-21T10:56:29.329Z"
spec_point_ids: ["spcpt_M4GXnt7WGTmCbzFp"]
spec_point_codes: ["4CH1-1.38"]
guided_study: true
...
> **Spec point** — `spcpt_M4GXnt7WGTmCbzFp` · know the charges of these ions: 
• metals in Groups 1, 2 and 3
• non-metals in Groups 5, 6 and 7 
• Ag+, Cu2+, Fe2+, Fe3+, Pb2+, Zn2+
• hydrogen (H+), hydroxide (OH– ), ammonium (NH4 +), carbonate (CO3 2– ), nitrate (NO3 - ), sulfate (SO4 2– ).
