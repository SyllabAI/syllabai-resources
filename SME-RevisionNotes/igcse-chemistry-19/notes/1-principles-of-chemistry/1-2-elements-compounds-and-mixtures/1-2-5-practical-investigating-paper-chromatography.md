---
note_id: "rn_TsfqyK9BYMtN2Bfd"
title: "Practical: Investigating Paper Chromatography"
source: https://www.savemyexams.com/igcse/chemistry/edexcel/19/revision-notes/1-principles-of-chemistry/1-2-elements-compounds-and-mixtures/1-2-5-practical-investigating-paper-chromatography
path: 1-principles-of-chemistry/1-2-elements-compounds-and-mixtures/1-2-5-practical-investigating-paper-chromatography
updated_at: "2025-11-04T10:06:23.899Z"
spec_point_ids: ["spcpt_cndDJFNXGZ5KY3gZ"]
spec_point_codes: ["4CH1-1.13"]
guided_study: true
...
![paper-chromatography-new](../../../assets/f14cefa5953b-paper-chromatography-new.png)
...
- This can lead to smearing and an inaccurate measurement of the *R*<sub>f</sub> value
...
- Therefore, you cannot calculate the *R*<sub>f</sub> values
...
| **Food colouring ** | **Distance moved by spot (mm)** | **Distance Moved by solvent (mm)** | ***R***<sub>**f **</sub>**value ** |
|---|---|---|---|
| A |   |   |   |
| B |   |   |   |
| C |   |   |   |
...
- The *R*<sub>f</sub> values of food colours A, B, C and D should be compared to that for the unknown sample as well as a visual comparison being made
