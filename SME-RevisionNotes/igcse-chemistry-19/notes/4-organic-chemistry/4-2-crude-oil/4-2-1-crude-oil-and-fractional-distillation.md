...
path: 4-organic-chemistry/4-2-crude-oil/4-2-1-crude-oil-and-fractional-distillation
updated_at: "2025-10-30T14:35:24.443Z"
spec_point_ids: ["spcpt_pRGVQD76dB6Fmnfv", "spcpt_WpZQk23vMdtyy6v2"]
spec_point_codes: ["4CH1-4.8", "4CH1-4.9"]
guided_study: true
...
> **Spec point** — `spcpt_pRGVQD76dB6Fmnfv` · know that crude oil is a mixture of hydrocarbons
...
![Fractional-Distillation, IGCSE & GCSE Chemistry revision notes](../../../assets/15142aa12293-fractional-distillation.png)
...
> **Spec point** — `spcpt_WpZQk23vMdtyy6v2` · know the names and uses of the main fractions obtained from crude oil: refinery gases, gasoline, kerosene, diesel, fuel oil and bitumen
...
| Gasoline / petrol | Fuel for cars (gasoline) |
| Kerosene / paraffin | Jet fuel (paraffin) |
| Diesel / gas oil | Diesel engines (gas oil) |
| Fuel oil | Ships & power stations |
| Bitumen | Surfacing roads and roofs |

> **Exam Hint**
> You need to learn the names and uses of the main fractions obtained from crude oil: refinery gases(also known as liquid petroleum gases), gasoline, kerosene, diesel, fuel oil and bitumen.
> 
