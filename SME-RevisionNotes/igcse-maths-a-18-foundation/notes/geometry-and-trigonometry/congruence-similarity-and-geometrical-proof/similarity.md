---
note_id: "rn_vb5bPffDKhgdYsqt"
title: "Similarity"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/foundation/revision-notes/geometry-and-trigonometry/congruence-similarity-and-geometrical-proof/similarity
path: geometry-and-trigonometry/congruence-similarity-and-geometrical-proof/similarity
updated_at: "2026-01-27T15:34:16.929Z"
spec_point_ids: ["spcpt_HcBpSfpzpdZqCFXk"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_HcBpSfpzpdZqCFXk`
...
> **Exam Hint**
> A pair of **similar triangles** can often be **opposite** each other in an hourglass formation. Look out for the **vertically opposite**, equal angles.
> 
...
> 
> ![Two similar rectangles](assets/b5f597ba42b5-18250-similarity-1.png)
> 
> **Answer:**
> 
...
> $\frac{5}{2}=2.5$
> 
> **Final answer:** **The two rectangles are similar, with a scale factor of 2.5**
> 
> (b) In the diagram below, *AB* and *CD* are parallel lines.
> Show that triangles *ABX* and *CDX* are similar.
> 
> ![Two similar triangles](assets/f0bbe808b280-43701-similarity-2.png)
> 
> **Answer:**
> 
