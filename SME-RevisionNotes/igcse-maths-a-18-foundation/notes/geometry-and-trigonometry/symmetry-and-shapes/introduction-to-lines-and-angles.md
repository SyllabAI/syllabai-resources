---
note_id: "rn_nYwTMH2sFt6Q9qg7"
title: "Introduction to Lines & Angles"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/foundation/revision-notes/geometry-and-trigonometry/symmetry-and-shapes/introduction-to-lines-and-angles
path: geometry-and-trigonometry/symmetry-and-shapes/introduction-to-lines-and-angles
updated_at: "2026-02-23T11:31:04.759Z"
spec_point_ids: ["spcpt_K8Fq9F3GXSkCRN75"]
spec_point_codes: []
guided_study: true
---
...
- Two lines are **parallel** if they continue in the **same direction as each other** forever
  ...
  - Parallel lines should be marked with arrows
    ...
    - If there is more than one pair (or set) of parallel lines in a diagram then multiple arrows will be used ![Diagonals of a parallelogram](assets/daf73f690c36-16835-introduction-to-lines-and-angles.png)
...
![types of angle - acute, right, obtuse, reflex](../../../assets/353459af0dee-14133-introduction-to-lines-and-angles-2.png)
