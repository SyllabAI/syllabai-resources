---
note_id: "rn_y34CVGKVXbyXvc8r"
title: "Introduction to Sequences"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/foundation/revision-notes/sequences-functions-and-graphs/sequences/introduction-to-sequences
path: sequences-functions-and-graphs/sequences/introduction-to-sequences
updated_at: "2026-05-15T10:53:17.322Z"
spec_point_ids: ["spcpt_NNhjQfXtS7sNJyHD"]
spec_point_codes: []
guided_study: true
---
...
- Another way to show the position of a term is using **subscripts**
  ...
  - A general sequence is given by *a*<sub>1</sub>, *a*<sub>2</sub>, *a*<sub>3</sub>, ...
    ...
    - ***a***<sub>**1**</sub> represents the **1st term**
    - ***a***<sub>**2**</sub> represents the **2nd term**
...
- For example, the *n *th term is *n*<sup>2</sup>  + 1

  - The 1st term is 1 <sup>2</sup>  + 1 = 2
  - The 2nd term is  2<sup>2</sup>  + 1 = 5
  - The 100th term is 100<sup>2</sup>  + 1 = 10 001
