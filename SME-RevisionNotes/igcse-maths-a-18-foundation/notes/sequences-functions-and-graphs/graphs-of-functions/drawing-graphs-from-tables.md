---
note_id: "rn_4wbVKBQQxj5kWNwh"
title: "Drawing Graphs from Tables"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/foundation/revision-notes/sequences-functions-and-graphs/graphs-of-functions/drawing-graphs-from-tables
path: sequences-functions-and-graphs/graphs-of-functions/drawing-graphs-from-tables
updated_at: "2026-01-19T12:19:26.464Z"
spec_point_ids: ["spcpt_7JDJGb5jbwdfKXMG"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_7JDJGb5jbwdfKXMG`
...
- Always put **brackets** around them and use **BIDMAS**
  ...
  - For example, *x*  = -3 in *y*  = -*x*<sup>2</sup>  + 8*x*
  
    - becomes *y*  = -(-3)<sup>2</sup> + 8(-3)
    - which simplifies to -9 - 24
    - so *y * = - 33
- For **reciprocal **graphs like $y=\frac{1}{x}$, do **not include *****x ***** = 0**
  ...
  - There is no value at *x*  = 0
    ...
    - The curved branches can't cross the *y*-axis
...
> | $x$ | $-1.5$ | $-1$ | $-0.5$ | $0$ | $0.5$ | $1$ | $1.5$ |
> |---|---|---|---|---|---|---|---|
> | $y$ | **Final answer:** **-8** | $2$ | **Final answer:** **8** | **Final answer:** **10** | **Final answer:** **8** | **Final answer:** **2** | $-8$ |
> 
...
> 
> ![cie-igcse-2018-may-jun-1-7](assets/2e0c6e215488-63317-drawing-graphs-from-tables.png)
> 
