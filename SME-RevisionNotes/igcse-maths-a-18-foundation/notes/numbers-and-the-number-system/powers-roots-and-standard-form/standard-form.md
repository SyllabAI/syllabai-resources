---
note_id: "rn_88DPWyhHkGSPW4Nf"
title: "Converting to & from Standard Form"
source: https://www.savemyexams.com/igcse/maths/edexcel/a/18/foundation/revision-notes/numbers-and-the-number-system/powers-roots-and-standard-form/standard-form
path: numbers-and-the-number-system/powers-roots-and-standard-form/standard-form
updated_at: "2026-02-11T16:03:54.984Z"
spec_point_ids: ["spcpt_9T2dpGhRRNvzf2n3"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_9T2dpGhRRNvzf2n3`
...
- Where:
  ...
  - $1\leqa<10$ ($a$ is **bigger than or equal to 1 and less than 10**)
  - $n$ is an **integer**
  
    - $n<0$ ($n$ is **negative**) for numbers bigger than 0 and less than 1
    - $n=0$ for numbers bigger than or equal to 1 and less than 10
    - $n>0$ ($n$ is **positive**) for numbers bigger than or equal to 10
...
- To write a **large number** such as 32 400 in standard form
  ...
  - 32 400 = 3.24 × 10 × 10 × 10 × 10 = **3.24 × 10**<sup>**4**</sup>

![Number 32400 written in scientific notation as 3.24 times 10 to the power of 4, with visual explanation using place value and arrow notation.](../../../assets/e5581901daf3-14323-standard-form-bigger-than-10.png)
...
- To write a **small number** such as 0.0000324 in standard form
  ...
  - 0.0000324 = 3.24 ÷ 10 ÷ 10 ÷ 10 ÷ 10 ÷ 10 = **3.24 × 10**<sup>**-5**</sup>

![Steps showing division of 324 by 10 repeatedly, resulting in 0.0000324, which equals 3.24 times 10 to the power of minus 5.](../../../assets/beb16df77056-65324-standard-form-less-than-1.png)
...
> **Answer:**
> 
> > *Standard form will be written as **a** × 10*<sup>*n*</sup>* where **a** is between 1 and 10*
...
> > *Therefore **n** = -3.*
> 
> **Final answer:** **0.007052 =**** 7.052 × 10**<sup>**-3**</sup>
> 
...
> > *Therefore **n** = 8*
> 
> **Final answer:** **324 500 000 =**** 3.245 × 10**<sup>**8**</sup>** **
