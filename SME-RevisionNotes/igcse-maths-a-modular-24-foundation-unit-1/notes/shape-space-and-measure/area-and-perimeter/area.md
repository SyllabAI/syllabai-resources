---
note_id: "rn_QHvpQdFrr7pGgHdh"
title: "Area"
source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/foundation-unit-1/revision-notes/shape-space-and-measure/area-and-perimeter/area
path: shape-space-and-measure/area-and-perimeter/area
updated_at: "2026-01-27T13:16:20.473Z"
spec_point_ids: ["spcpt_cWybMsd7STKjVBhx", "spcpt_FBH2bdb7K2GH7KxZ"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_cWybMsd7STKjVBhx`
...
- Area is calculated using lengths in **two dimensions**
  ...
  - **Units of measure **include mm<sup>2</sup>, cm<sup>2</sup>, m<sup>2</sup> etc
...
> **Worked Example**
> Work out the area of the shaded quadrilateral shown on the grid below. Each square on the grid represents 1 cm<sup>2</sup>.
> 
> ![cie-igce-core-rn-area-we-diagram](assets/9523ba23f2b5-37560-area-1.png)
> 
> **Answer:**
> 
> > *Count the number of whole squares, keeping track of which you have counted so far*
> 
> ![cie-igce-core-rn-area-we-diagram-2](assets/5b8403d90cc4-46871-area-2.png)
> 
> *Count the partially shaded squares*
> *Try to pair-up fractions of the squares to make whole squares*
> 
> ![E6YLVyoW_cie-igce-core-rn-area-we-diagram-3](assets/6df61a19aa22-48835-area-3.png)
> 
> > *There are 14 whole squares in total, and the shape was drawn on a 1 cm*<sup>*2*</sup>* grid*
> 
> **Final answer:** **Total area is 14 cm**<sup>**2**</sup>

## Area Formulas

> **Spec point** — `spcpt_FBH2bdb7K2GH7KxZ`

## Area formulas

### Which area formulas do I need to know?

![Area formulae for rectangle, triangle, trapezium and parallelogram](../../../assets/973e9c4a941e-56013-area-4.png)
...
- The area, *A*, of a **triangle** with base, *b*, and height, *h*, can be found using the formula
...
> (a)
> 
> ![A trapezium](assets/65cc99ec6260-49208-area-5.png)
> 
> **Answer:**
> 
...
> 
> **Final answer:** **450 cm**<sup>**2**</sup>
> 
> (b)
> 
> ![Parallelogram with base 15 cm and height 12 cm indicated, outlined on a white background, with arrows showing dimensions.](assets/5a1a074dfc4b-2070-area-6.png)
> 
> **Answer:**
> 
...
> $A=15\times12$
> 
> **Final answer:** **180 cm**<sup>**2**</sup>
> 
> (c)
> 
> ![A right-angled triangle](assets/75e2019a4ac2-62809-area-7.png)
> 
> **Answer:**
> 
