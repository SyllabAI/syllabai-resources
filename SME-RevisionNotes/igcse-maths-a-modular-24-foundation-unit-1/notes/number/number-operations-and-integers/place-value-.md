---
note_id: "rn_xjY2WZs8Q3jSjQBV"
title: "Place Value"
source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/foundation-unit-1/revision-notes/number/number-operations-and-integers/place-value-
path: number/number-operations-and-integers/place-value-
updated_at: "2026-04-19T07:55:50.605Z"
spec_point_ids: ["spcpt_xw9z6fM2cqDvqCt9"]
spec_point_codes: []
guided_study: true
---
...
> **Spec point** — `spcpt_xw9z6fM2cqDvqCt9`
...
- 12 345 678 starts in the ten millions place value
...
> **Exam Hint**
> Separate numbers with lots of digits into groups of three digits to make reading them easier. Start with the units and work to the left.
> 
> For example, 54687321 is easier to read as 54 687 321.
> 
> Large numbers are normally written with spaces between the groups of three digits.
...
- e.g. For the number 36.952
  ...
  - The 2 represents 2 **thousandths** (0.002)
...
> | *8* | *7* | *6* | *5* | *4* |
> 
> **Final answer:** ** 7 000 or s****even thousand**
> 
...
> | *1* | *4* | *.* | *2* | *6* | *3* |
> 
> **Final answer:** **0.003 seconds ****or 3 thousandths of a second**
