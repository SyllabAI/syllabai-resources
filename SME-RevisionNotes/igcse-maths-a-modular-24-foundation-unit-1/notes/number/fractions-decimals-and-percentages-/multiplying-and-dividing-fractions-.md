---
note_id: "rn_Rp6bdvGS4YFMYr3Y"
title: "Multiplying & Dividing Fractions"
source: https://www.savemyexams.com/igcse/maths/edexcel/a-modular/24/foundation-unit-1/revision-notes/number/fractions-decimals-and-percentages-/multiplying-and-dividing-fractions-
path: number/fractions-decimals-and-percentages-/multiplying-and-dividing-fractions-
updated_at: "2026-02-20T10:07:55.585Z"
spec_point_ids: ["spcpt_3sptc2fDMgGnNYqg", "spcpt_Fbm5V3ByzktDQbh5"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_3sptc2fDMgGnNYqg`
...
- **Multiply**
  ...
  - $\frac{3}{5}\times\frac{2}{11}=\frac{3\times2}{5\times11}=\frac{6}{55}$
...
> **Worked Example**
> Show that $\frac{4}{15}\times\frac{25}{11}=\frac{20}{33}$.
> 
> **Answer:**
> 
...
> 
> * *$\frac{4\times5}{3\times11}=\frac{20}{33}$
> 
...
> **Spec point** — `spcpt_Fbm5V3ByzktDQbh5`
...
- **Flip **the second fraction and **change** **÷** into **×** ”
  ...
  - $\frac{1}{3}\div\frac{4}{5}$  becomes  $\frac{1}{3}\times\frac{5}{4}$
...
> **Worked Example**
> Show that $3\frac{1}{4}\div\frac{3}{8}=8\frac{2}{3}$.
> 
> **Answer:**
> 
...
> > *Multiply the fractions*
> 
> $\frac{13\times2}{1\times3}=\frac{26}{3}$
> 
