---
note_id: "rn_YkgnYb7KR5fj8xyP"
title: "Letter Model Answer"
source: https://www.savemyexams.com/igcse/english-language/edexcel/a/16/paper-1-non-fiction-texts-and-transactional-writing/revision-notes/paper-1-non-fiction/paper-1-section-b-writing/letter-model-answer
path: paper-1-non-fiction/paper-1-section-b-writing/letter-model-answer
updated_at: "2026-09-15T09:41:11.817Z"
spec_point_ids: ["spcpt_XTdQ7VxBmkNCfVbk", "spcpt_24f3VcFBKxBYNkcw", "spcpt_7TnKtGwnqwFMTgPv"]
spec_point_codes: []
guided_study: false
---
...
> **Spec point** — `spcpt_XTdQ7VxBmkNCfVbk`
...
![An example of a letter task with a what who and why analysis.](../../../assets/10fae97e0af2-1-6.png)
...
> **Spec point** — `spcpt_24f3VcFBKxBYNkcw`
...
![A mindmap showing a plan for a letter called "Life in the 21st Century".](../../../assets/b9f54f28b8ab-2-10.png)

*Letter plan*

## Letter model answer with annotations

> **Spec point** — `spcpt_7TnKtGwnqwFMTgPv`
...
| **AO4** | 23-27 marks | - Communication is perceptive, mature and sophisticated<br>- The response is sharply focused on the purpose of the task and the expectations/requirements of the intended reader<br>- There is sophisticated use of form, tone and register |
|---|---|---|
| **AO5** | 16-18 marks | - The response manipulates complex ideas, using a range of structural and grammatical features to support overall coherence and cohesion<br>- The response uses extensive vocabulary strategically, with only occasional spelling errors which do not detract from overall meaning<br>- The response is punctuated with accuracy to aid emphasis and meaning, using a range of sentence structures accurately and selectively to achieve particular effects |
